        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="hero-buttons">
                    <!-- Ücretsiz Dene - Kayıt + Default Plan -->
                    <a href="{{ route('giris', ['register' => 1]) }}" class="btn-hero-primary">
...
<section class="cta-section">
    <div class="container">
        ...
        <p class="cta-description">
            {{ $cta['description'] ?? '14 gün ücretsiz deneyin.' }}
        </p>
        <!-- Kayıt + Default Plan -->
        <a href="{{ route('giris', ['register' => 1]) }}" class="btn btn-cta">
            <i class="{{ $cta['button_icon'] ?? 'fas fa-rocket' }} me-2"></i> 
            {{ $cta['button_text'] ?? 'Ücretsiz Denemeyi Başlat' }}
        </a>
    </div>
</section>
