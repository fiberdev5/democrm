...
<section class="integrations-section section" style="overflow-x: hidden;"> <!-- Yatay taşmayı engeller -->
    <div class="container">
        ...
        <div id="integrationsCarousel" class="carousel slide position-relative" data-bs-ride="carousel">
            ...
            <!-- Özel CSS: Bu bölümü head içine veya css dosyasına da taşıyabilirsiniz ama burada da çalışır -->
            <style>
                /* Genel Ok Stilleri */
                .custom-nav-btn {
                ...
                @media (min-width: 768px) {
                    .custom-nav-btn.prev-btn {
                        left: -70px; /* Müşteri yorumları gibi dışarı attık */
                    }
                    .custom-nav-btn.next-btn {
                        right: -70px; /* Müşteri yorumları gibi dışarı attık */
                    }
                }
                ...
                @media (max-width: 767px) {
                    ...
                    .custom-nav-icon {
                        width: 35px; 
                        height: 35px;
                        opacity: 0.9; /* İçeriği çok kapatmasın diye hafif şeffaf */
                    }
                }
            </style>
