    ...
    <div class="container">
        ...
        <div class="carousel-wrapper">
            <div id="integrationsCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <!-- Desktop Controls -->
                <button class="carousel-control-prev d-none d-md-flex" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="prev" style="width: 50px; left: -80px;">
                ...
                <button class="carousel-control-next d-none d-md-flex" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="next" style="width: 50px; right: -80px;">
                    <span style="width: 50px; height: 50px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
