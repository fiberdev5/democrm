...
>
  ...
  <button 
    @click="open = !open" 
    class="mb-4 inline-block w-full py-2 rounded-full border border-gray-300 text-gray-700 font-medium transition hover:bg-gray-100"
  >
    <span x-show="!open">Detayları Gör</span>
    <span x-show="open">Detayları Gizle</span>
  </button>
