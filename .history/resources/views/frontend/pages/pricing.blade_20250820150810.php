...
.price-description ul li::before {
  ...
  background-color: #212529; /* Marka renginiz */
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-start">
      @foreach($prices as $i => $price)
        ...
        <div class="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 p-8 flex flex-col text-center pricing-card">
          ...
          <p class="text-base text-gray-500 font-normal mb-2">Teknik servis süreçlerinizi dijitalleştirin, müşteri memnuniyetini artırın.</p>
          <div class="text-4xl font-extrabold text-gray-900 mb-4">
            ₺ {{$price->price}} <span class="text-base text-gray-500 font-normal">/aylık</span> <span class="text-base text-gray-900 font-normal" style="font-size: 11px">(%30 Kazanın)</span>
          </div>
