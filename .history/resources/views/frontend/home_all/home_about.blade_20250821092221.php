      ...
      <div class="row">
        <div class="col-lg-6">
            ...
            <div class="accordion-item">
              ...
              <div id="panelsStayOpen-collapse{{$faq->id}}" class="accordion-collapse collapse {{$faq->job == '1' ? 'show' : ''}}" aria-labelledby="panelsStayOpen-heading{{$faq->id}}" style="visibility: visible;">
