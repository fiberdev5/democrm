        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="hero-image">
                    <img src="{{ asset('images/dashboard-mockup.png') }}" alt="Serbis Dashboard" onerror="this.src='https://via.placeholder.com/600x450/0066FF/ffffff?text=Serbis+Dashboard'">
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-section">
    <div class="container">
        ...
        <button class="btn btn-cta" onclick="window.location.href='#'">
