...
p {
    font-size: 0.85rem;
        ...
        .auth-card {
            ...
            overflow: hidden;
             max-width: 600px; /* 700 yerine */
             width: 100%;
    min-height: auto; /* 600px sabit yükseklik yerine otomatik */
    padding: 20px; /* daha az iç boşluk */
        ...
        .form-control {
            ...
            border-radius: 10px;
            padding: 10px 12px; /* 12px yerine daha ince */
    font-size: 0.9rem;
            transition: all 0.3s ease;
        }
    ...
    <div class="main-container">
        <div class="auth-card">
            ...
            <div class="logo-section">
                {{-- <img src="{{ asset('frontend/img/serbis-logo.png') }}" alt="Serbis Logo"> --}}
                <h2>Serbis</h2>
            ...
            <div class="form-container">
                ...
                <div class="form-section" id="registerForm">
                    <form id="multiStepForm" method="POST" action="{{ route('kayit.action') }}">
                        @csrf
