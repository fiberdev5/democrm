...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Telefon Numaranızı Doğrulayın</div>
                ...
                <div class="card-body">
                    ...
                    <p>Lütfen <strong>{{ session('phone_number') }}</strong> numaralı telefona gönderilen 6 haneli doğrulama kodunu giriniz.</p>

                    <form method="POST" action="{{ route('sms.verification.verify') }}">
                        @csrf

                        <div class="form-group row">
                            <label for="code" class="col-md-4 col-form-label text-md-right">Doğrulama Kodu</label>
