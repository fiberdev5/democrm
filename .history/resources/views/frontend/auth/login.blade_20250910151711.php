...
<head>
    ...
    <style>
        ...
        .logo-section {
            ...
            padding: 10px 0 10px;
            color: white;
            background: #3e546a; /* DEĞIŞTI: Tek renk koyu mavi-gri */
        }
        ...
        .toggle-btn {
            ...
            text-align: center;
            background: none;
            border: 1px solid #3e546a; /* DEĞIŞTI: Koyu mavi-gri */
            border-radius: 50px;
            font-weight: 600;
            color: #666;
            cursor: pointer;
        ...
        .toggle-slider {
            ...
            width: 50%;
            height: 100%;
            background: linear-gradient(135deg, #f27c22 0%, #f58733 100%); /* Turuncu kalacak */
            border-radius: 50px;
        ...
        .form-control:focus {
            border-color: #3e546a; /* DEĞIŞTI: Koyu mavi-gri */
            box-shadow: 0 0 0 0.2rem rgba(62, 84, 106, 0.25); /* DEĞIŞTI: Koyu mavi-gri opacity */
        }
        ...
        .btn-primary:hover {
            background: linear-gradient(135deg, #e66b14 0%, #e47424 100%); /* Turuncu kalacak */
        ...
        .step.active .step-icon {
            background: linear-gradient(135deg, #3e546a 0%, #4a6280 100%); /* DEĞIŞTI: Koyu mavi-gri gradient */
            color: white;
            transform: scale(1.1);
        }

        .step.finish .step-icon {
            background: linear-gradient(135deg, #4caf50 0%, #45a049 100%); /* Yeşil kalacak */
            color: white;
        }
        ...
        .step.active .step-label {
            color: #3e546a; /* DEĞIŞTI: Koyu mavi-gri */
            font-weight: 700;
        }
        ...
        .countdown-timer {
            ...
            background: #f8f9fa;
            border-radius: 10px;
            border-left: 4px solid #3e546a; /* DEĞIŞTI: Koyu mavi-gri */
        }
