            ...
            <div class="form-container">
                ...
                <div class="form-section active" id="loginForm">
                    <form method="POST" action="{{ route('giris.action') }}">
                        ...
                        <div class="mb-3">
                            <label for="loginUsername" class="form-label" style="color: #333; font-weight: 500;">
                        ...
                        <div class="mb-3">
                            <label for="loginFirmaKodu" class="form-label" style="color: #333; font-weight: 500;">
                                Firma Kodu <span style="color: #dc3545;">*</span>
                            </label>
                            <div class="input-wrapper">
                                <input type="text" name="firma_kodu" id="loginFirmaKodu" class="form-control firma-kodu" 
                                       placeholder="000000" required maxlength="6" value="{{ old('firma_kodu') }}">
                                <div class="info-icon">
                        ...
                        <div class="mb-3">
                            <label for="loginPassword" class="form-label" style="color: #333; font-weight: 500;">
