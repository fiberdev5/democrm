...
<div class="container d-flex align-items-center justify-content-center register-container" style="min-height: 100vh;">
    ...
    <div class="alert alert-info d-inline-flex align-items-center gap-2 py-2 px-3 shadow-sm rounded-pill">
        <i class="bi bi-clock-history"></i>
        <span>Kodu girmek için </span>
        <span id="countdown" class="fw-bold text-dark">03:00</span>
        <span> dakikanız var</span>
    </div>

    <div class="mt-3" id="resend-container" style="display:none;">
        <a href="{{ route('sms.verification.resend') }}" 
           class="btn btn-outline-primary btn-sm rounded-pill shadow-sm" 
           id="resend-link">
           <i class="bi bi-arrow-repeat"></i> Kodu yeniden gönder
        </a>
    </div>
</div>
