    ...
    <script>
        $(document).ready(function() {
            ...
            function showPlanInfo(planData) {
                ...
                // Plan limits
                featuresHtml += `<span class="plan-feature"><strong>Kullanıcı:</strong> ${planData.users}</span>`;
                featuresHtml += `<span class="plan-feature"><strong>Bayi:</strong> ${planData.dealers}</span>`;
                featuresHtml += `<span class="plan-feature"><strong>Stok:</strong> ${planData.stocks}</span>`;
                featuresHtml += `<span class="plan-feature"><strong>Konsinye:</strong> ${planData.konsinye}</span>`;
