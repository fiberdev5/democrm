      ...
      <div class="row w-100">
        ...
        <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="">
                    ...
                    <p>Kodu girebilmek için <span id="countdown">03:00</span> dakikanız var.</p>
                    <div class="mt-2" id="resend-container" style="display:none;">
                        <a href="{{ route('sms.verification.resend') }}" id="resend-link">Kodu yeniden gönder</a>
                    </div>
