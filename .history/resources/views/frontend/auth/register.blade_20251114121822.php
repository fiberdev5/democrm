...
<body>  
        ...
        $('#nextBtn').on('click', function(e) {
            ...
            if (currentStep === 2) {
                ...
                error: function(xhr) {
                    ...
                    // Input'ları temizle ve focus'u ilk input'a al
    ...
    <script>
    // Toastr'ın yüklendiğini kontrol et
    if (typeof toastr === 'undefined') {
        console.error('Toastr kütüphanesi yüklenmedi!');
    }
</script>
