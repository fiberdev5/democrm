<footer class="footer">
    <div class="container">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="footer-brand mb-3">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <div style="width: 45px; height: 45px; background: linear-gradient(135deg, var(--primary-blue), var(--orange)); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-cogs" style="color: white; font-size: 1.5rem;"></i>
                        </div>
                        <div>
                            <h3 style="margin: 0; font-size: 1.8rem; font-weight: 700; color: white; letter-spacing: -0.5px;">
                                Serbis
                            </h3>
                            <p style="margin: 0; font-size: 0.75rem; color: var(--gray); letter-spacing: 1px;">
                ...
                <div class="mb-3">
                    <p class="mb-2" style="font-weight: 600; color: var(--dark);">Mobil Uygulamayı İndirin</p>
        ...
        <div class="footer-bottom text-center">
            <p class="mb-0" style="color: var(--gray); font-size: 0.95rem;">
                &copy; {{ date('Y') }} Serbis. Tüm hakları saklıdır.
            </p>
        </div>
    </div>
</footer>