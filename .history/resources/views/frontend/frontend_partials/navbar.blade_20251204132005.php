<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="{{ asset('frontend/img/logo_turkce.png') }}" alt="Serbis Logo" style="height: 55px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('') }}">AnaSayfa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('sectors') }}">Sektörler</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/ozellikler') }}">Özellikler</a>
                </li>
                <li class="nav-item">
