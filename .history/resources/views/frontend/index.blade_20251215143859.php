                    ...
                    <div class="hero-mockup-main">
                        <div class="mockup-browser">
                            <div class="browser-header">
                                ...
                                <div class="browser-url">serbis.app/dashboard</div>
                            </div>
                            <div class="browser-content">
                                <img src="{{ asset($hero['image']) }}" 
                                     alt="Serbis Dashboard" 
                                     onerror="this.src='https://via.placeholder.com/800x600/f8f9fa/6c757d?text=Dashboard'">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hero-stats-grid">
                        @php
                            $heroStats = $hero['stats'] ?? [
                                ['icon' => 'fas fa-users', 'number' => '500+', 'label' => 'Aktif Firma', 'color' => 'blue'],
                                ['icon' => 'fas fa-check-circle', 'number' => '50K+', 'label' => 'Tamamlanan İş', 'color' => 'orange'],
                                ['icon' => 'fas fa-clock', 'number' => '7/24', 'label' => 'Destek', 'color' => 'blue'],
                                ['icon' => 'fas fa-star', 'number' => '4.9', 'label' => 'Müşteri Puanı', 'color' => 'orange']
                            ];
                        @endphp
