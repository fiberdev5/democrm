        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="hero-image-wrapper">
                    <!-- Ana Dashboard Görseli -->
                    <div class="hero-dashboard-main">
                        <img src="{{ asset($hero['image']) }}" 
                             alt="Serbis Dashboard" 
                             class="hero-main-image"
                             onerror="this.src='https://via.placeholder.com/700x500/0066FF/ffffff?text=Serbis+Dashboard'">
                    </div>
                    
                    <!-- Floating Stats Cards - 4 Köşede -->
                    @php
                    ...
                    @foreach($heroStats as $stat)
                        <div class="hero-floating-stat stat-{{ $stat['position'] }}">
                            <div class="hero-stat-icon {{ $stat['color'] }}">
                                <i class="{{ $stat['icon'] }}"></i>
                            </div>
                    ...
                    <div class="hero-decoration-dots dots-1"></div>
                    <div class="hero-decoration-dots dots-2"></div>
                    <div class="hero-gradient-blur blur-1"></div>
                    <div class="hero-gradient-blur blur-2"></div>
                </div>
            </div>
        </div>
    </div>
