...
<section class="modules-section section">
    <div class="container">
        <div class="section-header">
            ...
            <h2 class="section-title">Güçlü <span class="accent">Özellikler</span></h2>
            <p class="section-subtitle">
                İşletmenizi yönetmek için ihtiyacınız olan tüm özellikler tek platformda
            </p>
        </div>
        <div class="row g-4">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <!-- Overlay divini kaldırdık, CSS ile halledeceğiz -->
