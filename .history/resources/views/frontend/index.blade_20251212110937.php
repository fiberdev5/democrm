...
<section class="hero-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="hero-title">
                    {{ $hero['title'] }} <span class="highlight">{{ $hero['highlight'] }}</span>
                </h1>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="hero-image">
                    <img src="{{ asset($hero['image']) }}" alt="Serbis Dashboard" onerror="this.src='https://via.placeholder.com/600x450/0066FF/ffffff?text=Serbis+Dashboard'">
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="integrationsCarousel" class="carousel slide position-relative" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $chunkIndex == 0 ? 'active' : '' }}">
                    <!-- Padding'i (px) kaldırdım, böylece kartlar üst bölümle aynı genişlikte olur -->
                    <div class="row g-4">
            ...
            <!-- OK BUTONLARI AYARLARI -->
            <!-- 1. left: 0 ve right: 0 -> Mobilde taşmayı engeller, "Müşteri Yorumları" gibi kenara yapışır. -->
            <!-- 2. width: 4% -> Mobilde tıklama alanını ayarlar, çok geniş olup içeriği kapatmaz. -->
            <!-- 3. top: 40% -> Burası kilit nokta. Alttaki noktalar (indicators) yüzünden '50%' aşağıda kalıyordu. '40%' diyerek görsel olarak tam kartın ortasına çektik. -->
            
            <button class="carousel-control-prev" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="prev" 
                    style="width: 5%; left: 0; top: 40%; bottom: auto; transform: translateY(-50%); opacity: 1;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(0,0,0,0.15);">
                    <i class="fas fa-chevron-left" style="color: white; font-size: 14px;"></i>
                </span>
            </button>
            
            <button class="carousel-control-next" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="next" 
                    style="width: 5%; right: 0; top: 40%; bottom: auto; transform: translateY(-50%); opacity: 1;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(0,0,0,0.15);">
