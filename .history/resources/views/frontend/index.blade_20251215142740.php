                ...
                <div class="hero-image-wrapper">
                    ...
                    <div class="hero-main-image-container">
                        <img src="{{ asset($hero['image']) }}" 
                             ...
                             onerror="this.src='https://via.placeholder.com/600x450/0066FF/ffffff?text=Serbis+Dashboard'">
                    ...
                    @foreach($heroStats as $stat)
                        <div class="hero-floating-stat floating-{{ $stat['position'] }}">
                    ...
                    <!-- Pattern Background -->
                    <div class="hero-pattern-background"></div>
                </div>
            </div>
        </div>
    </div>
