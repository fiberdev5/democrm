        ...
        <div id="integrationsCarousel" class="carousel slide position-relative" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $chunkIndex == 0 ? 'active' : '' }}">
                    <!-- px-5: İçeriği oklardan uzaklaştırmak için sağdan soldan boşluk -->
            ...
            <!-- OK BUTONLARI -->
            <!-- top: 50% ve transform: translateY(-50%) ile dikeyde tam ortalanır -->
            <!-- bottom: auto ile butonun aşağı uzaması engellenir -->
            <button class="carousel-control-prev" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="prev" 
                ...
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
