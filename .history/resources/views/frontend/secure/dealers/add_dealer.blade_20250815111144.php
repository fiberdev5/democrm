...
<div class="row">
    <label class="col-sm-4">Bayi Belgesi<span style="font-weight: bold; color: red;">*</span></label>
    <div class="col-sm-8">
      {{-- 'name' özelliğini dizi olarak değiştiriyoruz ve 'multiple' ekliyoruz --}}
      <input name="belgePdf[]" class="form-control" type="file" accept=".pdf,.jpg,.jpeg,.png,.svg" required multiple>
      <small class="text-muted">En fazla 2 adet belge yükleyebilirsiniz. PDF, JPG, PNG, SVG formatları kabul edilir.</small>
    </div>
</div>
