...
<div class="row">
 ...
 <div class="row">
    ...
    <div class="col-sm-8">
      <input name="belgePdf" class="form-control" type="file" accept=".pdf,.jpg,.jpeg,.png,.svg" required>
      <small class="text-muted">PDF, JPG, PNG, SVG formatları kabul edilir.</small>
    </div>
  </div>
