...
<div class="page-content" id="passwords">
    ...
    <div class="api-form-group">
        ...
        @if($isHipcallWebhook && $fieldValue)
            <div class="mt-2">
                <button type="button" class="btn btn-sm btn-outline-primary" onclick="copyWebhookUrl('{{ $fieldValue }}')">
                ...
                <button type="button" class="btn btn-sm btn-outline-success ms-2" onclick="testHipcallConnection()">
                    <i class="fas fa-check-circle"></i> Test Et
                </button>
            </div>
        @endif
    </div>
