                                                    ...
                                                    @foreach($apiFields as $field)
                                                        <div class="api-form-group">
                                                            ...
                                                            @if($isHipcallWebhook && $fieldValue)
                                                                <div class="mt-2">
                                                                    <button type="button" class="btn btn-sm btn-outline-primary" onclick="copyHipcallWebhookUrl()">
...
function copyHipcallWebhookUrl() {
    const input = document.getElementById('hipcallWebhookUrl');
    input.select();
    ...
    try {
        ...
        navigator.clipboard.writeText(input.value).then(function() {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Hata',
                text: 'Kopyalama başarısız. Lütfen manuel olarak kopyalayın.',
