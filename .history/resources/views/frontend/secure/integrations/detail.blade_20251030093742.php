        ...
        <div class="detail-container">
            ...
            <div class="detail-left">
                <div class="integration-header">
                    @if($integration->logo)
                    <img src="{{ asset('frontend/' . $integration->logo) }}" alt="{{ $integration->name }}" class="integration-logo-large">
                    @else
                ...
                @if($integration->logo)
                <img src="{{ asset('frontend/' . $integration->logo) }}" alt="{{ $integration->name }} Banner" class="integration-banner">
                @endif
            ...
            <div class="detail-right">
                <div class="pricing-box">
                    ...
                    <a href="{{ route('tenant.integrations.settings', $integration->id) }}" class="action-button-secondary">
                        <i class="fas fa-cog"></i> Ayarları Düzenle
                    </a>
                    @else
                    <a href="{{ route('tenant.integrations.activate', $integration->id) }}" class="action-button-primary">
