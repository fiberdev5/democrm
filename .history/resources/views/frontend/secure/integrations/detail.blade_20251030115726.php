                            ...
                            <div class="pricing-box">
                                <div class="price-display">
                                    ...
                                    <span class="price-badge">
                                        <i class="fas fa-percentage"></i> Tek seferlik ödeme ile %20 tasarruf
                                    </span>
                                    @else
                                ...
                                @else
                                <a href="{{ route('tenant.integrations.activate', [$tenant->id, $integration->id]) }}" class="action-button-primary">
                                    <i class="fas fa-check-circle"></i> Hemen Aktifleştir
                                </a>
                                @endif
                            </div>
