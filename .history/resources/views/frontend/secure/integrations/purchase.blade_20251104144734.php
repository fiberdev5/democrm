...
function loadPaytrIframe() {
    ...
    if (paytrResponse.success) {
        ...
        iframe.style.height = '800px'; // Başlangıç yüksekliği
        iframe.style.border = 'none';
        iframe.style.borderRadius = '0.375rem';
        iframe.style.overflow = 'hidden';
        iframe.setAttribute('scrolling', 'no'); // Scroll'u kapat
        ...
        // Yedek yükseklik ayarlaması (sayfa yüklendikten sonra)
