                        ...
                        <div class="detail-right">
                            ...
                            <div class="info-tabs mt-3">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    @endif
                                      {{-- VERIMOR SANTRAL WEB TELEFONU TABI --}}
                                    @if($integration->slug === 'verimor-santral' && $isPurchased && $isActive)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" 
                                                id="webphone-tab" 
                                                data-bs-toggle="tab" 
                                                data-bs-target="#webphone" 
                                                type="button" 
                                                role="tab">
                                            <i class="fas fa-phone"></i> Web Telefonu
                                        </button>
                                    </li>
                                    @endif
                                ...
                                <div class="tab-content">
                                    ...
                                    @endif
                                           {{-- ============================================ --}}
                                    {{-- VERIMOR SANTRAL ÖZEL BÖLÜM --}}
                                    {{-- ============================================ --}}
                                    @if($integration->slug === 'verimor-santral' && $isPurchased && $isActive)
                                    <div class="tab-pane fade" id="webphone" role="tabpanel">
                                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 12px; color: white; margin-bottom: 20px;">
                                            <div style="display: flex; align-items: center; gap: 20px;">
                                                <div style="flex-shrink: 0;">
                                                    <i class="fas fa-phone-volume" style="font-size: 48px; opacity: 0.9;"></i>
                                                </div>
                                                <div style="flex: 1;">
                                                    <h3 style="margin: 0 0 8px 0; font-size: 24px; font-weight: 600;">Web Telefonu Hazır!</h3>
                                                    <p style="margin: 0; opacity: 0.95; font-size: 15px;">
                                                        Verimor Bulutsantralim web telefonunu kullanarak doğrudan tarayıcınızdan arama yapabilirsiniz.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                                            <a href="{{ route('tenant.integrations.verimor-santral.webphone,$tenant->id') }}" 
                                               class="btn btn-success btn-lg" 
                                               style="padding: 15px; border-radius: 10px; display: flex; align-items: center; justify-content: center; gap: 10px; text-decoration: none;">
                                                <i class="fas fa-phone-volume" style="font-size: 20px;"></i>
                                                <span style="font-weight: 600;">Web Telefonunu Aç</span>
                                            </a>
                                            
                                            <button type="button" 
                                                    id="testVerimorConnectionBtn" 
                                                    class="btn btn-outline-info btn-lg"
                                                    style="padding: 15px; border-radius: 10px; display: flex; align-items: center; justify-content: center; gap: 10px;">
                                                <i class="fas fa-plug" style="font-size: 20px;"></i>
                                                <span style="font-weight: 600;">Bağlantı Testi</span>
                                            </button>
                                        </div>

                                        <div style="background: #f8f9fa; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                                            <h5 style="margin: 0 0 15px 0; font-weight: 600; color: #333;">
                                                <i class="fas fa-star text-warning"></i> Özellikler
                                            </h5>
                                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                                                <div style="display: flex; align-items: start; gap: 10px;">
                                                    <i class="fas fa-check-circle text-success" style="margin-top: 3px;"></i>
                                                    <span><strong>Mikrofon ile arama</strong><br><small class="text-muted">Tarayıcıdan direkt arama yapın</small></span>
                                                </div>
                                                <div style="display: flex; align-items: start; gap: 10px;">
                                                    <i class="fas fa-check-circle text-success" style="margin-top: 3px;"></i>
                                                    <span><strong>Gelen aramaları cevaplama</strong><br><small class="text-muted">Anlık bildirim alın</small></span>
                                                </div>
                                                <div style="display: flex; align-items: start; gap: 10px;">
                                                    <i class="fas fa-check-circle text-success" style="margin-top: 3px;"></i>
                                                    <span><strong>Arama kayıtları</strong><br><small class="text-muted">Tüm görüşmeleri dinleyin</small></span>
                                                </div>
                                                <div style="display: flex; align-items: start; gap: 10px;">
                                                    <i class="fas fa-check-circle text-success" style="margin-top: 3px;"></i>
                                                    <span><strong>Güvenli token</strong><br><small class="text-muted">24 saat geçerli güvenlik</small></span>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="alert alert-warning" style="border-left: 4px solid #ffc107; background: #fff3cd; border-radius: 8px;">
                                            <h6 style="margin: 0 0 10px 0; font-weight: 600; color: #856404;">
                                                <i class="fas fa-exclamation-triangle"></i> Önemli Hatırlatma
                                            </h6>
                                            <p style="margin: 0 0 10px 0; color: #856404; font-size: 14px;">
                                                Web telefonunu kullanabilmek için Verimor <strong>Online İşlem Merkezi</strong>'nde 
                                                aşağıdaki adımları tamamlamış olmalısınız:
                                            </p>
                                            <ol style="margin: 0; padding-left: 20px; color: #856404; font-size: 14px;">
                                                <li><strong>Abonelik İşlemleri</strong> menüsüne gidin</li>
                                                <li><strong>Personel Hesapları</strong> bölümünü açın</li>
                                                <li>Kullanacağınız <strong>dahili için personel hesabı</strong> oluşturun</li>
                                            </ol>
                                        ...
                                        <div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 8px; margin-top: 20px;">
                                            <p style="margin: 0; color: #6c757d; font-size: 13px;">
                                                <i class="fas fa-shield-alt"></i> Tüm aramalar SSL ile şifrelenir
                                            </p>
                                        </div>
                                    </div>
                                    @endif
                                    {{-- VERIMOR SANTRAL BÖLÜMÜ BİTİŞ --}}
...
$(document).ready(function() {
    $('#testVerimorConnectionBtn').click(function() {
        ...
        $.ajax({
            url: '{{ route("tenant.integrations.verimor-santral.test-connection") }}',
            type: 'GET',
            success: function(response) {
                if (response.success) {
                    if (typeof toastr !== 'undefined') {
