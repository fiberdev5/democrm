...
.my-integrations-btn.active {
    background: linear-gradient(135deg, #28a745 0%, #20c997 100%);
    box-shadow: 0 2px 8px rgba(40, 167, 69, 0.3);
}

.my-integrations-btn .badge {
...
.integration-card.active-integration::before {
    content: '';
    position: absolute;
    top: 10px;
    right: 10px;
                            ...
                            <div class="integration-card {{ in_array($integration->id, $activeIntegrationIds) ? 'active-integration' : '' }}" 
                                ...
                                <div class="integration-footer">
                                   ...
                                   @if(in_array($integration->id, $activeIntegrationIds))
                                        <span class="integration-price free" style="background: #28a745;">
