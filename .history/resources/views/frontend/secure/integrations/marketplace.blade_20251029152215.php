                    ...
                    <div class="container">
                        ...
                        <div class="stats-bar">
                            ...
                            <a href="" class="my-integrations-btn">
                                ...
                                Aktif Entegrasyonlarım ({{ count($activeIntegrations) }})
                            </a>
                        </div>
                        ...
                        <div class="integration-grid">
                            ...
                            <div class="integration-card">
                                ...
                                <div class="action-buttons">
                                    @if(in_array($integration->id, $activeIntegrations))
                                    <a href="{{ route('tenant.integrations.deactivate', [$tenant->id, $integration->id]) }}" 
                                       class="btn-deactivate"
                                       onclick="return confirm('Bu entegrasyonu devre dışı bırakmak istediğinize emin misiniz?');">
                                        <i class="fas fa-times"></i> Pasifleştir
                                    </a>
                                    <a href="{{ route('tenant.integrations.settings', [$tenant->id, $integration->id]) }}" class="btn-detail">
                                        <i class="fas fa-cog"></i> Ayarlar
                                    </a>
                                    @else
                                    <a href="{{ route('tenant.integrations.activate', [$tenant->id, $integration->id]) }}" class="btn-activate">
                                        <i class="fas fa-check-circle"></i> Aktifleştir
                                    </a>
                                    <a href="{{ route('tenant.integrations.show', [$tenant->id, $integration->slug]) }}" class="btn-detail">
