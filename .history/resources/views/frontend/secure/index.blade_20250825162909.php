...
/* Kırmızı: Acil durumu belirten, canlı ama neon olmayan bir ton. */
.status-high { background-color: #e74c3c; } 

/* Turuncu/Sarı: Dikkat çeken, sıcak bir "işlemde" rengi. */
.status-medium { background-color: #f39c12; }

/* Yeşil: Başarıyı ve tamamlanmayı simgeleyen, taze bir ton. */
.status-completed { background-color: #2ecc71; }

/* Mavi: "Beklemede" veya "Bilgi" durumları için griden daha çekici bir alternatif. */
.status-pending { background-color: #3498db; }

/* Gri: İptal edilmiş, pasif durumlar için nötr ve belirgin bir ton. */
