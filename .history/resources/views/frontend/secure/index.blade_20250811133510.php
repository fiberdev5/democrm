...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.9.1/chart.min.js"></script>
 ...
 <style>
        ...
        .stat-card.blue {
    --card-bg-1: #495057; /* koyu gri */
    --card-bg-2: #6c757d; /* orta gri */
}

.stat-card.green {
    --card-bg-1: #6c757d; /* orta gri */
    --card-bg-2: #adb5bd; /* açık gri */
}

.stat-card.red {
    --card-bg-1: #868e96; /* gri */
    --card-bg-2: #dee2e6; /* çok açık gri */
}

.stat-card.teal {
    --card-bg-1: #ced4da; /* en açık gri */
    --card-bg-2: #f8f9fa; /* beyazımsı gri */
    color: #333; /* yazı koyu kalsın */
}
