    ...
    <form action="{{ route('support.store', Auth::user()->tenant_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
                        ...
                        <div class="col-auto" style="min-width: 250px;"> {{-- col-auto and min-width for consistent card size in a single row --}}
                            ...
                            <label for="category_{{ $key }}" class="btn btn-outline-{{ $iconData['color'] }} w-100 h-100 p-1 category-card">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <small class=>{{ $iconData['desc'] }}</small>
                                </div>
                            </label>
                        </div>
                    @endforeach
            ...
            <div>
                ...
                <div class="row g-3 flex-nowrap overflow-auto pb-2"> {{-- Added flex-nowrap and overflow-auto for single row scrolling --}}
                    <div class="col-auto" style="min-width: 620px;"> {{-- col-auto and min-width for consistent card size --}}
                        ...
                        <label for="priority_orta" class="btn btn-outline-warning w-100 p-1 priority-card">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div class="text-start">
                                    ...
                                    <small class="d-block ">48 saat içinde yanıt</small>
                                </div>
                            </div>
                        </label>
                    </div>
                        ...
                        <label for="priority_yuksek" class="btn btn-outline-danger w-100 p-1 priority-card">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div class="text-start">
                                    ...
                                    <small class="d-block">24 saat içinde yanıt</small>
                                </div>
                            </div>
                        </label>
                    </div>
