    ...
    <form action="{{ route('support.store', Auth::user()->tenant_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div class="row g-3 flex-nowrap overflow-auto pb-2"> {{-- Added flex-nowrap and overflow-auto for single row scrolling --}}
                    @php
                    $categoryIcons = [
                    ...
                    @foreach($categories as $key => $value)
                        ...
                        <div class="col-auto" style="min-width: 250px;"> {{-- col-auto and min-width for consistent card size in a single row --}}
            ...
            <div>
                ...
                <div class="row g-3 flex-nowrap overflow-auto pb-2"> {{-- Tek satırda kaydırma için flex-nowrap ve overflow-auto eklendi --}}
                    @php
                    $priorityOptions = [
                        'acil' => ['icon' => 'fas fa-exclamation-circle', 'color' => 'danger', 'text' => 'Acil', 'desc' => 'En kısa sürede yanıt (1 saat içinde)'],
                        'kritik' => ['icon' => 'fas fa-shield-alt', 'color' => 'dark', 'text' => 'Kritik', 'desc' => 'Hızlı yanıt (4 saat içinde)'],
                        ...
                        'dusuk' => ['icon' => 'fas fa-chevron-down', 'color' => 'secondary', 'text' => 'Düşük', 'desc' => '72 saat içinde yanıt']
                    ];
                    @endphp

                    @foreach($priorityOptions as $key => $data)
                        <div class="col-auto" style="min-width: 200px;"> {{-- Kart boyutunu tutarlı tutmak için min-width ayarlandı --}}
