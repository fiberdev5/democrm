    ...
    <form action="{{ route('support.store', Auth::user()->tenant_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div class="row g-3 flex-nowrap overflow-auto pb-2"> {{-- Added flex-nowrap and overflow-auto for single row scrolling --}}
                    ...
                    @foreach($categories as $key => $value)
                        ...
                        <div class="col-auto" style="min-width: 180px;"> {{-- col-auto and min-width for consistent card size in a single row --}}
            ...
            <div>
                ...
                <div class="row g-3 flex-nowrap overflow-auto pb-2"> {{-- Added flex-nowrap and overflow-auto for single row scrolling --}}
                    <div class="col-auto" style="min-width: 220px;"> {{-- col-auto and min-width for consistent card size --}}
