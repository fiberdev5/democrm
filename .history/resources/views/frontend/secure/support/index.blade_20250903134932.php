...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            @php
                $statusCounts = [
                    'open' => $tickets->where('status', 'acik')->count(),
                    'in_progress' => $tickets->where('status', 'acik')->count(),
                    'waiting_customer' => $tickets->where('status', 'cevaplandi')->count(),
                    'closed' => $tickets->where('status', 'kapali')->count()
                ];
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 opacity-75">Toplam Talep</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-gradient-success text-white border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0">{{ $statusCounts['open'] + $statusCounts['in_progress'] }}</h5>
                                <p class="mb-0 opacity-75">Aktif Talep</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-gradient-warning text-white border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0">{{ $statusCounts['waiting_customer'] }}</h5>
                                <p class="mb-0 opacity-75">Yanıt Bekleyen</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-gradient-info text-white border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0">{{ $statusCounts['resolved'] + $statusCounts['closed'] }}</h5>
                                <p class="mb-0 opacity-75">Çözülen Talep</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('support.create', Auth::user()->tenant_id) }}" class="btn btn-primary btn-lg shadow-sm">
                    ...
                    <div class="card-body p-0">
                        ...
                        @if($tickets->count() > 0)
                                        ...
                                        @foreach($tickets as $ticket)
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    @php
                                                        $statusConfig = [
                                                            'open' => ['color' => 'primary', 'icon' => 'fas fa-folder-open', 'text' => 'Açık'],
                                                            'in_progress' => ['color' => 'warning', 'icon' => 'fas fa-spinner', 'text' => 'İşlemde'],
                                                            'waiting_customer' => ['color' => 'info', 'icon' => 'fas fa-user-clock', 'text' => 'Yanıt Bekleniyor'],
                                                            'resolved' => ['color' => 'success', 'icon' => 'fas fa-check-circle', 'text' => 'Çözüldü'],
                                                            'closed' => ['color' => 'secondary', 'icon' => 'fas fa-times-circle', 'text' => 'Kapatıldı']
                                                        ];
                            ...
                            <!-- Sayfalama -->
                            {{-- Check if $tickets is a paginator instance before trying to render links --}}
                            @if ($tickets instanceof \Illuminate\Pagination\LengthAwarePaginator && $tickets->hasPages())
                                <div class="card-footer bg-light border-0">
                                    <div class="d-flex justify-content-center">
                                        {{ $tickets->links('vendor.pagination.bootstrap-5') }} {{-- Use 'bootstrap-5' or your preferred pagination view --}}
                                    </div>
                                </div>
                            @endif
                        @else
                            <div class="text-center py-5 mx-3">
                                <div class="empty-state">
                                    ...
                                    <a href="{{ route('support.create', Auth::user()->tenant_id) }}" class="btn btn-primary btn-lg">
                                        <i class="fas fa-plus me-2"></i> İlk Destek Talebi Oluştur
                                    </a>
                                </div>
                            </div>
                        @endif
