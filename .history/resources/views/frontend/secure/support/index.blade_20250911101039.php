            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start h-100">
                    <div class="align-self-end">
                        <h5 class="mb-0 text-white display-6 fw-bold">{{ $totalTickets }}</h5>
                        <p class="mb-0 small">Toplam Talep</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-md-6">
        <div class="card bg-ticket-active text-white border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start h-100">
                    <div class="align-self-end">
                        <h5 class="mb-0 text-white display-6 fw-bold">{{ $statusCounts['acik'] + $statusCounts['cevaplandi'] }}</h5>
                        <p class="mb-0 small">Aktif Talep</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-md-6">
        <div class="card bg-ticket-solved text-white border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start h-100">
                    <div class="align-self-end">
                        <h5 class="mb-0 text-white display-6 fw-bold">{{ $statusCounts['kapali'] }}</h5>
                        <p class="mb-0 small">Çözülen Talep</p>
                    </div>
                </div>
            </div>
        </div>
