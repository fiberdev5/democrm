{{-- resources/views/frontendd/secure/support/show.blade.php --}}
...
<style>
.usersupport-show-page .ticket-header {
...
.usersupport-show-page .message-bubble {
    background: #f8f9fa;
    border-radius: 15px;
    padding: 15px;
    margin-bottom: 15px;
...
.usersupport-show-page .admin-bubble {
    border-left-color: #28a745;
    background: #f0f9f4;
}

.usersupport-show-page .user-avatar {
    width: 45px;
    height: 45px;
    border-radius: 50%;
    display: flex;
...
.usersupport-show-page .attachment-card {
    background: #f8f9fa;
    border: 1px solid #dee2e6;
    border-radius: 8px;
    padding: 10px;
...
.usersupport-show-page .attachment-card:hover {
    background: #e9ecef;
    transform: translateY(-2px);
    box-shadow: 0 4px 8px rgba(0,0,0,0.1);
}

.usersupport-show-page .file-upload-area {
...
.usersupport-show-page .file-upload-area:hover {
    border-color: #007bff;
    background: #f0f8ff;
}
.usersupport-show-page .file-preview {
    background: #e9ecef;
    border-radius: 8px;
    padding: 10px;
    margin: 5px;
...
.usersupport-show-page .file-remove {
    position: absolute;
    top: -5px;
    right: -5px;
    background: #dc3545;
...
.usersupport-show-page .timeline-line {
    position: absolute;
    left: 22px;
    top: 60px;
    bottom: 0;
...
.usersupport-show-page .message-container {
    position: relative;
}

.usersupport-show-page .status-badge-large {
    font-size: 0.9rem;
    padding: 8px 15px;
}
</style>

<div class="page-content usersupport-show-page">
