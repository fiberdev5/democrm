                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('support.create', Auth::user()->tenant_id) }}" class="btn btn-primary  shadow-sm">
                                        ...
                                        @foreach($tickets as $ticket)
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    @php
                                                        $statusConfig = [
                                                            'acik' => ['color' => 'primary', 'icon' => 'fas fa-folder-open', 'text' => 'Açık'],
                                                            ...
                                                            'cevaplandi' => ['color' => 'success', 'icon' => 'fas fa-check-circle', 'text' => 'Çözüldü'],
                                                            'kapali' => ['color' => 'secondary', 'icon' => 'fas fa-times-circle', 'text' => 'Kapatıldı']
                                                        ];
