                                    ...
                                    <div class="row g-3">
                                        ...
                                        @foreach($categories as $key => $value)
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <label for="category_{{ $key }}" class="btn btn-outline-{{ $iconData['color'] }} w-100 h-100 p-3 category-card">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <label for="priority_orta" class="btn btn-outline-warning w-100 p-3 priority-card">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label for="priority_yuksek" class="btn btn-outline-danger w-100 p-3 priority-card">
                                                <div class="d-flex align-items-center justify-content-center">
