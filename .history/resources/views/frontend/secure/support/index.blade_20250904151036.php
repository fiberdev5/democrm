...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- Özet Kartları -->
        @if($tickets->count() > 0)
        <div class="row mb-3 summary-ticket-cards">
            @php
                $statusCounts = [
            ...
            <div class="col-xl-4 col-md-6 btn-all">
                <div class="card quick-action text-white border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <div class="avatar-sm rounded-circle bg-black bg-opacity-25 p-2">
...
/* Sakin renk paleti - Daha soft tonlar */
...
/* Gradient Border Animation - daha sakin */
...
/* Sadece üstteki özet kartlar için */
.summary-ticket-cards .card .text-white {
    color: #433232 !important; /* senin istediğin renk */
}
.summary-ticket-cards .card p,
.summary-ticket-cards .card h5 {
    color: #433232 !important;
}
