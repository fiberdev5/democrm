...
@endif
                        <form action="{{ route('support.store', Auth::user()->tenant_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="form_token" id="formTokenSupport" value="">
...
<script>
// Token yönetimi - Çift tıklama önleme
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('formTokenSupport').value = generateToken();
        ...
        supportForm.addEventListener('submit', function(e) {
            ...
            setTimeout(function() {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.innerHTML = '<i class="fas fa-paper-plane me-2"></i> Destek Talebi Gönder';
                }
            }, 5000);
        });
    }
