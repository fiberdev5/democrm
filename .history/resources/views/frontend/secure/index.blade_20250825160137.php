        ...
        <div class="dashboard-card-body px-2">
            ...
            <div class="service-request-item">
                ...
                <div class="service-customer-info">
                    ...
                    {{-- YENİ: Teknisyen ve tarih için daha düzenli yapı --}}
                ...
                {{-- Sağdaki durum etiketi --}}
                <span class="service-status-badge {{ $service->status_info['class'] }}">
                    {{ $service->status_info['name'] }}
                </span>
            </div>
            @empty
            <p class="text-center text-muted p-4">Gösterilecek servis talebi bulunamadı.</p>
            @endforelse
        </div>
    </div>
</div>
