...
.stat-card.green {
    --card-bg-1: #495057; /* orta gri */
    --card-bg-2: #6c757d; /* açık gri */
}

.stat-card.red {
    --card-bg-1: #495057; /* gri */
    --card-bg-2: #6c757d; /* çok açık gri */
}

.stat-card.teal {
    --card-bg-1: #495057; /* en açık gri */
    --card-bg-2: #6c757d; /* beyazımsı gri */
