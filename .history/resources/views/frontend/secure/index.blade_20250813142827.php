    ...
    .filter-btn {
        ...
        <div class="dashboard-container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="{{ route('customers', ['tenant_id' => $tenant_id]) }}" class="stat-card green" id="totalCustomersCard">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="#" class="stat-card red" id="totalPersonnelCard">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="#" class="stat-card teal" id="totalCashCard">
