<div class="row mt-3 mb-2 ">
    ...
    <div class=" d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0 fw-bold text-gray border-bottom pb-2" style="font-size: 15px;">Cihaz Türleri</h4>
    </div>
  </div>
</div>
        <div  id="cihazTuru">
  ...
  <!-- add modal content -->
  <div id="addDeviceTypeModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 1080px;">
