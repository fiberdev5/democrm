<div class="row pageDetail">
  ...
  <!-- add modal content -->
  <div id="addDeviceTypeModal" class="modal " tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <!-- edit modal content -->
  <div id="editDeviceTypeModal" class="modal " tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
