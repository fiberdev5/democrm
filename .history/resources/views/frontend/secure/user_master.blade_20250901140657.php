                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <strong>Impersonation Aktif</strong>
...
$(document).ready(function() {
    ...
    function exitImpersonation() {
        ...
        .done(function(response) {
            if (response.success) {
                ...
                // Cache'i temizlemek için hard reload
                setTimeout(() => {
                    window.location.href = response.redirect_url + '?t=' + Date.now();
                }, 1000);
            }
        })
        .fail(function(xhr) {
    ...
    // Sayfa değişikliklerini dinle (SPA benzeri davranış için)
    $(window).on('popstate', function() {
        checkImpersonationStatus();
    });
    
    // AJAX navigation için (eğer kullanıyorsanız)
    $(document).ajaxComplete(function() {
        setTimeout(checkImpersonationStatus, 500);
    });
});
</script>
<style>
/* Impersonation modu için özel stiller */
.impersonating {
    position: relative;
}
