...
@section('user')
<link href="{{ asset('frontend/css/storage/storage_payment.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <img src="{{asset('frontend/img/troy.jpg')}}" alt="Troy" class="h-8" width="70">
                        ...
                        <div id="paytr-iframe-container" style="width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch;">
...
function loadPaytrIframe() {
    ...
    if (paytrResponse.success) {
        ...
        iframe.setAttribute('scrolling', 'yes'); // Mobilde scroll gerekebilir
