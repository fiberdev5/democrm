...
<div class="page-content">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <h6 class="mb-3"><i class="fas fa-info-circle text-primary me-2"></i>Mevcut Storage Durumunuz</h6>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ps-3 text-end" style="min-width: 150px;">
            <div class="text-muted small">Kalan Alan</div>
