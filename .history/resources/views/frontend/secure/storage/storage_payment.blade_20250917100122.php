                    ...
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-3">
                                <img src="{{asset('frontend/img/visa.jpg')}}" alt="Visa" class="h-8" width="50">
            <img src="{{asset('frontend/img/masterpass.jpg')}}" alt="Mastercard" class="h-10" width="50">
            <img src="{{asset('frontend/img/troy.jpg')}}" alt="Troy" class="h-8" width="50">
                            </div>
                        </div>
