          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              var newRow = `<tr>
                ...
                <td>
                  <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-outline-primary btn-sm editDevice mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editDeviceModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
