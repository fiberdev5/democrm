<link href="{{ asset('frontend/css/customer/add_customer.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="col-sm-9 custom-p-l">
      ...
      @if(isset($hasInvoiceIntegration) && $hasInvoiceIntegration)
        <small class="text-muted" style="display: block; margin-top: 5px;">
          <i class="fas fa-info-circle"></i> Fatura kesilecekse TC No zorunludur (Paraşüt entegrasyonu aktif)
        </small>
      @endif
    </div>
  </div>
    ...
    <div class="col-sm-4 col-sm-custom col-6 custom-p-l">
      ...
      @if(isset($hasInvoiceIntegration) && $hasInvoiceIntegration)
        <small class="text-danger" style="display: block; margin-top: 5px;">
          <i class="fas fa-exclamation-triangle"></i> Kurumsal müşteriler için zorunlu (Paraşüt entegrasyonu aktif)
        </small>
      @endif
    </div>
    <div class="col-sm-4 col-sm-custom col-6 custom-p-l">
        ...
        if (musteriTipi == '1') {
          ...
          if (!tcNo || tcNo.length === 0) {
            ...
            var confirmMessage = 'Fatura keseceğiniz bir müşteriyse TC Kimlik Numarası girmeniz önerilir.\n\n' +
                                'Paraşüt entegrasyonu kullanıyorsanız TC No zorunludur.\n\n' +
