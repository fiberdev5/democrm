...
<style>
/* Önceki stilleri koru veya güncelle */
...
@media (max-width: 767px) {
    ...
    .searchWrap{
        ...
        width: auto !important; /* Mobil görünümde otomatik genişlik */
    }
    .pageDetail .searchWrap{
        width: auto !important; /* Tekrar emin olalım */
        margin-bottom: 0px !important;
    }
    #datatableCustomer_filter label{width: 100% !important;}
    
    /* Dropdown menüsü için düzenlemeler */
    #musteri_filtre .dropdown-menu {
        transform: none !important; /* Bootstrap'in varsayılan transform değerini sıfırla */
        right: 0 !important;        /* Sağa hizala */
        left: auto !important;      /* Sol hizalamayı kaldır */
        min-width: 250px;           /* Minimum genişlik belirle, içeriğe göre ayarlanabilir */
        max-width: 95vw;            /* Ekran genişliğinin %95'i kadar maksimum genişlik */
        padding: 10px;              /* İç boşluk ekle */
        box-sizing: border-box;     /* Padding'in genişliği artırmamasını sağla */
    }
    .pageDetail .searchWrap .dropdown-menu .item {
        margin-bottom: 10px !important; /* Öğeler arasına boşluk ekle */
    }
    .pageDetail .searchWrap .dropdown-menu .item:last-child {
        margin-bottom: 0px !important;
    }

    /* Tarih aralığı input ve butonları için düzenlemeler */
    .tarih-araligi {
        width: 100% !important; /* Input'u tam genişlik yap */
    }
    .tarihAraligi { /* Mobil için butonların düzeni */
        display: flex;
        flex-wrap: wrap;
        gap: 5px;
        justify-content: space-between; /* Butonları eşit boşlukla dağıt */
    }
    .tarihAraligi button {
        flex: 1 1 calc(50% - 5px); /* Her satırda 2 buton olacak şekilde ayarla, gap'i dikkate al */
        min-width: unset; /* Minimum genişliği kaldır */
        max-width: calc(50% - 5px); /* Maksimum genişliği ayarla */
    }
...
/* Row içindeki label ve div oranlarını mobil için düzelt */
.pageDetail .searchWrap .dropdown-menu .item .row .filtre-i-p {
    padding-right: 0 !important;
    padding-left: 5px !important; /* Biraz boşluk ver */
}
.pageDetail .searchWrap .dropdown-menu .item .row label.col-3 {
    flex: 0 0 25%; /* Label'ın genişliğini sabitle */
    max-width: 25%;
}
.pageDetail .searchWrap .dropdown-menu .item .row div.col-9 {
    flex: 0 0 75%; /* Seçici div'in genişliğini sabitle */
    max-width: 75%;
}
