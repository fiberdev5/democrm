...
/* Ensure the search input has consistent padding */
#datatableCustomer_filter input[type="search"] {
    padding-right: 12px !important;
}

/* Hide the searchWrap by default, and make it visible when DataTables initializes it */
.searchWrap {
    visibility: hidden;
    opacity: 0;
...
/* Adjust top margin for the DataTables filter for better spacing */
.dataTables_filter {
    margin-bottom: -11px !important; /* Adjust as needed */
}
...
@media (max-width: 767px) {
  ...
  .pageDetail .searchWrap {
    width: 30% !important; /* Adjust based on desired spacing */
  ...
  /* Adjust dropdown menu positioning and width for mobile */
  .pageDetail .searchWrap .dropdown-menu {
    transform: translate3d(11px, 3px, 0px) !important; /* Fine-tune position */
    min-width: 100% !important; /* Make it fill the available width */
    max-width: 250px; /* Prevent it from being too wide on slightly larger mobiles */
    left: auto !important; /* Override default left alignment if any */
    right: 0 !important; /* Align to the right */
  }

  /* Remove bottom margin for dropdown items on mobile */
  .pageDetail .searchWrap .dropdown-menu .item {
    margin-bottom: 0px !important;
    padding: 0.5rem 1rem; /* Add some padding to items */
  }
  .pageDetail .searchWrap .dropdown-menu .item .row {
    align-items: center; /* Vertically align label and select */
  }
  .pageDetail .searchWrap .dropdown-menu .item label {
    margin-bottom: 0; /* Remove default label bottom margin */
  }

  /* DataTables pagination and info alignment for mobile */
  ...
  #datatableCustomer_wrapper .dataTables_info {
    margin-bottom: 10px; /* Space between info and pagination */
  }
  #datatableCustomer_wrapper .dataTables_length {
    margin-top: 10px; /* Space between pagination and length menu */
  }
}

/* Specific styling for the filter dropdown items to ensure consistent padding and spacing */
.searchWrap .dropdown-menu .item {
  padding: 8px 15px; /* Adjust padding as needed */
  border-bottom: 1px solid rgba(0, 0, 0, .05); /* Light separator */
}
.searchWrap .dropdown-menu .item:last-child {
  border-bottom: none; /* No separator for the last item */
}
.searchWrap .dropdown-menu .item .row {
  margin-left: 0;
  margin-right: 0;
  width: 100%;
}
.searchWrap .dropdown-menu .item label {
  font-weight: 500;
  color: #333; /* Darker label for readability */
}

/* Styling for date range buttons */
.tarihAraligi button {
...
/* Adjust DataTables search input and filter button alignment */
...
.dataTables_filter.input-group .searchWrap {
    margin-left: -1px; /* Overlap border for clean look */
}
</style>
