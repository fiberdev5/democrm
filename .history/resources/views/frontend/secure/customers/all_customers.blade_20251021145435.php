...
<div class="d-flex justify-content-between">
    <!-- Müşteri Ekle Butonu -->
     <div class="customer-buttons-container ">
        <a data-bs-toggle="modal" data-bs-target="#addCustomerModal" class="btn btn-success btn-sm addCustomer me-2">
            <i class="fas fa-plus"></i>
            <span class="d-none d-sm-inline">Müşteri Ekle</span>
        </a>
        
        <!--Yazdır Butonu -->
        <button id="printCustomers" class="btn btn-warning btn-sm ms-2 printCustomers me-2">
