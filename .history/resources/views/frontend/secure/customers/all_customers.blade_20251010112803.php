                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="tarihAraligi mt-2 mb-2">
                                ...
                                <button id="allTime" class="btn btn-sm btn-secondary">Tüm Zamanlar</button>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    var today = moment();
    var allTimeStart = moment('2000-01-01'); // Tüm zamanlar için başlangıç

    // DateRangePicker'ı başlat (varsayılan olarak tarih seçilmemiş)
    ...
    // Tarih seçildiğinde input'u güncelle
    ...
    // Eğer dashboard'dan tarih geldiyse, daterangepicker'ı ayarla
    ...
    $('#allTime').on('click', function () {
        $('#daterange').val(''); // Input'u temizle
        filterData(); // Tüm kayıtları göster
    });
...
$(document).ready(function() {
    ...
    function loadCities(countryId) {
        ...
        $.get("/get-states/" + countryId, function(data) {
            ...
            citySelect.empty();
            citySelect.append(new Option("Şehirler yüklenemedi", ""));
        });
    }
});
</script>
