...
function getFilterInfoForPrint() {
 ...
 buttons: [{
      ...
      autoPrint: true,
      exportOptions: {
        // ID sütununu da yazdırmak için 0. indeksi ekliyoruz
        columns: [0, 1, 2, 3] 
      },
      customize: function (win) {
        
        // 1. Adım: Mevcut tüm stilleri temizleyerek çakışmaları önle
        ...
        $(win.document.head).append(
          ...
          'table th, table td { border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 9px; text-align: left; }' +
        ...
        // 4. Adım: DataTables'ın otomatik eklediği başlığı (h1) kaldır
        $(win.document.body).find('h1').remove();

        // 5. Adım: Sayfanın en başına yeni başlığı (Tarih ve Firma Adı) ekle
        ...
        // 7. Adım: Tablonun altına yeni alt bilgiyi (Listelenen Müşteri Sayısı) ekle
        ...
        // Tablodaki thead ve tbody arasındaki boşluğu (varsa) kaldır
        $(win.document.body).find('table thead').css('display', 'table-row-group');
      }
    }],
