...
buttons: [{
  ...
  customize: function (win) {
    ...
    $(win.document.head).append(
      ...
      '.print-header { display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #666; padding-bottom: 10px; margin-bottom: 25px; font-size: 11px;}' +
      '.print-title { text-align: left; font-size: 18px; font-weight: bold; margin-bottom: 20px; }' +
      'table { width: 100%; border-collapse: collapse; }' +
      'table th, table td { border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 8px; text-align: left; font-size: 11px; }' +
      'table th { background-color: #f8f8f8; font-weight: bold; }' +
      '.print-footer { margin-top: 15px; text-align: left; font-size: 11px; border-top: 1px solid #ccc; padding-top: 10px; }' +
      // Sayfa numarasını gizle
      '@page { margin: 20mm; }' +
      '@media print { .page-number { display: none !important; } }' +
      '</style>'
    );
    ...
    // 4. DataTables'ın otomatik eklediği başlık ve sayfa numaralarını kaldır
