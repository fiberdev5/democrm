...
$(document).ready(function(){
  ...
  $('#müsteri_filtre').find('#daterangeCustomer').on('focus mousedown', function () {
    preventCustomerDropdownHide = true;
  });
  $('#müsteri_filtre').find('.tarihAraligi button').on('mousedown', function () {
    preventCustomerDropdownHide = true;
  });
  ...
  // Müşteriler için daterangepicker başlatma
