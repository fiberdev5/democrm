        ...
        <div class="card-body">
          ...
          <form id="primForm" class="row g-3">
            ...
            <div class="col-md-2">
              ...
              <input type="date" class="form-control datepicker" id="tarih1" name="tarih1" placeholder="gg/aa/yyyy" required>
            </div>
                        
            <div class="col-md-2">
              <label for="tarih2" class="form-label">Bitiş Tarihi</label>
              <input type="date" class="form-control datepicker" id="tarih2" name="tarih2" placeholder="gg/aa/yyyy" required>
            </div>
