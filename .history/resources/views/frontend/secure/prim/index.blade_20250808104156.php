        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('prim.ayarlar', $firma->id) }}" class="btn btn-info btn-sm">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            <div class="card-body p-2">
                                                <h6 class="card-title mb-1">{{ $ayar->role }}</h6>
                                                <small class="text-muted">
                                                    @if($ayar->role == 'Teknisyen')
                                                        Günlük {{ number_format($ayar->daily_limit, 0, ',', '.') }} TL üzeri teklif = %{{ $ayar->commission_rate }} prim
                                                    @elseif($ayar->role == 'Operator')
                                                        Günlük {{ $ayar->daily_limit }} servis = Servis başı {{ $ayar->commission_rate }} TL prim
                                                    @else
                                                        Günlük {{ $ayar->daily_limit }} tamamlama = Servis başı {{ $ayar->commission_rate }} TL prim
                                                    @endif
                                                </small>
                                            </div>
                                        </div>
