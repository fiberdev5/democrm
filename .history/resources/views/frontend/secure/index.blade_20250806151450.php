...
<div class="page-content" >
  <div class="container-fluid">
                ...
                <div class="row">      
                    <div class="col-md-4">                          
                        ...
                        <a class="card text-white bg-info o-hidden" href="">
                            ...
                            <div> <strong style="color: #fff;">Bugün</strong> Alınan Servis Sayısı (0) </div>
                            </div>
                        </a>
                        </div>
                    </div>
    ...
    <iframe src="https://ebelge.gib.gov.tr/efaturakayitlikullanicilar.html" width="100%" height="500"></iframe>
  </div>
</div>
