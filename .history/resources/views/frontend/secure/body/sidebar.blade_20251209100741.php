       ...
       <ul class="metismenu list-unstyled" id="side-menu" style="padding-top: 2px;"> 
             ...
             <li>
              ...
              <ul class="sub-menu" aria-expanded="false">
                  <li><a href="{{ route('super.admin.frontend.home') }}">Ana Sayfa Bölümleri</a></li>
                  <li><a href="{{ route('super.admin.frontend.content') }}">İçerik Yönetimi</a></li>
                  <li><a href="{{ route('super.admin.frontend.navigation') }}">Menü & Linkler</a></li>
                  <li><a href="{{ route('super.admin.frontend.legal-pages') }}">Yasal Sayfalar</a></li>
                  <li><a href="{{ route('super.admin.frontend.about_content') }}">Hakkımızda Sayfası</a></li>
                  {{-- <li><a href="{{ route('super.admin.frontend.sectors') }}">Sektörler</a></li>
                  <li><a href="{{ route('super.admin.frontend.features') }}">Özellikler</a></li>
                  <li><a href="{{ route('super.admin.frontend.integrations') }}">Entegrasyonlar</a></li> --}}
              </ul>
          </li>
          @endif
