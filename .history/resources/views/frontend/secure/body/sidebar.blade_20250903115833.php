            ...
            <i class="fas fa-life-ring"></i>
                  ...
                  <div class="collapse menu-dropdown" id="sidebarSupport">
                      <ul class="nav nav-sm flex-column">
                          <li class="nav-item">
                              <a href="{{ route('super.admin.destek.dashboard') }}" class="nav-link" data-key="t-support-dashboard">
                                  Dashboard
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="{{ route('super.admin.destek.index') }}" class="nav-link" data-key="t-all-tickets">
                                  Tüm Talepler
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="{{ route('super.admin.destek.index', ['status' => 'acik']) }}" class="nav-link" data-key="t-open-tickets">
                                  Açık Talepler
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="{{ route('super.admin.destek.index', ['priority' => 'yuksek']) }}" class="nav-link" data-key="t-urgent-tickets">
                                  Acil Talepler
                              </a>
                          </li>
                      </ul>
