...
@endcannot
       ...
       @endif
        ...
        @if(auth()->user()->can('Personelleri Görebilir') && $user->tenant->hasAccessToModule('users'))
        <li>
       ...
       @if(auth()->user()->can('Bayileri Görebilir') && $user->tenant->hasAccessToModule('dealers'))
       <li>
       ...
       @if(auth()->user()->can('Depoyu Görebilir') && $user->tenant->hasAccessToModule('stocks'))
       <li>
