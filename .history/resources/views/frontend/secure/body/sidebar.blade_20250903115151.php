 ...
 <div class="vertical-menu" style="width:186px;">
   <div data-simplebar class="h-100">
     ...
     <div id="sidebar-menu">
       ...
       <li class="nav-item">
    <a href="{{ route('super.admin.destek.dashboard') }}" class="nav-link {{ request()->routeIs('super.admin.destek.dashboard') ? 'active' : '' }}">
    ...
    <div class="collapse menu-dropdown" id="sidebarSupport"> {{-- Bu kısım artık doğrudan Destek Talepleri'ne tıklandığında açılmayacak, sadece ikonuna veya başka bir tetikleyiciye ihtiyaç duyar --}}
        <ul class="nav nav-sm flex-column">
            {{-- Dashboard linki yukarı taşındığı için buradan kaldırıldı --}}
            <li class="nav-item">
