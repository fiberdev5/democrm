...
@if(Auth::user()->isSuperAdmin())
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="{{ route('super.admin.tenants') }}">
                <i class="fas fa-building me-2"></i>Tüm Firmaları Yönet
            </a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item text-muted" href="#">
                <small>Super Admin Modu Aktif</small>
            </a></li>
        </ul>
    </li>
@endif

<!-- Normal kullanıcı menüsü devam eder -->
