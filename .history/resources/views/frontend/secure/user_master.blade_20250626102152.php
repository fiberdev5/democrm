...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/2.x.x/css/buttons.dataTables.min.css">
...
<body data-topbar="dark">
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.x.x/js/dataTables.buttons.min.js"></script>
    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.x.x/js/buttons.print.min.js"></script>
