          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              var newRow = `<tr>
                ...
                <td>
                  <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-outline-primary btn-sm editWarranty mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editWarrantyModal" title="Göster"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
