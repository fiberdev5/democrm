                                ...
                                <form id="filtreForm">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8 rw2">
                                            <input type="text" name="tarih1" class="form-control datepicker tarih1 kayitTarihi" readonly 
                                                   value="{{ now()->format('Y-m-d') }}" style="background:#fff;margin-bottom: 3px;">
                                            <input type="text" name="tarih2" class="form-control datepicker tarih2 kayitTarihi" readonly 
                                                   value="{{ now()->format('Y-m-d') }}" style="background:#fff;margin-bottom: 2px;">
