        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="datatablePersonel" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                @else
                    <a class="btn btn-success btn-sm addPersonel" disabled style="pointer-events: none; opacity: .4; cursor: default;    left: 104px;
    top: 47px;">
        <i class="fas fa-plus"></i><span>Personel Ekle</span>
    </a>
    <!-- Bilgi ikonu ve yanında yazı -->
    <span class="text-muted ms-2">
        <i class="fas fa-info-circle me-1"></i>Personel limiti doldu (maks: {{ $staffLimit }})
    </span>
                @endif
