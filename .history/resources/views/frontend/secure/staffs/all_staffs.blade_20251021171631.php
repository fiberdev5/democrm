...
$(document).ready(function () {
  ...
  customize: function (win) {
    ...
    $(win.document.head).append(
      ...
      // RENKLERI KALDIRMAK İÇİN
'.badge, span.badge { background-color: transparent !important; color: #000 !important; border: 1px solid #ddd !important; padding: 2px 6px !important; }' +
'.bg-success, .bg-danger, .bg-warning, .bg-info, .bg-primary, .bg-secondary { background-color: transparent !important; color: #000 !important; }' +
'span[class*="bg-"], span[class*="badge"] { background-color: transparent !important; color: #000 !important; }' +
      '</style>'
    );
