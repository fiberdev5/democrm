...
.service-item.today .service-count {
    color: #38b000; /* canlı yeşil - daha taze ve modern */
}

.service-item.yesterday .service-count {
    color: #ff7f50; /* mercan-turuncu tonu - sıcak ve çekici */
}

.service-item.previous .service-count {
    color: #6c757d; /* mevcut koyu gri tonu iyi, ama biraz yumuşatalım */
    color: #868e96; /* biraz daha açık ve modern gri */
}
...
.filter-btn:hover,
.filter-btn:focus {
    background-color: #6c757d; /* açık mor arka plan */
