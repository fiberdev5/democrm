<div class="row pageDetail">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body" id="izinler">
          ...
          <tbody>
            @foreach($permissions as $item)
              <tr data-id="{{$item->id}}">
                ...
                <td>
                  <a href="javascript:void(0);" class="btn btn-outline-primary  editPermission mobilBtn mbuton1" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editPermissionModal" title="Görüntüle"><i class="fas fa-eye"></i> <span> Düzenle</span></a>
                  <a href="javascript:void(0);" class="btn btn-outline-warning  editPermission mobilBtn mbuton1" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editPermissionModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
                  <a href="javascript:void(0);" class="btn btn-outline-danger  mobilBtn deletePermission" data-bs-id="{{$item->id}}" title="Sil"><i class="fas fa-trash-alt"></i> <span> Sil</span></a>
                </td>
              </tr>
            @endforeach
          </tbody>
