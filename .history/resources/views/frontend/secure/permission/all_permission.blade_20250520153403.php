          ...
          <tbody>
            @foreach($permissions as $item)
              <tr data-id="{{$item->id}}">
                ...
                <td>
                  <a href="javascript:void(0);" class="btn btn-warning btn-sm editPermission mobilBtn mbuton1" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editPermissionModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
                  <a href="javascript:void(0);" class="btn btn-danger btn-sm mobilBtn deletePermission" data-bs-id="{{$item->id}}" title="Sil"><i class="fas fa-trash-alt"></i> <span> Sil</span></a>
                </td>
              </tr>
            @endforeach
          </tbody>
