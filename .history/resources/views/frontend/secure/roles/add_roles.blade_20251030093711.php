      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          var newRow = `<tr>
            ...
            <td>
              <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-warning btn-sm editPermission mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editRoleModal" title="Görüntüle"><i class="fas fa-eye"></i> <span> Düzenle</span></a>
              <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-warning btn-sm editPermission mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editRoleModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
              <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-danger btn-sm mobilBtn deleteRole" title="Sil"><i class="fas fa-trash-alt"></i> <span> Sil</span></a>
            </td>
          </tr>`;
