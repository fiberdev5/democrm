          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              var newRow = `<tr>
                ...
                <td>
                  <a href="javascript:void(0);" data-bs-id="${response.id}" class="btn btn-warning btn-sm editCar mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editCarModal" title="Göster"><i class="fas fa-eye"></i> <span> Düzenle</span></a>
