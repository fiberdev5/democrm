...
<style>
    ...
    /* Chart Containers - More prominent */
    .chart-container {
        background: white;
        border-radius: 16px;
        padding: 20px;
        ...
        box-shadow: 0 10px 25px rgba(0,0,0,0.08);
        position: relative;
        height: 380px; /* Increased height for prominence */
    }
    ...
    .chart-canvas {
        position: relative;
        height: 300px; /* Increased chart area height */
    }
