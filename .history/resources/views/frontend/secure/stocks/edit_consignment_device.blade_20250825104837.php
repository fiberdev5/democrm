...
<script>
  $(document).ready(function() {
    ...
    // Modal içeriğini yenileme fonksiyonu (Depo gibi)
    ...
    $('.islemSec').on('change', function () {       
        ...
        // Stok hareketini sil - Benzersiz class ile işaretleme (Depo gibi)
    ...
    // Fotoğrafı sil - Benzersiz class ile işaretleme (Depo gibi)
