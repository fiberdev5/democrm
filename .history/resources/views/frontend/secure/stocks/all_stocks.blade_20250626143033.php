...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
    ...
    ajax: {
      ...
      order: [[0, 'desc']],
  dom: '<"d-flex justify-content-between align-items-center mb-2"Bf>rt<"d-flex justify-content-between align-items-center mt-2"<"me-auto"i><"ms-auto d-flex align-items-center gap-3"l p>>',
  buttons: [
    {
      extend: 'print',
