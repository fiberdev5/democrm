  ...
  $(".addStock").click(function(){
    $.ajax({
      ...
      if($.trim(data) === "-1"){
        ...
        // Modal içeriği yüklendikten sonra Select2'leri başlat
        initializeSelect2('#addStockModal select[name="marka_id"]', 'Marka ara...', '/' + firma_id + '/search-brands');
        initializeSelect2('#addStockModal select[name="cihaz_id"]', 'Cihaz türü ara...', '/' + firma_id + '/search-devices');
        initializeSelect2('#addStockModal select[name="urunKategori"]', 'Kategori ara...', '/' + firma_id + '/search-categories');
        initializeSelect2('#addStockModal select[name="raf_id"]', 'Raf ara...', '/' + firma_id + '/search-shelves');
      }
    });
  });
