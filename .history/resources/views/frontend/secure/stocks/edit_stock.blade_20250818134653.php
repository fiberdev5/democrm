...
<div class="card mb-3">
    ...
    <div class="card-body p-2"> <!-- Kart içeriğinin her yönden padding'i azaltıldı -->
        <form method="POST" id="editStockUnifiedForm" action="{{ route('update.stock', [$firma->id, $stock->id]) }}">
            @csrf
            
            <!-- 
                AÇIKLAMA:
                - "mb-1": Her satır arasına çok küçük bir dikey boşluk (margin-bottom) ekler.
                - "g-2": Etiket ve input arasındaki yatay boşluğu (gutter) azaltır.
                - "align-items-center": Sol ve sağdaki elemanları dikey olarak ortalayarak yüksekliklerini eşitler.
            -->
