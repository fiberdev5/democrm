                ...
                <div class="card-body p-1"> <!-- Kart içeriğinin her yönden padding'i azaltıldı -->
                    <form method="POST" id="editStockUnifiedForm" action="{{ route('update.stock', [$firma->id, $stock->id]) }}">
                        ...
                        <div class="row g-1 align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Markalar</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1  align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Cihaz Türü</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1  align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Kategori</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1  align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Raf</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1  align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Ürün Adı</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1  align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Ürün Kodu</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row g-1 align-items-center">
                            <label class="col-sm-3 col-form-label col-form-label-sm">Satış Fiyatı</label>
                            <div class="col-sm-9">
...
<div class="card">
   ...
   <div class="card-body">
    <!-- Yükleme Formu (Başlangıçta fotoğraf yoksa görünür) -->
    ...
    <!-- Fotoğraf ve Yanındaki Uyarı Alanı (Başlangıçta fotoğraf varsa görünür) -->
    <div id="photoDisplayArea" class="row align-items-center" style="display: {{ $photos->isEmpty() ? 'none' : 'flex' }};">
        <!-- Fotoğraf Sütunu -->
        <div id="imageColumn" class="col-auto">
            @if(!$photos->isEmpty())
                @foreach($photos as $foto)
                    <div class="stn" data-id="{{ $foto->id }}">
                        <img src="{{ Storage::url($foto->resimyol) }}" class="img-fluid border rounded" style="max-width: 120px;">
        ...
        <!-- Uyarı Mesajı Sütunu -->
        <div id="warningColumn" class="col">
   ...
   $(document).off('change', '#customFile').on('change', '#customFile', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#customFile').val('');
                 ...
                 const photoHtml = `
                    <div class="stn" data-id="${res.id}">
                        <img src="${res.resim_yolu}" class="img-fluid border rounded" style="max-width: 120px;">
                        <button class="btn btn-danger btn-sm w-100 stokFotoSil mt-1 py-0" data-id="${res.id}"><i class="fas fa-trash-alt"></i></button>
                    </div>`;

                // Fotoğrafı ilgili sütuna ekle
                $('#imageColumn').html(photoHtml);
                
                // İlgili alanları göster/gizle
                $('#uploadFormContainer').hide();
                $('#noPhotos').hide();
                $('#photoDisplayArea').css('display', 'flex'); // veya .show() yerine .css('display', 'flex')
            },
            error: function (xhr) {
                $(".imgLoad").hide();
    ...
    // Fotoğrafı sil - Benzersiz class ile işaretleme
     $(document).off('click', '.stokFotoSil').on('click', '.stokFotoSil', function (e) {
        ...
        let fotoDiv = $(this).closest('.stn'); // Butonun en yakın .stn parent'ını bul
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                fotoDiv.fadeOut(300, function () { 
                    ...
                    // Silme işleminden sonra hiç fotoğraf kalmadıysa
                    if ($('#imageColumn .stn').length === 0) {
                        $('#photoDisplayArea').hide();
