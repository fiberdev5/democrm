...
$(document).ready(function(){
  ...
  // Modal kapandığında DataTable'ı yenilemek için (isteğe bağlı ama önerilir)
  $("#editStockModal").on("hidden.bs.modal", function(){
    // $('#datatableStock').DataTable().ajax.reload(); // Değişikliklerin yansıması için tabloyu yeniler
  });
