...
@if(!is_null($stockLimit) && $stockLimit != -1 && $stockAll >= $stockLimit)
  <div class="alert alert-warning d-inline-flex align-items-center py-2 px-3 mb-3">
    <i class="fas fa-exclamation-triangle me-2"></i>
    <span>Stok limiti doldu (maks: {{ $stockLimit }}) - 
      <a href="{{ route('abonelikler', ['tenant_id' => $firma->id]) }}" class="alert-link fw-bold">
        Planınızı yükseltin
      </a>
    </span>
  </div>
