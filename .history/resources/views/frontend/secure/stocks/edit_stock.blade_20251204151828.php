...
<style>
    /* Bunu style etiketleri arasına veya css dosyana ekle */
@media (max-width: 768px) {
    .islemSec {
        height: 40px !important; /* Mobilde daha yüksek olsun */
        font-size: 16px !important; /* iPhone'da zoom yapmasını engeller */
        width: 100% !important; /* Mobilde tam genişlik olsun, sıkışmasın */
        margin-top: 5px;
    }
    
    /* Başlık ve filtrelerin olduğu alanı alt alta al */
    .card-header .d-flex {
