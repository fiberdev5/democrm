...
$(document).ready(function() {
   ...
   $('#editStockUnifiedForm').on('submit', function(e) {
    ...
    $.ajax({
     ...
     $('#hareketEkleForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
    // Modal'ı hemen kapat ve formu temizle
    ...
    // Modal tamamen kapandıktan sonra mesajı göster
    $('#hareketEkleModal').on('hidden.bs.modal.once', function () {
        // Ana modal içinde mesaj göster
