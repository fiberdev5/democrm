      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div id="stokToplamlari" class="mt-3">
<div>
  <strong>Toplam Adet:</strong> <span id="toplamAdet">0</span><br>
  <strong>Toplam Fiyat:</strong> <span id="toplamFiyat">0,00 ₺</span>
</div>
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
      ...
      let adet = parseInt(json.toplam_adet);
      if (isNaN(adet)) adet = 0;
      $('#toplamAdet').text(adet);

      let fiyat = parseFloat(json.toplam_fiyat);
      if (isNaN(fiyat)) fiyat = 0.00;
      $('#toplamFiyat').text(fiyat.toFixed(2).replace('.', ',') + ' ₺');
