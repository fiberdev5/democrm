  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-8">
      <div class="input-group">
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#addBrandModal">+</button>
      </div>
    </div>
  </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addBrandForm" action="{{ route('store.brand.ajax', $firma->id) }}">
                    ...
                    <div class="row mb-3"><label class="col-sm-4">Yetkili Servis Tel:</label><div class="col-sm-8"><input name="aciklama" class="form-control" type="text" ></div></div>
                    <div class="row mb-3"><label class="col-sm-4">Servis Ücreti:</label><div class="col-sm-8"><input name="servisUcreti" class="form-control" type="text"></div></div>
                    <div class="row mb-3"><label class="col-sm-4">Operatör Prim:</label><div class="col-sm-8"><input name="operatorPrim" class="form-control" type="text" placeholder="0.00"></div></div>
                    <div class="row mb-3"><label class="col-sm-4">Atolye Prim:</label><div class="col-sm-8"><input name="atolyePrim" class="form-control" type="text" placeholder="0.00"></div></div>
                    <div class="row"><div class="col-sm-12 text-end"><button type="submit" class="btn btn-primary">Kaydet</button></div></div>
                </form>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
 ...
 const childModals = ['#addBrandModal', '#addSupplierModal', '#addDeviceTypeModal', '#addCategoryModal', '#addShelfModal'];

    // Bu modallardan herhangi biri kapandığında ('hidden.bs.modal' olayı tetiklendiğinde)
    $(childModals.join(', ')).on('hidden.bs.modal', function () {
        // Ana modal olan #editStockModal hala ekranda görünür durumda mı diye kontrol et.
        if ($('#addStockModal').is(':visible')) {
            // Eğer görünür durumdaysa, Bootstrap'in sildiği 'modal-open' class'ını
            // body etiketine manuel olarak geri ekle.
