...
$(document).ready(function () {
    ...
    // Sadece bu olay dinleyiciyi güncelleyin
    $(document).on('click', '#openEditStockModalBtn', function() {
        var url = $(this).data('url');
        
        // Kapatılacak olan mevcut modalın ID'si
        var addStockModal = $('#addStockModal'); 

        // Mevcut modal tamamen kapandıktan sonra SADECE BİR KEZ çalışacak bir olay dinleyici ekle
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.html) {
                        ...
                        // --- ÇÖZÜM BURADA ---
                        // Yeni modalı göstermeden önce tarayıcının nefes almasına izin ver.
                        setTimeout(function() {
                            $('#editStockModal').modal('show');
                        }, 150); // 150 milisaniyelik bir gecikme genellikle yeterlidir.
