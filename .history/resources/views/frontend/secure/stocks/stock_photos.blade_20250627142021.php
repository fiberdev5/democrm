<form method="POST" id="stokFotoEkle" enctype="multipart/form-data">
    ...
    <!-- Önizleme resmi (sadece resim varsa görünür) -->
    ...
    @if(isset($firstPhoto) && $firstPhoto->belge)
    <div class="mb-3">
        <img 
            src="{{ $firstPhoto->belge }}" 
            alt="Mevcut Resim"
...
<div class="row imgBox">
    @foreach($photos as $foto)
        <div class="col-6 col-sm-3 stn mb-2" data-id="{{ $foto->id }}">
            <img src="{{ $foto->belge }}" class="img-fluid border" style="width: 100%;">
            <button class="btn btn-danger btn-sm w-100 stokFotoSil mt-1" data-id="{{ $foto->id }}">Sil</button>
            ...
            success: function (res) {
                ...
                $('.imgBox').prepend(`
                    <div class="col-6 col-sm-3 stn mb-2" data-id="${res.id}">
                        <img src="${res.belge}" class="img-fluid border" style="width: 100%;">
