...
$(document).ready(function () {
    // Değişkenleri kendi formunuza göre ayarlıyoruz
    var tenantId = "{{ $tenant_id }}";
    var mainFormId = '#addConsignmentDevice';
    
    // !!! DİKKAT !!!
    // addStock kodunda bu kontrol '#addStockModal' için yapılıyor.
    // Sizin konsinye formunuzu içeren ana modalın ID'si ne ise onu buraya yazın.
    // Eğer bu form bir modal içinde değilse bu satırları silebilirsiniz ama muhtemelen bir modal içindedir.
    var mainModalSelector = '#addConsignmentDeviceModal'; // Örnek ID, kendinizinkiyle değiştirin

    // -------------------------------------------------------------------
    // 1. SELECT2 BAŞLATMA (Çalışan koddakiyle BİREBİR AYNI fonksiyon)
    // -------------------------------------------------------------------
    ...
    // Select2'leri sayfa başında başlatıyoruz (Çalışan koddaki gibi)
    ...
    // -------------------------------------------------------------------
    // 2. ALT MODAL YÖNETİMİ (Çalışan koddakiyle BİREBİR AYNI MANTIK)
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // 3. DİĞER FORM İŞLEVLERİ (Doğrulama, Kontrol vb.)
    // -------------------------------------------------------------------
