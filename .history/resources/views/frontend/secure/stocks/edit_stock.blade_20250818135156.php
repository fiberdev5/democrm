...
$(document).ready(function() {
    ...
    $('#hareketEkleModal').on('hidden.bs.modal', function (e) {
        // Eğer ana modal (editStockModal) hala görünür durumdaysa,
        // Bootstrap'in kaldırdığı 'modal-open' sınıfını body'e geri ekle.
        // Bu, ana modalın tekrar düzgün çalışmasını sağlar.
        if ($('#editStockModalLabel').is(':visible')) {
