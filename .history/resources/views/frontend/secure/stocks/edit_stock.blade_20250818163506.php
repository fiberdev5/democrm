      ...
      <div class="modal-content">
        ...
        <div class="mb-2">
            ...
            <div class="input-group">
              ...
              <!-- YENİ EKLENDİ: Tedarikçi ekle butonu -->
              <button class="btn btn-success" type="button" id="addNewSupplierBtn" data-bs-toggle="modal" data-bs-target="#addSupplierModal">+</button>
            </div>
          </div>
...
$(document).ready(function() {
    ...
    // YENİ EKLENDİ: Tedarikçi Ekleme modalı kapandığında, arkadaki modalın scroll problemini düzelt
