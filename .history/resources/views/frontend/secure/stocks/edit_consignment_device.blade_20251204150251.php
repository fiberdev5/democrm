...
<div class="modal-body">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <div class="d-flex align-items-center gap-2">
            <!-- Mobilde sadece ikon, masaüstünde yazı görünsün diye içeriği düzenledik -->
            <button type="button" class="btn btn-success btn-sm hareketEkleBtn"
                data-stokid="{{ $stock->id }}" data-tenant-id="{{ $firma->id }}">
                 <span class="d-none d-sm-inline">Stok Hareketi Ekle</span>
                 <span class="d-inline d-sm-none"><i class="fas fa-plus"></i> Ekle</span>
            </button>
            
            <!-- form-select sınıfı eklendi ve width:auto yerine mobilde düzgün durması sağlandı -->
            <select class="form-select form-select-sm islemSec d-inline-block" name="islemSec"
