      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
              ...
              <div class="stok-toplamlar mt-2">
              <span><strong>Toplam Adet:</strong> <span id="toplamAdet">0</span></span> &nbsp;&nbsp;
              <span><strong>Toplam Fiyat:</strong> <span id="toplamFiyat">0.00</span></span>
              </div>
          </div>
        </div>
      </div>
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
      ...
      api.rows({ page: 'current' }).every(function () {
        ...
        // Adet: sayıya çevrilebiliyorsa
        let adet = parseFloat(data.adet) || 0;
        let fiyat = parseFloat(data.fiyat) || 0;

        toplamAdet += adet;
        toplamFiyat += (fiyat * adet);
      });

      $('#toplamAdet').text(toplamAdet);
