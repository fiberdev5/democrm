                ...
                <div class="card mt-5">
                    <div class="card-body text-center p-5">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <a href="{{ route('secure.home', $firma->id) }}" class="btn btn-secondary">
                                <i class="ri-arrow-left-line me-2"></i>
                                Ana Sayfaya Dön
                            </a>
                            <a href="{{ route('subscription.plans', $firma->id) }}" class="btn btn-primary" style="background:linear-gradient(135deg, #2d3748 0%, #4a5568 100%)">
