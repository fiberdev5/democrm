<!-- =================================================================== -->
<!-- =============== BİRLEŞTİRİLMİŞ TEK STOK MODALI ================== -->
<!-- =================================================================== -->
...
<div class="modal fade" id="hareketEkleModal" tabindex="-1" aria-labelledby="hareketEkleModalLabel" aria-hidden="true">
    {{-- Orijinal Hareket Ekle Modal içeriğinizin tamamı buraya gelecek --}}
    {{-- ... --}}
</div>
...
<div class="modal fade" id="personelStokModal" tabindex="-1" aria-labelledby="personelStokModalLabel" aria-hidden="true">
    {{-- Orijinal Personel Stok Detay Modal içeriğinizin tamamı buraya gelecek --}}
    {{-- ... --}}
</div>
