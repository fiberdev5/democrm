...
            </a>
            {{-- Eski Yazdır butonu kaldırıldı, DataTables kendi butonunu ekleyecek --}}
...
        }
      },
      dom: 'Bfrtip', // 'B' harfi, DataTables'a butonları dahil etmesini söyler
      buttons: [
          {
              extend: 'print',
              text: '<i class="fas fa-print"></i> Yazdır', // Buton metni ve simgesi
              title: 'Stok Raporu', // Yazdırılan sayfada görünecek başlık
              exportOptions: {
                  columns: ':visible', // Yalnızca görünür sütunları yazdırır
                  // Eylem sütununu (Düzenle) yazdırmadan hariç tutmak için:
                  // Son sütun eylem sütunu olduğundan, ilk 8 sütunu seçebiliriz (0'dan 7'ye kadar).
                  columns: [0, 1, 2, 3, 4, 5, 6, 7] 
              },
              customize: function ( win ) {
                  // Yazdırma penceresindeki tablo stilini özelleştirme
                  $(win.document.body).find('table').addClass('compact').css('font-size', 'inherit');
                  $(win.document.body).find('h1').css('text-align', 'center');
                  
                  // Toplam adet ve toplam fiyatı da eklemek için:
