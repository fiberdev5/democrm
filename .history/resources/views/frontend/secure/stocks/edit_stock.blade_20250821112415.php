          ...
          <!-- 1. KART: ÜRÜN BİLGİLERİ -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="photoLimitWarning" class="alert alert-warning p-2 mt-2 text-center" role="alert" style="display: {{ !$photos->isEmpty() ? 'block' : 'none' }};">
                        <small>
                    ...
                    <div id="noPhotos" class="text-center text-muted"  style="display: {{ $photos->isEmpty() ? 'block' : 'none' }};">
                        <i class="fas fa-images fa-3x mb-1" style="font-size: 2em;"></i>
