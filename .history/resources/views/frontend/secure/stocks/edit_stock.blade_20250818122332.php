    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body py-2 px-3"> {{-- Daha sıkı bir görünüm için padding azaltıldı --}}
                    <form method="POST" id="editStockUnifiedForm" action="{{ route('update.stock', [$firma->id, $stock->id]) }}">
                        @csrf
                        
                        {{-- Daha sıkı satırlar için mb-2 yerine mb-1 ve form-control-sm kullanıldı --}}
                        ...
                        <div class="row mb-1 align-items-center">
                            ...
                            <div class="col-sm-8">
                                <div class="d-flex align-items-center">
                                    <input type="text" name="urunKodu" class="form-control form-control-sm @error('urunKodu') is-invalid @enderror me-2" value="{{ old('urunKodu', $stock->urunKodu) }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row imgBox">
                        {{-- Daha küçük fotoğraflar için col-md-3 (4'lü sıra) --}}
        ...
        <!-- ================================================= -->
        <div class="col-lg-7">
            {{-- SAĞ SÜTUN İÇERİĞİ DEĞİŞMEDİ --}}
            @include('frontend.secure.stocks.partials.stock_movements')
            @include('frontend.secure.stocks.partials.personnel_stocks')
        </div>
    </div>
...
<div class="modal-footer">
    ...
    <a href="{{ route('stok.barkod.pdf', [$firma->id, $stock->id]) }}" target="_blank" class="btn btn-warning">
        Barkodu Yazdır
    </a>
