...
$(document).ready(function() {
    // 2. modal olan 'hareketEkleModal' gösterilmeden hemen önce bu fonksiyon çalışır.
    $('#hareketEkleModal').on('show.bs.modal', function () {
        // İlk modalın üzerine, ikinci modalın ise arkasına gelecek şekilde
        // z-index değeri daha yüksek olan yeni bir backdrop oluşturuyoruz.
        // Bootstrap'in varsayılan modal z-index'i 1055'tir. Biz 1060 kullanarak araya giriyoruz.
        $(this).before('<div class="modal-backdrop fade show" id="secondBackdrop" style="z-index: 1060;"></div>');
    });

    // 2. modal olan 'hareketEkleModal' tamamen kapandıktan sonra bu fonksiyon çalışır.
    $('#hareketEkleModal').on('hidden.bs.modal', function () {
        // Eklediğimiz özel backdrop'ı DOM'dan kaldırıyoruz.
        $('#secondBackdrop').remove();

        // Arka plandaki ilk modal hala açıksa, body'nin scrollbar'ının
        // kaybolmaması için 'modal-open' sınıfının kalmasını sağlıyoruz.
        // Bu kod sizde zaten vardı, onu burada birleştiriyoruz.
