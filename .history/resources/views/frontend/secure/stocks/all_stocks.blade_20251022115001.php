          ...
          <div class="card card-stock">
            ...
            <div class="card-body card-stock-body">
              <div class="d-flex d-sm-block">
                ...
                <a href="{{ route('consignmentdevice', $firma->id) }}" data-bs-target="#supplierModal" class="btn btn-info btn-sm supplierBtn d-flex align-items-center">
...
buttons: [{
  ...
  customize: function (win) {
    ...
    var title = '<div class="print-title">Tüm Stoklar</div>';
    $(win.document.body).find('table').before(title);
    
    var footer = '<div class="print-footer">' +
                 '  <span>Listelenen Ürün Sayısı: ' + totalRecords + ' - Tarih: ' + moment().format('DD/MM/YYYY') + '</span>' +
                 '</div>';
