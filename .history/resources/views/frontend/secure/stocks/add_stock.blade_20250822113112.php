...
$(document).ready(function () {
    ...
    function initializeSelect2(selector, placeholder, url) {
        // Hangi modalın içinde olduğumuzu bulalım. 
        // addStock formu hangi modalın içindeyse onun ID'sini verin.
        // Eğer addStock formu doğrudan bir modalın içindeyse, o modalın ID'sini kullanın.
        // Örneğin, ana modal'ın ID'si '#addStockModal' ise:
        var parentModal = $(selector).closest('.modal');
        if (parentModal.length === 0) {
            // Eğer bir modal içinde değilse (örneğin sayfa direk yükleniyorsa)
            // fallback olarak en üstteki görünen modalı bulabiliriz.
        ...
        $(selector).select2({
            ...
            allowClear: true,
            // ÇÖZÜM: dropdownParent'ı burada ayarlıyoruz.
