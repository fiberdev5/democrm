                       ...
                       <div class="row g-1  align-items-center">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a href="{{ route('stok.barkod.pdf', [$firma->id, $stock->id]) }}" 
                                    ...
                                    <i class="fa-solid fa-print me-1"></i> Barkodu Yazdır
                                </a>
                                </div>
                                @error('urunKodu')
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    @if($stokIslem->islem == 1)
                                        {{ $stokIslem->tedarikci ?? '-' }}
                                    @elseif($stokIslem->islem == 2)
                                    <a href="{{ route('all.services', [$firma->id,'did'=>$stokIslem->servisid]) }}" target="_blank" style="color:red;" class="link-stock">
