        ...
        <div class="col-lg-5">
            ...
            <div class="card card-stock">
                ...
                <div class="card-body card-stock-body p-2">
                    ...
                    <div id="photoLimitWarning" class="alert alert-warning text-center p-2" role="alert"
...
<div class="modal fade" id="hareketEkleModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-konsinye">
        <form id="hareketEkleForm" method="POST" action="{{ route('store.consignment.stock.action', $firma->id) }}">
            ...
            <input type="hidden" name="form_token" id="konsinyeHareketFormToken" value="">
...
<script>
    $(document).ready(function () {
        // Token sistemi
        let konsinyeHareketFormSubmitting = false;
        // Benzersiz token oluştur
        function generateKonsinyeHareketToken() {
        ...
        $('#hareketEkleForm').on('submit', function (e) {
            ...
            // Token kontrolü
            if (konsinyeHareketFormSubmitting) {
                return false;
            }
            ...
            konsinyeHareketFormSubmitting = true;
            ...
            $.ajax({
                ...
                // ÖNEMLİ: Yeni token oluştur (modal açık kalabilir)
                $('#konsinyeHareketFormToken').val(generateKonsinyeHareketToken());
                konsinyeHareketFormSubmitting = false;
                ...
                complete: function () {
                    // 3 saniye sonra butonu aktif et
                    setTimeout(function() {
                        konsinyeHareketFormSubmitting = false;
...
// Modal kapandığında temizlik
        $('#hareketEkleModal').on('hidden.bs.modal', function () {
            ...
            // Token ve flag'i sıfırla
            $('#konsinyeHareketFormToken').val('');
            konsinyeHareketFormSubmitting = false;
        ...
        $(document).on('submit', '#addStokSupplier', function (e) {
            ...
            // Form zaten submit ediliyor mu kontrol et
            ...
            $.ajax({
                ...
                complete: function () {
                    // Her durumda form durumunu sıfırla
