...
<div class="row mb-2">
  ...
  <div class="row mb-2">
    <label class="col-sm-4 ">Adet <span class="text-danger">*</span></label>
    <div class="col-sm-8">
...
$(document).ready(function () {
    ...
    // Otomatik fiyat birim hesaplama
...
Bu script, Select2'nin başlatılması, "+" butonlarının işlevselliği, AJAX ile yeni kayıt ekleme ve form doğrulama gibi tüm dinamik işlemleri yönetir.
