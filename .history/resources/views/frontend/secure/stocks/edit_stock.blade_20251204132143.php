    ...
    <div class="row">
        ...
        <div class="col-lg-5">
          <!-- 1. KART: ÜRÜN BİLGİLERİ -->
            ...
            <div class="photo-warning-wrapper d-flex">
    <div class="photo-warning-box">
        <div id="photoLimitWarning" class="alert alert-warning text-center" role="alert"
            style="font-size: 1em; height:60px">
            <small>
        ...
        <div class="row imgBox">
            @foreach($photos as $foto)
                <div class="col-4 col-md-3 stn mb-2" data-id="{{ $foto->id }}">
                    ...
                    <button class="btn btn-outline-danger btn-sm w-100 stokFotoSil mt-1 py-0" data-id="{{ $foto->id }}">
