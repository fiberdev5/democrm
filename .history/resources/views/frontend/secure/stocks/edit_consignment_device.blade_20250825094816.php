    ...
    $('#hareketEkleForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Select2'yi de temizle
                if ($('#tedarikciSelect').hasClass('select2-hidden-accessible')) {
