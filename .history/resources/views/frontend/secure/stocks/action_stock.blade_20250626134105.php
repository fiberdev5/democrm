  ...
  <div class="mt-2 toplam-bilgi" style="display: none;">
    ...
    <div class="card-body" style="padding: 0;">
      <div class="table-responsive">
        ...
        <td colspan="3"></td>
        <td class="toplam-adet-header" style="font-weight: bold; text-align: center; color: #007bff;">
          0 Adet
        </td>
        <td class="toplam-fiyat-header" style="font-weight: bold; text-align: center; color: #007bff;">
          0 TL
        </td>
        <td></td>
      </tr>
