        ...
        **buttons: [
            {
                ...
                exportOptions: {
                    ...
                    // İsteğe bağlı: Eylem sütununu yazdırmadan hariç tutmak için
                    // columns: [0, 1, 2, 3, 4, 5, 6, 7] // veya indexlerini belirtin
                },
                customize: function ( win ) {
                    // Yazdırma penceresindeki tablo stilini özelleştirme
                    $(win.document.body).find('table').addClass('compact').css('font-size', 'inherit');
                    $(win.document.body).find('h1').css('text-align', 'center');
                    // Toplam adet ve toplam fiyatı da eklemek isterseniz:
