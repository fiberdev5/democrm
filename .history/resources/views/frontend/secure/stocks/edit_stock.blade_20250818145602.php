...
<style>
.modal-open .edit-stock-modal-bg-fade {
    /* Bu stil, ana modalın kendisi veya ana modalın içeriği için kullanılabilir */
...
$(document).ready(function() {
    ...
    // Hareket Ekle modalı açıldığında
    $('#hareketEkleModal').on('show.bs.modal', function () {
        // Ana modalın içeriğini soluklaştır
        $('#editStockContent').addClass('edit-stock-modal-bg-fade');
        
        // Hareket ekle modalını dikeyde ortalamak için
        $(this).addClass('modal-dialog-centered');
    });

    // Hareket Ekle modalı kapandığında
    $('#hareketEkleModal').on('hidden.bs.modal', function () {
        // Ana modalı tekrar normal hale getir
        $('#editStockContent').removeClass('edit-stock-modal-bg-fade');
    });
