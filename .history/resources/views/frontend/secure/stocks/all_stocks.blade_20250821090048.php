...
$(document).ready(function(){
  ...
  //Sorunlu kod bunu kaldırınca stok eklemedeki modal açılıyor ancak editmodal açılmıyor.
  //Bu olunca da stok kartı eklemedeki + butolarında açılan modalları açıp kapattıktan sonra diğer stok kartı ekle modlaı kapanıyor.
  // Ana modal temizleme işlemini sadece gerçekten gerektiğinde yap
  $("#addStockModal").on("hidden.bs.modal", function(e){
    var modal = $(this);
    
    // Eğer bir alt modal tetiklenmişse temizleme
    if (e.target === this) {
      setTimeout(function(){
        // 200ms sonra kontrol et, başka modal açılmışsa temizleme
