...
<div class="stock-buttons-container d-flex align-items-center gap-2 flex-wrap">
  ...
  @if(!is_null($stockLimit) && $stockLimit != -1 && $stockAll >= $stockLimit)
    <span class="badge bg-warning text-dark px-3 py-2">
      ...
      Limit doldu ({{ $stockAll }}/{{ $stockLimit }}) - 
      <a href="{{ route('abonelikler', ['tenant_id' => $firma->id]) }}" class="text-dark text-decoration-underline fw-bold">
        Yükselt <i class="fas fa-arrow-up"></i>
      </a>
    </span>
  @endif
