...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-lg-5">
          <!-- 1. KART: ÜRÜN BİLGİLERİ (DÜZENLENMİŞ HALİ) -->
<div class="card mb-3">
    <div class="card-header py-2">
        <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Ürün Bilgileri</h5>
    </div>
    <div class="card-body p-2"> <!-- Padding biraz artırılarak içerik kenarlardan uzaklaştırıldı -->
        <form method="POST" id="editStockUnifiedForm" action="{{ route('update.stock', [$firma->id, $stock->id]) }}">
            @csrf
            <!-- Her satıra mb-2 eklenerek aralarındaki dikey boşluk tutarlı hale getirildi -->
