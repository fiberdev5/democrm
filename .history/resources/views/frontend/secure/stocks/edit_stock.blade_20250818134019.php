...
<div class="card">
    <div class="card-header py-2"> <!-- Dikey padding azaltıldı -->
        <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Ürün Bilgileri</h5> <!-- Başlık altındaki margin kaldırıldı -->
    </div>
    <div class="card-body p-2"> <!-- Padding her yönden azaltıldı -->
        <form method="POST" id="editStockUnifiedForm" action="{{ route('update.stock', [$firma->id, $stock->id]) }}">
            @csrf
            
            {{-- Satırlar arası boşluğu azaltmak için mb-1 ve g-2 (gutter) kullanıldı --}}
            ...
            <div class="row g-2 mb-1 align-items-center">
                ...
                <div class="col-sm-8">
                    <div class="input-group input-group-sm"> <!-- Input group ile daha sıkı bir yapı -->
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-sm-8">
                    <div class="alert alert-info p-1 mb-0 fs-sm"> <!-- Padding, margin ve font boyutu küçültüldü -->
