...
<div class="row mb-2">
    ...
    <div class="col-sm-8">
        <input name="urunKodu" type="text" class="form-control" 
               ...
               data-mask="000-0000-000000" required>
        <small class="text-danger">Ürün kodu 13 haneli olmalıdır. Format: XXX-XXXX-XXXXXX</small>
...
<!-- jQuery Mask Plugin CDN'i eklemeyi unutmayın -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js"></script>

<script>
$(document).ready(function () {
    // Ürün kodu mask
    $('input[name="urunKodu"]').mask('000-0000-000000', {
    ...
    // Form validation - DÜZELTİLDİ
    $('#addStock').submit(function(event) {
        // cleanVal() kullanarak sadece rakamları al
        var urunKodu = $('input[name="urunKodu"]').cleanVal();
        
        console.log('Ürün Kodu (temiz):', urunKodu, 'Uzunluk:', urunKodu.length); // Debug için

        if (urunKodu.length !== 13) {
            event.preventDefault();
            alert('Ürün kodu tam 13 haneli olmalıdır! Şu anda ' + urunKodu.length + ' haneli.');
        ...
        // Diğer required alanları kontrol et
        var isValid = true;
