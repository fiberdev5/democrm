            ...
            <div class="searchWrap float-end">
              <div class="btn-group mb-2 ">
                ...
                <div class="dropdown-menu p-3" style="min-width: 250px;">
                 ...
                 <!-- Personel dropdown'ının mevcut hali -->
<div class="item">
  <div class="row align-items-center">
    ...
    <div class="col-sm-7">
      <select id="personel" class="form-select form-select-sm">
        ...
        @foreach($personeller as $personel)
          <!-- Debug için her iki değeri de kontrol edin -->
          <option value="{{ $personel->user_id ?? $personel->id }}" data-debug="{{ json_encode($personel->toArray()) }}">
            {{ $personel->name }}
          </option>
        @endforeach
      </select>
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
    ...
    ajax: {
      ...
      data: function (d) {
        ...
        // Debug için konsola yazdırabilirsiniz
        console.log('Personel filter value:', d.personel);
      }
    },
      columns: [
        { data: 'id', name: 'id' },
  ...
  // Filtreler değiştiğinde tabloyu yeniden çiz - BURADA DÜZELTİLDİ
  // Başında boşluk olan ' #raf' yerine '#raf' kullanın
...
console.log('Personeller:', @json($personeller));
</script>
@endsection
