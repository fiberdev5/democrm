...
// DataTable
$(document).ready(function () {
  // Personel depo istatistiklerinden gelen personel ID'sini kontrol et
  var depo_personel_id = getUrlParameter('depo_personel_id');
  if (depo_personel_id) {
    $('#personel').val(depo_personel_id);
  }
  var table = $('#datatableStock').DataTable({
    ...
    ajax: {
      ...
      data: function (d) {
        ...
        // Personel depo istatistiklerinden gelen filtre
        d.depo_personel_id = getUrlParameter('depo_personel_id');
      }
    },
      columns: [
        { data: 'id', name: 'id' },
