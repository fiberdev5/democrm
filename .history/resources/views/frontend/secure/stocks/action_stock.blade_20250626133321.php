...
<script>
 ...
 $(document).ready(function () {
    $('.islemSec').on('change', function () {
        ...
        // Toplam satırını güncelle veya ekle
        updateTotalRow(card, toplamAdet, toplamFiyat, goruntulenenSatir);
    });

    function updateTotalRow(card, toplamAdet, toplamFiyat, goruntulenenSatir) {
        ...
        if (goruntulenenSatir > 0) {
            ...
            var toplamSatir = `
                <tr class="toplam-satir" style="background-color: #f8f9fa; font-weight: bold; border-top: 2px solid #dee2e6;">
                    <td style="display:none;"></td>
                    <td colspan="3" style="text-align: right; padding-right: 10px;">TOPLAM:</td>
                    <td>${toplamAdet} Adet</td>
    ...
    // Sayfa yüklendiğinde başlangıç toplamını hesapla
    $('.islemSec').each(function() {
        $(this).trigger('change');
    });
});
