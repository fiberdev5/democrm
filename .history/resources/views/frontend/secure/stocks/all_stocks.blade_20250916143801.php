        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="datatableStock" class="table table-bordered dt-responsive nowrap" style="width: 100%;">
             ...
             <!-- Kasa sayfasındaki gibi toplama alanı -->
            <div class="tableToplamaAlani">
              <div class="row r1" style="text-align: center;">
                <div class="col-12" style="padding: 20px; border: none; width: 100%; float: none;">
                  <div style="display: inline-block; margin: 0 30px;">
                    <strong>Toplam Ürün: </strong><span id="toplamAdet">0</span>
                  </div>
                  <div style="display: inline-block; margin: 0 30px;">
                    <strong>Depo Kazanç: </strong><span id="toplamFiyat">0 ₺</span>
                  </div>
                </div>
              </div>
            </div>
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
    ...
    ajax: {
      ...
      order: [[0, 'desc']],
      // Kasa sayfasındaki gibi DOM ayarı - sayfalama altta
