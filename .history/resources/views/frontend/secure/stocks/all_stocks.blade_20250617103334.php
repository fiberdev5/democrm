        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-2 d-flex justify-content-between">
              <div>
                  <button type="button" class="btn btn-success btn-sm stokEkleBtn"><i class="fas fa-plus"></i> Ürün Ekle</button>
                  <button type="button" class="btn btn-info btn-sm tedarikcilerBtn"><i class="fas fa-industry"></i> Tedarikçiler</button>
