      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- DataTable butonlarının konumlandırılacağı alan -->
            <div id="datatableStock_wrapper" class="dataTables_wrapper dt-bootstrap4">
              <div class="row">
                <div class="col-sm-12 col-md-6">
                  <div class="dataTables_length" id="datatableStock_length"></div>
                </div>
                <div class="col-sm-12 col-md-6">
                  <div class="dataTables_filter" id="datatableStock_filter"></div>
                </div>
              </div>
              <!-- Butonlar buraya yerleştirilecek -->
              <div class="row mb-2">
                <div class="col-sm-12">
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
      ...
      // DOM düzeni düzeltildi - butonların konumu ayarlandı
