...
$(document).ready(function () {
                ...
                success: function (res) {
                    if (res.exists) {
                        var warningHtml = '<div class="alert alert-warning mt-2">' +
                                          ...
                                          '<a href="#" id="openEditModalBtn" data-url="' + res.edit_url + '" class="btn btn-sm btn-primary ms-2">Ürünü Düzenle</a>' +
                                          '</div>';
    ...
    // Modal açma butonu için event handler
