...
/* Select2 dropdown input ve seçim alanını Bootstrap boyutuna uydur */
.select2-container .select2-selection--single {
    height: 38px !important;       /* Bootstrap default input height */
    padding: 6px 12px !important;  /* Bootstrap padding */
    font-size: 0.875rem;           /* Bootstrap küçük form-control font */
    line-height: 1.5 !important;
    border: 1px solid #ced4da;     /* Bootstrap border */
    border-radius: 0.375rem;       /* Bootstrap radius */
}

/* Seçilen yazı hizalaması */
...
/* Ok simgesinin hizalanması */
.select2-container--default .select2-selection--single .select2-selection__arrow {
    height: 36px !important;
    right: 8px;
}

/* Dropdown arama alanını küçült */
