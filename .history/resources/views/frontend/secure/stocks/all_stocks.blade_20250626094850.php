    ...
    <div class="row pageDetail">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-3">
              <a data-bs-toggle="modal" data-bs-target="#addStockModal" class="btn btn-success btn-sm addStock me-2">
                <i class="fas fa-plus"></i> <span>Ürün Ekle</span>
              </a>
              <a href="{{ route('consignmentdevice', $firma->id) }}" class="btn btn-info btn-sm supplierBtn me-2">
                <i class="fas fa-industry"></i> Konsinye Cihazlar 
              </a>
              <button type="button" class="btn btn-warning btn-sm me-2" id="customPrintBtn">
