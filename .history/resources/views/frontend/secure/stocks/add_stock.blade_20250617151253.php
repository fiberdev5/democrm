<form method="post" id="addStockForm" action="{{ route('store.stock', $firma->id) }}" enctype="multipart/form-data">
  @csrf
  <div class="row mb-3">
    <label class="col-sm-4 col-form-label">Stok Adı<span style="color:red;">*</span></label>
    <div class="col-sm-8">
...
<script>
  $(document).ready(function () {
    // Form submit kontrolü (zorunlu alanlar)
