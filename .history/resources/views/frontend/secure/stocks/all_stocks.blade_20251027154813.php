...
.stock-limit-alert-custom:hover {
...
.stock-count-badge-custom {
  ...
  color: #d97706;
  margin: 0 5px;
  border: 1.5px solid rgba(217, 118, 6, 0.25);
  box-shadow: 0 1px 3px rgba(217, 118, 6, 0.1);
}
  </style>
...
<div class="stock-buttons-container">
 ...
 @if(!is_null($stockLimit) && $stockLimit != -1 && $stockAll >= $stockLimit)
              <span class="text-muted stock-limit-warning">
                ...
                <a href="{{ route('abonelikler', ['tenant_id' => $firma->id]) }}" class="text-primary">
                  Planınızı yükseltin
                </a>
              </span>
@endif
