...
@if(!is_null($stockLimit) && $stockLimit != -1 && $stockAll >= $stockLimit)
  <span class="text-warning stock-limit-warning">
    <i class="fas fa-exclamation-triangle me-1"></i>Stok limiti doldu (maks: {{ $stockLimit }}) - 
    <a href="{{ route('abonelikler', ['tenant_id' => $firma->id]) }}" class="text-primary fw-bold">
      Planınızı yükseltin
    </a>
  </span>
@endif
