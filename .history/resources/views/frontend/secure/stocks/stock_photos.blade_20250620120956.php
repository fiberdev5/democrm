<form method="POST" id="stokFotoEkle" enctype="multipart/form-data">
    ...
    <!-- Önizleme için img -->
    <div class="mb-3">
        <img id="resimGoster" src="" alt="Resim Önizleme" style="max-width: 200px; display:none; border: 1px solid #ccc; padding: 5px;">
    </div>
...
$(document).ready(function () {
    ...
    // Dosya input değişince hem önizleme hem ajax yükleme
    $('#customFile').on("change", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                $(".imgLoad").hide();
                $('#customFile').val('');
                $('#resimGoster').hide();  // Önizlemeyi temizleyelim, yüklenen resim zaten aşağıda

                // Yeni resmi galeriye ekle
                $('.imgBox').prepend(`
