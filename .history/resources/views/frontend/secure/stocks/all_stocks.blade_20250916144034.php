        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="tableToplamaAlani" >
              <div class="row r1"style="text-align:center !important;">
               <div class="sol" style="display: flex; align-items: center; justify-content: center;"><strong>Toplam Bilgiler</strong></div>
                <div class="sag">
