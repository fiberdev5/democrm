      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a data-bs-toggle="modal" data-bs-target="#addKonsinyeModal" class="btn btn-success btn-sm addConsigment">
              <i class="fas fa-plus"></i> <span>Cihaz Ekle</span>
            </a>
            <a data-bs-toggle="modal" data-bs-target="#konsinyePrintModal" class="btn btn-warning btn-sm consigmentPrintButton">
