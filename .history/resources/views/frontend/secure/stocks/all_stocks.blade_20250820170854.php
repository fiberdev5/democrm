...
$(document).ready(function(){
  var firma_id = {{ $firma->id }};
   ...
   $('#addStockModal').on('hidden.bs.modal', function () {
    // Modal'ın bir sonraki açılışta yeniden başlatılmasını sağlamak için verilerini temizle
    $(this).removeData('bs.modal');
    // Modal'ın body içeriğini temizle ki bir sonraki açılışta eski içerik görünmesin
