...
<script>
   function hesaplaToplamFiyat() {
    var adet = parseFloat($('#inputAdet').val()) || 0;
    var birimFiyat = parseFloat($('#inputBirimFiyat').val()) || 0;
    var toplam = adet * birimFiyat;

    $('#toplamFiyatGoster').val(toplam.toFixed(2) + ' TL');
    $('#hiddenToplamFiyat').val(toplam.toFixed(2));
  }

  $(document).ready(function () {
    $('#inputAdet, #inputBirimFiyat').on('input', hesaplaToplamFiyat);
  });
  $(document).on('click', '.hareketEkleBtn', function() {
    ...
    $('#inputAdet').val('');
    $('#inputBirimFiyat').val('');
    $('#toplamFiyatGoster').val('');
    $('#hiddenToplamFiyat').val('');
