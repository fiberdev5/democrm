...
$(document).ready(function () {
    ...
    function initializeSelect2(selector, placeholder, url) {
        ...
        $(selector).select2({
            ...
            allowClear: true,
            width: '100%', // Genişlik problemi için
    ...
    // Select2'leri başlatma fonksiyonu
    ...
    // Modal event handlers - Tüm modaller için ortak
    $('.modal').on('shown.bs.modal', function () {
        ...
        setTimeout(function() {
            modal.find('select').each(function() {
                ...
                if (placeholder && url) {
                    initializeSelect2('#' + modal.attr('id') + ' select[name="' + name + '"]', placeholder, url);
                }
            });
        }, 100);
    });
    ...
    $('.modal').on('hidden.bs.modal', function () {
        // Modal kapandığında Select2'leri temizle
        ...
        // Ana modal hala açıksa body class'ını koru
    ...
    $(document).on('click', '#addNewBrandBtn', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '#addNewDeviceTypeBtn', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '#addNewShelfBtn', function (e) {
        e.preventDefault();
    ...
    // Sayfa yeniden yüklendiğinde Select2'leri başlat
