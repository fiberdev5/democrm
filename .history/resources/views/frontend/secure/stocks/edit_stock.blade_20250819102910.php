...
.col-form-label-sm {
 ...
 .fs-sm {
    ...
    /* Select2 kutularının yüksekliğini standart form elemanıyla eşitle */
#hareketEkleModal .select2-container .select2-selection--single {
    height: 38px; /* Bootstrap 5'teki varsayılan .form-control yüksekliği */
}

/* Select2 kutusunun font boyutu, padding'i ve dikey hizalamasını ayarla */
#hareketEkleModal .select2-container--bootstrap-5 .select2-selection {
    font-size: 1rem;      /* Standart .form-control font boyutu */
    padding: 0.375rem 0.75rem; /* Standart .form-control padding'i */
    display: flex;
    align-items: center; /* İçeriği dikey olarak ortala */
}

/* Seçilen metnin dikey hizalamasını ve padding'ini düzelt */
#hareketEkleModal .select2-container--bootstrap-5 .select2-selection--single .select2-selection__rendered {
    padding-left: 0; /* Ana kutunun padding'i yeterli */
    line-height: normal; /* Flex ile hizaladığımız için bu daha iyi sonuç verir */
}

/* Sağdaki okun pozisyonunu dikey olarak ortala */
#hareketEkleModal .select2-container--bootstrap-5 .select2-selection--single .select2-selection__arrow {
    height: 100%; /* Kapsayıcısının tamamını kaplasın */
    display: flex;
