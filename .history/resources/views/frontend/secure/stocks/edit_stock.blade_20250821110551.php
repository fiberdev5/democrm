    ...
    $(document).on('change', '#customFile', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                // --- YENİ EKLENEN KISIM ---
                // Fotoğraf eklendiği için formu ve "fotoğraf yok" yazısını gizle
                $('#noPhotos').hide();
                $('#uploadFormContainer').hide(); // Yükleme formunu gizleyerek ikinci yüklemeyi engelle
            ...
            success: function (res) {
                ...
                fotoDiv.fadeOut(300, function () { 
                    ...
                    if ($('.imgBox .stn').length === 0) {
                        ...
                        // Dosya seçme formunu dinamik olarak oluştur ve ekle
                        var uploadForm = `
                            <form method="POST" id="stokFotoEkle" enctype="multipart/form-data">
                        ...
                        // Form'u noPhotos div'inin önüne ekle
                        $('#noPhotos').before(uploadForm);
                    }
                });
            },
            error: function (xhr) {
