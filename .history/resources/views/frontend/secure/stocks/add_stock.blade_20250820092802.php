  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-8">
      <div class="input-group">
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#addBrandModal" id="addNewBrandBtn">+</button>
      </div>
    </div>
  </div>
...
$(document).ready(function () {
    ...
    $(document).on('click', '#addNewBrandBtn', function () {
        ...
        var supplierModal = new bootstrap.Modal(document.getElementById('addBrandModal'));
        // Modalı göster
        supplierModal.show();
    });
