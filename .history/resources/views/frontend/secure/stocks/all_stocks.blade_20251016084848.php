    ...
    <div class="container-fluid stock-header-top">
      <div class="row pageDetail">
        ...
        @if(is_null($stockLimit) || $stockLimit == -1 || $stockAll < $stockLimit)
            <!-- me-2 sınıfı mobilde yan yana dururken sağda küçük bir boşluk bırakır -->
        ...
        @else
            <!-- me-2 sınıfı mobilde yan yana dururken sağda küçük bir boşluk bırakır -->
            <a class="btn btn-success btn-sm addStock me-2" disabled style="pointer-events: none; opacity: .4; cursor: default;">
                <i class="fas fa-plus"></i> <span >Stok Kartı Ekle</span>
            </a>
