...
<div class="item">
  <div class="row mb-2">
    <label class="col-sm-5">Raf</label>
    <div class="col-sm-7">
      <select name="raf" id="raf" class="form-select">
...
<div class="item">
  <div class="row mb-2">
    <label class="col-sm-5">Marka</label>
    <div class="col-sm-7">
...
<div class="item">
  <div class="row mb-2">
    <label class="col-sm-5">Cihaz</label>
    <div class="col-sm-7">
...
<div class="item">
  <div class="row mb-2">
    <label class="col-sm-5">Personel</label>
    <div class="col-sm-7">
      <select name="personel" id="personel" class="form-select">
        <option value="">Hepsi</option>
      ...
      <!-- Eğer stok için başka filtreler ekleyeceksen buraya benzer şekilde satır ekleyebilirsin -->
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
    ...
    // Filtre dropdownlarının değişimlerinde tabloyu yenile
  $('#durum, #raf, #marka, #cihaz, #personel').change(function() {
    table.draw();
  });
});
</script>
