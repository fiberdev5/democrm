      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- Yeni pagination ve toplam bilgileri düzeni -->
            <div class="pagination-info-container mt-3">
              <div class="left-section">
                <div class="dataTables_length-wrapper"></div>
              </div>
              
              <div class="right-section">
                <div class="pagination-wrapper">
                  <div class="dataTables_paginate-wrapper"></div>
                </div>
                
                <div class="toplam-bilgiler">
                  <div><strong>Toplam Ürün Sayısı:</strong> <span id="toplamAdet">0</span></div>
                  <div><strong>Depo Toplam Kazanç:</strong> <span id="toplamFiyat">0 ₺</span></div>
                </div>
              </div>
            </div>
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
    ...
    ajax: {
      ...
      order: [[0, 'desc']],
      // YENİ DOM yapılandırması - pagination ve length menüsünü özel konumlara yerleştir
      dom: '<"d-flex justify-content-between align-items-center mb-2"Bf>rt<"clear">',
      buttons: [
        {
          extend: 'print',
      ...
      drawCallback: function(settings) {
        ...
        // YENİ: Pagination ve length menüsünü özel konumlara taşı
        $('.dataTables_length').appendTo('.dataTables_length-wrapper');
        $('.dataTables_paginate').appendTo('.dataTables_paginate-wrapper');
      },
...
.toplam-bilgiler div:last-child {
    margin-bottom: 0;
}

.toplam-bilgiler strong {
    font-weight: 600;
}
