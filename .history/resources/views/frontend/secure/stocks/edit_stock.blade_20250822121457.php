                        ...
                        <div class="row g-1 align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-sm">
                                    ...
                                    <a href="{{ route('stock.barcode.pdf', [$firma->id, $stock->id]) }}" target="_blank" class="btn btn-outline-secondary" type="button" title="Barkod Yazdır">
                                        <i class="bi bi-printer"></i> <!-- Bootstrap Ikonu kullandım, siz FontAwesome da kullanabilirsiniz -->
                                    </a>
                                </div>
                            </div>
                        </div>
