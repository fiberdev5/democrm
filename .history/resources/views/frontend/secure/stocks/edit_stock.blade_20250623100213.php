...
<div class="row mb-2">
  ...
  <div class="col-sm-8">
    <div class="d-flex align-items-center">
      <input type="text" name="urunKodu" class="form-control me-2" value="{{ old('urunKodu', $stock->urunKodu) }}">
...
<div class="row mb-2">
  ...
  <div class="col-sm-8 d-flex gap-3">
    <div class="border rounded p-2 flex-fill text-center bg-light text-nowrap">
