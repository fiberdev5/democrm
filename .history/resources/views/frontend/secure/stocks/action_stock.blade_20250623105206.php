<div class="card" style="margin-bottom: 3px;">
    <div class="card-header ch1" style="padding: 3px 0;">
      <div class="row" style="margin-left: -10px; margin-right: -10px;">
        <div class="col-5">
                <button type="button"
                class="btn btn-success hareket-ekle-btn"
...
<div class="col-7 text-end">
  ...
  <!-- Hareket Ekle Modal -->
<div class="modal fade modal-primary" id="hareketEkleModal" tabindex="-1" aria-labelledby="hareketEkleModalLabel" aria-hidden="true">
...
<script>
  $(document).on('click', '.hareket-ekle-btn', function() {
