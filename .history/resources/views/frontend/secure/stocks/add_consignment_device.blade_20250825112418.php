    ...
    <div class="modal-dialog modal-sm ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- Bu butona btn-close-submodal sınıfı eklendi -->
                <button type="button" class="btn-close btn-close-submodal"></button>
            </div>
            <div class="modal-body">
                <form id="addDeviceTypeForm" action="{{ route('store.device.type.ajax', $tenant_id) }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-end">
                            <!-- 'İptal' butonundan 'data-bs-dismiss' kaldırıldı ve 'btn-close-submodal' sınıfı eklendi -->
                            <button type="button" class="btn btn-secondary btn-sm btn-close-submodal">İptal</button>
