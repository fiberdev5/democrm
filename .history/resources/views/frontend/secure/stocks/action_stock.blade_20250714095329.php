...
var getUrlParameter = function getUrlParameter(sParam) {
    ...
    return false; // Parametre bulunamadığında false döndür
};
...
$(document).ready(function() {
    ...
    // mid parametresi varsa ve geçerli bir değerse modal aç
    if (mid && mid !== 'false' && mid !== '') {
        console.log('Modal açılıyor, servis ID:', mid); // Debug için
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($.trim(data) === "-1") {
                    ...
                    // URL'den did parametresini kaldır
...
// Modal kapandığında URL'den did parametresini kaldır
