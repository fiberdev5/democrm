        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="datatableStock" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  ...
                  <button type="button" class="btn btn-info btn-sm supplierBtn"><i class="fas fa-industry"></i> Tedarikçiler</button>
                  <button type="button" class="btn btn-warning btn-sm stockprintButton"><i class="fas fa-print"></i> Yazdır</button>
              <div class="btn-group">
