...
<td>
  <button type="button"
    class="btn btn-danger btn-sm deleteStockActionBtn"
    data-id="{{ $stokIslem->id }}"
    data-url="{{ route('delete.stock.action', ['tenant_id' => request()->route('tenant_id'), 'id' => $stokIslem->id]) }}">
...
<script>
$(document).on('click', '.deleteStockActionBtn', function () {
