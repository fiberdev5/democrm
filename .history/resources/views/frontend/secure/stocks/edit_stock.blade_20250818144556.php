...
<!-- Hareket Ekle Modal -->
<div class="modal fade " id="hareketEkleModal" tabindex="-1"  data-bs-backdrop="static" aria-labelledby="hareketEkleModalLabel" aria-hidden="true">
...
<style>
.modal-backdrop {
    background-color: rgba(0,0,0,0.3) !important; /* Daha açık transparan */
}
.modal-blur {
    filter: blur(2px);
}

/* Eğer ikinci modal açıkken arkadaki modal da görünür olsun */
.modal-backdrop.show {
    opacity: 0.5; /* sadece hafif karartma */
}
...
$(document).ready(function() {
    ...
    $('#editStockModal .modal-content').addClass('modal-blur');
});
$('#hareketEkleModal').on('hidden.bs.modal', function () {
    $('#editStockModal .modal-content').removeClass('modal-blur');
});
