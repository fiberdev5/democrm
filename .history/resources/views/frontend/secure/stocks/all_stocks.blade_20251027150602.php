...
@if(!is_null($stockLimit) && $stockLimit != -1 && $stockAll >= $stockLimit)
  <div class="alert alert-warning alert-dismissible fade show mt-3 mb-0 border-0 shadow-sm" role="alert">
    <div class="d-flex align-items-center">
      <div class="flex-shrink-0">
        <div class="bg-warning bg-opacity-25 rounded-circle p-2 d-flex align-items-center justify-content-center" 
             style="width: 40px; height: 40px;">
          <i class="fas fa-chart-line text-warning"></i>
        </div>
      </div>
      <div class="flex-grow-1 ms-3">
        <h6 class="mb-1 fw-bold">Stok Limitine Ulaştınız</h6>
        <p class="mb-0 small">
          {{ $stockAll }}/{{ $stockLimit }} stok kartı kullanılıyor. 
          Daha fazla stok eklemek için planınızı yükseltin.
        </p>
      </div>
      <div class="flex-shrink-0 ms-3">
        <a href="{{ route('abonelikler', ['tenant_id' => $firma->id]) }}" 
           class="btn btn-warning btn-sm fw-bold">
          <i class="fas fa-rocket me-1"></i>Yükselt
        </a>
      </div>
    </div>
