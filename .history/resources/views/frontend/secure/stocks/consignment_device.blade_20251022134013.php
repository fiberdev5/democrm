...
.btn-secondary {
    ...
    /*****************************Konsinye yazdırma ve ekleme butonu*******************************/
    @media (max-width: 767px) {
      .pageDetail .consignment-buttons-container {
        display: flex;
        gap: 5px;
        width: 100%;
        margin-bottom: 10px;
      ...
      .pageDetail .consignment-buttons-container .btn {
        flex: 1;
      ...
      .pageDetail .consignment-buttons-container .btn i {
        display: none !important;
      }
      
      /* Limit uyarısı mobilde */
      .consignment-limit-warning {
        display: block;
        width: 100%;
        margin-top: 5px;
        margin-left: 0 !important;
            ...
            <div class="tableToplamaAlani">
              <div class="row r1" style="display: flex; align-items: center; justify-content: center;">
                ...
                <div class="sag">
                  ...
                  <div class="tur t4"><span>Konsinye Kazanç: </span><span id="toplamFiyat">0 ₺</span></div>
                </div>
              </div>
            </div>
...
$(document).ready(function() {
  ...
  // Konsinye cihaz ekleme modalı
  $(".addConsignment").click(function() {
    $.ajax({
      url: "/" + firma_id + "/konsinye-ekle/"
    }).done(function(data) {
      if ($.trim(data) === "-1") {
  ...
  $('#datatableConsignment').on('click', '.editConsignment', function() {
    ...
    $.ajax({
      url: "/" + firma_id + "/konsinye/duzenle/" + id,
      dataType: 'json',
