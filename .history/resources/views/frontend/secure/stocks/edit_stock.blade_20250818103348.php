...
<body>
                    ...
                    <div class="section-body">
                        <div class="action-buttons mb-3">
                            ...
                            <select class="form-select form-select-sm" style="width: auto;">
                                <option value="0">Tüm İşlemler</option>
                        ...
                        <div class="table-container">
                            <table class="table table-bordered compact-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>13/08/25</td>
                                        <td>Serviste Kullanım</td>
                                        <td>Servis: 12345 (Mehmet K.)</td>
                                        <td>2</td>
                                        <td>-</td>
                                        <td>
                                            <button class="btn btn-danger btn-sm">
                    ...
                    <div class="section-body">
                        <form class="compact-form">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" value="iPhone 15 Pro Max">
                            </div>

                            <div class="row g-2 mb-2">
                                <div class="col-8">
                                    <label class="form-label">Ürün Kodu</label>
                                    <input type="text" class="form-control" value="1234567890123">
                                </div>
                                <div class="col-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Stok hareketi filtreleme
            $('.form-select').on('change', function() {
                if ($(this).closest('.action-buttons').length > 0) {
                    const filterValue = $(this).val();
                    console.log('Filtre seçildi:', filterValue);
