          ...
          <!-- 1. KART: ÜRÜN BİLGİLERİ -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="photoLimitWarning" class="alert alert-warning  text-center" role="alert" style="display: {{ !$photos->isEmpty() ? 'block' : 'none' }};">
                        <small>
                            <i class="fas fa-exclamation-triangle" style="font-size: 2em;"></i> Yalnızca 1 fotoğraf ekleyebilirsiniz. <br>
