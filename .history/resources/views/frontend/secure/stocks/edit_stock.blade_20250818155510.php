...
.modal-backdrop:nth-of-type(2) {
    z-index: 1055; /* İkinci modal'ın arka planını birinci modal'ın üzerine çıkarır */
}
...
$(document).ready(function() {
    $('#hareketEkleModal').on('show.bs.modal', function () {
        // Arkadaki "Stok Detayları" modalına karartma efektini uygula
        $('#editStockModal').addClass('modal-stack');
    });

    // "Hareket Ekle" modalı tamamen kapandığında...
    $('#hareketEkleModal').on('hidden.bs.modal', function () {
        // Arkadaki "Stok Detayları" modalından karartma efektini kaldır
        $('#editStockModal').removeClass('modal-stack');
        
        // Önemli Not: İkinci modal kapandığında Bootstrap bazen body'den 'modal-open'
        // sınıfını kaldırır ve sayfa kaydırılabilir hale gelir. Bu durumu engellemek için,
        // eğer ilk modal hala açıksa, bu sınıfı body'ye tekrar ekliyoruz.
        // Sizin kodunuzda bu zaten vardı, burada bir kez daha teyit ediyoruz.
