...
<a id="printButton" href="javascript:void(0);" class="btn btn-warning btn-sm stockprintButton">
...
$(document).ready(function () {
  var table = $('#datatableStock').DataTable({
      ...
      // DOM’dan “B” yi kaldırdık, böylece DataTables kendi butonunu basmaz
      dom: '<"d-flex justify-content-between align-items-center mb-2">f>rt<"d-flex justify-content-between align-items-center mt-2"ilp>',
  ...
  // Senin butonuna tıklayınca DataTables yazdırma butonunun işlevini tetikleme
