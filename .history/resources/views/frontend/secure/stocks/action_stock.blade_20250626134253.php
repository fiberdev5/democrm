  ...
  <div class="mt-2 toplam-bilgi" style="display: none;">
    ...
    <div class="card-body" style="padding: 0;">
      ...
      <tr class="toplam-header-row" style="background-color: #f8f9fa; border-bottom: 2px solid #dee2e6;">
        ...
        <td colspan="3"></td>
        <td class="toplam-adet-header" style="font-weight: bold; text-align: center; color: #050505;">
          0 Adet
        </td>
        <td class="toplam-fiyat-header" style="font-weight: bold; text-align: center; color: #050505;">
          0 TL
        </td>
        <td></td>
      </tr>
