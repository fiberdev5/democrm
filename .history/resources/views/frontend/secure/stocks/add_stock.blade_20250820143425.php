<form method="post" id="addStock" action="{{ route('store.stock', $firma->id) }}" enctype="multipart/form-data">
  ...
  <div class="row mb-1 align-items-center">
    <label class="col-sm-2">Markalar</label>
    <div class="col-sm-10">
  ...
  <div class="row mb-1">
    <label class="col-sm-2">Cihaz Türleri</label>
    <div class="col-sm-10">
      <div class="input-group">
  ...
  <div class="row mb-1">
    <label class="col-sm-2">Kategori<span style="color:red;">*</span></label>
    <div class="col-sm-10">
      <div class="input-group">
...
<div class="row mb-1">
    <label class="col-sm-2">Raf Seç</label>
    <div class="col-sm-10">
      <div class="input-group">
...
<div class="row mb-0">
    <label class="col-sm-2">Ürün Kodu <span class="text-danger">*</span></label>
    <div class="col-sm-10">
  ...
  <div class="row mb-0">
    <label class="col-sm-2">Ürün Adı <span class="text-danger">*</span></label>
    <div class="col-sm-10">
...
<div class="row mb-0">
    <label class="col-sm-2">Satış Fiyatı</label>
    <div class="col-sm-10">
      <div class="row g-2">
        <div class="col-8">
