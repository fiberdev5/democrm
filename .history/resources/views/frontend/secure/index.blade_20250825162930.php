...
/* Kırmızı: Yumuşak bir mercan (coral) rengi, uyarıcı ama sakin. */
.status-high { background-color: #ff8a80; } 

/* Sarı: Açık ve yumuşak bir "tereyağı" sarısı. */
.status-medium { background-color: #ffc966; }

/* Yeşil: Sakinleştirici bir nane yeşili. */
.status-completed { background-color: #69d0a3; }

/* Mavi-Gri: Bekleme durumları için şık ve modern bir mavi-gri tonu. */
.status-pending { background-color: #90a4ae; }

/* Açık Gri: İptal durumları için pastel temaya uygun, açık bir gri. */
.status-cancelled { background-color: #b0bec5; }
