...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.9.1/chart.min.js"></script>
 ...
 <style>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                     <a href="#" onclick="window.location.href = buildCashUrl('total')" 
                       class="stat-card teal" id="totalCashCard">
                        ...
                        <div class="stat-value" id="daily_cash">0,00 TL</div>
    ...
    // Günlük grafik - MAVİ ÇİZGİ GRAFİK
    dailyChart = new Chart(dailyCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Günlük Servis',
                data: dailyData?.data || [],
                borderColor: '#4facfe', // Mavi renk
                backgroundColor: 'rgba(79, 172, 254, 0.2)', // Mavi arkaplan
                borderWidth: 3,
                fill: true,
                tension: 0.4,
    ...
    hourlyChart = new Chart(hourlyCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: 'rgba(255,193,7,1)', // Sarı çizgi
                backgroundColor: 'rgba(255,193,7,0.1)', // Hafif sarı arkaplan
                borderWidth: 3,
                fill: false, // Sadece çizgi ve nokta
                tension: 0.1,
                pointBackgroundColor: 'rgba(255,193,7,1)', // Sarı noktalar
                pointBorderColor: 'rgba(255,193,7,1)',
                pointBorderWidth: 2,
                pointRadius: 8, // Daha büyük noktalar
                pointHoverRadius: 12
            }]
        },
        options: {
