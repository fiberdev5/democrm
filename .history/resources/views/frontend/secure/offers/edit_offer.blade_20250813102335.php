        ...
        <div class="card-body">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-9 rw2">
              <input name="kayitTarihi" class=" datepicker"  type="date" value="{{$sontarih}}" style="width: 110px!important;display: inline-block!important;background:#fff;text-align:center" required>
