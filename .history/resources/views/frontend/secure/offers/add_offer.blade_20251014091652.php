      ...
      e.stopPropagation();
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            // ✅ Reload tamamlandıktan SONRA modal'ı kapat
            $('#datatableOffer').DataTable().ajax.reload(function() {
                $('#addOfferModal').modal('hide');
                $('#addOffer')[0].reset(); // Formu temizle
            }, false); // false = sayfa ilk sayfaya dönmesin
          },
          error: function(xhr, status, error) {
