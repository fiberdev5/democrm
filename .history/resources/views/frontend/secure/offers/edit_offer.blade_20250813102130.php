        ...
        <div class="card-body">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-9 rw2">
              <input name="kayitTarihi" class="form-control datepicker"  type="date" value="{{$sontarih}}" style="width: 110px;display: inline-block;background:#fff;text-align:center" required>
