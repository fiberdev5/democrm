...
{{$musteri->adres}} - {{$musteri->state->ilceName}}/{{$musteri->country->name}}</textarea>
        ...
        <div class="card-body">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-9 rw2">
              <input name="kayitTarihi" class="form-control datepicker kayitTarihi"  type="date" value="{{$sontarih}}" style="width: 110px;display: inline-block;background:#fff;text-align:center" required>
    ...
    <div class="card card3">
      <div class="card-body">
        ...
        <div class="row form-group">
          <button type="button" class="col-xs-12 form-control btn btn-primary satirEkle" data-id="{{$i+1}}" style="color: #fff;display: inline-block;margin: 5px">Satır Ekle</button>
        </div>
