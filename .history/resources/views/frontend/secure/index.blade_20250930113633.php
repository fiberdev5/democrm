...
@media (max-width: 768px) {
    .dashboard-container { 
        margin: 8px;      /* 10px yerine 8px */
        padding: 12px;    /* 15px yerine 12px */
    }
    
    .stat-card { 
        margin-bottom: 8px;   /* 12px yerine 8px */
        padding: 14px 18px;   /* 16px 20px yerine */
    }
    
    .stat-value { font-size: 1.8rem; }  /* 2rem yerine biraz küçült */
    .stat-icon { font-size: 1.5rem; }   /* 1.6rem yerine */
    
    /* Row için özel ayar */
    .row { 
        margin-left: -6px;  /* -8px yerine */
        margin-right: -6px; 
    }
    
    .row > [class*="col-"] { 
        padding-left: 6px;  /* 8px yerine */
        padding-right: 6px; 
    }
...
@media (min-width: 576px) {
    .stat-card { 
        margin-bottom: -9px;   /* Daha da kompakt */
        padding: 6px 13px;
    }
