...
@if(App\Services\InvoiceIntegrationFactory::hasIntegration($firma->id) && $invoice_id->integration_invoice_id)
<div class="row form-group" style="border:0">
    <div class="col-md-4 rw1"><label>Tahsilat İşlemleri</label></div>
    <div class="col-md-8 rw2">
        <button type="button" class="btn btn-success btn-sm tahsilatEkleBtn" data-invoice-id="{{$invoice_id->id}}" data-parasut-id="{{$invoice_id->integration_invoice_id}}">
