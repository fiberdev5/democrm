<form method="post" id="addInvo" action="{{ route('store.invoices', $firma->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
  ...
  <div class="row form-group">
    <div class="col-sm-4"><label for="country">İl</label></div>
    <div class="col-sm-8">
      <select name="il" id="country" class="form-control form-select">
  ...
  <div class="row form-group">
    <div class="col-sm-4"><label for="city">İlçe</label></div>
    <div class="col-sm-8">
      <select name="ilce" id="city" class="form-control form-select">
        <option value="" selected disabled>-Seçiniz-</option>
      </select>
    </div>
  </div>
  ...
  <div class="row form-group">
    <div class="col-sm-4"><label>Adres <span style="color:red">*</span></label></div>
    <div class="col-sm-8">
      <textarea name="adres" class="form-control" rows="3" style="resize: none;"></textarea>
    </div>
  </div>
</div>
