...
$(document).ready(function() {
    ...
    // Tahsilat Ekle Butonu
     $('.tahsilatEkleBtn').on('click', function() {
        ...
        // ⭐ Ana modalı gizle, tahsilat modalını aç
    ...
    $('.tahsilatlariGorBtn').on('click', function() {
        ...
        // ⭐ Ana modalı gizle, tahsilatları gör modalını aç
        $('#editInvoiceModal').modal('hide');
        
        setTimeout(() => {
            $('#tahsilatlariGorModal').modal('show');
            loadPayments(invoiceId, firmaId);
        }, 300);
    });

    // Tahsilat modalı kapandığında edit modalı geri aç
