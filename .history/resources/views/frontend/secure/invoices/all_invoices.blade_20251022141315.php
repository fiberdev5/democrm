...
<script>
  ...
  customize: function (win) {
    ...
    $(win.document.head).append(
      ...
      'table tbody td * { color: #000 !important; font-weight: normal !important; }' + // <- BURAYA font-weight: normal EKLENDİ
      'table tbody td span { color: #000 !important; background-color: transparent !important; font-weight: normal !important; }' + // <- BURAYA DA
      'table tbody td { font-weight: normal !important; }' + // <- YENİ SATIR: Tüm hücreler normal
