      ...
      <div class="card card-invoices f3 h-100"> 
        <div class="card-body card-invoices-body">
          ...
          <div class="row form-group" style="border:0">
            ...
            <div class="col-md-8 rw2">
              <input type="text" name="faturaNumarasi" class="form-control buyukYaz faturaNumarasi" value="" disabled>
            </div>
          </div>
...
<script>
 $(document).ready(function (e) {
    ...
    function kdvHesapla(toplam){
      ...
      console.log('=== KDV HESAPLA DEBUG ===');
    console.log('Tevkifat Oranı RAW:', $(".tevkifatOrani").val());
    console.log('Tevkifat Oranı NUMBER:', tevkifatOrani);
    console.log('Toplam elementi sayısı:', $(".tevkifatOrani").length);
      
      // Tevkifat hesaplama - SADECE tevkifat oranı 0'dan büyükse
      ...
      $(".kdv").val(kdv);
      $(".tevkifatTutari").val(tevkifatHesapla); // Her zaman güncellenecek (0 veya hesaplanan değer)
