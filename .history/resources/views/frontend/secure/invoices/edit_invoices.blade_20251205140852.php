            ...
            <div class="row form-group" style="border:0">
                ...
                <div class="col-md-8 rw2">
                    <div class="btnWrap">
                        ...
                        <span class="badge bg-{{ $color }} me-2" style="align-items: baseline;">{{ $text }}</span>
        ...
        <div class="card-body card-invoices-body" style="padding:17px 5px">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4 custom-rw2 col-6 rw2">
              <input type="text" class="form-control tevkifatTutari" readonly  value="{{number_format($invoice_id->tevkifatTutari ?? 0, 2, '.', '')}}" disabled>
