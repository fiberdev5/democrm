           ...
           <div class="col-sm-6 s1">
              <div class="row form-group">
                ...
                <div class="col-md-8 rw2 d-flex flex-wrap align-items-center gap-2">
                    ...
                    <a href="{{ route('all.services', [$firma->id, 'did' => $invoice_id->servisid]) }}" target="_blank" class="servisiAc btn btn-outline-danger px-2 py-1"style="font-size: 13px; line-height: 1.3;">Servisi Aç</a>
                </div>
              </div>
              <div class="row form-group">
