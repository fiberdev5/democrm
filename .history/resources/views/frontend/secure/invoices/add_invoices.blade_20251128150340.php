           ...
           <div class="col-sm-6 s1">
              <div class="row form-group ">
                ...
                <div class="col-md-8 rw2 d-flex flex-wrap align-items-center gap-3">
                    <input id="search" type="text" name="servisid" class="form-control servisid" data-bs-id="" autocomplete="off" placeholder="Servis id ve Müşteri Ara" style="flex: 1 1 auto; max-width: 160px;">
