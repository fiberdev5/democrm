<form method="post" id="addInvo" action="{{ route('store.invoices', $firma->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="row">
           <div class="col-sm-6 s1">
              <div class="row form-group">
                ...
                <div class="col-md-8 rw2 d-flex align-items-center justify-content-between gap-2" style="max-width: 100%;">
  <input 
    id="search" 
    type="text" 
    name="servisid" 
    class="form-control servisid" 
    data-bs-id="" 
    autocomplete="off" 
  ...
  <a 
    href="#" 
    target="_blank" 
    class="servisiAc btn btn-outline-danger btn-sm"
  >
    Servisi Aç
  </a>
</div>
  ...
  <div class="card f2">
    <div class="card-body">
      ...
      <div class="satirBody">
        <div class="row form-group">
          <div class="col-5 rw1 col-form-label"><input type="text" name="aciklama[]" class="form-control aciklama aciklama0" placeholder="Ürün" autocomplete="off"></div>
