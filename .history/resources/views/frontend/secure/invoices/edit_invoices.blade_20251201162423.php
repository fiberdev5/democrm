...
<script>
$(document).ready(function() {
    // ⭐ TAHSİLAT BUTON EVENT'LERİ
    // Tahsilat Ekle Butonu
    $(document).on('click', '.tahsilatEkleBtn', function() {
    ...
    $(document).on('click', '.tahsilatlariGorBtn', function() {
        const invoiceId = $(this).data('invoice-id');
    ...
    // Tahsilat Kaydet
    $(document).on('click', '#tahsilatKaydetBtn', function() {
