        ...
        <div class="row" style="border:0">
          ...
          <div class="row form-group" style="border:0">
            ...
            <div class="col-md-8 rw2">
                ...
                <a href="{{$invoice_id->faturaPdf}}" target="_blank" class="btn btn-warning btn-sm btn-block d-none">Görüntüle</a>
                @else
                <a href="{{$invoice_id->faturaPdf}}" target="_blank" class="btn btn-warning btn-sm btn-block">Görüntüle</a>
                @endif
