...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    // ⭐ DataTable'ı yenile ve edit modalını yeniden yükle
                    ...
                    setTimeout(() => {
                        // Faturayı yeniden yükle veya sayfayı yenile
    ...
    function loadPayments(invoiceId, firmaId) {
        $.ajax({
            url: `/${firmaId}/fatura/${invoiceId}/odemeler`,
            type: 'GET',
            success: function(response) {
