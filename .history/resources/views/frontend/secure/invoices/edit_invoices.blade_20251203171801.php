...
@if($hasParasutIntegration && $invoice_id->formalized && $invoice_id->formalization_status === 'sent')
<div class="row form-group" style="border:0">
    ...
    <div class="col-md-8 rw2">
        <div class="btnWrap">
            ...
            @if(!empty($invoice_id->formalization_pdf_url))
                <a href="{{ $invoice_id->formalization_pdf_url }}" target="_blank" class="btn btn-success btn-sm btn-block">
...
@endif
    ...
    <div class="col-md-4 col-sm-6 text-end">
        ...
        @if(!$invoice_id->formalized)
            <input type="submit" class="btn btn-info btn-sm waves-effect waves-light" value="Kaydet" style="min-width: 120px;">
        @endif
    </div>
</div>
  </div>
