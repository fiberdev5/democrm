      ...
      <div class="card col-lg-6 f4">
        ...
        <div class="row form-group">
          ...
          <div class="row form-group" style="padding-bottom: 0">  
            ...
            <div class="col-md-4 rw2"><input type="text" onkeyup="sayiKontrol(this)" name="genelToplam" value="{{$invoice_id}}" autocomplete="off" class="form-control genelToplam" required></div>
          </div>
