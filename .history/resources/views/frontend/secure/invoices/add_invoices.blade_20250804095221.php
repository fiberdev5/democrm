     ...
     <div class="card-body">
        <div class="row">
           ...
           <div class="col-sm-6 s2">
              ...
              <div class="row form-group">
                 <div class="col-md-3 rw1"><label>Adres <span style="font-weight: bold; color: red;">*</span></label></div>
                 <div class="col-md-9 rw2"><textarea name="adres" class="form-control buyukYaz adres" placeholder="Adres" rows="3" style="resize: none !important"></textarea></div>
              </div>
           </div>
        </div>
     </div>
