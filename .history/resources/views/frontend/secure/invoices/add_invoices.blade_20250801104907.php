        ...
        <div class="row">
           ...
           <div class="col-sm-6 s2">
              <div class="row form-group">
                 ...
                 <div class="col-md-4 col-6 rw2">
                   <select  class="form-control il" name="il" id="il" required>
                      <option value="">-İL SEÇİNİZ-</option>
                      <?php 
                         $iller = $yonetim->getIller();
                         foreach ($iller as $il) {
                            echo '<option value="'.$il.'">'.$il.'</option>';
                         }   
                       ?>
                   </select>
                   <input type="hidden" id="eskiİl" name="eskiİl" value="<?php echo $kullanici["il"]; ?>" />
                 </div>
                 <div class="col-md-4 col-6 rw3"  style="padding-right: 0">
                   <select  class="form-control ilce" name="ilce" id="ilce" disabled="disabled" >
                     <option value="">-İLÇE SEÇİNİZ-</option>
                   </select>
                   <input type="hidden" id="eskiİlce" name="eskiİlce" />
                 </div>
              </div>
