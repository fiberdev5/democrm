...
$(document).ready(function() {
  $('#tahsilatModal').on('hidden.bs.modal', function () {
    // Edit modal hala açıksa, body'ye modal-open class'ını geri ekle
    if ($('#editInvoiceModal').hasClass('show')) {
        $('body').addClass('modal-open');
        $('body').css('padding-right', ''); // Scroll bar padding'i düzelt
    }
});

$('#tahsilatlariGorModal').on('hidden.bs.modal', function () {
    // Edit modal hala açıksa, body'ye modal-open class'ını geri ekle
    if ($('#editInvoiceModal').hasClass('show')) {
        $('body').addClass('modal-open');
