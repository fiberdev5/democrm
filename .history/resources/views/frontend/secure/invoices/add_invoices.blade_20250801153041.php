    ...
    <div class="card col-lg-6 f3">
      ...
      <div class="card col-lg-6 f4">
        <div class="card-body" style="padding:17px 5px">
          ...
          <div class="row form-group">
          <div class="col-md-8 rw1 col-form-label"><label>İndirim</label></div>
          <div class="col-md-4 rw2 col-form-label"><input type="text" onkeyup="sayiKontrol(this)" name="indirim" autocomplete="off" class="form-control indirim"></div>
        </div>
        <div class="row form-group">
          <div class="col-md-8 rw1 col-form-label"><label>Ara Toplam</label></div>
          <div class="col-md-4 rw2 col-form-label"><input type="text" onkeyup="sayiKontrol(this)" name="araToplam" autocomplete="off" class="form-control araToplam"></div>
        </div>
