    ...
    <div class="col-lg-6 mb-3 mb-lg-0 custom-p-m">
      <div class="card card-invoices f3 h-100"> <!-- h-100 ile kart yüksekliğini eşitleyebilirsiniz -->
        <div class="card-body card-invoices-body">
          ...
          {{-- YENİ EKLENEN: KDV'li/KDV'siz Fiyat Hesaplama --}}
                                ...
                                var listItem = `
                                    <li class="list-group-item servis-list-item" style="cursor: pointer; border-left: 3px solid #007bff;"
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <strong style="color: #007bff;">Servis #${servis.servis_id}</strong> - 
                                                ...
                                                <br>
                                                <small class="text-muted">
                                                    <i class="fas fa-tools"></i> Arıza: ${servis.cihazAriza ? (servis.ariza.length > 50 ? servis.ariza.substring(0, 50) + '...' : servis.ariza) : 'Belirtilmemiş'}
                                                </small>
                                            </div>
