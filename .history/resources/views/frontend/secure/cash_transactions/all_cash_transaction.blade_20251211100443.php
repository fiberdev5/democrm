...
<script>
$(document).ready(function() {
  // Mobilde dropdown açıldığında pozisyonu düzelt
  if (window.innerWidth < 768) {
    $('#kasaFilterDropdownContainer').on('shown.bs.dropdown', function () {
      var dropdown = $(this).find('.dropdown-menu');
      var windowWidth = $(window).width();
      
      // Dropdown'ı merkeze hizala
      dropdown.css({
        'position': 'fixed',
        'left': '50%',
        'right': 'auto',
        'transform': 'translateX(-50%)',
        'top': '60px', // Üstten mesafe
    ...
    // Dropdown kapandığında stil temizle
    $('#kasaFilterDropdownContainer').on('hidden.bs.dropdown', function () {
