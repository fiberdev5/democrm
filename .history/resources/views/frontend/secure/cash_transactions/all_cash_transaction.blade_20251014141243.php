...
<div class="d-lg-none">
    <div class="d-flex gap-1 justify-content-between align-items-center">
        ...
        <button type="submit" id="kasaArama" class="btn btn-sm btn-dark searchBtn kasaArama"><i class="fas fa-search"></i></button>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#datatableKasa tbody').on('click', 'tr', function(e) {
      ...
      // Sadece butonlara tıklanmışsa engelle (Düzenle kolonu - 9. kolon, index 9)
      if ($target.closest('.btn').length > 0 || $target.closest('td').index() === 9) {
        return;
      }
