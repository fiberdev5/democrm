<form method="post" id="editDom" action="{{ route('update.cash.transaction', $firma->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <select name="odeme_turu" class="form-select odemeTuru"  readonly>
  ...
  @if (strpos($cash_payment_id["cevaplar"], '6') !== false)
    <div class="row form-group">
      ...
      <div class="col-md-8">
        <select class="form-select cihazlar" name="cihazlar" style="font-weight: 500" readonly>
  ...
  @if (strpos($cash_payment_id["cevaplar"], '5') !== false)
    <div class="row form-group">
      ...
      <div class="col-md-8">
        <select class="form-select markalar" name="markalar" style="font-weight: 500" readonly>
          <option value="">-Seçiniz-</option>
