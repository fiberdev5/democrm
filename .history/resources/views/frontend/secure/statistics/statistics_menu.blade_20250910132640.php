<!-- HTML KODU (Değişiklik yok, bu haliyle mükemmel) -->
...
<!-- CSS KODU (Scroll Olmayan Responsive Yapı) -->
<style>
    /* Menü Konteyneri: Otomatik olarak alt satıra geçen grid yapısı */
    .statistics-menu {
        display: grid;
        /* Bu satır, ekrana sığabildiği kadar kartı yan yana dizer.
           Her kart en az 160px genişliğinde olur ve kalan boşlukları doldurur. */
