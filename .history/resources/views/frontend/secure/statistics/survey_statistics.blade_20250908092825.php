...
$(document).ready(function () {
    ...
    // Filtre değişiklikleri - dropdown'u kapat
    ...
    // Kapatma butonları için event handler
    $('.dropdown-close-btn').click(function() {
        closeDropdown($(this).closest('.dropdown'));
    });

    // Dropdown event'lerini kontrol et
    $('.dropdown-menu').on('click', function(e) {
        // Sadece daterangepicker için event'i durdur
        if ($(e.target).hasClass('tarih-araligi') || 
            $(e.target).closest('.daterangepicker').length > 0) {
            e.stopPropagation();
        }
    });

    // ESC tuşu ile dropdown'u kapatma
