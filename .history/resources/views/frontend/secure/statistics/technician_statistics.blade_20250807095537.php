    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header sayfaBaslik d-flex justify-content-between align-items-center">
                ...
                <!-- Filtre Dropdown -->
                <div class="dropdown_teknisyen">
                    <button class="btn btn-primary btn-sm dropdown_teknisyen-toggle" type="button" id="filtreDropdown" data-bs-toggle="dropdown_teknisyen" aria-expanded="false">
                        FİLTRELE
                    </button>
                    <div class="dropdown_teknisyen-menu p-3 dropdown_teknisyen-menu-end" style="min-width: 300px;">
                        <form id="filtreForm">
                            <div class="row mb-3">
