...
$(document).ready(function () {
   ...
   var table = $('#datatableOperatorStats').DataTable({
    ...
    drawCallback: function() {
        ...
        // Mobil görünümde başlıkları değiştir
        if ($(window).width() <= 767) {
            $('#datatableOperatorStats thead th').eq(0).html('Operatör');
            $('#datatableOperatorStats thead th').eq(1).html('Toplam');
            $('#datatableOperatorStats thead th').eq(2).html('');
        }
    },
