...
$(document).ready(function () {
    ...
    function updateRange(start, end) {
        ...
        // Aktif olan filtre menüsünü bul ve kapat
        var activeDropdownToggle = document.querySelector('.servis-istatistik .dropdown-toggle.show');
        if (activeDropdownToggle) {
            var dropdownInstance = bootstrap.Dropdown.getInstance(activeDropdownToggle);
            if (dropdownInstance) {
