            ...
            <div class="card shadow-sm mb-4 istatistik-card">
                <div class="card-header sayfaBaslik d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-filter me-1"></i>Filtrele <i class="mdi mdi-chevron-down"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end p-3" style="width: 300px;"> {{-- dropdown-menu-end ile sağa hizalandı, p-3 ile içerik boşluğu eklendi --}}
                        <form id="istatistikAra" action="{{ route('statistics', $tenant_id) }}" method="get">
                            <div class="mb-3">
                                <label class="form-label mb-1">Personel</label>
                                <select name="personeller" class="form-select form-select-sm"> {{-- form-select-sm ile boyut küçültüldü --}}
                            ...
                            <div class="mb-3">
                                <label class="form-label mb-1">Servis Kaynağı</label>
                                <select name="servisKaynak" class="form-select form-select-sm">
                            ...
                            <div class="d-flex flex-wrap justify-content-between mb-3">
                                <button type="button" class="btn btn-outline-primary btn-sm quick-date mb-1" data-days="1">Bugün</button>
                                <button type="button" class="btn btn-outline-primary btn-sm quick-date mb-1" data-days="7">Son 7 Gün</button>
                                <button type="button" class="btn btn-outline-primary btn-sm quick-date mb-1" data-days="30">Son 30 Gün</button>
                                <button type="button" class="btn btn-outline-primary btn-sm quick-date mb-1" data-days="365">Son 1 Yıl</button>
                            </div>

                            <div class="text-end">
                                <button type="submit" name="servisSayListele" class="btn btn-primary btn-sm">
