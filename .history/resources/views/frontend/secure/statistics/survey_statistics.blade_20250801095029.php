                    ...
                    <div class="card-header">
                        ...
                        <div class="searchWrap float-end">
                            <div class="btn-group mb-2">
                                <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="filterToggleResults">
                                    Filtrele <i class="mdi mdi-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu p-3" style="min-width: 200px;" id="filterDropdownResults">
                                    <div class="item">
                                        <div class="row mb-3">
            ...
            <div class="col-12">
                <div class="table-modern">
                    <div class="card-header">
                        ...
                        <div class="searchWrap float-end">
                            <div class="btn-group mb-2">
                                <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="filterTogglePersonnel">
                                    Filtrele <i class="mdi mdi-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu p-3" style="min-width: 200px;" id="filterDropdownPersonnel">
                                    <div class="item">
                                        <div class="row mb-3">
                                            <label class="col-sm-4">Cihaz Türü:</label>
                                            <div class="col-sm-8">
                            ...
                            <table id="datatableSurveyStats" class="table table-hover mb-0">
                                <thead class="title">
                                    <tr>
                                        ...
                                        <th style="width: 170px"><i class="fas fa-check-circle me-2"></i>Tamamlanan Servisler</th>
                                        <th style="width: 170px"><i class="fas fa-poll me-2"></i>Yapılan Anket</th>
                                        <th style="width: 100px">Anket Oranı</th>
...
$(document).ready(function () {
    ...
    // Dropdown menü tıklama olaylarını yönet
    ...
    // Filter toggle butonları için event handler
    $('#filterToggleResults').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        $('#filterDropdownResults').toggleClass('show');
        $('#filterDropdownPersonnel').removeClass('show');
    });

    $('#filterTogglePersonnel').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        $('#filterDropdownPersonnel').toggleClass('show');
        $('#filterDropdownResults').removeClass('show');
    });

    // Dropdown içerisindeki tıklamaları durdur
    ...
    function updatePersonnelTable(personnelStats) {
        ...
        if (statsArray.length === 0) {
            tableBody.append('<tr><td colspan="5" class="text-center">Gösterilecek veri bulunamadı.</td></tr>');
            return;
        }
        ...
        statsArray.forEach(function(personnel) {
            ...
            // Detay URL'sini oluştur - anket yapılan servisler için
            ...
            let row = `<tr>
                ...
                <td class="text-center">
                    <span class="badge bg-info">${personnel.tamamlanan_servis_sayisi}</span>
                </td>
                <td class="text-center">
                    <span class="badge bg-success">${personnel.anket_yapilan_servis_sayisi}</span>
                </td>
                <td class="text-center">
                    <span class="badge bg-primary">${personnel.anket_orani}%</span>
                </td>
                <td class="text-center">
                    <a href="${detailUrl}" target="_blank" class="btn btn-action btn-sm">
                        <i class="fas fa-eye me-1"></i>Anketli Servisleri Gör
                    </a>
                </td>
            </tr>`;
...
/* Tablo stilleri */
.servis-istatistik .table-hover tbody tr:hover {
...
.servis-istatistik .dropdown-menu.show {
    display: block;
}

.servis-istatistik .dropdown-menu .item {
    padding: 10px;
}

/* Tarih aralığı butonları */
.servis-istatistik .tarihAraligi .btn {
    border-radius: 20px;
...
.servis-istatistik .tarihAraligi .btn:hover {
