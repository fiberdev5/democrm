                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-select form-select-sm" id="ilSelect">
                                                    ...
                                                    @foreach($iller as $il)
                                                        <option value="{{ $il->name }}">{{ $il->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
        ...
        columns: [
                    ...
                    return `
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">${row.il}</small>
                            </div>
                        </div>`;
                }
            },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    var url = "{{ url($tenant_id . '/servisler') }}" + "?ilceArama=" + encodeURIComponent(ilceParam) + "&tarih1=" + from_date + "&tarih2=" + to_date;
