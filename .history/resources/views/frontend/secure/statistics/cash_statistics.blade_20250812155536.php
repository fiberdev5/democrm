...
<div class="page-content servis-istatistik">
    <div class="container-fluid">
        ...
        <div class="card kasaSonuclari" style="margin-bottom: 5px;">
            ...
            <div class="card-body">
                {{-- Bu satır, içindeki sütunların yüksekliklerini eşitlemek için d-flex kullanır --}}
                                ...
                                <ul class="h-100 d-flex flex-column justify-content-between">    
                                    @foreach($odemeTuruAll as $key => $value )
                                        @php 
                                            ...
                                            $renkler = [
                                            '#E91E63', '#FF5722', '#FF9800', '#FFC107', '#8BC34A', '#4CAF50', '#00BCD4',
                                            '#009688', '#2196F3', '#3F51B5', '#673AB7', '#9C27B0', '#F44336'
                                        ];
...
<style>
/* Yeni stiller bu alana eklendi */
.kasaSonuclari .card-body > .row {
    height: 100%;
}
.kasaSonuclari .card-body > .row > .col-sm-6 {
    display: flex;
    flex-direction: column;
}
.kasaSonuclari .card-body .row .col-sm-6 ul {
    flex-grow: 1; /* Listelerin dikeyde esnemesini sağlar */
}
