...
">Operatör İstatistikleri</span>
    ...
    // Search box'ı baştan gizle
    dom: '<"d-none"f>rt<"bottom"i<"float-end"lp>><"clear">',
    ...
    "preDrawCallback": function(settings) {
        // İlk yüklemede layout shift'i önlemek için
        if (!this.api().data().count()) {
            $('.card-header .d-flex').remove();
        }
    },
    "initComplete": function (settings, json) {
        // Search container'ı bul
        ...
        // Sınıfları ekle
        searchContainer.addClass('flex-grow-1').removeClass('d-none');
        searchInput.addClass('w-100').attr('placeholder', 'Operatör Ara...');
        ...
        // Görünür yap (animasyon için setTimeout)
        setTimeout(function() {
