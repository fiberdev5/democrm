...
$(document).ready(function () {
    ...
    // Her iki input için de daterangepicker başlat
    ...
    // Kısayol butonları - class kullanarak tüm butonları hedefle
    ...
    var table = $('#datatableStateStats').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    var activeDateRange = $('.tarih-araligi:visible').first();
                    var from_date = activeDateRange.data('daterangepicker').startDate.format('YYYY-MM-DD');
                    var to_date = activeDateRange.data('daterangepicker').endDate.format('YYYY-MM-DD');
