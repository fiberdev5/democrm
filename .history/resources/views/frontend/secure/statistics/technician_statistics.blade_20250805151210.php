                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h6 class="card-title text-secondary">Tamamlanan Servisler</h6>
...
function generateStageCards(detaySayilari) {
    const stages = [
        ...
        { key: 'atolyede_tamir', label: 'Atölyede Tamir', color: 'primary' },
        { key: 'atolyeye_aldir', label: 'Atölyeye Aldır', color: 'primary' },
        { key: 'cihaz_atolyede', label: 'Cihaz Atölyede', color: 'primary' },
        { key: 'tamir_edilemiyor', label: 'Tamir Edilemiyor', color: 'primary' },
        { key: 'cihaz_teslim', label: 'Cihaz Teslim', color: 'primary' },
        { key: 'cihaz_teslim_parca', label: 'Cihaz Teslim (Parça)', color: 'primary' },
        { key: 'fiyat_anlasilamadi', label: 'Fiyat Anlaşılamadı', color: 'primary' },
        { key: 'musteri_atolyeye_getirdi', label: 'Müşteri Atölyeye Getirdi', color: 'primary' },
        ...
        { key: 'parca_tek_yon', label: 'Parça Tek. Yönlendir', color: 'primary' },
        { key: 'parca_atolyeye_alindi', label: 'Parça Atölyeye Alındı', color: 'primary' },
        { key: 'tahsilata_gonder', label: 'Tahsilata Gönder', color: 'primary' },
        { key: 'teslimata_hazir', label: 'Teslimata Hazır', color: 'primary' },
        { key: 'garantili_cikti', label: 'Garantili Çıktı', color: 'primary' },
        { key: 'yeniden_tek_yon', label: 'Yeniden Tek. Yönlendir', color: 'primary' },
        { key: 'yerinde_bakim', label: 'Yerinde Bakım', color: 'primary' }
    ];
