<!-- HTML KODUNUZ DEĞİŞMEYECEK, BU HALİYLE DOĞRU -->
...
<!-- İSTEDİĞİNİZ ŞEKİLDE ÇALIŞAN, SCROLL OLUŞTURMAYAN CSS -->
<style>
    /* Menü Konteyneri: Otomatik olarak alt satıra geçen grid yapısı */
    .statistics-menu {
        display: grid;
        /* BU SİHİRLİ SATIR, TÜM İŞİ YAPIYOR:
           Ekrana sığabildiği kadar kartı yan yana dizer.
           Her kartın en az 160px genişliğinde olmasını sağlar ve boşluk kalırsa
           o boşluğu eşit şekilde paylaştırır (1fr). */
