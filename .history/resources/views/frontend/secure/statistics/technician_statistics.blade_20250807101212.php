        ...
        <div class="card">
            <div class="card-header sayfaBaslik d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="filtreDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    FİLTRELE <i class="mdi mdi-chevron-down">
                </button>
...
.teknisyen-detay-btn.clicked .detay-icon {
...
.table-container::before {
    content: "💡 Teknisyen detaylarını görmek için satırlara tıklayabilirsiniz";
    display: block;
    font-size: 0.85rem;
    color: #6c757d;
    margin-bottom: 10px;
...
.teknisyen-dropdown-menu form {
    width: 100%;
}

.teknisyen-dropdown-menu .form-select,
.teknisyen-dropdown-menu input.form-control {
    width: 100%;
    margin-bottom: 10px;
}

.teknisyen-dropdown-menu .tarih-butonlari .btn {
    font-size: 0.75rem;
}

/* Teknisyen dropdown içerisindeki tarih butonları için özel stiller */
...
.teknisyen-dropdown .tarih-butonlari .btn:not(.active):hover {
...
$(document).ready(function() {
    ...
    // Tarih butonları
     $('.teknisyen-dropdown .tarih-btn').click(function() {
         // Tüm teknisyen dropdown butonlarını normale döndür
        $('.teknisyen-dropdown .tarih-btn').removeClass('active btn-primary').addClass('btn-outline-secondary');
    ...
    $('.teknisyen-dropdown .tarih-btn[data-days="30"]').addClass('active btn-primary').removeClass('btn-outline-secondary');

    // Dropdown içindeki form gönderimini engelle
     $('.teknisyen-dropdown-menu').click(function(e) {
        e.stopPropagation();
    });
    ...
    // DEĞİŞİKLİK: Table container class'ı eklendi
