...
<div class="row mt-3">
    <div class="col-12 text-center">
        <p class="lead">
            <strong>Toplam Tamamlanan Servis:</strong> <span class="text-primary fw-bold" id="totalCompletedServices">0</span> &nbsp;&nbsp;|&nbsp;&nbsp;
            <strong>Yapılan Toplam Anket:</strong> <span class="text-success fw-bold" id="totalSurveyedServices">0</span>
        </p>
    </div>
