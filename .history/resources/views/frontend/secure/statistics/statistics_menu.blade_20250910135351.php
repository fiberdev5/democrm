...
<style>
    /* 1. TEMEL MENÜ VE KART STİLLERİ */

    /* Menü Konteyneri: Varsayılan (geniş ekran) ayarı */
    .statistics-menu {
        display: grid;
        /* Geniş ekranlarda kartlar 180px'den dar olmayacak şekilde sığdığı kadar sıralanır */
        grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));
        gap: 0.75rem;
        width: 100%;
    }

    /* Kartların (Butonların) genel stili */
    .statistic-btn {
        background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
        border: 1px solid #dee2e6;
        border-radius: 12px;
        box-shadow: 0 2px 8px rgba(0,0,0,0.06);
        color: #495057; /* Yazı rengi sabitlendi */
        text-decoration: none;
        font-weight: 600; /* 800 çok kalındı, 600 daha okunaklı */
        padding: 1rem;
        position: relative;
        overflow: hidden;
        display: flex;
        ...
        min-height: 90px;
        text-align: center;
        font-size: 0.9rem; /* Okunaklı bir boyut ayarlandı */
        transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);
    }

    /* ÜZERİNE GELİNCE RENK DEĞİŞİMİNİ ENGELLEYEN KURAL */
    .statistic-btn:hover {
        color: #495057; /* Hover durumunda da yazı rengi aynı kalır */
        text-decoration: none;
        transform: translateY(-3px);
        box-shadow: 0 6px 16px rgba(0,0,0,0.1);
    }
    
    /* 2. ARKA PLAN İKONLARI VE RENKLERİ */
    ...
    /* Özel Renkler (HTML'den buraya taşındı) */
    .btn-durum { background-color: #8e44ad; color: white; }
    .btn-depo { background-color: #6e4c1e; color: white; }
    .btn-ilce { background-color: #1c3aa9; color: white; }
    .btn-anket { background-color: #4e6e3f; color: white; }
    .btn-durum:hover, .btn-depo:hover, .btn-ilce:hover, .btn-anket:hover { color: white; }
    ...
    .btn-durum::before { background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="white" d="M192 0c-41.8 0-77.4 26.7-90.5 64H64C28.7 64 0 92.7 0 128V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H282.5C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM72 272a24 24 0 1 1 48 0 24 24 0 1 1 -48 0zm104-16H304c8.8 0 16 7.2 16 16s-7.2 16-16 16H176c-8.8 0-16-7.2-16-16s7.2-16 16-16zM72 368a24 24 0 1 1 48 0 24 24 0 1 1 -48 0zm104-16H304c8.8 0 16 7.2 16 16s-7.2 16-16 16H176c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>'); }
    ...
    .btn-depo::before { background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="white" d="M0 488V171.3c0-26.2 15.9-49.7 40.2-59.4L331.1 4.8c7.6-3.1 16.1-3.1 23.8 0L645.8 111.9c24.3 9.7 40.2 33.3 40.2 59.4V488c0 13.3-10.7 24-24 24H568c-13.3 0-24-10.7-24-24V432c0-17.7-14.3-32-32-32H384c-17.7 0-32 14.3-32 32v56c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24z"/></svg>'); }
    .btn-ilce::before { background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="white" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>'); }
    .btn-anket::before { background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="white" d="M160 80c0-26.5 21.5-48 48-48h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H208c-26.5 0-48-21.5-48-48V80zM0 272c0-26.5 21.5-48 48-48H80c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V272zM368 96h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H368c-26.5 0-48-21.5-48-48V144c0-26.5 21.5-48 48-48z"/></svg>'); }
    ...
    /* 3. RESPONSIVE AYARLARI (Farklı Ekran Boyutları İçin) */

    /* Laptop ve daha küçük ekranlar */
    @media (max-width: 1200px) {
        .statistics-menu {
            /* Satırda 3 kart gösterir */
    ...
    @media (max-width: 768px) {
        .statistics-menu {
            /* Tüm kartları alt alta tek sütunda gösterir */
            grid-template-columns: 1fr;
            gap: 0.5rem;
        }
        .statistic-btn {
            /* Yazıyı ve ikonu sola yaslar, daha liste görünümü verir */
