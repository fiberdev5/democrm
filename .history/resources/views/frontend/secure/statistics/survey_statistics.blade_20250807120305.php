...
.servis-istatistik .bg-success {
    background: linear-gradient(135deg, #868e96 0%, #ced4da 100%) !important;
}

.servis-istatistik .bg-warning {
    background: linear-gradient(135deg, #adb5bd 0%, #dee2e6 100%) !important;
}

.servis-istatistik .bg-danger {
    background: linear-gradient(135deg, #ced4da 0%, #f1f3f5 100%) !important;
}
