...
/* Durum tiplerine göre renkler */
.status-pending {
    background: linear-gradient(135deg, #f39c12, #f1c40f); /* Turuncu */
}
...
.status-canceled {
    background: linear-gradient(135deg, #c0392b, #e74c3c); /* Kırmızı */
}

.status-inprogress {
    background: linear-gradient(135deg, #2980b9, #3498db); /* Mavi */
}
...
$(document).ready(function () {
    ...
    render: function(data, type, row) {
        // Durum koduna göre sınıf ataması
        let statusClass = '';
        switch(row.durum_kod) {
        ...
        // Kutu içinde ilk harfi göstermek veya simge koymak istersen buraya ekleyebilirsin
        let iconText = data.charAt(0).toUpperCase();
