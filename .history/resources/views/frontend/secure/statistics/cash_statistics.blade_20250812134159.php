...
$(document).ready(function () {
     ...
     // Tarih aralığını bugünün tarihi olarak ayarla
    var today = moment();

    // Daterangepicker inputunu bugüne ayarla (ilk yüklemede görünsün)
    ...
    // İstatistikleri filtrele (bugünün verilerini getir)
