...
<style>
    ...
    .table-modern thead {
        background: linear-gradient(135deg, #c8a2c8 0%, #e0b3ff 100%);
        color: #4b2354;
    }

    .table-modern tbody tr:hover {
        background: linear-gradient(135deg, rgba(200, 162, 200, 0.15), rgba(224, 179, 255, 0.15));
    ...
    .btn-action {
        background: linear-gradient(135deg, #d1b3f5 0%, #e4c6f8 100%);
        border: none;
        border-radius: 20px;
        padding: 6px 14px;
        color: #4b2354;
    ...
    .btn-action:hover {
        background: linear-gradient(135deg, #c89ee7 0%, #dab6f0 100%);
        color: #3d1f46;
    }
</style>
