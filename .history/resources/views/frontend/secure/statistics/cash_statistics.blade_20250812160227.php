                    ...
                    <div class="col-sm-6 gelirTablosu">
                        <div class="row">
                            ...
                            <div class="sag col-sm-6">
                                {{-- DEĞİŞİKLİK: Canvas'a class eklendi --}}
                                    ...
                                    @foreach($odemeTuruAll as $key => $value )
                                        @php 
                                            ...
                                            $renkler = [
                                                ...
                                                '#8BC34A', '#4CAF50', '#00BCD4', '#009688', 
                                                '#2196F3', '#3F51B5', '#673AB7', '#9C27B0', '#F44336'
                                            ];
...
/* YENİ KURAL: Bu kural her iki grafiğin de aynı yüksekliğe sahip olmasını sağlar */
.pie-chart-canvas {
    height: 220px !important; /* Yüksekliği sabitle. Değeri artırıp azaltarak istediğiniz boyutu ayarlayabilirsiniz. */
    width: 100% !important;   /* Genişliğin kapsayıcıya uymasını sağla */
}
</style>
