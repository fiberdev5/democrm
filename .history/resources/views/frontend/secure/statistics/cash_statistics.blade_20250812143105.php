    ...
    <div class="container-fluid">
        ...
        <div class="card kasaSonuclari" style="margin-bottom: 5px;">
            ...
            <div class="row d-flex align-items-center">
                <!-- Gelir Listesi -->
                <div class="col-md-6">
                    <div class="kasa-listesi">
                        <div class="kasa-item">
                            <span class="renk-kutusu" style="background-color: #34a853;"></span>
                            <span class="adi">Nakit</span>
                            <span class="para">{{ number_format($nakit, 2, ',', '.') }} TL</span>
                        </div>
                        <div class="kasa-item">
                            <span class="renk-kutusu" style="background-color: #e01010;"></span>
                            <span class="adi">EFT/Havale</span>
                            <span class="para">{{ number_format($eft, 2, ',', '.') }} TL</span>
                        </div>
                        <div class="kasa-item">
                            <span class="renk-kutusu" style="background-color: #1a73e8;"></span>
                            <span class="adi">Kredi Kartı</span>
                            <span class="para">{{ number_format($kart, 2, ',', '.') }} TL</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Gelir Grafiği -->
                <div class="col-md-6">
                    <canvas id="gelirChart" height="220"></canvas>
                </div>
            </div>
        </div>
                      <div class="col-lg-6">
            <div class="row d-flex align-items-center">
                <!-- Gider Listesi -->
                <div class="col-md-7">
                    <div class="kasa-listesi gider-listesi">
                        @foreach($odemeTuruAll as $key => $value)
                            ...
                            @endphp
                            <div class="kasa-item">
                                <span class="renk-kutusu" style="background:{{$renk}}"></span>
                                <span class="adi">{{$key}}</span>
                                <span class="para">{{number_format($value, 2, ',', '.')}} TL</span>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <!-- Gider Grafiği -->
                <div class="col-md-5">
                    <canvas id="giderArea" height="220"></canvas>
                </div>
            </div>
        </div>
                </div>
...
.kasa-item .adi {
    flex-grow: 1; /* Esnek büyüme sağlar */
    font-size: 14px;
    white-space: nowrap; /* Metinlerin alt satıra kaymasını engeller */
    overflow: hidden;
    text-overflow: ellipsis; /* Taşan metinleri ... ile gösterir */
}

.kasa-item .para {
    font-weight: bold;
    font-size: 14px;
    margin-left: 10px; /* Adı ve para arasında boşluk */
    white-space: nowrap; /* Fiyatın kaymasını engeller */
}

/* AJAX ile yüklenen gider listesi için, class adını `giderTablosu .sol` yerine `.gider-listesi` yapmanız gerekebilir */
.gider-listesi .kasa-item .adi {
    flex-grow: 1;
}

/* Grafiklerin mobil uyumluluğu için */
