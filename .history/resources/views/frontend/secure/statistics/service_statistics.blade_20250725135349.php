...
<div class="page-content servis-istatistik">
    ...
    <div class="dropdown-menu dropdown-menu-end servisDrop p-3 shadow w-100 position-static" style="min-width: 100%; max-width: 1000px;">
        <form id="istatistikAra" action="{{ route('statistics', $tenant_id) }}" method="get">
            ...
            <div class="row mt-3 align-items-center">
                ...
                <div class="col-md-3 text-end">
                    <button type="submit" name="servisSayListele" class="btn btn-primary w-100">
