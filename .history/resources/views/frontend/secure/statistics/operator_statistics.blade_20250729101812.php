@extends('layouts.app') {{-- Kendi layout dosyanızın yolunu buraya yazın --}}

@section('content')
<div id="wrapper">
    @include('include.menu') {{-- include.menu blade yolunu kendi projenize göre düzenleyin --}}
    <div id="content-wrapper">
        <div class="container-fluid">
            <div class="girisEkrani istatistiklerGirisEkrani">
                @include('include.istatistikler-menu') {{-- include.istatistikler-menu blade yolunu düzenleyin --}}
            </div>

            {{-- Yetki kontrolü --}}
            @if(auth()->user()->grup == "242" || auth()->user()->yetki == "1") {{-- User modelinizdeki alan adlarına göre güncelleyin --}}
