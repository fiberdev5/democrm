        ...
        <div class="card bg-light">
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-6 border-end"> {{-- Sütun ayırıcı olarak border kullanabiliriz --}}
                        <i class="fas fa-check-circle fa-2x text-primary mb-2"></i>
                        <h4 class="mb-0" id="totalCompletedServices">0</h4>
                        <p class="text-muted mb-0">Tamamlanan Servisler</p>
                    </div>
                    <div class="col-6">
                        <i class="fas fa-poll fa-2x text-success mb-2"></i>
                        <h4 class="mb-0" id="totalSurveyedServices">0</h4>
                        <p class="text-muted mb-0">Yapılan Anketler</p>
                    </div>
                </div>
            </div>
        </div>
