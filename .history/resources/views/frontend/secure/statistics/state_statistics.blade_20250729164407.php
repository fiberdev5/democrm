...
.status-avatar {
    ...
    height: 30px;
    border-radius: 50%;
    background: linear-gradient(135deg, #8e44ad, #9b59b6); /* Mor renk geçişi */
    display: inline-flex;
    align-items: center;
    ...
    font-size: 14px;
    margin-right: 10px;
    box-shadow: 0 0 8px rgba(158, 73, 171, 0.6);
    flex-shrink: 0;
    user-select: none;
}
...
$(document).ready(function () {
    ...
    var table = $('#datatableStateStats').DataTable({
        ...
        render: function(data, type, row) {
            // Burada data = durum metni, örn: "Tamamlandı"
            // Durumun baş harfi avatar içinde gösterilebilir
