                    ...
                    <div class="card-header">
                        ...
                        <div class="searchWrap float-end">
                            <div class="btn-group mb-2">
                                <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" >
                    ...
                    <div class="card-header">
                        ...
                        <div class="searchWrap float-end" id="personel_anket">
                            <div class="btn-group mb-2 dropup">
                                <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                    Filtrele <i class="mdi mdi-chevron-down"></i>
                                </button>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="tarihAraligi mt-2 mb-2">
                                                    ...
                                                    <button class="btn btn-sm btn-secondary me-1 btnLastMonth" type="button">Son 1 Ay</button>
                                                    <button class="btn btn-sm btn-secondary me-1 btnLast15Days" type="button">Son 15 Gün</button>
                                                    <button class="btn btn-sm btn-secondary me-1 btnLastWeek" type="button">Son 7 Gün</button>
                                                    <button class="btn btn-sm btn-secondary me-1 btnYesterday" type="button">Dün</button>
                                                    <button class="btn btn-sm btn-secondary btnToday" type="button">Bugün</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function () {
    ...
    // Anket sonuçları kısayol butonları - event.preventDefault() ve event.stopPropagation() eklendi
    $('#lastMonthResults').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateResultsRange(moment().subtract(1, 'month'), today);
    });
    $('#last15DaysResults').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateResultsRange(moment().subtract(15, 'days'), today);
    });
    $('#lastWeekResults').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateResultsRange(moment().subtract(7, 'days'), today);
    });
    $('#yesterdayResults').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateResultsRange(moment().subtract(1, 'days'), moment().subtract(1, 'days'));
    });
    $('#todayResults').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateResultsRange(today, today);
    });

    // Personel istatistikleri kısayol butonları - event.preventDefault() ve event.stopPropagation() eklendi
    $('#personel_anket .btnLastMonth').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateRange(moment().subtract(1, 'month'), today);
    });
    $('#personel_anket .btnLast15Days').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateRange(moment().subtract(15, 'days'), today);
    });
    $('#personel_anket .btnLastWeek').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateRange(moment().subtract(7, 'days'), today);
    });
    $('#personel_anket .btnYesterday').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
        updateRange(moment().subtract(1, 'days'), moment().subtract(1, 'days'));
    });
    $('#personel_anket .btnToday').click(function(event) {
        event.preventDefault();
        event.stopPropagation();
