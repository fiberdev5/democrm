...
@section('user')
    <link href="{{ asset('frontend/css/statistics/operator_statistics.css') }}" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
    
    <style>
        Bu kayma sorunu, DataTable'ın yüklenmesi sırasında DOM manipülasyonundan kaynaklanıyor. initComplete callback'inde search ve filter elemanları taşınıyor, bu da layout shift'e neden oluyor. İşte çözümler:
1. CSS Ekleyin (En Hızlı Çözüm)
Blade dosyanızın <style> bölümüne veya CSS dosyanıza ekleyin:
css/* Sayfa yüklenirken kaymaları önle */
.searchWrap {
    visibility: hidden;
    opacity: 0;
...
/* DataTable yüklenene kadar search box'ı gizle */
#datatableOperatorStats_filter {
    visibility: hidden;
    opacity: 0;
}

/* Card header için minimum yükseklik */
.card-statics-op-body .card-header {
    min-height: 60px;
    display: flex;
    align-items: center;
}

/* Table container için minimum yükseklik */
#datatableOperatorStats_wrapper {
    min-height: 400px;
}

/* Processing indicator gösterilirken */
...
">Operatör İstatistikleri</span>
    ...
    setTimeout(function() {
        ...
        searchContainer.css({ visibility: 'visible', opacity: 1 });
    }, 100);
}
