...
<!-- jQuery UI ve Bootstrap Datepicker CSS -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.min.css">

<!-- jQuery UI ve Bootstrap Datepicker JS -->
...
jQuery(document).ready(function($) {
    ...
    function loadStatistics() {
        ...
        console.log('URL:', '{{ route("technician.statistics.data", $tenant_id) }}');
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                if (xhr.status === 419) {
                    errorMessage = 'Güvenlik tokeni geçersiz. Sayfayı yenileyip tekrar deneyin.';
                } else if (xhr.status === 405) {
                    errorMessage = 'İstek yöntemi desteklenmiyor. Lütfen tekrar deneyin.';
