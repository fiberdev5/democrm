...
<div class="page-content servis-istatistik">
    ...
    <div class="btn-group mb-3">
        ...
        <div class="dropdown-menu p-3 servisDrop" style="min-width: 350px; max-width: 400px;">
            <!-- Personel -->
            <div class="item mb-2">
                ...
                <select name="personeller" class="form-select form-select-sm">
                    ...
                    @foreach($personeller as $personel)
                        <option value="{{ $personel->user_id }}" {{ request('personeller') == $personel->user_id ? 'selected' : '' }}>
                            {{ $personel->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="item mb-2">
                ...
                <select name="device_brands" class="form-select form-select-sm">
                    <option value="">Hepsi</option>
                    @foreach($device_brands as $brand)
                        <option value="{{ $brand->id }}" {{ request('device_brands') == $brand->id ? 'selected' : '' }}>
                            {{ $brand->marka }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="item mb-2">
                ...
                <select name="device_types" class="form-select form-select-sm">
                    <option value="">Hepsi</option>
                    @foreach($device_types as $type)
                        <option value="{{ $type->id }}" {{ request('device_types') == $type->id ? 'selected' : '' }}>
                            {{ $type->cihaz }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="item mb-2">
                ...
                <select name="service_resource" class="form-select form-select-sm">
                    <option value="">Hepsi</option>
                    @foreach($service_resources as $resource)
                        <option value="{{ $resource->id }}" {{ request('service_resource') == $resource->id ? 'selected' : '' }}>
                            {{ $resource->kaynak }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="item mb-2">
                ...
                <select name="il" id="country2" class="form-select form-select-sm">
                    <option value="" selected>-Seçiniz-</option>
                    @foreach($states as $item)
                        <option value="{{ $item->id }}" {{ request('il') == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="item mb-2">
                ...
                <select name="ilce" id="city2" class="form-select form-select-sm">
                    <option value="" selected disabled>-Seçiniz-</option>
                    <!-- İlçeler JS ile dinamik yüklenecek -->
                </select>
            </div>
