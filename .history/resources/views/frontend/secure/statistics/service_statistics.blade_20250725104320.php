            ...
            <div class="col-lg-5">
                <div class="card shadow-sm servisSaatleriChart" style="height: 300px;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <!-- Tarih Seçimi -->
                            <input type="date" name="saatTarih" class="form-control form-control-sm saatTarih me-2" style="max-width: 140px;" value="{{ date('Y-m-d') }}">
                            <!-- Tab Navigation -->
                            <ul class="nav nav-tabs border-0" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link hourly-tab" data-bs-toggle="tab" href="#saat7" data-type="7days">7 Gün</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link hourly-tab" data-bs-toggle="tab" href="#saat15" data-type="15days">15 Gün</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active hourly-tab" data-bs-toggle="tab" href="#saatToday" data-type="today">Bugün</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="card-body" style="height: calc(100% - 70px);">
                        <div class="tab-content h-100">
                            <div id="saat7" class="tab-pane fade h-100">
                            ...
                            <div id="saatToday" class="tab-pane fade show active h-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadHourlyChart('today', 'saatArea', hourlyColors.today);
