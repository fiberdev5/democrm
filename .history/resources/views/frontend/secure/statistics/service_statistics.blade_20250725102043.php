...
<div class="col-lg-4">
    <div class="card shadow-sm servisSaatleriChart" style="height: 300px;">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <input type="date" name="saatTarih" class="form-control form-control-sm saatTarih" style="max-width: 140px;" value="{{ date('Y-m-d') }}">
        </div>

        <!-- Gün Seçimi İçin Sekmeler -->
        <ul class="nav nav-tabs border-0 px-3 pt-2" role="tablist">
            <li class="nav-item">
                <a class="nav-link active saat-chart-tab" data-bs-toggle="tab" href="#saat7" data-days="7">7 Gün</a>
            </li>
            <li class="nav-item">
                <a class="nav-link saat-chart-tab" data-bs-toggle="tab" href="#saat15" data-days="15">15 Gün</a>
            </li>
            <li class="nav-item">
                <a class="nav-link saat-chart-tab" data-bs-toggle="tab" href="#saat30" data-days="30">30 Gün</a>
            </li>
        </ul>

        <div class="card-body" style="height: calc(100% - 100px);">
            <div class="tab-content h-100">
                <div id="saat7" class="tab-pane fade show active h-100">
                    <canvas id="saatChart7" style="height: 100% !important;"></canvas>
                </div>
                <div id="saat15" class="tab-pane fade h-100">
                    <canvas id="saatChart15" style="height: 100% !important;"></canvas>
                </div>
                <div id="saat30" class="tab-pane fade h-100">
                    <canvas id="saatChart30" style="height: 100% !important;"></canvas>
                </div>
            </div>
        </div>
    </div>
