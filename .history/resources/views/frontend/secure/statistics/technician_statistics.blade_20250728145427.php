...
.dropdown-menu {
    ...
    /* min-height: 220px; Bu satırı kaldırın veya değerini artırın */
    max-height: 400px; /* Yeni eklenen satır: menünün maksimum yüksekliğini belirler */
    overflow-y: auto; /* Kaydırma çubuğu gerektiğinde çıksın */
    padding: 15px; /* Mevcut hali uygun */
}
