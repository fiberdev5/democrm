                ...
                <div class="table-modern">
                    ...
                    <div class="card-body">
                        <table id="datatableOperatorStats" class="table table-hover mb-0">
                            <thead class="title">
                                <tr>
                                    <th><i class="d-lg-block d-none fas fa-user me-2"></i>Operatör Adı</th>
                                    <th><i class="d-lg-block d-none fas fa-clipboard-list me-2"></i>Toplam Servis Kaydı</th>
                                    <th style="d-lg-block d-none width: 130px;">İşlemler</th>


                                    <th><i class="d-lg-none d-block fas fa-user me-2"></i>Operatör Adı</th>
                                    <th><i class="d-lg-none d-block fas fa-clipboard-list me-2"></i>Toplam Servis Kaydı</th>
                                    <th style="d-lg-none d-block width: 130px;">İşlemler</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
