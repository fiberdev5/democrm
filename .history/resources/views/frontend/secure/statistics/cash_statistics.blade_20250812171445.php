...
/* Gider listesi ve grafik hizalama */
.giderTablosu .row,
.gelirTablosu .row {
    display: flex;
    align-items: center;
...
.giderTablosu .sol li.gider {
    display: flex;
    align-items: center;
    margin: 4px 0;
    font-size: 13px; /* Yazılar biraz küçültüldü */
}

.giderTablosu .sol li.gider .renk {
    width: 14px;
    height: 14px;
    border-radius: 3px;
    margin-right: 8px;
