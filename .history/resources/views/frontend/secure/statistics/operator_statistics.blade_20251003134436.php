                ...
                <div class="table-modern">
                    ...
                    <div class="card-body">
                        <table id="datatableOperatorStats" class="table table-hover mb-0">
                            <thead class="title">
                                <tr>
                                    <th class="operator-name-header">
                                        <i class="fas fa-user me-2"></i><span class="d-none d-md-inline">Operatör Adı</span><span class="d-inline d-md-none">Operatör</span>
                                    </th>
                                    <th class="operator-total-header">
                                        <i class="fas fa-clipboard-list me-2"></i><span class="d-none d-md-inline">Toplam Servis Kaydı</span><span class="d-inline d-md-none">Toplam</span>
                                    </th>
                                    <th class="operator-action-header" style="width: 130px;">
                                        <span class="d-none d-md-inline">İşlemler</span><span class="d-inline d-md-none">İşlem</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `<a href="${url}" target="_blank" class="btn btn-action btn-sm">
                                <i class="fas fa-eye me-1"></i><span class="d-none d-md-inline">Servisleri Gör</span><span class="d-inline d-md-none">Gör</span>
                            </a>`;
                }
            }
        ],
