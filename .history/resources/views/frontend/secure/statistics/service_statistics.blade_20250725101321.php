...
<div class="page-content servis-istatistik">
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm servisSayilariChart" style="height: 400px;">
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm servisSaatleriChart" style="height: 400px;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                    ...
                    <div class="card-body" style="height: calc(100% - 70px);">
                        <canvas id="saatArea" style="height: 100% !important;"></canvas>
                    </div>
                </div>
            </div>
        </div>
