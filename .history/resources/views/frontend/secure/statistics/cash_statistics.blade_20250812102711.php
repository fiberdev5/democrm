                        ...
                        <div class="row">        
                            <div class="sag">
                                <div class="row text-center">
                                    <div class="col-3">
                                        <h6 class="mb-0 gelirNakit">{{ number_format($tutarlar['Nakit'] ?? 0, 0, ',', '.') }} TL</h6>
                                        <p class="text-muted text-truncate">Nakit</p>
                                    </div>
                                    <div class="col-3">
                                        <h6 class="mb-0 gelirEft">{{ number_format($tutarlar['EFT / Havale'] ?? 0, 0, ',', '.') }} TL</h6>
                                        <p class="text-muted text-truncate">EFT/Havale</p>
                                    </div>
                                    <div class="col-3">
                                        <h6 class="mb-0 gelirKart">{{ number_format($tutarlar['Kredi Kartı'] ?? 0, 0, ',', '.') }} TL</h6>
