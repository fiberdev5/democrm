...
<div class="page-content servis-istatistik-genel">
           ...
           <!-- Modern Header Card -->
            <div class="card shadow-sm mb-4 istatistik-card">
                <div class="card-header sayfaBaslik d-flex justify-content-between align-items-center">
                    <h6 class="mb-0"><i class="fas fa-chart-line me-2"></i>Servis İstatistikleri</h6>
    ...
    <i class="fas fa-tags me-1"></i>Markalar
</h5>
                                                </div>
                                                <div class="card-body p-2">
                                                    @forelse($period['markalar'] as $marka)
                                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
    <p class="mb-0 text-truncate fs-6">{{ $marka->marka }}</p>
    <span class="badge bg-secondary fs-6 fw-bold">{{ $marka->sayi }}</span>
</div>
                                                    @empty
        ...
        <div class="row mt-4">
                ...
                <div class="card shadow-sm servisSayilariChart" style="height: 300px;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <h6 class="mb-0"><i class="fas fa-chart-line me-2"></i>Servis Sayıları</h6>
                        </div>
            ...
            <div class="col-lg-5">
                <div class="card shadow-sm servisSaatleriChart" style="height: 300px;">
                    <div class="card-header  d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <h6 class="mb-0"><i class="fas fa-clock me-2"></i>Saat Aralıkları</h6>
                        </div>
                        <!-- Tab Navigation -->
                        <ul class="nav nav-tabs border-0" role="tablist">
                            <li class="nav-item">
                            <input type="date" name="saatTarih" class="form-control form-control-sm saatTarih" style="max-width: 82px;" value="{{ date('Y-m-d') }}">
                            </li>
                            <li class="nav-item">
