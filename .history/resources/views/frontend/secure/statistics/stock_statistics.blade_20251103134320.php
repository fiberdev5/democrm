...
@section('user')
   ...
   <script>
    ...
    $(document).ready(function () {
        ...
        // =================================================================
        // YENİ EKLENEN BÖLÜM: DateRangePicker'ı başlatma ve event atama
        // =================================================================
        $('#daterange').daterangepicker({
            autoUpdateInput: false, // Başlangıçta input boş görünsün
            locale: {
                cancelLabel: 'Temizle',
                applyLabel: 'Uygula',
                fromLabel: 'Başlangıç',
        ...
        // Tarih seçilip "Uygula" butonuna basıldığında tetiklenir
        ...
        // "Temizle" butonuna basıldığında tetiklenir
        ...
        // Hızlı tarih butonları (Son 1 Yıl, Son 1 Ay vb.)
        $('#lastYear, #lastMonth, #lastWeek, #yesterday, #today').on('click', function() {
            ...
            $('.dropdown-menu').removeClass('show'); // Filtre menüsünü kapat
        });


        // =================================================================
        // MEVCUT DATATABLE KODUNUZ (AJAX bölümü güncellendi)
        // =================================================================
        var table = $('#datatablePersonelDepoStats').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    d._token = "{{ csrf_token() }}";
                    // =================================================
                    // GÜNCELLENEN BÖLÜM: Tarih aralığını sunucuya gönder
                    // =================================================
