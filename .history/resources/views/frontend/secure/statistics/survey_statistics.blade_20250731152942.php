...
$(document).ready(function () {
    ...
    function updatePersonnelTable(personnelStats) {
        ...
        tableBody.empty(); // Mevcut verileri temizle
        ...
        personnelStats.forEach(function(personnel) {
            // URL'i JavaScript içinde oluşturuyoruz
           let detailUrl = `/secure/${TENANT_ID}/personel-anket-detay/${personnel.personnel_id}`;

let row = `<tr>
    <td>${personnel.adsoyad}</td>
    <td>${personnel.completed_services}</td>
    <td>${personnel.survey_count}</td>
    <td>
        <a href="${detailUrl}" class="btn btn-info btn-sm">Detay</a>
    </td>
</tr>`;
...
console.log(response.personnelStats); // => array geliyor mu?
