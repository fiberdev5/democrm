...
<div class="page-content servis-istatistik">
    ...
    <a href="#" id="today" class="btn btn-outline-primary quick-date">Bugün</a>
    <a href="#" id="yesterday" class="btn btn-outline-primary quick-date">Dün</a>
    <a href="#" id="lastWeek" class="btn btn-outline-primary quick-date">Son 7 Gün</a>
    <a href="#" id="lastMonth" class="btn btn-outline-primary quick-date">Son 1 Ay</a>
    <a href="#" id="lastYear" class="btn btn-outline-primary quick-date">Son 1 Yıl</a>
</div>
...
$(document).ready(function () {
    ...
    $('#today').on('click', function (e) {
        e.preventDefault();
        $('input[name="tarih1"]').val(today);
        $('input[name="tarih2"]').val(today);
    });

    $('#yesterday').on('click', function (e) {
        e.preventDefault();
        $('input[name="tarih1"]').val(yesterday);
        $('input[name="tarih2"]').val(yesterday);
    });

    $('#lastWeek').on('click', function (e) {
        e.preventDefault();
        $('input[name="tarih1"]').val(lastWeek);
        $('input[name="tarih2"]').val(today);
    });

    $('#lastMonth').on('click', function (e) {
        e.preventDefault();
        $('input[name="tarih1"]').val(lastMonth);
        $('input[name="tarih2"]').val(today);
    });

    $('#lastYear').on('click', function (e) {
        e.preventDefault();
        $('input[name="tarih1"]').val(lastYear);
        $('input[name="tarih2"]').val(today);
    });
});
</script>
