    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header bg-dark text-white text-center">
                <h4 class="mb-0">Kasa İstatistikleri</h4>
            </div>
        </div>
        <div class="card kasaSonuclari" style="margin-bottom: 5px;">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-6 gelirTablosu">
                    ...
                    <div class="col-12 col-md-6 giderTablosu mt-3 mt-md-0">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0 d-flex align-items-center justify-content-center">
...
/* Responsive boşluk ve hizalama için eklenen stil */
