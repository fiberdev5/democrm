...
$(document).ready(function () {
    ...
    // Anket sonuçları daterangepicker olayları
    $('#daterangeResults').on('apply.daterangepicker', function(ev, picker) {
        loadSurveyResults();
    });

    $('#daterangeResults').on('show.daterangepicker', function() {
        // daterangepicker açıldığında, ilgili dropdown'ın kapanmasını geçici olarak engelle
        $(this).closest('.dropdown-menu').parent().addClass('dropdown-open-datepicker');
    });

    $('#daterangeResults').on('hide.daterangepicker', function() {
        // daterangepicker kapandığında, engellemeyi kaldır
        $(this).closest('.dropdown-menu').parent().removeClass('dropdown-open-datepicker');
    });
    ...
    // Personel istatistikleri daterangepicker olayları
    ...
    // Dropdown menülerinin kapanmasını engellemek için genel bir yöntem
    // Bu, data-bs-auto-close="outside" ile birlikte kullanılmalıdır.
    $(document).on('click', '.dropdown-open-datepicker .dropdown-menu', function (e) {
        e.stopPropagation();
    });
