...
<div class="page-content personel-depo-istatistik" id="personelDepoStats">
...
$(document).ready(function () {
    ...
    var table = $('#datatablePersonelDepoStats').DataTable({
        processing: true,
        serverSide: true,
        order: [[1, 'desc']], // Toplam stok adedine göre azalan sıralama
        language: {
            paginate: {
        ...
        columns: [
            {
                ...
                render: function(data, type, row) {
                    // Personel adı için stil veya ikon ekleyebilirsiniz
            ...
            {
                data: 'total_stock', // Controller'da 'total_stock' olarak tanımlandı
                name: 'personel_stocks_count', // İlişki üzerinden gelen count adı
                render: function(data) {
                    return `<span class="badge bg-info">${data}</span>`;
                }
            },
            {
                data: 'action', // Controller'da 'action' olarak tanımlandı
                name: 'action',
                orderable: false,
                searchable: false
            }
