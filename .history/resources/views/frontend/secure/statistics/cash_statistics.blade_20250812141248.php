        ...
        <div class="card kasaSonuclari" style="margin-bottom: 5px;">
            <div class="card-header sayfaBaslik" style="padding:5px!important;font-weight:500;font-size:18px;">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <div class="searchWrap mt-2 mt-md-0">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <div class="item p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="modalDaterange" class="tarih-araligi form-control mb-2" style="z-index: 9999;">          
                                            <div class="tarihAraligi mt-2 mb-2 d-flex flex-wrap gap-1">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-6 gelirTablosu mb-3 mb-lg-0">
                        <div class="row">        
                            <div class="sag">
                    ...
                    <div class="col-12 col-lg-6 giderTablosu">
                        <div class="row">
...
function filterGiderData(startDate, endDate) {
    $.ajax({
        ...
        success: function(response) {
            $(".giderTablosu .gider-list").html(response.html);
        },
        error: function(xhr, status, error) {
            console.error(error);
        }
...
/* Chart wrapper - Her iki grafik aynı boyutta olsun */
.chart-wrapper {
    height: 250px;
    position: relative;
}
