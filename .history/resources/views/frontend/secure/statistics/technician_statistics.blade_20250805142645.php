                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <canvas id="tamamlananChart_${data.id}" style="height: 150px;"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
...
function drawDetailCharts(data) {
    ...
    const tamamlananCtx = document.getElementById(`tamamlananChart_${data.id}`);
    if (tamamlananCtx) {
    ...
    const iptalCtx = document.getElementById(`iptalChart_${data.id}`);
    if (iptalCtx) {
        new Chart(iptalCtx, {
            type: 'line',
            data: {
    ...
    // Gelir Grafiği
    const gelirCtx = document.getElementById(`gelirChart_${data.id}`);
    if (gelirCtx) {
        new Chart(gelirCtx, {
            type: 'line',
            data: {
