...
.pageDetail.servis-istatistik .searchWrap .dropdown-menu.show {
...
$(document).ready(function () {
    ...
    var table = $('#datatableOperatorStats').DataTable({
        ...
        initComplete: function(settings, json) {
            var searchContainer = $('#datatableOperatorStats_filter'); // Tablo ID'sini doğru kullandık
            var searchInput = searchContainer.find('input');
            searchInput.attr('placeholder', 'Operatör Ara...'); // Arama placeholder'ını güncelledim
