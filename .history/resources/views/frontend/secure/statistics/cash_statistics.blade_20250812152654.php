                ...
                <div class="sol col-sm-6">
                    <ul>
                        <li class="gelir">
                            ...
                            <div class="para">{{number_format($nakit, 0, ',', '.')}} TL</div>
                        </li>
                        <li class="gelir">
                            <div class="renk" style="background:#2196F3"></div>
                            <div class="adi">EFT/Havale</div>
                            <div class="para">{{number_format($eft, 0, ',', '.')}} TL</div>
                        </li>
                        <li class="gelir">
                            <div class="renk" style="background:#FFC107"></div>
                            <div class="adi">Kredi Kartı</div>
                            <div class="para">{{number_format($kart, 0, ',', '.')}} TL</div>
                        </li>
                        <li class="gelir">
                            <div class="renk" style="background:#000"></div>
                            <div class="adi">Toplam</div>
                            <div class="para">{{number_format($gelirler, 0, ',', '.')}} TL</div>
                        </li>
                    </ul>
                </div>
