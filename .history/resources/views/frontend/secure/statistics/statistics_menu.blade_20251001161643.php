...
@media (max-width: 768px) {
    .statistics-menu {
        ...
        gap: 0.25rem; /* 0.5rem yerine - ÇOK AZALTILDI */
    }
    
    .statistic-btn {
        justify-content: flex-start;
        padding: 8px 12px; /* 10px yerine 8px */
        margin-bottom: 0; /* 16px yerine 0 - ÖNEMLİ */
    }
}

@media (max-width: 576px) {
    .statistics-menu {
        gap: 0.2rem; /* Daha da azaltıldı */
    }
    
    .statistic-btn {
        font-size: 0.75rem; /* 0.8rem yerine */
        padding: 6px 10px; /* 8px yerine 6px */
        margin-bottom: 0; /* Kesinlikle 0 olmalı */
    }
}
