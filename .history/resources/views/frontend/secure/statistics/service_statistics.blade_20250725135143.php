            ...
            <div class="card shadow-sm mb-4 istatistik-card">
                <div class="card-header sayfaBaslik d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Servis İstatistikleri</h4>
                      <div class="dropdown"> {{-- Bootstrap 5 dropdown için `btn-group` yerine `dropdown` sınıfını kullanabiliriz --}}
                    <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" id="filtreDropdownButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Filtrele <i class="fas fa-filter ms-1"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end p-3" aria-labelledby="filtreDropdownButton" style="min-width: 300px;"> {{-- `servisDrop` yerine `p-3` ile padding verelim ve `min-width` ile genişletelim --}}
                        <form id="istatistikAra" action="{{ route('statistics', $tenant_id) }}" method="get">
                            <div class="row g-3">
                                <div class="col-12"> {{-- Küçük ekranlarda daha iyi görünmesi için `col-md-3` yerine `col-12` veya daha büyük breakpoint kullanabiliriz --}}
                                    <label for="personeller" class="form-label">Personel</label>
                                    <select name="personeller" id="personeller" class="form-select form-select-sm"> {{-- `form-select-sm` ile daha kompakt hale getirebiliriz --}}
                                ...
                                <div class="col-12">
                                    <label for="servisKaynak" class="form-label">Servis Kaynağı</label>
                                    <select name="servisKaynak" id="servisKaynak" class="form-select form-select-sm">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" name="tarih1" id="tarih1" class="form-control form-control-sm"
                                        value="{{ \Carbon\Carbon::parse($request->tarih1 ?? now()->subDays(29))->format('Y-m-d') }}">
                                </div>
                                <div class="col-12">
                                    <label for="tarih2" class="form-label">Bitiş Tarihi</label>
                                    <input type="date" name="tarih2" id="tarih2" class="form-control form-control-sm"
                                        value="{{ \Carbon\Carbon::parse($request->tarih2 ?? now())->format('Y-m-d') }}">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-12 d-flex flex-wrap gap-2 justify-content-between"> {{-- Butonları esnek hale getirelim --}}
                                    <div class="btn-group flex-wrap" role="group" aria-label="Hızlı Tarih Seçimi">
                                    ...
                                    <button type="submit" name="servisSayListele" class="btn btn-primary btn-sm"> {{-- Butonu küçültelim --}}
