...
/* Tablo Başlığı */
.table-modern thead {
    /* Mor ve mavinin daha sıcak, turuncuya yakın bir tonuyla geçiş */
    background: linear-gradient(135deg, #FF7F50 0%, #FF6347 100%); /* Canlı turuncu-kırmızı geçiş */
    color: white;
}

/* Tablo Satırlarının Üzerine Gelindiğinde Animasyon */
.table-modern tbody tr:hover {
    /* Hafif bir turuncu tonu veya gri tonu */
    background: linear-gradient(135deg, rgba(255,165,0,0.1) 0%, rgba(255,140,0,0.1) 100%); /* Hafif turuncu gradyan */
...
/* Aksiyon Butonları */
.btn-action {
    /* Canlı, parlak bir turuncu-mavi gradyan */
    background: linear-gradient(135deg, #FFA07A 0%, #FF4500 100%); /* Açık turuncu ile koyu turuncu arası geçiş */
    border: none;
    border-radius: 20px;
    padding: 6px 14px;
    color: white;
...
.btn-action:hover {
    ...
    box-shadow: 0 5px 15px rgba(255,165,0,0.4); /* Turuncu tonlarında gölge */
    color: white;
}
...
.avatar {
    ...
    height: 35px;
    border-radius: 50%;
    /* Mor-mavi gradyanı koruyabilir veya turuncuya uyumlu hale getirebiliriz */
    background: linear-gradient(135deg, #667eea, #764ba2); /* Mevcut mor-mavi gradyanı korundu */
    display: flex;
    align-items: center;
...
.badge.bg-primary {
    /* Mevcut bg-primary yerine turuncu tonları kullanabiliriz */
...
/* Datatable genel stil ayarları (mevcut arka plan rengini kaldırıp modern tablo stiline bırakıyoruz) */
