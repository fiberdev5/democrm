                                ...
                                <div class="dropdown-menu p-3" style="min-width: 200px;">
                                    <div class="item">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input id="daterangeResults" class="form-control form-control-sm tarih-araligi" readonly />
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-end">
                                                <button type="button" class="btn btn-outline-secondary btn-sm dropdown-close-btn">
                ...
                <div class="table-modern">
                    <div class="card-header">
                        ...
                        <div class="searchWrap float-end" id="personel_anket">
                            <div class="btn-group mb-2">
                                <button class="btn btn-dark btn-sm dropdown-toggle filtrele" type="button" data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false">
                                    Filtrele <i class="mdi mdi-chevron-down"></i>
                                </button>
                                 <div class="dropdown-menu dropdown-menu-end p-3" style="min-width: 300px;">
                                    <div class="item">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-4">Tarih Aralığı:</label>
                                            <div class="col-sm-8">
                                                <input id="daterange" class="form-control form-control-sm tarih-araligi" readonly />
                                                <div class="tarihAraligi mt-2 mb-2">
...
function closeDropdown(dropdownElement) {
    ...
    $(dropdownElement).find('.dropdown-toggle').attr('aria-expanded', 'false');
}
...
$(document).ready(function () {
    ...
    $('#daterangeResults').daterangepicker({
        ...
        endDate: end_date,
        parentEl: 'body', // Dropdown dışına taşı
        locale: {
            format: 'DD-MM-YYYY',
            separator: ' - ',
            applyLabel: 'Uygula',
        ...
        loadSurveyResults();
        // Tarih seçildiğinde dropdown'u kapat
        closeDropdown($('#daterangeResults').closest('.dropdown'));
    });
    ...
    $('#daterange').daterangepicker({
        ...
        // Tarih seçildiğinde dropdown'u kapat
        closeDropdown($('#daterange').closest('.dropdown'));
    });
    ...
    // Dropdown click event kontrolü - sadece daterangepicker açılırken dropdown'un kapanmasını engelle
    $('.dropdown-menu').on('click', 'input.tarih-araligi', function(e) {
        e.stopPropagation();
    });

    // Daterangepicker açılma/kapanma event'leri
    $('.tarih-araligi').on('show.daterangepicker', function() {
        $(this).closest('.dropdown-menu').addClass('keep-open');
    });
    
    $('.tarih-araligi').on('hide.daterangepicker', function() {
