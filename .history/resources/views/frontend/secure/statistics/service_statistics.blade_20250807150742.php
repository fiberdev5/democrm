...
<script>
document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('istatistikAra');

    // Select ve input alanlarını seç
    const selects = form.querySelectorAll('select');
    const dates = form.querySelectorAll('input[type="date"]');

    // Selectbox değiştiğinde formu gönder
    ...
    // Tarihler değiştiğinde formu gönder
    ...
    // Hızlı filtre butonları için: tarihleri değiştirip formu gönder
    ['lastYear', 'lastMonth', 'lastWeek', 'yesterday', 'today'].forEach(id => {
