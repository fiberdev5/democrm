...
<div class="mb-2">
    ...
    <div>
        <div class="d-flex flex-wrap gap-1">
            <button type="button" class="btn btn-sm btn-outline-secondary quick-date" data-start="{{ now()->subYear()->format('Y-m-d') }}" data-end="{{ now()->format('Y-m-d') }}">Son 1 Yıl</button>
            <button type="button" class="btn btn-sm btn-outline-secondary quick-date" data-start="{{ now()->subMonth()->format('Y-m-d') }}" data-end="{{ now()->format('Y-m-d') }}">Son 1 Ay</button>
            <button type="button" class="btn btn-sm btn-outline-secondary quick-date" data-start="{{ now()->subDays(7)->format('Y-m-d') }}" data-end="{{ now()->format('Y-m-d') }}">Son 7 Gün</button>
            <button type="button" class="btn btn-sm btn-outline-secondary quick-date" data-start="{{ now()->subDay()->format('Y-m-d') }}" data-end="{{ now()->subDay()->format('Y-m-d') }}">Dün</button>
            <button type="button" class="btn btn-sm btn-outline-secondary quick-date" data-start="{{ now()->format('Y-m-d') }}" data-end="{{ now()->format('Y-m-d') }}">Bugün</button>
        </div>
    </div>
</div>
