                                ...
                                <div class="dropdown-menu">
                                    <div class="item">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-select form-select-sm ilSelect">
                            ...
                            <thead class="title">
                                <tr>
                                    <th>
                                        ...
                                        <span class="d-none d-lg-inline">İlçe</span>
                                        <span class="d-lg-none">İlçe</span>
                                    </th>
                                    <th>
                                        <i class="fas fa-clipboard-list me-2 d-none d-lg-inline"></i>
                                        <span class="d-none d-lg-inline">Toplam Servis</span>
...
$(document).ready(function () {
    ...
    // İl seçimi değiştiğinde tabloyu yenile ve her iki select'i senkronize et
    $('.ilSelect').on('change', function() {
        var selectedValue = $(this).val();
        $('.ilSelect').val(selectedValue);
        if (typeof table !== 'undefined') {
            table.draw();
        }
    });
    ...
    var table = $('#datatableIlceStats').DataTable({
        ...
        ajax: {
            ...
            data: function(data) {
                ...
                // İl filtresini ekle - görünür olan select'ten al
                var activeIlSelect = $('.ilSelect:visible').first();
                if (activeIlSelect.length) {
                    data.il = activeIlSelect.val();
                } else {
                    data.il = $('.ilSelect').first().val();
                }
            }
        },
        columns: [
            { 
                ...
                render: function(data, type, row) {
                    return `<div style="display:flex; align-items:center;">
                                <span>${data}</span>
                                <small class="text-muted ms-2 d-none d-lg-inline">(${row.ilName})</small>
                            </div>`;
                }
            },
            { 
