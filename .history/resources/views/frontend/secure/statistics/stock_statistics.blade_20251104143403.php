   ...
   <link href="{{ asset('frontend/css/statistics/stock_statistics.css') }}" rel="stylesheet" type="text/css" />
    ...
    <script>
        ...
        $(document).ready(function () {
           Evet, burada da aynı sorun var. Daterangepicker açıldığında dropdown kapanıyor. Çözümü ekleyelim:
ÇÖZÜM:
İlk <script> bloğunun içine (satır 72'den sonra, $(document).ready içine) aşağıdaki kodu ekleyin:
javascript$(document).ready(function () {
    ...
    // ✅ DROPDOWN KAPANMASINI ENGELLEYEN KOD - BURAYA EKLE
    ...
    // ✅ DROPDOWN KAPANMASINI ENGELLEYEN KOD SONU
