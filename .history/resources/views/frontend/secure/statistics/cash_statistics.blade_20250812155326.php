    ...
    <div class="row">
        <div class="sol col-sm-6">
            <ul>
                {{-- Nakit --}}
                <li class="gider">
                    <div class="renk" style="background:#34a853"></div> {{-- Nakit için yeşil renk --}}
                ...
                {{-- EFT/Havale --}}
                <li class="gider">
                    <div class="renk" style="background:#e01010"></div> {{-- EFT için kırmızı renk --}}
                ...
                {{-- Kredi Kartı --}}
                <li class="gider">
                    <div class="renk" style="background:#1a73e8"></div> {{-- Kredi Kartı için mavi renk --}}
                ...
                {{-- Toplam --}}
                <li class="gider">
                    <div class="renk" style="background: #000"></div> {{-- Toplam için siyah renk --}}
