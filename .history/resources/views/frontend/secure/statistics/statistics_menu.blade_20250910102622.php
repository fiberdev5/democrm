            ...
            <div class="row">
              <div class="col-12">
                <div class="statistics-menu">
                  ...
                  <a href="{{ route('stock.statistics', $tenant_id) }}" class="btn statistic-btn btn-depo mb-2" style="background-color:#6e4c1e; color: #fff;">
                    <i class="fas fa-warehouse"></i> Depo İstatistikleri
                  </a>
                  <a href="{{ route('ilce.statistics', $tenant_id) }}" class="btn statistic-btn btn-ilce mb-2" style="background-color:#1c3aa9; color: #fff;">
                    <i class="fas fa-map-marked-alt"></i> İlçe İstatistikleri
                  </a>
                  <a href="{{ route('survey.statistics', $tenant_id) }}" class="btn statistic-btn btn-anket mb-2" style="background-color:#4e6e3f; color: #fff;">
