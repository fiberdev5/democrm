                    ...
                    <div class="dropdown-menu dropdown-menu-end servisDrop p-3" style="min-width: 320px;">
                        <form id="istatistikAra" action="{{ route('statistics', $tenant_id) }}" method="get">
                            ...
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div class="flex-grow-1" style="min-width: ">
                                    ...
                                    <div class="tarihAraligi mt-2 mb-2">
                                        <button type="button" id="lastMonth" class="btn btn-sm btn-secondary me-1">Son 1 Ay</button>
                                        <button type="button" id="last15Days" class="btn btn-sm btn-secondary me-1">Son 15 Gün</button>
                                        <button type="button" id="lastWeek" class="btn btn-sm btn-secondary me-1">Son 7 Gün</button>
                                        <button type="button" id="yesterday" class="btn btn-sm btn-secondary me-1">Dün</button>
