...
<div class="btn-group mb-0">
    ...
    <div class="dropdown-menu dropdown-menu-end servisDrop p-3" style="min-width: 200px;">
        <form id="istatistikAra" action="{{ route('statistics', $tenant_id) }}" method="get">
            
            {{-- Personel --}}
            <div class="d-flex align-items-center mb-2">
                <label class="form-label me-2 mb-0" style="width: 120px;">Personel</label>
            ...
            {{-- Servis Kaynağı --}}
            <div class="d-flex align-items-center mb-2">
                <label class="form-label me-2 mb-0" style="width: 120px;">Servis Kaynağı</label>
            ...
            {{-- Başlangıç Tarihi --}}
            <div class="d-flex align-items-center mb-2">
                <label class="form-label me-2 mb-0" style="width: 120px;">Başlangıç</label>
            ...
            {{-- Bitiş Tarihi --}}
            <div class="d-flex align-items-center mb-2">
                <label class="form-label me-2 mb-0" style="width: 120px;">Bitiş</label>
            ...
            {{-- Hızlı Butonlar + Ara --}}
            <div class="mb-2 mt-2">
                <div class="btn-group flex-wrap mb-2 w-100" role="group">
