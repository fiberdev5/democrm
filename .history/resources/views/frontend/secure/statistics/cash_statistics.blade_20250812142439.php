    ...
    <div class="container-fluid">
        ...
        <div class="card kasaSonuclari" style="margin-bottom: 5px;">
            <div class="card-header sayfaBaslik" style="padding:5px!important;font-weight:500;font-size:18px;">
                {{-- DEĞİŞİKLİK: Ana başlık güncellendi --}}
            ...
            <div class="card-body">
                <div class="row">
                    {{-- DEĞİŞİKLİK: Sütun sınıfları responsive olacak şekilde güncellendi (col-lg-6 col-md-12) --}}
                    <div class="col-lg-6 col-md-12 gelirTablosu mb-4 mb-lg-0">
                        {{-- DEĞİŞİKLİK: Gelir alt başlığı eklendi --}}
                        ...
                        <div class="row">        
                            <div class="sag">
                                ...
                                {{-- DEĞİŞİKLİK: Grafik için sarmalayıcı div eklendi ve canvas'tan height kaldırıldı --}}
                     ...
                     {{-- DEĞİŞİKLİK: Sütun sınıfları responsive olacak şekilde güncellendi (col-lg-6 col-md-12) --}}
                    <div class="col-lg-6 col-md-12 giderTablosu">
                        {{-- DEĞİŞİKLİK: Gider alt başlığı eklendi --}}
...
myChart = new Chart(ctx, {
    ...
    options: {
        ...
        responsive: true,
        maintainAspectRatio: false, // Bu satır zaten vardı, doğru.
    }
});
</script>
...
myChart2 = new Chart(ctx2, {
    ...
    options: {
        ...
        responsive: true,
        maintainAspectRatio: false, // DEĞİŞİKLİK: Bu satır eklendi
    },
});
</script>

<script>
// GERİ KALAN JAVASCRIPT KODU DEĞİŞİKLİK GEREKTİRMEZ
// ...
...
<style>
/* DEĞİŞİKLİK: Grafik sarmalayıcı için stil eklendi */
.chart-container {
    position: relative;
    height: 300px; /* Grafikler için sabit bir yükseklik belirler */
    width: 100%;
}
