        ...
        <div class="col-lg-4">
            <div class="card shadow-sm servisSaatleriChart" style="height: 300px;">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs border-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active hourly-chart-tab" data-bs-toggle="tab" href="#hourlyToday" data-type="today" data-date="{{ date('Y-m-d') }}">Bugün</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hourly-chart-tab" data-bs-toggle="tab" href="#hourly7Days" data-type="7days">7 Gün</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hourly-chart-tab" data-bs-toggle="tab" href="#hourly15Days" data-type="15days">15 Gün</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hourly-chart-tab" data-bs-toggle="tab" href="#hourly30Days" data-type="30days">30 Gün</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body" style="height: calc(100% - 70px);">
                    <div class="tab-content h-100">
                        <div id="hourlyToday" class="tab-pane fade show active h-100">
                            <canvas id="saatAreaToday" style="height: 100% !important;"></canvas>
                        </div>
                        <div id="hourly7Days" class="tab-pane fade h-100">
                            <canvas id="saatArea7Days" style="height: 100% !important;"></canvas>
                        </div>
                        <div id="hourly15Days" class="tab-pane fade h-100">
                            <canvas id="saatArea15Days" style="height: 100% !important;"></canvas>
                        </div>
                        <div id="hourly30Days" class="tab-pane fade h-100">
                            <canvas id="saatArea30Days" style="height: 100% !important;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
