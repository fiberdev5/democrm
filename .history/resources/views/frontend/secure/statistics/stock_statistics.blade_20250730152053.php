    ...
    var table = $('#datatablePersonelDepoStats').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                searchable: false,
                render: function(data, type, row) {
                    var url = "{{ url($tenant_id . '/stoklar') }}?depo_personel_id=" + row.user_id;
                    return '<a href="' + url + '" target="_blank"  class="btn btn-action btn-sm" style="font-size:13px;padding:1px">Parçaları Göster</a>';
                }
            }
        ],
