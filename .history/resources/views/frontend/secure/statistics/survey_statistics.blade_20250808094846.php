            ...
            <div class="card-header">
                ...
                <div class="searchWrap float-end">
                    <div class="btn-group mb-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-3 personnel-filter-dropdown" style="min-width: 300px;">
                            <div class="item">
                                <div class="row mb-3">
                                    <label class="col-sm-4">Cihaz Türü:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="applyPersonnelFilters" class="btn btn-primary btn-sm w-100">
...
<style>
    /* Dropdown positioning ve responsive düzeltmeleri */
...
/* Dropdown içeriğinin tıklanmasında kapanmayı engelle */
.personnel-filter-dropdown .item {
    padding: 0;
}
...
/* Responsive dropdown düzeltmeleri */
@media (max-width: 992px) {
    ...
    /* Mobile backdrop */
    .personnel-filter-dropdown::before {
        content: '';
        position: fixed;
        top: 0;
        left: 0;
