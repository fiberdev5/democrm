                ...
                <div class="table-modern">
                    ...
                    <div class="card-body">
                        <table id="datatableOperatorStats" class="table table-hover mb-0">
                            <thead class="title">
                                <tr>
                                    <!-- Masaüstü için sütunlar -->
                                    <th class="d-none d-md-table-cell">
                                        <i class="fas fa-user me-2"></i>Operatör Adı
                                    </th>
                                    <th class="d-none d-md-table-cell">
                                        <i class="fas fa-clipboard-list me-2"></i>Toplam Servis Kaydı
                                    </th>
                                    <th class="d-none d-md-table-cell" style="width: 130px;">
                                        İşlemler
                                    </th>

                                    <!-- Mobil için sütunlar -->
                                    <th class="d-table-cell d-md-none">
                                        <i class="fas fa-user me-2"></i>Operatör
                                    </th>
                                    <th class="d-table-cell d-md-none">
                                        <i class="fas fa-clipboard-list me-2"></i>Toplam
                                    </th>
                                    <th class="d-table-cell d-md-none" style="width: 130px;">
                                        İşlem
                                    </th>
                                </tr>
                            </thead>
