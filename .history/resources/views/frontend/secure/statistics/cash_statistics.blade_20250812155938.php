...
myChart = new Chart(ctx, {
    ...
    options: {
        ...
        responsive: true,
        maintainAspectRatio: false, // Orantıyı koruma, hizalama için önemli
    }
});
</script>
...
myChart2 = new Chart(ctx2, {
    ...
    options: {
        ...
        legend: {
            display: false // Manuel liste oluşturduğumuz için grafiğin kendi etiketlerini kapattık
        },
        responsive: true,
        maintainAspectRatio: false, // Orantıyı koruma, hizalama için önemli
    },
...
<style>
/* Stil kodunu tekrar kullanmak için herhangi bir değişiklik gerekmez */
.gider {
    display: flex;
    align-items: center;
    margin-bottom: 5px;
