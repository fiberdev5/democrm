...
<div class="row mt-3">
    <div class="col-12">
        <div class="card bg-light shadow-sm"> {{-- Gölge ekleyerek daha modern bir görünüm --}}
            <div class="card-body">
                <h5 class="card-title text-center mb-4">Genel Anket Özeti</h5> {{-- Başlığı ortaya alıp alta biraz boşluk ekliyoruz --}}
                <div class="d-flex justify-content-around align-items-center flex-wrap"> {{-- Responsive olması için flex-wrap ekliyoruz --}}
                    <div class="text-center p-2 flex-fill"> {{-- Her bir metriği esnek ve dolgu ile ayarlıyoruz --}}
                        <p class="mb-1 text-muted small">Tamamlanan Servisler</p> {{-- Daha küçük ve silik metin --}}
                        <h3 class="text-primary fw-bold" id="totalCompletedServices">0</h3> {{-- Kalın ve birincil renk --}}
                    </div>
                    <div class="vr mx-3 d-none d-md-block"></div> {{-- Masaüstünde dikey çizgi, mobilde gizliyoruz --}}
                    <div class="text-center p-2 flex-fill">
                        <p class="mb-1 text-muted small">Yapılan Anketler</p>
                        <h3 class="text-success fw-bold" id="totalSurveyedServices">0</h3> {{-- Kalın ve başarı rengi --}}
                    </div>
                </div>
            </div>
        </div>
