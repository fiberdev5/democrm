            ...
            <div class="col-lg-4">
                <div class="card shadow-sm servisSaatleriChart" style="height: 300px;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <!-- Tab Navigation -->
                            <ul class="nav nav-tabs border-0 me-3" role="tablist">
                                <li class="nav-item">
                            ...
                            <!-- Tarih Seçimi -->
                            <input type="date" name="saatTarih" class="form-control form-control-sm saatTarih" style="max-width: 120px;" value="{{ date('Y-m-d') }}">
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Tarih değiştirildiğinde - sadece 7 gün tab'ı aktifse güncelle
    document.querySelector('.saatTarih').addEventListener('change', function() {
        ...
        // Eğer 7 gün tabı aktifse chart'ı güncelle (tarih spesifik veri için)
        const sevenDaysTab = document.querySelector('.hourly-tab[data-type="7days"]');
        if (sevenDaysTab.classList.contains('active')) {
            loadHourlyChart('today', 'saatArea7', hourlyColors['7days'], formattedDate);
        }
    });
});
</script>
