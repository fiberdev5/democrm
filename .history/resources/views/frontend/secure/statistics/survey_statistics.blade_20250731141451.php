...
<div class="row mt-3 justify-content-center">
    <div class="col-md-8 col-lg-6"> {{-- Daha küçük bir sütun genişliği seçerek ortaya hizalıyoruz --}}
        <div class="card bg-light">
            <div class="card-body text-center">
                <h5 class="card-title mb-3">Genel Anket Özeti</h5>
                <div class="d-flex justify-content-around align-items-center"> {{-- Flexbox ile yan yana hizalama --}}
                    <div>
                        <p class="mb-0 text-muted">Tamamlanan Servisler</p>
                        <h3 class="text-primary" id="totalCompletedServices">0</h3>
                    </div>
                    <div class="vr"></div> {{-- Dikey çizgi ayırıcı --}}
                    <div>
                        <p class="mb-0 text-muted">Yapılan Anketler</p>
