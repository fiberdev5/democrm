...
<div class="page-content servis-istatistik">
    ...
    <div class="col-8">
        <div class="d-flex flex-wrap align-items-center gap-2">
            <input type="text" name="tarih1" id="tarih1" class="form-control datepicker" readonly 
                   value="{{ date('d/m/Y', strtotime('-31 days')) }}" style="background:#fff; max-width: 130px;">
            <span>-</span>
            <input type="text" name="tarih2" id="tarih2" class="form-control datepicker" readonly 
                   value="{{ date('d/m/Y') }}" style="background:#fff; max-width: 130px;">

            <!-- Butonlar -->
            <div class="tarih-butonlari d-flex flex-wrap gap-1 ms-3">
