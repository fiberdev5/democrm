...
.table-modern tbody tr:hover {
    background: linear-gradient(135deg, rgba(255,165,0,0.1) 0%, rgba(255,140,0,0.1) 100%) !important; /* !important eklendi */
...
.avatar {
    ...
    height: 35px;
    border-radius: 50%;
    /* Sarı-turuncu tonlu gradyan */
    background: linear-gradient(135deg, #FFD700 0%, #FFA500 100%); /* Altın sarısı ile turuncu arası geçiş */
    display: flex;
    align-items: center;
    justify-content: center;
    color: white; /* Yazı rengini hala beyaz tutuyoruz */
    font-weight: bold;
    margin-right: 10px;
}
