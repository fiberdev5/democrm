                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="2" class="text-start">
                                            <strong>Toplam Tamamlanan Servis:</strong> <span id="totalCompletedServices">0</span>
                                        </td>
                                        <td colspan="2" class="text-start">
                                            <strong>Toplam Yapılan Anket:</strong> <span id="totalSurveyedServices">0</span>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
            ...
            success: function (response) {
                ...
                if (Object.keys(response.groupedSurveys).length > 0) {
                    Object.values(response.groupedSurveys).forEach(function(personel) {
                        ...
                        // Personel bazında tamamlanan servis sayısını doğru yerden almalı
                        // Eğer bu bilgi personel objesi içinde gelmiyorsa, backend'den bu bilgiyi de çekmen gerekecektir.
                        // Şimdilik varsayılan olarak 0 bırakılmıştır, doğru veri kaynağına göre düzeltmelisin.
                        tableHtml += '<td><strong>' + (personel.completed_services_count || 0) + '</strong></td>'; 
