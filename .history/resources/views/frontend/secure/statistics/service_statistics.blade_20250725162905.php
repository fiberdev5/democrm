...
$(document).ready(function () {
    ...
    document.getElementById('lastYear').addEventListener('click', function(e) {
        ...
        e.stopPropagation(); // Bu satırı ekledik!
    ...
    // İsteğe bağlı: Dropdown menünün içine tıklayınca da kapanmasını engellemek için
    // Eğer Personel veya Servis Kaynağı seçimlerinden sonra da kapanmasını istemiyorsanız bu eklenebilir.
    // Ancak sadece hızlı tarih butonları için yeterliyse bu koda ihtiyacınız olmayabilir.
