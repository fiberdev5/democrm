    ...
    <div class="container-fluid">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card h-100 border-0 bg-light">
                                        <div class="card-header bg-danger text-white">
                                            <h6 class="mb-0"><i class="fas fa-users me-1"></i>Personeller</h6>
                                        </div>
                                        <div class="card-body p-2">
        ...
        @else
            ...
            <div class="period-statistics">
                <!-- Compact Tab Headers -->
                <div class="period-tabs-compact d-flex flex-wrap gap-2 mb-3">
                    @foreach($periodStats as $key => $period)
                        <button class="period-tab-compact btn btn-outline-primary {{ $key === 'bugun' ? 'active' : '' }}" 
                                data-period="{{ $key }}" 
...
.period-tabs-compact .period-tab-compact {
    border-radius: 0;
    font-size: 0.85rem;
    padding: 12px 8px;
    border: none;
...
.period-tabs-compact .period-tab-compact:last-child {
    border-right: none;
}

.period-tabs-compact .period-tab-compact:hover {
    background: #e3f2fd;
    color: #1976d2;
    transform: translateY(-1px);
}

.period-tabs-compact .period-tab-compact.active,
.period-tabs-compact .period-tab-compact[aria-expanded="true"] {
    background: #2196f3;
    color: #fff;
    font-weight: 600;
...
.period-tabs-compact .period-tab-compact.active .badge,
.period-tabs-compact .period-tab-compact[aria-expanded="true"] .badge {
    background: rgba(255,255,255,0.2) !important;
    color: #fff !important;
}

.period-statistics .collapse {
