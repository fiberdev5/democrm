        ...
        <div class="row mb-3 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <div class="input-group" style="height: 30px !important">
                    <input type="date" class="form-control" style="width:57px" id="start_date" value="{{ date('Y-m-d', strtotime('-30 days')) }}">
                    <span class="input-group-text px-1" style="height:28px !important">-</span>
                    <input type="date" class="form-control"  style="width:57px" id="end_date" value="{{ date('Y-m-d') }}">
                </div>
            </div>
