        ...
        <div class="row mb-3 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <div class="input-group" style="margin-top: 2px;">
                    <input type="text" class="form-control" id="start_date" value="{{ date('Y-m-d', strtotime('-30 days')) }}" placeholder="YYYY-MM-DD">
                    <span class="input-group-text px-1" style="font-size: 12px;">-</span>
                    <input type="text" class="form-control" id="end_date" value="{{ date('Y-m-d') }}" placeholder="YYYY-MM-DD">
                </div>
            </div>
