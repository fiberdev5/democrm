        ...
        <div class="row mb-3 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <div class="input-group" style="margin-top: 2px;">
                    <input type="date" class="form-control" id="start_date" value="{{ date('Y-m-d', strtotime('-30 days')) }}" style="-webkit-calendar-picker-indicator: { display: none; } ::-webkit-calendar-picker-indicator { opacity: 0; }">
                    <span class="input-group-text px-1" style="font-size: 12px;">-</span>
                    <input type="date" class="form-control" id="end_date" value="{{ date('Y-m-d') }}" style="-webkit-calendar-picker-indicator: { display: none; } ::-webkit-calendar-picker-indicator { opacity: 0; }">
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="search_input" placeholder="IP, kullanıcı adı veya açıklama ile arama yapın...">
            </div>
