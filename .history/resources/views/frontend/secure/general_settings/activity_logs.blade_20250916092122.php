...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row mb-1 align-items-end">
            ...
            <div class="col-md-2">
                <label class="form-label small">İşlem Türü</label>
            ...
            <div class="col-md-2">
             ...
             <div class="col-md-1">
                ...
                <input type="date" class="form-control form-control-sm" id="start_date" value="{{ date('Y-m-d', strtotime('-30 days')) }}">
            </div>
            <div class="col-md-1">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control form-control-sm" id="search_input" placeholder="IP, kullanıcı, açıklama, servis ID...">
                <button class="btn btn-outline-secondary" onclick="loadLogs()">
                            <i class="fas fa-search"></i>
                </button>
            </div>
            <div class="col-md-3 text-end">
                <button class="btn btn-primary btn-sm me-1" onclick="loadLogs()" title="Ara">
                    <i class="fas fa-search"></i>
                </button>
...
<!-- Filtreler ve Arama - CSS eklemeleri -->
<style>
.compact-filters {
    gap: 6px !important;
}
...
<!-- Filtreler ve Arama - Güncellenmiş yapı -->
<div class="row mb-3 align-items-end compact-filters">
    ...
    <div class="col-md-1">
        <label class="form-label">Kayıt</label>
        <select class="form-select" id="per_page" onchange="loadLogs()">
