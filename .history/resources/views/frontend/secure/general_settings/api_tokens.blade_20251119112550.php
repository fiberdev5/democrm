                    ...
                    <div class="card-body">
                        ...
                        @if($apiToken)
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="apiTokenInput" value="{{ $apiToken->plain_token }}" readonly>
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-warning updateApiToken" data-bs-toggle="modal" data-bs-target="#apiTokenModal">
                                    <i class="fas fa-sync-alt"></i> Token'ı Yenile
                                </button>
                                
                                <button class="btn btn-{{ $apiToken->is_active ? 'secondary' : 'success' }} toggleApiToken">
                                    <i class="fas fa-power-off"></i> {{ $apiToken->is_active ? 'Pasif Yap' : 'Aktif Yap' }}
                                </button>

                                <button class="btn btn-danger deleteApiToken">
                        ...
                        @else
                            ...
                            <div class="alert alert-warning">
                                ...
                                <hr>
                                <button class="btn btn-success createApiToken" data-bs-toggle="modal" data-bs-target="#apiTokenModal">
                        ...
                        <div class="alert alert-secondary">
                            <h5><i class="fas fa-book me-2"></i>API Kullanımı</h5>
                            <p class="mb-2"><strong>Endpoint:</strong></p>
                            <code>POST {{ url('/') }}/api/v1/public/customers</code>
                            
                            <p class="mb-2 mt-3"><strong>Headers:</strong></p>
                            <pre class="bg-light p-2 rounded"><code>Authorization: Bearer YOUR_API_TOKEN
Content-Type: application/json</code></pre>

                            <p class="mb-2 mt-3"><strong>Örnek İstek Body:</strong></p>
    ...
    "il": "İstanbul",
    "ilce": "Kadıköy",
    "adres": "Örnek Mahallesi, Test Sokak No:1",
    "tcNo": "12345678901"
}</code></pre>

                            <a href="{{ url('/') }}/{{ $firma->id }}/api-dokumantasyon" class="btn btn-info mt-2" target="_blank">
                                <i class="fas fa-external-link-alt"></i> Detaylı API Dokümantasyonu
                            </a>
                        </div>
