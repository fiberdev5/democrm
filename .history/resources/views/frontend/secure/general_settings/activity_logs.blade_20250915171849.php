        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" class="form-control" id="search_input" placeholder="IP, kullanıcı adı, servis ID veya açıklama ile arama yapın...">
...
function createPagination(pagination) {
    ...
    $('#log_count').text(`${pagination.total} kayıt`);
}
