...
function updateDetailedInfo(details) {
    ...
    // Diğer dosyalar
    const otherCount = details.other_files?.total_count || 0;
    //const otherSize = details.other_files?.total_size_formatted || '0 B';
    //document.getElementById('otherFilesCount').textContent = `${otherCount} dosya (${otherSize})`;
    document.getElementById('otherFilesCount').textContent = `${otherCount} dosya`;
}
