...
<div class="row mt-3 mb-2">
    <div class="col-12">
      <div class=" d-sm-flex align-items-center justify-content-center">
        <h4 class="mb-sm-0 fw-bold text-gray pb-2" style="font-size: 19px;">Api Token Ayarları</h4>
      </div>
    </div>
  </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('api.tokens.toggle', [$tenant_id,$token->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('PUT')
                                            ...
                                            <form action="{{ route('api.tokens.destroy', [$tenant_id,$token->id]) }}" method="POST" style="display: inline;" onsubmit="return confirm('Bu token\'ı silmek istediğinize emin misiniz?')">
                                                @csrf
                                                @method('DELETE')
...
<div class="modal fade" id="createTokenModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('api.tokens.store', $tenant_id) }}" method="POST">
                @csrf
