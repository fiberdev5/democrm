<div class="row mt-3 mb-2">
  <div class="col-12">
    <div class=" d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0" style="font-size: 13px;">Firma Ayarları</h4>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        <form id="companySettings" method="post" action="{{ route('update.firma',$firma->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate style="width: 50%;">
          ...
          <div class="row mb-3">
            <label class="col-sm-4 col-form-label">Personel Sayısı:</label>
            <div class="col-sm-8">
              <input class="form-control" name="personel_sayisi" type="text" value="{{ $firma->personelSayisi}}">
            </div>
          </div>
          <!-- end row -->

          <div class="row mb-3">
            <label class="col-sm-4 col-form-label">Bayi Sayısı:</label>
            <div class="col-sm-8">
              <input class="form-control" name="bayiSayisi" type="text" value="{{ $firma->bayiSayisi}}">
            </div>
          </div>
          <!-- end row -->
