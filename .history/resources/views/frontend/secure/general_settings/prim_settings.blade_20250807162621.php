<div class="row mt-3 mb-2">
    <div class="col-12">
      <div class=" d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0" style="font-size: 13px;">Prim Sistemi Ayarları</h4>
      </div>
    </div>
  </div>
        ...
        <div class="card-body">
          <form id="primSettings" method="post" action="{{ route('update.firm.prim',$firma->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate style="width: 50%;">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input class="form-control" name="operatorPrim" type="number" value="{{ $prim->operatorPrim}}" required>
              </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input class="form-control" name="operatorPrimTutar" type="number" value="{{ $prim->operatorPrimTutari}}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input class="form-control" name="teknisyenPrim" type="number" value="{{ $prim->teknisyenPrim}}" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input class="form-control" name="teknisyenPrimTutari" type="number" value="{{ $prim->teknisyenPrimTutari}}" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input class="form-control" name="atolyePrim" type="number" value="{{ $prim->atolyePrim}}" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input class="form-control" name="atolyePrimTutari" type="number" value="{{ $prim->atolyePrimTutari}}" required>
                </div>
              </div>
