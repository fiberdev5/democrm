<link href="{{ asset('frontend/css/general_settings/settings_menu.css') }}" rel="stylesheet" type="text/css" />
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu" style="">
          ...
          <a class="dropdown-item nav26" data-bs-toggle="pill" href="#tab26" data-id="" role="tab">
              <i class="fas fa-file-contract custom-icon"></i>Kullanım Koşulları & Gizlilik Politikası
          </a>
