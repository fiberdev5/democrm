    ...
    <div class="card-body">
        ...
        <div class="row mb-3 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <input type="text" class="form-control form-control-sm" id="search_input" placeholder="IP, kullanıcı adı...">
            </div>
            <div class="col-auto">
    ...
    if (pagination.last_page > 1) {
        ...
        if (pagination.current_page > 1) {
            html += `<li class="page-item">
                        <a class="page-link" href="#" onclick="event.preventDefault(); loadLogs(${pagination.current_page - 1})">Önceki</a>
                    </li>`;
        }
        ...
        if (pagination.current_page < pagination.last_page) {
            html += `<li class="page-item">
                        <a class="page-link" href="#" onclick="event.preventDefault(); loadLogs(${pagination.current_page + 1})">Sonraki</a>
                    </li>`;
        }
