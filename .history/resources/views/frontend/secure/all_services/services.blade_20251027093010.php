...
@section('user')
 <!-- <script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>-->
  ...
  <style>
    ...
    #datatableService_wrapper {
    min-height: 500px;
    opacity: 0;
    transition: opacity 0.3s ease-in-out;
}

#datatableService_wrapper.ready {
    opacity: 1;
}
  </style>
...
<script type="text/javascript">
  ...
  <script>
    $(document).ready(function () {
      ...
      // DataTable wrapper'ı gizle
      $('#datatableService_wrapper').css('opacity', '0');
      ...
      var table = $('#datatableService').DataTable({
        ...
        "initComplete": function (settings, json) {
          ...
          // Son olarak her şeyi göster
      setTimeout(function() {
        $('#datatableService_wrapper').addClass('ready');
        $('.kullanici_teknisyenfiltre').css({ 
          visibility: 'visible', 
          opacity: 1 
        });
      }, 100);
