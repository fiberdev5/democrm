        ...
        <div class="card">
          ...
          <div class="card-body">
            @if(auth()->user()->can('Tüm Servisleri Görebilir'))
                ...
                <a  type="button" class="btn btn-success btn-sm gelenCagriButon" data-bs-toggle="modal" data-bs-target="#gelenCagriModal"><div class="text">Gelen Çağrılar <i data-toggle="tooltip" title="" class="fas fa-info-circle" data-bs-original-title="Toplu servis yönlendirmeleri yapmak için kullanılır."></i></div></a>
...
<script>
  var getUrlParameter = function getUrlParameter(sParam) {
    ...
    if(mid){
      $.ajax({
        url:  url: "/" + firma_id + "/servis/duzenle/" + mid
      }).done(function(data) { 
        if($.trim(data)==="-1"){
          window.location.reload(true);
        }else{
