        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="datatableService" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <button type="button" class="btn btn-primary btn-sm anketRaporlaModalBtn" data-toggle="modal" data-target="#anketRaporlaModal">Anketler</button>
...
<div id="anketRaporlaModal" class="modal fade" style="padding-top: 50px;background: rgba(0, 0, 0, 0.50);">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
