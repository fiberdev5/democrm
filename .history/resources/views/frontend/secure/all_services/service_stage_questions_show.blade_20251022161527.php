                    ...
                    <div class="col-lg-12"> 
                        ...
                        @elseif(str_contains($stage->cevapTuru, 'Grup'))
                            @php
                                ...
                                $roller = [];
                                $isRequired = true; // Varsayılan olarak zorunlu

                                // Eğer Grup-5 varsa zorunlu olmamalı
                                if (in_array('5', $grupKodlari)) {
                                    $roller = ['Teknisyen', 'Yardımcı Teknisyen'];
                                    $isRequired = false; // Grup-5 zorunlu değil
                                } elseif (in_array('4', $grupKodlari)) {
                                    $roller = ['Teknisyen'];
                                    $isRequired = true; // Grup-4 zorunlu
                                } elseif (count(array_intersect($grupKodlari, ['261', '262'])) > 0) {
