                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8 rw2">
                                <input type="date" class="form-control datepicker planTarih" 
                                        value="{{ $tomorrow }}" style="background:#fff">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    // İlk yüklemede seçili ilin ilçelerini getir
    loadDistricts(document.getElementById('il').value);
...
function loadDistricts(cityId) {
    $('#ilce').html('<option value="" selected>HEPSİ</option>');

    $.get('{{ route('service.districts', $firma->id) }}',   // route sabit
        { city_id: cityId },                                 // GET parametresi
        function (districts) {
