  ...
  <div class="row align-items-center">
          ...
          <button type="button"
            ...
            <div class="d-flex  justify-content-center align-items-center text gap-2">
              ...
              <i class="fas fa-info-circle d-none d-md-inline" data-toggle="tooltip"
                title="Servisleri göster butonu solda seçilen teknisyene ait sadece bugün atanan servisleri listelemeye yaramaktadır.">
              </i>
            </div>
          </button>
        </div>
    ...
    <div class="col-md-4 custom-p-min custom-p-r-min">
      ...
      data-pers="{{ $dataPers }}" @endif>Atama Yap 
        <i class="fas fa-info-circle d-none d-md-inline" data-toggle="tooltip"
                title="Atama yap butonu listeleme yaptığınız servislere personel atamak için kullanılır. Atama yaparken belirli bir tarih seçilmediği sürece otomatik yarına atanmaktadır.">
              </i>
    </button>
    </div>
  </div>
