...
<script>
  $(document).ready(function() {
    ...
    $(document).on('hidden.bs.modal', '.modal', function() {
      ...
      // SADECE bu modalı hariç tutun
  if (modalId === 'personelServisDuzenleModal') {
    return; // Bu modal için hiçbir şey yapma
  }
    ...
    // Modal açıldığında ve kapandığında log tutun
$('#personelServisDuzenleModal').on('show.bs.modal', function() {
    console.log('Modal açılıyor...');
});

$('#personelServisDuzenleModal').on('shown.bs.modal', function() {
    console.log('Modal açıldı');
});

$('#personelServisDuzenleModal').on('hide.bs.modal', function() {
