    ...
    <tbody>
      @forelse($services as $service)
        <tr>
          ...
          <td style="vertical-align: middle;font-size: 11px; padding: 3px 10px;cursor:pointer;" class="personelServisDuzenle" data-bs-id="{{$service->id}}" data-name=""><strong>{{ $service->musteri->state->ilceName }}</strong></td>
...
<div id="personelServisDuzenleModal" class="modal fade" data-bs-backdrop="static" tabindex='-1'>  {{--data-bs-backdrop="static" data-bs-keyboard="false"  modalın hemen kapanmaması için bunu eklemiştim. Eğer eklenmesi gerekirse aria-hidden in yanına ekleyebilirsin--}}
