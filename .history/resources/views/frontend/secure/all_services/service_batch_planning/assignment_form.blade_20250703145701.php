...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // Listeyi yenile
            $.ajax({
                url: "/{{ $tenant_id }}/servis-liste-getir",
                data: {
                    planTarih: $('.planTarih').val(),
                    il: $('.il').val(),
                ...
                success: function (html) {
                    $('.servisListe').html(html);
                },
                error: function () {
                    $('.servisListe').html('<div class="alert alert-danger">Servis listesi alınamadı.</div>');
                }
            });
        }
    });
