...
<div id="personelServisDuzenleModal" class="modal fade" tabindex='-1' style="padding-top: 20px;background: rgba(0, 0, 0, 0.50);">  {{--data-bs-backdrop="static" data-bs-keyboard="false"  modalın hemen kapanmaması için bunu eklemiştim. Eğer eklenmesi gerekirse aria-hidden in yanına ekleyebilirsin--}}
