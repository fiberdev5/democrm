...
// Event delegation ile modal açma
    $(document).on('click', '.personelServisDuzenle', function(e){
        ...
        $.ajax({
            ...
            $('#personelServisDuzenleModal .modal-body').html('<div class="alert alert-danger">Servis bilgileri yüklenirken bir hata oluştu.</div>');
        });
    });
</script>
