<form method="POST" id="topluPlanKaydet" style="padding:0 10px;">
    @csrf 
...
$(document).ready(function() {
    ...
    $("#topluPlanKaydet").on('submit', function(e) {
        ...
        var firma_id = {{$tenant_id}};
        $.ajax({
            url: "/" + firma_id + "/servis-atama"
            type: 'POST',
            ...
            success: function(response) {
                ...
                if (response.success) {
                    alert("Planlama başarıyla tamamlandı."); // Başarı mesajını göster
