    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.consignment-device-select', function() {
            ...
            if (selectedValue) {
                ...
                quantityInput.val(1); // Set initial quantity to 1
                ...
                hiddenInput.val(''); // Clear hidden input if no device selected
            }
        });
        ...
        $(document).on('change keyup', '.quantity-input', function() {
            ...
            var quantity = parseInt($(this).val()); // Ensure quantity is an integer
        ...
        $('.consignment-device-select').each(function() {
            ...
            if (selectedOption.val()) {
                ...
                // Initialize hidden input value correctly on page load if a device is selected
                hiddenInput.val(selectedOption.val() + '---' + quantityInput.val());

            } else {
                quantityGroup.hide(); // Hide if no device is selected initially
                hiddenInput.val(''); // Clear hidden input if no device selected initially
            }
        });
    });
</script>