...
<div id="incomingCallsSection" style="display: none; margin-top: 20px;">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fas fa-phone-alt"></i> Gelen Çağrılar Raporu
                <button type="button" class="btn btn-sm btn-secondary float-end" onclick="$('#incomingCallsSection').hide();">
...
<script>
  // Mevcut kodunuza eklenecek kısım
