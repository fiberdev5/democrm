...
/* Filtre butonu ve arama kutusu için başlangıç durumu */
#datatableService_wrapper .top {
    visibility: hidden;
    opacity: 0;
    transition: opacity 0.3s ease-in-out;
}

#datatableService_wrapper .top.ready {
    visibility: visible;
    opacity: 1;
}
  </style>
...
<script type="text/javascript">
  ...
  // Top container'ı görünür yap
  topContainer.addClass('ready');
