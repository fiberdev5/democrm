            ...
            <table id="datatableService" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              ...
              <div class="btn-group mb-2 ">
                ...
                <div class="dropdown-menu">
                  <div class="item">
                    <div class="row">
                      <label class="col-sm-4">Cihaz Marka:</label>
                      <div class="col-sm-8">
                  ...
                  <div class="item">
                    <div class="row">
                      <label class="col-sm-4">Servis Durumu:</label>
                      <div class="col-sm-8">
                  ...
                  <div class="item">
                    <div class="row">
                      <label class="col-sm-4">Servis Kaynağı:</label>
                      <div class="col-sm-8">
                        <select name="stages" id="stages" class="form-select">
                          <option value="">Hepsi</option>
                  ...
                  <div class="item">
                    <div class="row">
                      <label class="col-sm-4">İlçe:</label>
                      <div class="col-sm-8">
