...
<div class="row cardWrap2">
  <div class="col-sm-6">
    ...
    <div class="col-md-8 rw2">
        {{-- Buraya PHP kodunuzu ekleyin --}}
        @php
            $kullanilanKonsinyeArray = [];

            // plan değişkenindeki cevabı ayrıştır
            if (!empty($service_id->konsinye)) {
                $cevaplarArray = explode(', ', $service_id->konsinye);
        ...
        @else
            <span>Konsinye Cihaz Seçilmemiş</span>
        @endif
    </div>
</div>
