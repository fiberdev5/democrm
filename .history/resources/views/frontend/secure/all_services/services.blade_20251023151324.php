...
<script type="text/javascript">
  ...
  <script type="text/javascript">
  $(document).ready(function () {
    let topluPlanlamaYukleniyor = false; // çift tıklama koruması

    $(".servisPlanlaBtn").on("click", function (e) {
      e.preventDefault(); // form submit'ini tamamen engeller
      if (topluPlanlamaYukleniyor) return; // birden fazla istek olmasın
      topluPlanlamaYukleniyor = true;
      ...
      $.ajax({
        ...
        // Her durumda (başarılı veya hata) butonu yeniden aktif et
        topluPlanlamaYukleniyor = false;
      });
    });
  });
</script>
