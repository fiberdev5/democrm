...
@section('user')
  ...
  <script>
    $(document).ready(function () {
      ...
      function filterData() {
          console.log('filterData çağrıldı - filterType:', activeFilterType);
...
window.activeFilterType = activeFilterType;
      ...
      var table = $('#datatableService').DataTable({
        ...
        ajax: {
          ...
          type: 'GET',
          data: function (data) {
            console.log('AJAX ÇAĞRILDI - filterType:', activeFilterType);
            console.log('AJAX ÇAĞRILDI - filters:', activeFilters);
            ...
            //Raporlama filtreleri - Yeni obje oluştur
          data.filters = JSON.parse(JSON.stringify(activeFilters));
          data.filterType = activeFilterType ? activeFilterType : '';

            console.log('GÖNDERİLEN DATA:', data);
 ...
 window.activeFilters = {};
    window.activeFilterType = '';
    console.log('MARKA DEĞİŞTİ - Sonra:', activeFilterType, activeFilters);
    table.draw();
      });
