<div class="container">
  <div class="row">
    ...
    @elseif($soru->cevapTuru == "[Konsinye Cihaz]")
        @php
        dd($plan->cevap); // Planın mevcut cevabını görün
        dd($detailedConsignmentStocks->toArray()); // Detaylı konsinye stoklarını görün
        dd($currentConsignmentId, $currentConsignmentQuantity, $selectedConsignmentDeviceCurrentStock); // Çekilen ID ve adetleri görün
    @endphp
