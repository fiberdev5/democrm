...
<button type="button" class="btn btn-info btn-sm" onclick="openSurveyModal({{ $service_id->id }})" title="Müşteri Anketi">
    <i class="fas fa-poll"></i> Müşteri Anketi
</button>
