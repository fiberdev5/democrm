                ...
                <div class="dropdown-menu">
                  ...
                  <div class="item">
                      <div class="row">
                        ...
                        <div class="col-sm-8">
                          <input id="daterange2" class="tarih-araligi">
...
<script>
  $(document).ready(function () {
    ...
    $('#lastYear').on('click', function() {
        $('#daterange2').data('daterangepicker').setStartDate(lastYear);
        $('#daterange2').data('daterangepicker').setEndDate(today);
        // Filtreleme fonksiyonunu çağır
        filterData();
    });

    $('#lastMonth').on('click', function() {
        $('#daterange2').data('daterangepicker').setStartDate(lastMonth);
        $('#daterange2').data('daterangepicker').setEndDate(today);
        // Filtreleme fonksiyonunu çağır
        filterData();
    });
    ...
    $('#lastWeek').on('click', function() {
        $('#daterange2').data('daterangepicker').setStartDate(lastWeek);
        $('#daterange2').data('daterangepicker').setEndDate(today);
        // Filtreleme fonksiyonunu çağır
        filterData();
    });
    ...
    $('#yesterday').on('click', function() {
        $('#daterange2').data('daterangepicker').setStartDate(yesterday);
        $('#daterange2').data('daterangepicker').setEndDate(yesterday);
        // Filtreleme fonksiyonunu çağır
        filterData();
    });

    $('#today').on('click', function() {
        $('#daterange2').data('daterangepicker').setStartDate(today);
        $('#daterange2').data('daterangepicker').setEndDate(today);
        // Filtreleme fonksiyonunu çağır
        filterData();
    });
...
<script>
  $(document).ready(function () {
    ...
    function(start_date, end_date){
      $('#daterange2').html(start_date.format('DD-MM-YYYY') + '-' + end_date.format('DD-MM-YYYY'));
      table.draw();
    });
    ...
    var table = $('#datatableService').DataTable({
      ...
      ajax: {
        ...
        data: function(data) {
          ...
          data.from_date = $('#daterange2').data('daterangepicker').startDate.format('YYYY-MM-DD');
          data.to_date = $('#daterange2').data('daterangepicker').endDate.format('YYYY-MM-DD');
        }
      },
      'columns': [
