...
<!-- Anket Modalı -->
<div class="modal fade" id="anketModal" tabindex="-1" aria-labelledby="anketModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm"style="max-width: 500px; max-height: 500px; ">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Müşteri Anketi</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Kapat"></button>
      </div>
      <div class="modal-body" id="anketModalContent">
