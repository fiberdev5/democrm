            ...
            <tbody>
              @foreach($incoming_calls as $item)
                <tr data-id="{{$item->id}}">
                  ...
                  <td><a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Tarih:</div>{{ Carbon\Carbon::parse($item->created_at)->format('d/m/Y H:i')}}</a></td>
                  <td><a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Telefon:</div>{{$item->serviskaynak->kaynak}}</a></td>
