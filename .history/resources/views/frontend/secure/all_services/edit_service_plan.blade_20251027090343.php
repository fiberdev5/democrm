...
@if($soru->cevapTuru == "[Parca]")
    <div class="row form-group">
        <div class="col-lg-12">
            ...
            <div class="parcalar-dropdown myParcaList" data-soru-id="{{ $plan->id }}" style="width:100% display:block;">>
            ...
            <div class="konsinye-dropdown myKonsinyeList" style="width:100% display:block;">
...
$('.myParcaList, .myKonsinyeList').show();
