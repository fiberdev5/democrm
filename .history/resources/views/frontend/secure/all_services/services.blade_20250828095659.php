...
<style>
/* Servisler sayfası buton çakışması düzeltmesi */

/* Sağ taraftaki buton container'ı */
.card-body {
    display: flex;
    flex-wrap: wrap;
...
/* Sol taraftaki ana butonlar */
.card-body > a:not(.float-end *),
.card-body > button:not(.float-end *) {
    flex: 0 0 auto;
    margin: 2px;
}
...
@media (max-width: 1200px) {
    /* Sağdaki butonları alt satıra al */
    .searchWrap {
        order: 10;
        width: 100%;
    ...
    /* Filtrele dropdown'ını en sağa al */
...
@media (max-width: 992px) {
    ...
    /* Sol butonları flex container yap */
    .card-body > *:not(.searchWrap):not(#servicesTableSection):not(#incomingCallsSection) {
        margin: 2px;
        flex: none;
    }
    
    /* Sağ butonları küçük yap */
    .searchWrap .btn {
        font-size: 0.75rem;
...
@media (max-width: 768px) {
    ...
    /* Tüm butonları tek sütunda göster */
    .card-body {
        flex-direction: column;
        gap: 5px;
    }
...
@media (max-width: 576px) {
    ...
    /* Buton yazılarını kısalt */
    .btn-sm .text,
    .btn-sm span {
        font-size: 0.7rem;
    }
    
    /* Çok uzun buton isimlerini kısalt */
    .servisRaporlaModalBtn .text::after {
        content: "Raporlar";
    }
    
    .servisRaporlaModalBtn .text {
        font-size: 0;
    }
...
/* Tablo container'ını en alta al */
