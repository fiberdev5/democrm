        ...
        <div class="card">
          ...
          <div class="card-body">
            @if(auth()->user()->can('Tüm Servisleri Görebilir'))
              ...
              @if(Auth::check() && Auth::user()->hasAnyRole(['Teknisyen', 'Teknisyen Yardımcısı', 'Operatör', 'Atölye Ustası', 'Atölye Çırak']))
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('prim.kullanici') }}">
                        <i class="fas fa-money-bill-wave"></i> Primlerim
                    </a>
                </li>
              @endif
