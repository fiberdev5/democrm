...
@elseif($stage->cevapTuru == "[Konsinye Cihaz]")
    ...
    @php
        ...
        // Bu değişken, alanın zorunlu olup olmayacağını belirler.
        // Soru metninde 'Yardımcı' kelimesi geçmiyorsa, zorunlu olacaktır.
        // Eğer veritabanındaki sorunuz farklıysa ('Yardımcı Teknisyen' yerine '2. Teknisyen' gibi), 
        // lütfen 'Yardımcı' kelimesini uygun metinle değiştirin.
