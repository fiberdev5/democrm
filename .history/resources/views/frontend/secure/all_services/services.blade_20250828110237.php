...
<div class="page-content" id="customerTable">
  <div class="container-fluid">
    <div class="row pageDetail">
      <div class="col-12">
        <div class="card">
  <div class="card-header d-flex justify-content-between align-items-center sayfaBaslik">
    <span>Servisler</span>
    <div class="btn-group gap-1">
      <button type="button" class="btn btn-primary btn-sm servisRaporlaModalBtn" data-bs-toggle="modal" data-bs-target="#servisRaporlaModal">Raporlar</button>
      <button type="button" class="btn btn-primary btn-sm anketModalBtn" data-bs-toggle="modal" data-bs-target="#anketModal">Anketler</button>
      @if(Auth::check() && Auth::user()->hasAnyRole(['Operatör',]))
        <button type="button" class="btn btn-primary btn-sm kullaniciPrimGoster"  
                data-bs-toggle="modal" data-bs-target="#kullaniciPrimModal">
          Primlerim
        </button>
      @else
        <button type="button" class="btn btn-primary btn-sm primModalBtn" data-bs-toggle="modal" data-bs-target="#primModal">Primler</button>
      @endif
    </div>
  </div>
          <div class="card-body">
