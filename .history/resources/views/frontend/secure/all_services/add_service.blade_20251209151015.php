...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <button class="btn btn-success" type="button" id="addNewDeviceBrandBtn" title="Yeni Ekle">
        <i class="fas fa-plus"></i>
      </button>
    </div>
  </div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <button class="btn btn-success" type="button" id="addNewDeviceTypeServiceBtn" title="Yeni Ekle">
        <i class="fas fa-plus"></i>
      </button>
    </div>
  </div>
