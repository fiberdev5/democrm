                    ...
                    @elseif($soru->cevapTuru == "[Konsinye Cihaz]")
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8">
                                    ...
                                    if ($plan->cevap) {
                                        ...
                                        if ($currentConsignmentId) {
                                            ...
                                            if ($originalDevice) {
                                                ...
                                                // Eğer daha önce bu planla ilişkilendirilmiş bir stok hareketi varsa, o adedi geri eklemeliyiz.
                                ...
                                @if($currentConsignmentName && $currentConsignmentId) {{-- currentConsignmentId'nin de dolu olduğundan emin olun --}}
                                ...
                                <div class="consignment-quantity-group" id="consignmentQuantityGroup_{{ $plan->id }}" style="display: {{ $currentConsignmentId ? 'block' : 'none' }}; margin-top: 10px;">
                                    ...
                                    <input type="number"
                                            ...
                                            min="0" {{-- Adet 0 olabilir, yani cihaz kaldırılabilir --}}
...
$(document).ready(function() {
    ...
    function updateConsignmentCombinedValue($selectElement) {
        ...
        if (selectedValue && quantity > 0) {
            ...
            // Seçim yapılmamışsa veya adet 0 ise boşalt
            $hiddenInput.val('');
        }
