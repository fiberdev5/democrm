...
@elseif($stage->cevapTuru == "[Konsinye Cihaz]")
    ...
    {{-- Grup 4 ve/veya Grup 5 için özel işlem --}}
    @if(in_array('4', $grupKodlari) || in_array('5', $grupKodlari))
        
        {{-- Sadece Grup 4 varsa - Teknisyen --}}
        @if(in_array('4', $grupKodlari) && !in_array('5', $grupKodlari))
            @php
        ...
        {{-- Grup 5 de varsa - Teknisyen Yardımcısı --}}
