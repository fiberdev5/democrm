    ...
    var table = $('#datatableService').DataTable({
      ...
      ajax: {
        ...
        data: function(data) {
          ...
          // Raporlama filtreleri (accordion içinden gelen)
    data.filterType = activeFilterType || null;
    data.filters    = activeFilters || null;

    // DEBUG
    console.log('DataTables gönderilen parametreler:', data);
        }
      },
      'columns': [
