        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="datatableService" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <a href="{{route('incoming.calls', $firma->id)}}" type="button" class="btn btn-success btn-sm gelenCagriBtn"><div class="text">Gelen Çağrılar <i data-toggle="tooltip" title="" class="fas fa-info-circle" data-bs-original-title="Toplu servis yönlendirmeleri yapmak için kullanılır."></i></div></a>
