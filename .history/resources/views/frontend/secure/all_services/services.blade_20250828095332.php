...
<style>
  /* Servisler sayfası responsive düzeltmeleri */

/* Ana buton konteynerı */
.card-body {
    position: relative;
}

/* Butonları flex düzenine al */
.card-body > a,
.card-body > button {
    margin: 2px;
}

/* Küçük ekranlarda buton düzeni */
@media (max-width: 992px) {
    
    /* Primlerim butonunun position absolute'ını kaldır */
    .kullaniciPrimGoster[style*="position:absolute"] {
        position: static !important;
        left: auto !important;
    }
    
    /* Butonları flex container'a al */
    .card-body {
        display: flex;
        flex-wrap: wrap;
    ...
    /* Tablo konteynerını butonların altına al */
...
/* Tablet ekranlarda buton boyutlarını küçült */
@media (min-width: 768px) and (max-width: 991px) {
    ...
    .card-body .btn-sm .text {
        font-size: 0.7rem;
    }
}

/* Mobil ekranlarda butonları kompakt yap */
@media (max-width: 767px) {
    ...
    /* Icon ve text arasındaki boşluğu azalt */
    .card-body .btn-sm i {
        margin-right: 3px;
    }
    
    /* Çok küçük ekranlarda text'leri gizle, sadece iconları göster */
    @media (max-width: 480px) {
        .card-body .btn-sm span,
        .card-body .btn-sm .text {
            display: none;
        }
        ...
        /* Tooltip ekle - butonun ne işe yaradığını göster */
        .addService::after {
            content: "Servis Ekle";
            position: absolute;
            bottom: 100%;
...
@media (max-width: 576px) {
    ...
    .dropdown-menu.servisDrop .item {
        margin-bottom: 15px;
    }
    
    .dropdown-menu.servisDrop .tarihAraligi .btn {
        font-size: 0.7rem;
