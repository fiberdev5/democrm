...
@elseif($stage->cevapTuru == "[Konsinye Cihaz]")
    ...
    <div class="form-group">
        ...
        @if($teknisyenler->count())
            <select class="form-control" name="soru[{{ $stage->id }}]" id="teknisyen-{{ $stage->id }}" required>
    ...
    <div class="form-group mt-3">
        ...
        @if($teknisyenVeYardimcilari->count())
            <select class="form-control" name="soru[{{ $stage->id }}]" id="yardimci-teknisyen-{{ $stage->id }}">
                <option value="">-Seçiniz-</option>
