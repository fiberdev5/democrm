...
<div class="col-sm-6 c2" style="text-align: right;">
  ...
  <div class="input-group" style="width: 152px; display: inline-block;">
    <select class="form-control form-select servisReso" name="servisReso" style="width: 126px; display: inline-block;" required>
      <option value="">Seçiniz</option>
      @foreach($service_resources as $item)
        <option value="{{ $item->id }}">{{ $item->kaynak }}</option>
      @endforeach
    </select>
    <button class="btn btn-success btn-sm" type="button" id="addNewServiceResourceBtn" style="padding: 2px 6px;">+</button>
  </div>
</div>
        </div>
      </div>
...
<div class="row form-group ">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <button class="btn btn-success" type="button" id="addNewDeviceBrandBtn">+</button>
    </div>
  </div>
</div>
                <!-- Cihaz Türü -->
<div class="row form-group ">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <button class="btn btn-success" type="button" id="addNewDeviceTypeServiceBtn">+</button>
    </div>
  </div>
</div>
                <div class="row form-group">
...
<div class="modal fade" id="addServiceResourceModal" tabindex="-1" aria-hidden="true" style="background: rgba(0, 0, 0, 0.7); padding-top:100px;">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addServiceResourceForm" action="">
                    @csrf
