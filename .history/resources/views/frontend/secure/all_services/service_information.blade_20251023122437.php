...
<div class="servisAsamalari">
  <div class="card card3">
    ...
    <div class="checkmark" style="display: inline-block; width: 14px; height: 14px; border: 1px solid #fff; border-radius: 2px; position: relative; top: 2px; vertical-align: middle;">
