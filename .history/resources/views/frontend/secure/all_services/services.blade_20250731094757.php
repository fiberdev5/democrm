      ...
      ajax: {
        ...
        data: function(data) {
         ...
         //Operatör istatistikleri filtreleme için URL parametresi aktarma
          ...
          data.operator_id = getUrlParameter('ilceArama');
          data.opeator_istatistik_tarih1 = getUrlParameter('ilce_istatistik_tarih1');
          data.opeator_istatistik_tarih2 = getUrlParameter('ilce_istatistik_tarih2');
