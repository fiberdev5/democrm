  ...
  <table class="table table-hover table-striped" width="100%" cellspacing="0" style="margin: 0">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endif
        <td style="vertical-align: middle;font-size: 11px; padding: 0 10px;"><strong><a href="/teklifler?did={{$offer->id}}" class="btn btn-danger btn-sm editDomain" style="font-size:11px" target="_blank">Detaylar</a></strong></td>
      </tr>
      @endforeach
    </tbody>
  </table>
  @else
    <div style="color: black;text-align:center;">Teklif bulunmamaktadır</div>
  @endif
</div>
