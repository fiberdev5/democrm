...
<style>
/* Minimal responsive düzeltme - buton sırasını bozmaz */

/* Sadece çakışan butonları düzelt */
@media (max-width: 1400px) {
    ...
    /* Card body'yi flex yap ama sırayı bozmadan */
    .card-body {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    /* Sağdaki searchWrap'ı margin ile ayarla */
    .searchWrap {
        margin-left: auto;
    }
}

/* Sadece çok küçük ekranlarda butonları alt alta sırala */
@media (max-width: 992px) {
    ...
    /* Sol taraftaki butonları bir satırda tut */
    .card-body > a:not(.searchWrap *),
    .card-body > button:not(.searchWrap *) {
        margin: 2px;
    }
    
    /* SearchWrap'ı tam genişlik yap */
    .searchWrap {
        width: 100%;
        margin-left: 0;
        display: flex;
...
/* Mobil ekranlarda butonları küçült */
...
/* Çok küçük ekranlarda buton metinlerini kısalt */
@media (max-width: 576px) {
    ...
    .gelenCagriButon .text,
    .servisPlanlaBtn .text {
        font-size: 0.65rem;
    }
}
</style>
