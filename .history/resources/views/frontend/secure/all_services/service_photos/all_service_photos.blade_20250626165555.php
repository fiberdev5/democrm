...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.css">
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    <style>
            ...
            font-size: 12px;
                ...
                <form id="servisFotoEkle" enctype="multipart/form-data">
                    <div class="upload-zone" onclick="document.getElementById('resimInput').click()">
                        ...
                        <p class="text-muted small" style="margin-bottom:0;">Desteklenen formatlar: JPG, PNG, JPEG (Max: 5MB)</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row" id="photoGallery">
                    ...
                    @foreach ($photos as $item)
                        ...
                        <div class="photo-item">
                            <a href="/storage/app/{{ $item->resimyol }}" data-fancybox="gallery">
                                <img src="/storage/app/{{ $item->resimyol }}" alt="Servis Fotoğrafı">
                            </a>
                ...
                <div id="noPhotos" class="text-center text-muted" style="display: none;">
    ...
    <script>
        ...
        const $photoItem = $(this).closest('.col-md-3, .col-sm-6');
        const $button = $(this);
