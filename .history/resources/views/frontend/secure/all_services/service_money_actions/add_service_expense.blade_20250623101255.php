  ...
  <div class="row form-group ">
    ...
    <div class="row form-group ">
      ...
      <div class="col-lg-7 rw2">
        <input type="date" name="tarih" class="form-control datepicker tarih kayitTarihi" readonly="" value="{{date('Y-m-d')}}" style="width: 105px;display: inline-block;background:#fff">
      </div>
    </div>
    <div class="row form-group ">
