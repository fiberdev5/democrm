<form method="post" id="servisGiderEkle" class="col-sm-6" style="margin: 0 auto;padding:10px;">
  <div class="row form-group ">
    ...
    <div class="row form-group ">
      ...
      <div class="col-lg-7 rw2">
        <input type="date" name="tarih" class="form-control datepicker tarih kayitTarihi" readonly="" value="<?php echo date("d/m/Y"); ?>" style="width: 105px;display: inline-block;background:#fff">
      </div>
    </div>
    <div class="row form-group ">
