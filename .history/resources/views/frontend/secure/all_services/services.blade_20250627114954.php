                ...
                <div class="dropdown-menu">
                  ...
                  <div class="item">
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <select name="il" id="il" class="form-control form-select" style="width:100%!important;">
                  ...
                  <div class="item">
                    <div class="row">
                      <label class="col-sm-5">İl:</label>
                      <div class="col-sm-7">
                        <select name="ilce" id="ilce" class="form-control form-select" style="width:100%!important;">
