<form method="post" id="servisOptNotuDuzenle" action="{{ route('update.service.opt.note', $firma->id) }}" class="col-sm-6" style="margin: 0 auto;padding:10px;">
  @csrf
...
<script>
  $(document).ready(function () {
    $('#servisOptNotuDuzenle').submit(function (event) {
    ...
    $("#servisOptNotuDuzenle").submit(function (event) {
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.success) { 
            alert("Servis operatör notu başarıyla güncellendi.");
