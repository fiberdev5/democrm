...
<script>
    ...
    $(document).on('submit', '#surveyForm', function(e) {
        ...
        $.ajax({
            url: `/${firma_id}/anket/kaydet`, // Eğer route POST /{firma_id}/anket/kaydet şeklindeyse
            method: 'POST',
            data: $(this).serialize(),
            success: function(response) {
                if (response.success) {
                    ...
                    location.reload(); // Sayfayı yenile veya başka bir işlemi tetikle
                } else {
