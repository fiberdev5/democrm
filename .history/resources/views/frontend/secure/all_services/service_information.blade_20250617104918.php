...
function loadServiceHistory(service_id) {
    // Loading göster
    $('#serviceHistoryTableBody').html('<tr><td colspan="6" class="text-center">Yükleniyor...</td></tr>');
    ...
    $.ajax({
        ...
        error: function() {
            $('#serviceHistoryTableBody').html('<tr><td colspan="6" class="text-center text-danger">Veriler yüklenirken hata oluştu.</td></tr>');
        }
    });
}
