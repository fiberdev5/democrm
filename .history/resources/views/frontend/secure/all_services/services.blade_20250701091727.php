        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="datatableService" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <button type="button" class="btn btn-danger btn-sm servisPlanlaBtn"><div class="mText"><i class="fas fa-location-arrow"></i></div><div class="text">Servis Planlama <i data-toggle="tooltip" title="" class="fas fa-info-circle" data-original-title="Toplu servis yönlendirmeleri yapmak için kullanılır."></i></div></button>
