...
<script>
  $(document).ready(function () {
    ...
    // Anket istatistikleri için URL parametrelerini kontrol et
    ...
    if (personel_id && personel_istatistik_tarih1 && personel_istatistik_tarih2) {
        ...
        // Personel filtresini uygula (eğer böyle bir filtre alanınız varsa)
        if ($('#personel_filter').length) {
            $('#personel_filter').val(personel_id);
        }
