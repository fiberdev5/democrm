      ...
      <div class="card-header ch1" >
        <div class="row">
          ...
          <div class="col-sm-6 c2" style="text-align: right;">
            ...
            <div class="d-inline-block" style="vertical-align: middle; width: 180px;">
              <div class="input-group input-group-sm">
                <select class="form-select servisReso" name="servisReso" required>
                  <option value="">Seçiniz</option>
                  @foreach($service_resources as $item)
                    <option value="{{ $item->id }}">{{ $item->kaynak }}</option>
                  @endforeach
                </select>
                <button class="btn btn-success" type="button" id="addNewServiceResourceBtn" title="Yeni Kaynak Ekle">
            ...
            <div class="card" style="margin-bottom: 5px;">
              ...
              <div class="card-body custom-padding-bottom">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-8 rw2">
                    <div class="input-group">
                      <select class="form-select cihazMarka" name="cihazMarka" required>
                        <option value="">-Seçiniz-</option>
                        @foreach($device_brands as $marka)
                          <option value="{{ $marka->id }}">{{ $marka->marka }}</option>
                        @endforeach
                      </select>
                      <button class="btn btn-success" type="button" id="addNewDeviceBrandBtn" title="Yeni Marka Ekle">
                        <i class="fas fa-plus"></i>
                      </button>
                    </div>
                  </div>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-8 rw2">
                    <div class="input-group">
                      <select class="form-select cihazTur" name="cihazTur" required>
                        <option value="">-Seçiniz-</option>
                        @foreach($device_types as $cihaz)
                          <option value="{{ $cihaz->id }}">{{ $cihaz->cihaz }}</option>
                        @endforeach
                      </select>
                      <button class="btn btn-success" type="button" id="addNewDeviceTypeServiceBtn" title="Yeni Cihaz Türü Ekle">
                        <i class="fas fa-plus"></i>
                      </button>
                    </div>
                  </div>
...
$(document).ready(function() {
    ...
    $('#servisEkle').submit(function(event) {
        ...
        // Sadece buton disable et, yazı değiştirme
        formSubmitting = true;
