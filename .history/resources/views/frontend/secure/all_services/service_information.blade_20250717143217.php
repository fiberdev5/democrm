@include('frontend.secure.surveys.survey_form', ['tenant_id' => $firma->id])
  ...
  <div class="card-header" style="padding: 3px 5px;">
    <div class="row">
      ...
      <div class="col-sm-11" style="text-align: right;">
        <button type="button" class="btn btn-warning servisMusteriAnketiBtn" data-servisid="{{ $service_id->id }}" data-bayi="0" data-tip="personel" data-bs-toggle="modal"  data-bs-target="#surveyModal">>Müşteri Anketi</button>
...
<script>
$(document).ready(function() {
  $('.servisMusteriAnketiBtn').click(function() {
    var servisid = $(this).data('servisid');
    var bayi = $(this).data('bayi');
    var tip = $(this).data('tip');

    $('#surveyModal #servisid').val(servisid);
    $('#surveyModal #bayi').val(bayi);
    $('#surveyModal #tip').val(tip);

    // Burada dilersen AJAX ile mevcut anket verilerini çekip formu doldurabiliriz (isteğe bağlı)
