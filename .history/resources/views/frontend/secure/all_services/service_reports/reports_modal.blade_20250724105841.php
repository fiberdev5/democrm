      ...
      <div class="accordion-body">
        <form id="gelenCagriArama">
          ...
          <div class="row form-group">
            <div class="col-lg-5 rw1"><label>Tarih Aralığı</label></div>
            <div class="col-lg-7 rw2">
              <input type="date" name="cagri_tarih1" class="form-control acil_tarih1" value="{{ date('Y-m-d') }}">
              <input type="date" name="cagri_tarih2" class="form-control acil_tarih2" value="{{ date('Y-m-d') }}">
            </div>
          </div>
