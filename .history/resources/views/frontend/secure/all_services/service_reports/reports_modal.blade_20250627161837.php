<div id="accordion">
  <div class="card">
    <div class="card-header">
      <a class="card-link collapsed" data-toggle="collapse" href="#collapse1" aria-expanded="true"><span data-toggle="tooltip" title="Seçilen personelin kayıt aldığı servisleri listeler." class="fas fa-info-circle"></span> Oparatör Arama <i class="icon-action fa fa-chevron-down"></i></a></div>
