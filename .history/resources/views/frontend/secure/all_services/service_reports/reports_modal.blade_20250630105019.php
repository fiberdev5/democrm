        ...
        <form method="post" id="oparatorArama">
          <div class="row form-group">
            ...
            <div class="col-lg-7 rw2">
              <select name="operator" class="form-control personeller">
          ...
          <div class="row form-group">
            ...
            <div class="col-lg-7 rw2">
              <input type="date" name="tarih1" class="form-control operator_tarih1 "  value="{{date('Y-m-d')}}" style="background:#fff;margin-bottom: 3px;">
              <input type="date" name="tarih2" class="form-control operator_tarih2 "  value="{{date('Y-m-d')}}"  style="background:#fff;margin-bottom: 2px;">
            </div>
          </div>
