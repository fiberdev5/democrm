  ...
  <div class="accordion-item">
    ...
    <div id="collapse1" class="accordion-collapse collapse" 
      ...
      <div class="accordion-body">
        <form  id="oparatorArama" action="javascript:void(0);">
          ...
          <div class="row form-group">
            ...
            <div class="col-lg-7 rw2">
              <input type="date" name="operator_tarih1" class="form-control operator_tarih1 "  value="{{date('Y-m-d')}}" style="background:#fff;margin-bottom: 3px;">
              <input type="date" name="operator_tarih2" class="form-control operator_tarih2 "  value="{{date('Y-m-d')}}"  style="background:#fff;margin-bottom: 2px;">
            </div>
          </div>
