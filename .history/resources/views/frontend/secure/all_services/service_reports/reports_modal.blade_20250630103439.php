      ...
      <div class="accordion-body">
        <form method="post" id="oparatorArama">
          ...
          <div class="row form-group">
            ...
            <div class="col-lg-7 rw2">
              <input type="date" name="tarih1" class="form-control tarih1 "  value="{{date('Y-m-d')}}" style="background:#fff;margin-bottom: 3px;">
              <input type="date" name="tarih2" class="form-control tarih2 "  value="{{date('Y-m-d')}}"  style="background:#fff;margin-bottom: 2px;">
            </div>
          </div>
