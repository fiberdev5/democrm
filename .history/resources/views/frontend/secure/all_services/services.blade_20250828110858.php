...
<style>
  .header-buttons .btn {
    margin-left: 0.5rem; /* Butonlar arasına boşluk bırakır */
}
.header-buttons .btn:first-child {
    margin-left: 0; /* İlk butonun solunda boşluk olmasın */
}
</style>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(auth()->user()->can('Tüm Servisleri Görebilir'))
                            ...
                            {{-- Raporlar, Anketler, Primler butonları buradan kaldırıldı --}}
                        @endif
