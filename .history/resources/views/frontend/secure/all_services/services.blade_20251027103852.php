...
/* Filtre butonu gizli başlasın */
.kullanici_teknisyenfiltre {
    visibility: hidden;
    opacity: 0;
    transition: all 0.3s ease-in-out;
}

/* DataTable hazır olduğunda göster */
.datatable-ready .kullanici_teknisyenfiltre {
    visibility: visible;
    opacity: 1;
}
  </style>
...
<script type="text/javascript">
  ...
  <script>
    $(document).ready(function () {
      ...
      // Filtre butonunu da gizle
  $('.kullanici_teknisyenfiltre').css({ visibility: 'hidden', opacity: 0 });
