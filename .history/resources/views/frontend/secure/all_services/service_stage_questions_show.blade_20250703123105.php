        ...
        <div class="row form-group">
            <div class="col-lg-12">
                ...
                @elseif($stage->cevapTuru == "[Konsinye Cihaz]")
                    <div class="parcalar-dropdown myParcaList" style="width:100%"> {{-- Konsinyeler için de aynı dropdown class'ı, arama için gerekiyorsa --}}
                    ...
                    <input type="hidden" name="soru[{{ $stage->id }}]" class="form-control" value="Konsinye Cihaz"/> {{-- Gizli input değeri de farklılaştı --}}
