                            ...
                            <div class="col-lg-8">
                                @php
                                    ...
                                    if ($plan->cevap) {
                                        ...
                                        // Bu, konsol çıktınızdaki "ECAKombi" gibi hatalı girişleri ele alır.
                                        ...
                                        if ($currentConsignmentId) {
                                            ...
                                            if ($originalDevice) {
                                                ...
                                                // Seçili olan cihazın kendisi daha önce bu planda kullanılmışsa, o adeti de mevcut stoka eklemeliyiz.
                                                // Çünkü Update anında kendi kullandığı adedi sanki "çıkış" olarak hesaplamış gibi oluruz.
            ...
            success: function(data) {
                if (data.error) {
                    ...
                    if (typeof loadServiceHistory === 'function' && data.servis_id) {
                        ...
                        location.reload(); // Alternatif olarak sayfayı yenileyebiliriz
                    }
                }
            },
