    ...
    <tbody>
     @foreach($customer_invoices as $invoice)  
      ...
      <tr>
        ...
        <td style="vertical-align: middle;font-size: 11px; padding: 0 10px;"><strong><a href="{{ route('invoices', [$firma->id, 'did' => $invoice->id]) }}" class="btn btn-danger btn-sm editDomain" style="font-size:11px" target="_blank">Detaylar</a></strong></td>
      </tr>
