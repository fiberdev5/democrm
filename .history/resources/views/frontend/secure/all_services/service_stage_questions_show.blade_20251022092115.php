...
@elseif($stage->cevapTuru == "[Konsinye Cihaz]")
    ...
    {{-- Sadece [Grup-4] ise (Teknisyen) --}}
    @if(count($grupKodlari) == 1 && in_array('4', $grupKodlari))
        @php
    ...
    {{-- [Grup-4], [Grup-5] ise (Yardımcı Teknisyen) --}}
    @elseif(count($grupKodlari) == 2 && in_array('4', $grupKodlari) && in_array('5', $grupKodlari))
        @php
    ...
    {{-- Diğer gruplar için (261, 262 gibi) --}}
