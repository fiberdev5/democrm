...
<div class="container">
  ...
  <div class="alert alert-warning alert-dismissible fade show" role="alert" style="margin-bottom: 15px;">
    <h5 class="alert-heading"><i class="fas fa-exclamation-triangle"></i> Dikkat!</h5>
    <p class="mb-0">
      Lütfen servis ekleyebilmek için önce 
      <strong>Servis Kaynağı Ekleme</strong> butonundan en az bir servis kaynağı ekleyiniz.
    </p>
  </div>

  <!-- Servis Kaynağı Ekleme Butonu - Kaynak Yoksa Herkese Göster -->
  <div class="text-center" style="margin-bottom: 20px;">
    <button class="btn btn-success btn-lg" type="button" id="addNewServiceResourceBtn">
      <i class="fas fa-plus"></i> Servis Kaynağı Ekle
    </button>
  </div>
  @endif
