            ...
            <div class="card-body">
              ...
              <div id="servicesTableSection">
                <table id="datatableService" class="table table-bordered dt-responsive nowrap"
                  ...
                  <thead class="title">
                    <tr>
                      <th class="custom-table-size-id" >ID</th>
                      <th style="width: 10px">Tarih</th>
                      <th >Müşteri</th>
                      <th >Cihaz</th>
                      <th class="custom-table-size" >Servis Durumu</th>
                      <th class="custom-table-size-edit" data-priority="1" >Düzenle</th>
                      <th style="max-width: 40px!important;">Kapat</th>
                      <th class="custom-table-size-select" style="text-align: center;">Seç</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
