...
<div class="servisAsamalari">
  <div class="card card3">
    ...
    <div class="checkmark" style="display: inline-block; width: 15px; height: 15px; border: 1px solid #fff; border-radius: 2px; position: relative; top: 2px; margin-left: 5px;">
        <i class="fas fa-check" style="position: absolute; top: -2px; left: 1px; font-size: 11px; {{$service_id->acil == 1 ? 'display: block;' : 'display: none;'}}"></i>
    </div>
</label>
