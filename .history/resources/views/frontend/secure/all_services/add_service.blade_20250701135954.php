              ...
              <div class="card-body">
                <div class="row form-group" style="border: 0;padding-bottom: 0;margin-bottom: 0">
                  ...
                  <div class="col-md-8 " style="display: flex; gap: 5px; align-items: center;">
                    ...
                    @endphp
                    <input name="kayitTarihi" class="form-control datepicker kayitTarihi" type="date" value="{{$formattedDate}}" style="width: 100px;display: inline-block;background:#fff;text-align:center;" required>
