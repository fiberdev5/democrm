...
<div class="row cardWrap2">
  ...
  @if(!empty($kullanilanKonsinyeArray))
    @php
        $konsinyeInputText = implode(', ', $kullanilanKonsinyeArray);
    @endphp
    <div class="form-group">
        <label for="kullanilanKonsinyeInput"><b>Kullanılan Konsinye Cihaz(lar)</b></label>
        <input type="text" readonly class="form-control" id="kullanilanKonsinyeInput" value="{{ $konsinyeInputText }}">
    </div>
@endif
