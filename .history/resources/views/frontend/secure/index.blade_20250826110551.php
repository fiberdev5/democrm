...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.9.1/chart.min.js"></script>
 ...
 <style>
    ...
    .status-medium { background-color: #f8560b; } /* Orta Öncelik */
    .status-completed { background-color: #28a79c; } /* Tamamlandı */
    .status-pending { background-color: #0ca4d3; } /* Beklemede */
        ...
        <div class="dashboard-container">
         ...
         <div class="row">
            ...
            <div class="dashboard-card-header">
                ...
                <a href="{{route('all.services')}}" class="view-all-btn">Tümünü Gör <i class="fas fa-arrow-right"></i></a>
            </div>
...
<script>
        ...
        function buildServiceUrl(type) {
            ...
            let extraParams = ''; // Ekstra parametreler için boş bir değişken tanımla
            ...
            switch(type) {
                case 'today':
                    ...
                    break;
                 //İptal edilen servisler için URL
                case 'today-cancelled':
                    startDate = formatDate(today);
                    endDate = formatDate(today);
                    extraParams = '&status_group=cancelled'; // İptal durumu için özel parametre
                    break;
                
                //İşlemde olan servisler için URL
                case 'today-in-process':
                    startDate = formatDate(today);
                    endDate = formatDate(today);
                    extraParams = '&status_group=in_process'; // İşlemde durumu için özel parametre
                    break;
                case 'total':
                    // Son 30 gün
