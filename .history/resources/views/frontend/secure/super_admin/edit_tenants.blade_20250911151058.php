<!-- Tenant Detay Modal -->
     ...
     <div class="card-header bg-gradient bg-primary text-white d-flex align-items-center justify-content-between p-3" style="padding: 5px!important;">
      ...
      <div class="card-body p-4">
        ...
        <div class="row g-4">
          <div class="col-12">
            <h6 class="mb-3"><i class="fas fa-box me-2"></i>Paket Bilgileri</h6>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-3">
            <div class="row align-items-center">
                <div class="col-md-3">
                    <div class="d-flex align-items-center">
                        <div class="icon bg-light text-info rounded-circle d-flex justify-content-center align-items-center me-3" style="width:50px; height:50px;">
                ...
                <div class="col-md-2 text-center">
                    <div class="fw-bold text-info fs-5">Ücretsiz</div>
                    <small class="text-muted">Fiyat</small>
                </div>
                
                <div class="col-md-2 text-center">
                    <div class="fw-bold text-info">{{ $tenant->trial_ends_at->diffInDays(now()) }} gün</div>
           ...
           <div class="mt-3">
    <h6 class="mb-2">Deneme Süresi Özellikleri:</h6>
    <div class="row g-2">
        <div class="col-md-3">
            <div class="small">
        ...
        <div class="col-md-3">
              ...
              <div class="card border-0 shadow-sm">
                <div class="card-body p-3">
                  <div class="row align-items-center">
                    <div class="col-md-3">
                      <div class="d-flex align-items-center">
                        <div class="icon bg-light text-primary rounded-circle d-flex justify-content-center align-items-center me-3" style="width:50px; height:50px;">
                    ...
                    <div class="col-md-2 text-center">
                      <div class="fw-bold text-primary fs-5">{{ $currentSubscription->plansubs->getFormattedPrice() }}</div>
                      <small class="text-muted">Fiyat</small>
                    </div>
                    ...
                    <div class="col-md-2 text-center">
                      @if($isTrialFromTenant)
                        ...
                        <small class="text-muted">Deneme kaldı</small>
                      @elseif($currentSubscription->status === 'trial')
                        <div class="fw-bold text-info">{{ $currentSubscription->getRemainingDays() }} gün</div>
                        <small class="text-muted">Deneme kaldı</small>
                      @elseif($currentSubscription->status === 'active')
                        <div class="fw-bold text-success">{{ $currentSubscription->getRemainingDays() }} gün</div>
                    ...
                    <div class="col-md-3 text-center">
                      @if($isTrialFromTenant)
                        ...
                        <small class="text-muted">Deneme Bitiş</small>
                      @elseif($currentSubscription->status === 'trial')
                        <div class="fw-bold">{{ $currentSubscription->trial_ends_at ? $currentSubscription->trial_ends_at->format('d.m.Y') : 'Belirsiz' }}</div>
                        <small class="text-muted">Deneme Bitiş</small>
                      @else
                        <div class="fw-bold">{{ $currentSubscription->ends_at ? $currentSubscription->ends_at->format('d.m.Y') : 'Belirsiz' }}</div>
                        <small class="text-muted">Bitiş Tarihi</small>
                      @endif
                    </div>
                  </div>
                  ...
                  @if($currentSubscription->plansubs->limits)
                    <div class="mt-3">
                      ...
                      <div class="row g-2">
                        @foreach($currentSubscription->plansubs->limits as $key => $limit)
                          <div class="col-md-3">
                            <div class="small">
            ...
            @else
              <div class="alert alert-warning">
                ...
                @if(config('app.debug'))
                  <br><small>
                    Debug: Total subscriptions = {{ $tenant->subscriptions->count() }},
                    Active subscription = {{ $tenant->activeSubscription ? 'var' : 'yok' }}
                  </small>
                @endif
              </div>
            @endif
