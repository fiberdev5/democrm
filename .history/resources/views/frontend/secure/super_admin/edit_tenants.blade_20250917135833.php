...
<div class="card-body p-2">
      ...
      <div class="border rounded p-2 h-100">
        ...
        <div class="row mb-2">
          <div class="col-6">
            ...
            <span class="fw-medium">{{ $tenant->firma_adi }}</span>
          </div>
          <div class="col-6">
  ...
  <div class="border rounded p-2 mt-2">
    ...
    @if($isTrialFromTenant || ($currentSubscription && $currentSubscription->plansubs))
      <!-- Abonelik Durumu -->
      <div class="border border-2 rounded p-3 mb-2 bg-light" style="border-color: #e3f2fd !important;">
        <div class="row text-center align-items-center">
          <div class="col-md-2">
            <small class="text-muted d-block mb-2">Paket</small>
          ...
          <div class="col-md-2">
            <small class="text-muted d-block mb-2">Fiyat</small>
            <div class="fw-semibold">
              @if($isTrialFromTenant)
                Ücretsiz
              @else
          ...
          <div class="col-md-3">
            <small class="text-muted d-block mb-2">Kalan Süre</small>
            <div class="fw-semibold">
              @if($isTrialFromTenant)
          ...
          <div class="col-md-3">
            <small class="text-muted d-block mb-2">Bitiş Tarihi</small>
            <div class="fw-semibold">
              @if($isTrialFromTenant)
      ...
      <div>
        <div class="row g-2">
          ...
          <div class="col-md-2 col-6">
            <div class="text-center p-2 rounded bg-light">
              <small class="text-muted d-block mb-1">Bayi</small>
              <div class="fw-semibold">
                @if($isTrialFromTenant)
          ...
          <div class="col-md-2 col-6">
            <div class="text-center p-2 rounded bg-light">
              <small class="text-muted d-block mb-1">Stok Ürün</small>
              <div class="fw-semibold">
                @if($isTrialFromTenant)
          ...
          <div class="col-md-2 col-6">
            <div class="text-center p-2 rounded bg-light">
              <small class="text-muted d-block mb-1">Konsinye</small>
              <div class="fw-semibold">
                @if($isTrialFromTenant)
          ...
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['tickets_per_month']))
            <div class="col-md-2 col-6">
              <div class="text-center p-2 rounded bg-light">
                <small class="text-muted d-block mb-1">Aylık Destek</small>
                <div class="fw-semibold">
          ...
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['storage_gb']))
            <div class="col-md-2 col-6">
              <div class="text-center p-2 rounded bg-light">
                <small class="text-muted d-block mb-1">Depolama</small>
                <div class="fw-semibold">
