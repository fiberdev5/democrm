...
<div class="col-md-1 d-flex align-items-end">
    <button type="submit" class="btn" style="background: #6c757d; color: white; border: none; border-radius: 6px; padding: 12px; font-weight: 500; box-shadow: 0 2px 4px rgba(108, 117, 125, 0.2); transition: all 0.3s ease; width: 48px; height: 44px;" onmouseover="this.style.background='#5a6268'; this.style.boxShadow='0 3px 8px rgba(108, 117, 125, 0.3)'" onmouseout="this.style.background='#6c757d'; this.style.boxShadow='0 2px 4px rgba(108, 117, 125, 0.2)'" title="Filtrele">
