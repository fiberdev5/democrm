...
<div class="row">
    <div class="col-12">
        <div class="ticket-header d-flex flex-wrap justify-content-between align-items-start">
            
            <!-- Sol Taraf: Talep Başlığı + Firma/Kullanıcı + Statü -->
            <div class="ticket-left flex-grow-1 me-3">
            ...
            <div class="ticket-right d-flex flex-column align-items-end gap-3">
                <!-- Buton -->
                <div>
