...
<div class="page-content">
    <div class="container-fluid">
                ...
                <div class="card filter-card">
                    <div class="card-body">
                        ...
                        <form method="GET" class="row g-3 align-items-end"> {{-- Added align-items-end --}}
                            ...
                            <div class="col-md-2"> {{-- Changed from col-md-3 to col-md-2 to make space for per_page --}}
                            ...
                            <div class="col-md-1"> {{-- Per page dropdown added here --}}
                                <label class="form-label text-muted small">Göster</label>
                            ...
                            <div class="col-md-1"> {{-- Filter button adjusted --}}
        ...
        <!-- Main Card - Support Tickets List -->
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                @if(isset($tickets) && $tickets->hasPages())
                                    <small class="text-muted">
                                        Sayfa {{ $tickets->currentPage() }} / {{ $tickets->lastPage() }}
                                    </small>
                                @endif
                                        ...
                                        @foreach($tickets as $ticket)
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    @php
                                                        $statusConfig = [
                                                            'acik' => ['color' => 'primary', 'icon' => 'fas fa-spinner fa-spin', 'text' => 'Açık'], {{-- Added fa-spin for visual --}}
