...
/* Avatar Sizes */
.avatarsupersupport-xs { height: 1.5rem; width: 1.5rem; }
.avatarsupersupport-sm { height: 2rem; width: 2rem; }
.avatarsupersupport-xl { height: 4rem; width: 4rem; }

.avatarsupersupport-title {
    align-items: center;
    display: flex;
    font-size: 1rem;
    font-weight: 500;
