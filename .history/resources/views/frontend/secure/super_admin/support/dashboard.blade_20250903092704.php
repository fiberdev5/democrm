        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Destek Talepleri Dashboard</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('super.admin.dashboard') }}">Super Admin</a></li>
                            <li class="breadcrumb-item active">Destek Dashboard</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <a href="{{ route('super.admin.support.index') }}" class="btn btn-outline-primary w-100 mb-2">
                                    <i class="fas fa-list me-2"></i>Tüm Talepler
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('super.admin.support.index', ['status' => 'acik']) }}" class="btn btn-outline-warning w-100 mb-2">
                                    <i class="fas fa-clock me-2"></i>Açık Talepler
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('super.admin.support.index', ['priority' => 'yuksek']) }}" class="btn btn-outline-danger w-100 mb-2">
                                    <i class="fas fa-exclamation-triangle me-2"></i>Acil Talepler
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('super.admin.support.index', ['status' => 'cevaplandi']) }}" class="btn btn-outline-info w-100 mb-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('super.admin.support.index') }}" class="btn btn-sm btn-primary">
