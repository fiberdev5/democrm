            ...
            <div class="col-12">
                <div class="card filter-card">
                    <div class="card-body">
                        ...
                        <form method="GET" class="row g-3 align-items-end"> {{-- align-items-end ekledik --}}
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1"> {{-- d-flex align-items-end kaldırdık --}}
                                <button type="submit" class="btn btn-secondary w-100 text-white" style="border-radius:6px; font-weight:600;">
                                    <i class="fas fa-search me-1"></i> Filtrele {{-- İkon ekledik --}}
                                </button>
                            </div>
                        </form>
                    </div>
