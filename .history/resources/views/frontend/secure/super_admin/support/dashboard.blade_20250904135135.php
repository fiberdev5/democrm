...
/* Quick Actions */
/* Quick Actions Butonları için Renkli ve Efektli Stiller */
.quick-action-btn {
    border-radius: 10px;
    transition: all 0.4s ease; /* Geçiş süresini biraz artırıldı */
...
/* Her buton için özel degrade renkler */
.quick-action-btn[href*="destek.index"]:first-of-type { /* Tüm Talepler */
    background: linear-gradient(45deg, #007bff, #00c6ff); /* Mavi tonları */
}

.quick-action-btn[href*="status=acik"] { /* Açık Talepler */
    background: linear-gradient(45deg, #ffc107, #ffecb3); /* Turuncu/Sarı tonları */
    color: #333 !important; /* Yazı rengini koyu yap */
}

.quick-action-btn[href*="priority=acil"] { /* Acil Talepler */
    background: linear-gradient(45deg, #dc3545, #fd7e14); /* Kırmızı/Turuncu tonları */
}

.quick-action-btn[href*="status=cevaplandi"] { /* Cevaplanan */
    background: linear-gradient(45deg, #17a2b8, #20c997); /* Turkuaz/Yeşil tonları */
}
...
.quick-action-btn::before {
    ...
    width: 100%;
    height: 100%;
    background: rgba(255, 255, 255, 0.1); /* Hafif beyaz parlama efekti */
    z-index: -1;
...
.quick-action-btn:hover {
    transform: translateY(-5px) scale(1.02); /* Hafif yukarı kayma ve büyüme */
    box-shadow: 0 8px 20px rgba(0,0,0,0.2); /* Daha belirgin gölge */
    filter: brightness(1.1); /* Hafif parlaklık artışı */
}

.quick-action-btn .fw-semibold {
    color: inherit !important; /* Üst elementten gelen rengi koru */
}
.quick-action-btn small {
    color: rgba(255, 255, 255, 0.7) !important; /* Alt metin için hafif şeffaf beyaz */
}
.quick-action-btn[href*="status=acik"] small {
     color: rgba(51, 51, 51, 0.7) !important; /* Açık talep için koyu alt metin */
}

/* İkon ve Metin hizalaması için */
.quick-action-btn i {
    font-size: 1.25rem; /* İkon boyutunu biraz büyüt */
}
.quick-action-btn .text-start {
    margin-left: 0.75rem; /* İkon ile metin arasına boşluk */
}
