    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            @php
                ...
                $totalTickets = $tickets->total() ?? $tickets->count();
                
                $priorityCounts = [
                    'yuksek' => $tickets->whereIn('priority', ['acil', 'kritik', 'yuksek'])->count(),
                    'orta' => $tickets->where('priority', 'orta')->count()
                ];
            @endphp
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 opacity-75">Bekleyen Talep</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-gradient-danger text-white border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0">{{ $priorityCounts['yuksek'] }}</h5>
                                <p class="mb-0 opacity-75">Yüksek Öncelik</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 text-muted">Tüm kullanıcı destek taleplerini buradan yönetebilir, yanıtlayabilir ve takip edebilirsiniz.</p>
                                    </div>
                                </div>
                            </div>
