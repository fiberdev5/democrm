...
<div class="page-content">
    <div class="container-fluid">
        ...
        </div>{{-- resources/views/frontend/secure/super_admin/support/show.blade.php --}}
                ...
                <div class="admin-actions">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="text-muted">Bu talep üzerinde hızlı işlemler gerçekleştirebilirsiniz</small>
                        </div>
                        <div>
                            @if($ticket->status == 'kapali')
                                <form action="{{ route('super.admin.destek.reopen', $ticket->id) }}" 
