...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{-- Filtreler bölümünde, mevcut filtre formunun sonuna eklenecek --}}

<!-- Filtre formunun son satırına ekleyin -->
<div class="col-md-1">
    <label class="form-label text-muted small">Sayfa Başına</label>
...
{{-- Sayfalama bilgileri için card-header'a ekleyin --}}
...
{{-- Sayfalama bölümünü de geliştirelim --}}
@if (isset($tickets) && method_exists($tickets, 'hasPages') && $tickets->hasPages())
    <div class="card-footer bg-white border-0 py-3">
        <div class="d-flex justify-content-between align-items-center">
            <div class="text-muted small">
                Toplam {{ $tickets->total() }} kayıttan {{ $tickets->firstItem() }}-{{ $tickets->lastItem() }} arası gösteriliyor
            </div>
            <div>
