...
<div class="page-content support-index-page">
    ...
    <button type="submit" class="btn w-100" style="background: #5664d2; color: white; border: none; border-radius: 8px; padding: 11px 20px; font-weight: 500; box-shadow: 0 2px 8px rgba(86, 100, 210, 0.2); transition: all 0.3s ease;" onmouseover="this.style.background='#4c57c4'; this.style.boxShadow='0 4px 12px rgba(86, 100, 210, 0.3)'; this.style.transform='translateY(-1px)'" onmouseout="this.style.background='#5664d2'; this.style.boxShadow='0 2px 8px rgba(86, 100, 210, 0.2)'; this.style.transform='translateY(0)'">
