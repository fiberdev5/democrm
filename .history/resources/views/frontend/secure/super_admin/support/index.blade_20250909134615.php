                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('super.admin.destek.dashboard') }}" class="text-decoration-none">Destek Talepleri</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-1 d-flex align-items-end">
                                <button type="submit" class="btn btn-seccondary w-100 " style="border: 1px solid black">
