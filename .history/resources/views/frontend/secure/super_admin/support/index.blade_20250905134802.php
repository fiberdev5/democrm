                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" class="row g-3">
                           ...
                           <div class="col-md-1 d-flex align-items-end">
                            <button type="submit" class="btn w-100" style="background: #6c63ff; color: white; border: 2px solid #6c63ff; border-radius: 8px; font-weight: 500; padding: 10px; transition: all 0.3s ease;" onmouseover="this.style.background='transparent'; this.style.color='#6c63ff'" onmouseout="this.style.background='#6c63ff'; this.style.color='white'">
