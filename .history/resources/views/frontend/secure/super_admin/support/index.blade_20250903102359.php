        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Super Admin - Destek Talepleri</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <a href="{{ route('super.admin.support.dashboard') }}" class="btn btn-outline-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-{{ $ticket->priority == 'yuksek' ? 'danger' : 'secondary' }}">
                                                        {{ $ticket->priority == 'yuksek' ? 'Yüksek' : 'Orta' }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-{{ $ticket->status == 'acik' ? 'warning' : ($ticket->status == 'cevaplandi' ? 'info' : 'success') }}">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                @if(request()->hasAny(['status', 'priority', 'category', 'tenant_id', 'search']))
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ route('super.admin.support.index') }}" class="btn btn-primary">
