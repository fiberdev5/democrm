...
<style>
    ...
    top: 0;
    right: 0;
    margin-top: 20px; /* Üstten biraz boşluk bırakmak için */
    margin-right: 10px; /* Sağdan biraz boşluk bırakmak için */
    z-index: 10; /* Diğer içeriklerin üzerine çıkmasını sağlamak için */
}

/* Küçük ekranlarda butonun düzgün görünmesi için responsive ayar */
@media (max-width: 767.98px) {
    .ticket-action-button {
        position: static; /* Küçük ekranlarda normal akışa dönsün */
        text-align: right; /* Butonu sağa hizala */
        margin-top: 15px; /* Üstteki başlık ve kartlardan biraz boşluk */
        margin-right: 0;
        width: 100%;
    }
}
...
<div class="row">
    <div class="col-12">
        <div class="ticket-header position-relative"> {{-- position-relative ekledik --}}
            ...
            <div class="row g-3 mb-3 mt-3"> {{-- mt-3 ekledim, isterseniz ayarlayabilirsiniz --}}
                <!-- Firma Kartı -->
                <div class="col-sm-4">
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body p-2 d-flex flex-column justify-content-center">
                            <div class="d-flex align-items-center mb-2">
                                <i class="fas fa-calendar-plus text-success me-2 fa-2x"></i>
                                <div>
                            ...
                            <div class="d-flex align-items-center">
                                <i class="fas fa-clock text-info me-2 fa-2x"></i>
                                <div>
            ...
            <div class="ticket-action-button"> {{-- Yeni bir div oluşturduk --}}
