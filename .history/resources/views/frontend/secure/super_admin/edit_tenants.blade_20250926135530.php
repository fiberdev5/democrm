    ...
    <div class="widget-main-content">
        ...
        <div class="subscription-section">
            <div class="section-header">
                ...
                <button class="btn-refresh" onclick="refreshUnifiedWidget()" title="Yenile" style="margin-left: auto; background: none; border: none; color: rgba(255,255,255,0.7); font-size: 14px;">
...
function refreshUnifiedWidget() {
    ...
    // Depolama detaylarını yeniden yükle
