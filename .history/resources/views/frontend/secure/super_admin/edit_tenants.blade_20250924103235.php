            ...
            <div class="tab-pane {{ $key === 'bugun' ? 'show active' : '' }}" 
              ...
              <div class="row g-2">
                    ...
                    <div class="tenant-service-stats-card-body">
                      @forelse($period['markalar'] as $marka)
                        <div class="tenant-stats-item">
                          <span class="tenant-stats-name">{{ $marka->marka }}</span>
                          <span class="tenant-stats-count">{{ $marka->sayi }}</span>
                        </div>
                      @empty
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="tenant-service-stats-card">
                    <div class="tenant-service-stats-card-header">
                      <span class="tenant-stats-title">Cihaz Türleri</span>
                    </div>
                    <div class="tenant-service-stats-card-body">
                      @forelse($period['turler'] as $tur)
                        <div class="tenant-stats-item">
                          <span class="tenant-stats-name">{{ $tur->cihaz }}</span>
                          <span class="tenant-stats-count">{{ $tur->sayi }}</span>
                        </div>
                      @empty
                        <div class="tenant-stats-empty">Kayıt yok</div>
                      @endforelse
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="tenant-service-stats-card">
                    <div class="tenant-service-stats-card-header">
                      <span class="tenant-stats-title">Kaynaklar</span>
                    </div>
                    <div class="tenant-service-stats-card-body">
                      @forelse($period['kaynaklar'] as $kaynak)
                        <div class="tenant-stats-item">
                          <span class="tenant-stats-name">{{ $kaynak->kaynak }}</span>
                          <span class="tenant-stats-count">{{ $kaynak->sayi }}</span>
                        </div>
                      @empty
                        <div class="tenant-stats-empty">Kayıt yok</div>
                      @endforelse
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="paymentDetailContent">
        ...
        <!-- Error State -->
        <div id="paymentDetailError" class="tenant-payment-error text-center py-4" style="display: none;">
          <i class="fas fa-exclamation-triangle fa-3x text-warning mb-3"></i>
