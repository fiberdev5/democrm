<!-- Tenant Detay Modal -->
<!-- Header -->
<div class="card-header text-white d-flex align-items-center justify-content-between m-0 p-3" style="background-color: #0d6efd; border-radius: 0.375rem 0.375rem 0 0;">
  <div class="d-flex align-items-center">
    <div>
      <h4 class="mb-0">{{ $tenant->firma_adi }}@if($tenant->status == 1)
        <span class="badge bg-success ms-2">Aktif</span>
      @else
        <span class="badge bg-secondary ms-2">Aktif Değil</span>
      @endif</h4>
    </div>
  </div>
...
<div class="card-body p-3">
  <div class="row g-3">
     <!-- İletişim Bilgileri -->
    <div class="col-md-6">
      <div class="border rounded p-3 h-100" style="border-color: #0d6efd !important;">
  ...
  <!-- Abonelik Bilgileri -->
  <div class="border rounded p-3 mt-3" style="border-color: #0d6efd !important;">
    ...
    @if($isTrialFromTenant || ($currentSubscription && $currentSubscription->plansubs))
      <!-- Abonelik Durumu -->
      <div class="border border-2 rounded p-3 mb-3" style="border-color: #e3f2fd !important;">
...
<!-- Footer -->
<div class="card-footer bg-light d-flex justify-content-between align-items-center p-3" style="border-radius: 0 0 0.375rem 0.375rem;">
  <div>
