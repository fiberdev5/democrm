    ...
    <div class="col-sm-9 custom-p-l">
        ...
        @if($integration->logo)
            <div class="mt-3" id="logoPreviewContainer">
                ...
                <img src="{{ asset($integration->logo) }}" alt="Mevcut Logo" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; background: #f8f9fa;" id="logoPreview">
