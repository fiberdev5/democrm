    ...
    <div class="col-sm-9 custom-p-l">
        ...
        @if($integration->logo)
            <div class="mt-3" id="logoPreviewContainer">
                ...
                <img src="{{ asset('frontend/' . $integration->logo) }}" alt="Mevcut Logo" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; background: #f8f9fa;" id="logoPreview">
        ...
        @else
            <div class="mt-3" id="logoPreviewContainer" style="display: none;">
                ...
                <img src="" alt="Logo Önizleme" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; background: #f8f9fa;" id="logoPreview">
            </div>
        @endif
    </div>
</div>
