...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Sistem Log Kayıtları (Tüm Firmalar)</h5>
            <button class="btn btn-danger btn-sm" onclick="showClearModal()">
                <i class="fas fa-trash"></i> Log Temizle
            </button>
        </div>
        <div class="card-body">
            <!-- Filtreler -->
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="action_filter">
                        ...
                        <option value="service_status_changed">Durum Değişikliği</option>
                        <option value="customer_created">Müşteri Oluşturma</option>
                        <option value="stock_action">Stok İşlemi</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <button class="btn btn-info btn-sm ms-2" onclick="exportLogs()">
            ...
            <div class="table-responsive">
                ...
                <div id="log_container">
                    <textarea class="form-control" id="log_display" rows="25" readonly style="font-family: 'Courier New', monospace; font-size: 11px; background-color: #000; color: #00ff00; padding: 15px;"></textarea>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    // Clear modal seçenekleri
    $('#clear_option').on('change', function() {
        const option = $(this).val();
        $('#days_option, #tenant_option').hide();
