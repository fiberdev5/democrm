      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="storageHeading">
          <button class="accordion-button collapsed" type="button" 
            ...
            <i class="fas fa-hdd me-2"></i>Depolama Detayları
          </button>
        </h2>
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if (response.success) {
        ...
        // Toplam - Backend'den gelen değeri kullan
        ...
        container.html(`
          <div class="storage-breakdown-list">
            <div class="storage-item">
              ...
              <div class="storage-size">Hata oluştu</div>
            </div>
          </div>
        `);
      }
...
.storage-item.total .storage-type::before {
  content: "💾";
}
