...
/* Status ve Invoice hücreleri için özel stil */
.table > tbody > tr > td > .t-link.status-cell,
.table > tbody > tr > td > .t-link.invoice-cell {
...
.table > tbody > tr > td > .t-link.status-cell:hover,
.table > tbody > tr > td > .t-link.invoice-cell:hover {
    opacity: 0.85;
