      ...
      <div class="card-body p-4">
        ...
        <div class="row g-4">
          <div class="col-12">
            ...
            @php
              // Önce tenant'ın kendi subscription_status'unu kontrol et
              $currentSubscription = null;
              $isTrialFromTenant = false;
              
              // Tenant tablosundaki trial durumunu kontrol et
            ...
            @if($currentSubscription && $currentSubscription->plansubs)
