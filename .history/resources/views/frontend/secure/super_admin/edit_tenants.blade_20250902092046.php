<!-- Tenant Detay Modal -->
      ...
      <div class="card-footer bg-light d-flex justify-content-between align-items-center p-3">
        ...
        <div>
          ...
          <form action="{{ route(''tenant.toggle.status', [$tenant->id,$tenant->id]) }}" method="POST" style="display: inline;">
          ...
          <a href="{{ route('delete.tenant', [$tenant->id, $tenant->id]) }}" type="button" class="btn btn-danger btn-sm">Sil</a>
        </div>
</div>
