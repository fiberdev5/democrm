        ...
        @php
            ...
            if ($storageUsagePercent <= 0) {
                ...
                if (!empty($usageMatches) && !empty($limitMatches)) {
                    ...
                    $usageUnit = $usageMatches[2];
                    $limitValue = floatval(str_replace(',', '', $limitMatches[1]));
                    $limitUnit = $limitMatches[2];
                    
                    // Byte cinsine çevir
                    $usageBytes = convertToBytes($usageValue, $usageUnit);
                    $limitBytes = convertToBytes($limitValue, $limitUnit);
