...
@endphp
    ...
    <div class="storage-details-section">
        <div class="storage-breakdown-container" id="storageBreakdownContainer">
            ...
            <div class="subscription-storage-detail" style="margin-top: 10px; padding: 8px; background: rgba(255,255,255,0.05); border-radius: 4px; border-top: 1px solid rgba(255,255,255,0.1);">
                <div class="detail-label" style="color: rgba(255,255,255,0.8); font-size: 12px;">Depolama Planı:</div>
                <div class="detail-value">
                    ...
                    @else
                        ...
                        @if($storageUsagePercent > 0)
                            <div class="storage-progress" style="margin-top: 4px;">
                                <div class="progress-bar" style="height: 4px; background: rgba(255,255,255,0.2); border-radius: 2px;">
                                    <div class="progress-fill" style="width: {{ min($storageUsagePercent, 100) }}%; height: 100%; background: #28a745; border-radius: 2px;"></div>
                                </div>
                            </div>
                        @endif
                    @endif
