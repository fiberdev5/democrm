...
<style>
  /* Modern Dashboard CSS - Tamamen Güncellenmiş */
...
/* İstatistik Kartları */
.stat-card.primary { 
    --accent-gradient: linear-gradient(90deg, #3498db, #5dade2); 
}
.stat-card.success { 
    --accent-gradient: linear-gradient(90deg, #27ae60, #58d68d); 
}
.stat-card.info { 
    --accent-gradient: linear-gradient(90deg, #8e44ad, #af7ac5); 
}
.stat-card.warning { 
    --accent-gradient: linear-gradient(90deg, #f39c12, #f8c471); 
}
...
.row.mb-4 {
    margin-bottom: 1.5rem !important; /* Kartlar arası boşluğu azalt */
}
...
.status-container .col-12:last-child {
    padding-bottom: 0;
}
