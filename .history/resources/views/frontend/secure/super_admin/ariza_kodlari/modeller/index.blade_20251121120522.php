                    ...
                    <div class="card-body">
                        ...
                        <div class="align-items-center justify-content-between">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="{{ route('super.admin.markalar.index') }}" class="btn btn-secondary btn-sm px-3">
                                    ...
                                    <tr data-id="{{ $model->id }}">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if($model->resimyol)
                                                    <img src="{{ asset('upload/'.$model->resimyol) }}" 
                                                        width="50" 
                                                        height="50" 
...
<style>
    ...
    .modelEkleBtn, .btn-secondary {
        position: relative;
        margin-right: 5px;
    }
    
    .modelEkleBtn i, .btn-secondary i {
        display: none;
    }
    
    @media (max-width: 767px) {
        .modelEkleBtn span, .btn-secondary span {
            display: none;
        }
        .modelEkleBtn i, .btn-secondary i {
            display: block;
