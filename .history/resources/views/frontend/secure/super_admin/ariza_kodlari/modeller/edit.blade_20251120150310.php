// resources/views/frontend/secure/super_admin/ariza_kodlari/modeller/edit.blade.php
...
$(document).ready(function() {
    $("#modelDuzenle").on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('modeller.update', $modelSec->id) }}",
            type: "POST",
            ...
            success: function(data) {
                alert(data.message);
                window.location.href = "{{ route('modeller.index', $modelSec->mid) }}";
            },
            error: function(xhr) {
