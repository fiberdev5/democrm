    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <a href="{{ route('super.admin.markalar.index') }}" class="btn btn-secondary">Geri</a>
            </div>
...
$(document).ready(function() {
    ...
    $('.modelEkleBtn').click(function() {
        $.ajax({
            url: "{{ route('super.admin.modeller.create', $markaSec->id) }}"
        }).done(function(data) {
    ...
    $('.modelDuzenleBtn').click(function() {
        var id = $(this).data('id');
        $.ajax({
            url: "{{ route('super.admin.modeller.edit', '') }}/" + id
        }).done(function(data) {
