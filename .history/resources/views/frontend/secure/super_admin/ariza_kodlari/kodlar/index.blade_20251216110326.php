...
@section('user')
<link href="{{ asset('frontend/css/super_admin/ariza_kodlari/ariza_kodlari.css') }}" rel="stylesheet" type="text/css" />
<div class="page-content" id="passwords">
    ...
    <div class="d-flex gap-2 justify-content-center">
        <button class="btn btn-outline-primary btn-sm rounded-circle kodDuzenleBtn" 
                data-id="{{ $kod->id }}"
                title="Düzenle"
                style="width: 32px; height: 32px; padding: 0;">
            <i class="fa fa-edit"></i>
        </button>
        <button class="btn btn-outline-danger btn-sm rounded-circle kodSil" 
                data-id="{{ $kod->id }}"
                title="Sil"
                style="width: 32px; height: 32px; padding: 0;">
