...
$(document).ready(function(){
    ...
    kodTableInstance = $('#kodTable').DataTable({
        ...
        "drawCallback": function() {
            // Her çizimden sonra event listener'ları yeniden bağla
    ...
    function attachEventListeners() {
        // Düzenle butonları
        $('.kodDuzenleBtn').off('click').on('click', function(){
            let id = $(this).data('id');
            $.ajax({
        ...
        // Sil butonları
        $('.kodSil').off('click').on('click', function(){
    ...
    // İlk yüklemede event listener'ları bağla
    attachEventListeners();

    /** Kod Ekle Modal Aç **/
    $('.kodEkleBtn').on('click', function(){
        $.ajax({
