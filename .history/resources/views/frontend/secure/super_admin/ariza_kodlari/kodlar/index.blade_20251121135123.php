                        ...
                        <div class="table-responsive">
                            <table id="kodTable" class="table table-hover table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="{{ $kod->id }}">
                                        <td class="align-middle" data-order="{{ $kod->kodu }}">
...
<script>
// Natural Sort için özel fonksiyon
...
$(document).ready(function(){
    ...
    // DataTable başlat - Natural sorting ile
    kodTableInstance = $('#kodTable').DataTable({
        ...
        "dom": 'frti',
        "columnDefs": [
            { "type": "natural", "targets": 0 },  // Kod sütunu için natural sorting
