// resources/views/frontend/secure/super_admin/ariza_kodlari/markalar/index.blade.php
                ...
                <table id="dataTable" class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('modeller.index', $marka->id) }}" class="btn btn-info btn-sm">Modeller</a>
                                <a href="{{ route('kodlar.index', ['marka_id' => $marka->id, 'model_id' => 0]) }}" 
