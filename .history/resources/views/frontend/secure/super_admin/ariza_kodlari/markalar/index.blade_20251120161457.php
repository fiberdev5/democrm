...
$(document).ready(function() {
    ...
    $(document).on('submit', '#markaDuzenle', function(e) {
        ...
        // Form action URL'ini form etiketinden alıyoruz
        // Edit blade dosyasındaki form etiketi şöyle olmalı: <form id="markaDuzenle" action="{{ route('...', $id) }}" ... >
        // Eğer blade dosyanızda action yoksa manuel olarak url oluşturmalıyız. 
        // Güvenli yol: Edit formunuzun action attribute'unu doğru ayarlayın.
        
        // Eğer action attribute edit.blade.php içinde tanımlı değilse aşağıdaki satırı kullanın:
        // var url = "{{ route('super.admin.markalar.update', '') }}/" + $(this).find('input[name="id"]').val();
        
        // Ama en doğrusu formun kendi action'ını kullanmaktır:
