...
@section('user')
<link href="{{ asset('frontend/css/super_admin/ariza_kodlari/markalar.css') }}" rel="stylesheet" type="text/css" />
...
$(document).ready(function(){
    ...
    let formSubmitting = false; // Token kontrolü için flag
    ...
    /** Marka Ekle Modal Açıldığında Token Oluştur **/
    $('#markaEkleModal').on('show.bs.modal', function() {
