  ...
  <div class="col-lg-2 col-md-6 col-sm-12">
    <div class="form-group mb-3">
      ...
      <div class="d-flex flex-wrap gap-1">
        <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="7" style="white-space: nowrap;">Son 7 Gün</button>
        <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="30" style="white-space: nowrap;">Son 30 Gün</button>
        <button type="button" class="btn btn-outline-secondary btn-sm" id="this-month" style="white-space: nowrap;">Bu Ay</button>
        <button type="button" class="btn btn-outline-secondary btn-sm" id="last-month" style="white-space: nowrap;">Geçen Ay</button>
      </div>
    </div>
  </div>
</div>
