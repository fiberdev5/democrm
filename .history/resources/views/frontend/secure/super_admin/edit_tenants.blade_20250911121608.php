              ...
              <div class="card border-0 shadow-sm">
                <div class="card-body p-3">
                  <div class="row align-items-center">
                    <div class="col-md-3">
                      <div class="d-flex align-items-center">
                        <div class="icon bg-light text-primary rounded-circle d-flex justify-content-center align-items-center me-3" style="width:50px; height:50px;">
                          <i class="{{ $tenant->activeSubscription->plan->getIconClass() }}"></i>
                        </div>
                        <div>
                          <h5 class="mb-0">{{ $tenant->activeSubscription->plan->name }}</h5>
                          <small class="text-muted">{{ $tenant->activeSubscription->plan->getBillingCycleText() }}</small>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2 text-center">
                      <div class="fw-bold text-primary fs-5">{{ $tenant->activeSubscription->plan->getFormattedPrice() }}</div>
                  ...
                  <div class="mt-3">
                    ...
                    <div class="row g-2">
                      @if($tenant->activeSubscription->plan->limits)
                        @foreach($tenant->activeSubscription->plan->limits as $key => $limit)
                          <div class="col-md-3">
                            <div class="small">
                              <strong>{{ ucfirst(str_replace('_', ' ', $key)) }}:</strong>
                              {{ $tenant->activeSubscription->plan->getFeatureText($key) }}
                            </div>
                          </div>
                        @endforeach
                      @endif
