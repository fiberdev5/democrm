    ...
    <div class="col-lg-3 col-md-6 ">
      <div class="form-group mb-3">
        ...
        <div class="d-flex gap-1 flex-wrap">
          <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="7" title="Son 7 Gün">
            Son 7 Gün
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="30" title="Son 30 Gün">
            Son 30 Gün
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="this-month" title="Bu Ay">
            Bu Ay
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="last-month" title="Geçen Ay">
            Geçen Ay
          </button>
        </div>
      </div>
