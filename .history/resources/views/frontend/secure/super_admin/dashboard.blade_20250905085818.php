...
<div class="page-content gradient-bg">
    <div class="container-fluid">
            ...
            <div class="col-lg-4 mb-3">
                <div class="card modern-card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.support.index', ['priority' => 'acil']) }}" class="action-item d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.support.index', ['status' => 'acik']) }}" class="action-item d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.support.index') }}" class="action-item d-flex align-items-center">
                            <div class="action-icon" style="background: linear-gradient(135deg, #3498db, #5dade2);">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card modern-card privilege-card">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            <div class="privilege-icon me-3" style="width: 60px; height: 60px; border-radius: 15px; background: rgba(255,255,255,0.2); display: flex; align-items: center; justify-content: center;">
                                <i class="fas fa-user-shield fa-2x"></i>
                            </div>
                            <div>
                                <h4 class="text-white mb-1">Super Admin Yetkileri</h4>
                                <p class="text-white-50 mb-0">Sistem genelinde tam yetkili erişim</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-2">
                                <div class="privilege-item">
                                    <i class="fas fa-user-secret"></i>
                                    <span>Herhangi bir kullanıcı olarak giriş yapma</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 mb-2">
                                <div class="privilege-item">
                            ...
                            <div class="col-lg-4 col-md-6 mb-2">
                                <div class="privilege-item">
                                    ...
                                    <span>Tüm destek taleplerini yönetme</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 mb-2">
                                <div class="privilege-item">
                                    <i class="fas fa-cogs"></i>
                                    <span>Sistem ayarlarını yapılandırma</span>
                                </div>
                            </div>
                        </div>
                    </div>
