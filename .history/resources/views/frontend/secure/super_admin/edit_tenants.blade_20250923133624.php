...
<div class="card-body p-3">
  ...
  <div class="row g-2">
    ...
    <div class="col-md-3">
      <div class="info-card">
        <h6 class="info-card-title">İletişim</h6>
        <div class="info-content">
          <div class="info-item">
    ...
    <div class="col-md-3">
      <div class="info-card">
        <h6 class="info-card-title">Tarihler</h6>
        <div class="info-content">
          <div class="info-item">
            <small class="text-muted">Kayıt:</small>
            <span class="info-value">{{ $tenant->created_at->format('d.m.Y') }}</span>
          </div>
          <div class="info-item">
  ...
  <div class="subscription-card mt-3">
    <h6 class="subscription-card-title">Abonelik Bilgileri</h6>
    ...
    @if($isTrialFromTenant || ($currentSubscription && $currentSubscription->plansubs))
      <!-- Abonelik Bilgileri Table -->
      <div class="subscription-table">
        <div class="subscription-row">
          <div class="subscription-label">Paket:</div>
        ...
        <div class="subscription-row">
          <div class="subscription-label">Durum:</div>
          <div class="subscription-value">
            @if($isTrialFromTenant)
              Deneme
        ...
        <div class="subscription-row">
          <div class="subscription-label">Fiyat:</div>
          <div class="subscription-value">
            @if($isTrialFromTenant)
              Ücretsiz
            @else
        ...
        <div class="subscription-row">
          <div class="subscription-label">Kalan Süre:</div>
          <div class="subscription-value">
            @if($isTrialFromTenant)
        ...
        <div class="subscription-row">
          <div class="subscription-label">Bitiş Tarihi:</div>
          <div class="subscription-value">
            @if($isTrialFromTenant)
      ...
      <div class="package-features">
        <h6 class="features-title">Paket Özellikleri</h6>
        <div class="features-table">
          <div class="feature-row">
            <div class="feature-label">Kullanıcı:</div>
          ...
          <div class="feature-row">
            <div class="feature-label">Bayi:</div>
            <div class="feature-value">
              @if($isTrialFromTenant)
          ...
          <div class="feature-row">
            <div class="feature-label">Stok Ürün:</div>
            <div class="feature-value">
              @if($isTrialFromTenant)
          ...
          <div class="feature-row">
            <div class="feature-label">Konsinye:</div>
            <div class="feature-value">
              @if($isTrialFromTenant)
          ...
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['tickets_per_month']))
            <div class="feature-row">
              <div class="feature-label">Aylık Destek:</div>
              <div class="feature-value">
          ...
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['storage_gb']))
            <div class="feature-row">
              <div class="feature-label">Depolama:</div>
              <div class="feature-value">
                ...
                @else
                  ...
                  @if($extraStorage > 0)
                    (+{{ number_format($extraStorage, 0) }} GB ek)
                  @endif
                @endif
              </div>
            </div>
      ...
      <!-- Depolama Kullanım Detayları -->
      @if(isset($storageInfo))
      <div class="storage-details">
        <h6 class="storage-details-title">Depolama Kullanım Detayları</h6>
        <div class="storage-breakdown">
          @if(isset($storageInfo['breakdown']))
            <div class="storage-item">
              <span class="storage-type">Servis Fotoğrafları:</span>
              <span class="storage-size">{{ $storageInfo['breakdown']['service_photos'] ?? '0 B' }}</span>
            </div>
            <div class="storage-item">
              <span class="storage-type">Stok Fotoğrafları:</span>
              <span class="storage-size">{{ $storageInfo['breakdown']['stock_photos'] ?? '0 B' }}</span>
            </div>
            <div class="storage-item">
              <span class="storage-type">Diğer Dosyalar:</span>
              <span class="storage-size">{{ $storageInfo['breakdown']['other_files'] ?? '0 B' }}</span>
            </div>
          @else
            <div class="storage-item">
              <span class="storage-type">Toplam Kullanım:</span>
              <span class="storage-size">{{ $storageInfo['current_usage_formatted'] ?? '0 B' }}</span>
            </div>
          @endif
        </div>
      </div>
  ...
  <div class="subscription-section">
    ...
    @if($isTrialFromTenant || ($currentSubscription && $currentSubscription->plansubs))
      <div class="subscription-content">
        <!-- Abonelik Detayları Grid -->
        <div class="subscription-grid">
          <div class="grid-item">
            <div class="grid-label">Paket</div>
          ...
          <div class="grid-item">
            <div class="grid-label">Durum</div>
            <div class="grid-value">
              @if($isTrialFromTenant)
          ...
          <div class="grid-item">
            <div class="grid-label">Fiyat</div>
            <div class="grid-value price">
              @if($isTrialFromTenant)
                Ücretsiz
              @else
                {{ $currentSubscription->plansubs->getFormattedPrice() }}
          ...
          <div class="grid-item">
            <div class="grid-label">Kalan Süre</div>
            <div class="grid-value remaining">
              @if($isTrialFromTenant)
                {{ $tenant->trial_ends_at->diffInDays(now()) }} gün
              @else
                {{ $currentSubscription->getRemainingDays() }} gün
          ...
          <div class="grid-item">
            <div class="grid-label">Bitiş Tarihi</div>
            <div class="grid-value">
              @if($isTrialFromTenant)
                {{ $tenant->trial_ends_at->format('d.m.Y') }}
              @else
          ...
          <div class="grid-item">
            <div class="grid-label">Kullanıcı</div>
            <div class="grid-value">
              @if($isTrialFromTenant)
                @if($tenant->personelSayisi == -1)
                  Sınırsız
          ...
          <div class="grid-item">
            <div class="grid-label">Stok Ürün</div>
            <div class="grid-value">
              @if($isTrialFromTenant)
                @if($tenant->stokSayisi == -1)
                  Sınırsız
          ...
          <div class="grid-item">
            <div class="grid-label">Konsinye</div>
            <div class="grid-value">
              @if($isTrialFromTenant)
                @if($tenant->konsinyeSayisi == -1)
                  Sınırsız
          ...
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['tickets_per_month']))
            <div class="grid-item">
              <div class="grid-label">Aylık Destek</div>
              <div class="grid-value">
                @if($currentSubscription->plansubs->limits['tickets_per_month'] == -1)
                  Sınırsız
                @elseif($currentSubscription->plansubs->limits['tickets_per_month'] == 0)
          ...
          @endif
          @if(!$isTrialFromTenant && isset($currentSubscription->plansubs->limits['storage_gb']))
            <div class="grid-item storage-item">
              <div class="grid-label">Depolama</div>
              <div class="grid-value">
                <div class="storage-main">
                  ...
                  @else
                    ...
                    {{ $storageInfo['current_usage_formatted'] ?? '0 B' }} / {{ number_format($totalGB, 0) }} GB
                    @if($extraStorage > 0)
                      <div class="storage-extra">+{{ number_format($extraStorage, 0) }} GB ek</div>
                    @endif
                  @endif
                </div>
                @if(isset($storageInfo) && $currentSubscription->plansubs->limits['storage_gb'] > 0)
                  <div class="storage-details">
                    <div class="storage-breakdown">
                      @if(isset($storageInfo['service_photos_size']))
                        <div>Servis: {{ $storageInfo['service_photos_size_formatted'] ?? '0 B' }}</div>
                      @endif
                      @if(isset($storageInfo['stock_photos_size']))
                        <div>Stok: {{ $storageInfo['stock_photos_size_formatted'] ?? '0 B' }}</div>
                      @endif
                      @if(isset($storageInfo['other_files_size']))
                        <div>Diğer: {{ $storageInfo['other_files_size_formatted'] ?? '0 B' }}</div>
                      @endif
                    </div>
                    @if($percentage > 0)
...
/* Storage Feature Special Styling */
.storage-feature .feature-value {
  display: flex;
  flex-direction: column;
  gap: 0.5rem;
}
