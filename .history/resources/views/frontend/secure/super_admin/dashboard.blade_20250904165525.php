                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('super.admin.destek.dashboard') }}" class="list-group-item list-group-item-action d-flex align-items-center justify-content-between py-3">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-xs flex-shrink-0 me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">Destek Talepleri Yönetimi</h6>
                                        <p class="font-size-13 text-muted mb-0">Kullanıcılardan gelen destek taleplerini görüntüleyin ve yönetin.</p>
                                    </div>
                                </div>
                                <div class="flex-shrink-0 text-end">
                                    {{-- Destek talebi sayısı için $stats dizinize yeni bir değer eklemeniz gerekebilir. Şimdilik boş bırakıyorum. --}}
                                    {{-- <span class="badge bg-secondary-subtle text-secondary">X</span> --}}
                                    <i class="ri-arrow-right-s-line align-middle ms-1"></i>
                                </div>
                            </a>
                        </div>
