                ...
                <table class="table table-hover mb-0" id="payments-table">
                  <thead class="table-light">
                    <tr>
                      ...
                      <th class="text-end">Tür</th>
                      <th class="text-end">Açıklama</th>
                      <th class="text-end">Tutar</th>
                      <th class="text-end">Ödeme Yöntemi</th>
...
<div class="tableToplamaAlani odemeToplamaAlani">
  ...
  <div class="row r2">
    ...
    <div class="sag">
      <div class="tur t1 subscriptionCompleted"><span>Tamamlanan:</span></div>
      <div class="tur t2 subscriptionPending"><span>Bekleyen:</span></div>
      <div class="tur t3 subscriptionFailed"><span>Başarısız:</span></div>
      <div class="tur t4 subscriptionTotal"><span>Toplam:</span></div>
    </div>
  </div>
  ...
  <div class="row r4">
    ...
    <div class="sag">
      <div class="tur t1 storageCompleted"><span>Tamamlanan:</span></div>
      <div class="tur t2 storagePending"><span>Bekleyen:</span></div>
      <div class="tur t3 storageFailed"><span>Başarısız:</span></div>
      <div class="tur t4 storageTotal"><span>Toplam:</span></div>
    </div>
  </div>
</div>
...
window.PaymentModule = (function() {
  ...
  return `
    <tr class="payment-row-clickable" data-payment-type="${payment.type}" data-payment-id="${payment.id}" style="cursor: pointer; height: 60px;">
      ...
      <td class="text-end align-middle">${typeBadge}</td>
      <td class="text-end align-middle">
      ...
      <td class="text-end align-middle">${statusBadge}</td>
      <td class="text-end align-middle">
...
.odemeToplamaAlani .r2 {
  background: #dc3545;
}

.odemeToplamaAlani .r4 {
  background: #343a40;
}
...
.odemeToplamaAlani .r2 .sol {
  border-right: 1px solid #b92d3b;
}

.odemeToplamaAlani .r4 .sol {
