  ...
  <div class="col-auto">
    <div class="form-group mb-3">
      ...
      <div class="d-flex flex-nowrap gap-1">
        <button type="button" class="btn btn-outline-light text-dark btn-sm quick-filter" data-days="7" style="white-space: nowrap; font-size: 11px;">Son 7 Gün</button>
        <button type="button" class="btn btn-outline-light text-dark btn-sm quick-filter" data-days="30" style="white-space: nowrap; font-size: 11px;">Son 30 Gün</button>
        <button type="button" class="btn btn-outline-light text-dark btn-sm quick-filter" id="this-month" style="white-space: nowrap; font-size: 11px;">Bu Ay</button>
        <button type="button" class="btn btn-outline-light text-dark btn-sm quick-filter" id="last-month" style="white-space: nowrap; font-size: 11px;">Geçen Ay</button>
