          ...
          <div class="card-body">
                      ...
                      <div class="row align-items-end">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6">
                          <div class="form-group mb-3">
                            <label for="tenant_id" class="form-label fw-bold" style="font-size: 12px;">
                              Firma
                            </label>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6">
                          <div class="form-group mb-3">
                            <label for="date_from" class="form-label fw-bold" style="font-size: 12px;">
                              Başlangıç
                            </label>
                            <input type="date" 
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6">
                          <div class="form-group mb-3">
                            <label for="date_to" class="form-label fw-bold" style="font-size: 12px;">
                              Bitiş
                            </label>
                            <input type="date" 
                              class="form-control form-control-sm" 
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6">
                          <div class="form-group mb-3">
                            <label for="type" class="form-label fw-bold" style="font-size: 12px;">
                              Tür
                            </label>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6">
                          <div class="form-group mb-3">
                            <label for="status" class="form-label fw-bold" style="font-size: 12px;">
                              Durum
                            </label>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="d-flex flex-wrap gap-2 align-items-center">
                            <span class="text-muted fw-bold mr-2" style="font-size: 12px;">
                            ...
                            <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="90">
                              Son 3 Ay
                            </button>
                            <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="365">
                              Son 1 Yıl
                            </button>
                            <button type="button" class="btn btn-outline-secondary btn-sm" id="this-month">
                              Bu Ay
                            </button>
                            <button type="button" class="btn btn-outline-secondary btn-sm" id="last-month">
                              Geçen Ay
                            </button>
                          </div>
                        </div>
            ...
            <div class="tableToplamaAlani">
              <div class="row r1">
                ...
                <div class="sag">
                  <div class="tur t1"><span>Tamamlanan:</span> {{ number_format($pagination->where('status', 'completed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t2"><span>Bekleyen:</span> {{ number_format($pagination->where('status', 'pending')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t3"><span>Başarısız:</span> {{ number_format($pagination->where('status', 'failed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t4"><span>Toplam:</span> {{ number_format($pagination->sum('amount'), 2) }} ₺</div>
                </div>
              </div>
              ...
              <div class="row r2">
                ...
                <div class="sag">
                  <div class="tur t1"><span>Tamamlanan:</span> {{ number_format($pagination->where('type', 'subscription')->where('status', 'completed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t2"><span>Bekleyen:</span> {{ number_format($pagination->where('type', 'subscription')->where('status', 'pending')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t3"><span>Başarısız:</span> {{ number_format($pagination->where('type', 'subscription')->where('status', 'failed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t4"><span>Toplam:</span> {{ number_format($pagination->where('type', 'subscription')->sum('amount'), 2) }} ₺</div>
                </div>
              </div>
              ...
              <div class="row r3">
                ...
                <div class="sag">
                  <div class="tur t1"><span>Tamamlanan:</span> {{ number_format($pagination->where('type', 'storage')->where('status', 'completed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t2"><span>Bekleyen:</span> {{ number_format($pagination->where('type', 'storage')->where('status', 'pending')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t3"><span>Başarısız:</span> {{ number_format($pagination->where('type', 'storage')->where('status', 'failed')->sum('amount'), 2) }} ₺</div>
                  <div class="tur t4"><span>Toplam:</span> {{ number_format($pagination->where('type', 'storage')->sum('amount'), 2) }} ₺</div>
                </div>
              </div>
