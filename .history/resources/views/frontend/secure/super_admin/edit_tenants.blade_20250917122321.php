...
<div class="card-body p-2">
  ...
  <div class="border rounded p-2 mt-2">
    ...
    @if($isTrialFromTenant || ($currentSubscription && $currentSubscription->plansubs))
      <!-- Abonelik Durumu -->
      <div class="border border-2 rounded p-2 mb-2" style="border-color: #007bff !important;">
      ...
      <!-- Paket Özellikleri -->
      <div class="border border-2 rounded p-1 mt-2" style="border-color: #007bff !important;">
        <div class="row g-2">
