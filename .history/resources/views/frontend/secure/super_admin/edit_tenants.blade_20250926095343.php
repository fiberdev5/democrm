...
<div class="unified-subscription-storage-widget">
    ...
    <div class="widget-header">
        ...
        <div class="widget-actions">
            ...
            <button class="btn-details" onclick="toggleUnifiedDetails()" title="Detaylar">
    ...
    <div class="unified-details" id="unifiedDetails" style="display: none;">
        <div class="details-row">
            <!-- Subscription Details -->
            <div class="details-column">
                <h6><i class="fas fa-info-circle"></i> Abonelik Detayları</h6>
                <div class="detail-items">
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Bayi:</span>
                        <span class="detail-value">
                            @if($isTrialFromTenant)
                            ...
                            @elseif(isset($currentSubscription->plansubs->limits['dealers']))
                                @if($currentSubscription->plansubs['dealers'] == -1)
                                    Sınırsız
                                @else
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Stok Ürün:</span>
                        <span class="detail-value">
                            @if($isTrialFromTenant)
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Konsinye:</span>
                        <span class="detail-value">
                            @if($isTrialFromTenant)
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Aylık Destek:</span>
                        <span class="detail-value">
            ...
            <!-- Storage Details -->
            <div class="details-column">
                <h6><i class="fas fa-folder-open"></i> Depolama Detayları</h6>
                <div class="detail-items" id="storageBreakdown">
                    <div class="detail-item">
