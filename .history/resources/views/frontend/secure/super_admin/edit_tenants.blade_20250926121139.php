    ...
    <div class="widget-main-content">
        ...
        <div class="storage-section">
            <div class="section-header">
               ...
               @php
                    // Depolama yüzdesini doğru hesapla
                    $storageUsagePercent = 0;
                    if(isset($storageInfo['current_usage_bytes']) && isset($storageInfo['limit_bytes']) && $storageInfo['limit_bytes'] > 0) {
                        $storageUsagePercent = ($storageInfo['current_usage_bytes'] / $storageInfo['limit_bytes']) * 100;
                        $storageUsagePercent = min(100, round($storageUsagePercent, 1));
                    }
                    
                    // Kullanılan ve kalan miktarları hesapla
                    $usedGB = 0;
                    $totalGB = 0;
                    $remainingGB = 0;
                    
                    if(isset($storageInfo['current_usage_bytes'])) {
                        $usedGB = $storageInfo['current_usage_bytes'] / (1024*1024*1024); // GB'ye çevir
                    }
                    if(isset($storageInfo['limit_bytes'])) {
                        $totalGB = $storageInfo['limit_bytes'] / (1024*1024*1024); // GB'ye çevir
            ...
            <!-- Storage Progress - Compact -->
             <div class="storage-progress-compact">
                <div class="storage-stats">
                    ...
                    <div class="stat">
                        <span class="value">{{ number_format($usedGB, 2) }} GB</span>
                ...
                <div class="storage-info">
                    <small>{{ number_format($usedGB, 2) }} GB kullanılan / {{ number_format($totalGB, 0) }} GB toplam</small>
                </div>
            </div>
