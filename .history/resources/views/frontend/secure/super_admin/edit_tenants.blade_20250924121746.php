...
/* ÖDEME TABLOSU STİLLERİ - DÜZENLENDİ */
.table {
...
.table th {
  ...
  padding: 12px 15px !important; /* Padding artırıldı */
  background-color: #f8f9fa;
  position: sticky;
  top: 0;
  z-index: 1;
...
.table td {
  ...
  font-size: 0.875rem;
  text-align: left !important;
  padding: 15px !important; /* Padding artırıldı */
...
.payment-row-clickable:hover td {
  border-left-color: #0d6efd;
}

/* BUTON STİLLERİ - DÜZENLENDİ */
.btn-group-sm {
  display: inline-flex;
  vertical-align: middle;
  gap: 2px;
...
.btn-group-sm .btn {
  padding: 6px 10px !important; /* Padding artırıldı */
  font-size: 0.75rem;
  border-radius: 4px !important; /* Yuvarlaklık geri eklendi */
...
/* Buton hover efektleri - Beyaz renk sorunu çözüldü */
.btn-outline-primary {
...
/* Tablo başlık hizalaması */
.table thead th:nth-child(1) { width: 15%; } /* Tarih */
.table thead th:nth-child(2) { width: 12%; } /* Tür */
.table thead th:nth-child(3) { width: 25%; } /* Açıklama */
.table thead th:nth-child(4) { width: 12%; } /* Tutar */
.table thead th:nth-child(5) { width: 15%; } /* Ödeme Yöntemi */
.table thead th:nth-child(6) { width: 12%; } /* Durum */
.table thead th:nth-child(7) { width: 9%; }  /* İşlemler */
