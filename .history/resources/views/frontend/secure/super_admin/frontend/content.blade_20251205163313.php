                        ...
                        <div class="tab-content p-3">
                            ...
                            <div class="tab-pane active" id="hero" role="tabpanel">
                                ...
                                <form id="heroForm">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Hero Resmi</label>
                                        <input type="file" class="form-control" id="hero_image_file" accept="image/*">
                                        <small class="text-muted">Önerilen boyut: 800x600px (Boş bırakırsanız mevcut resim korunur)</small>
...
$('#heroForm').on('submit', function(e) {
    ...
    if(imageFile) {
        ...
        // Mevcut resmi koru
        formData.append('existing_image', $('#hero_image').val());
    }
