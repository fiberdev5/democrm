                        ...
                        <form action="{{ route('super.admin.frontend.legal-pages.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="section" {{ $page ? 'disabled' : '' }} required>
                                    ...
                                    <option value="kullanim-sartlari" {{ $section == 'kullanim-sartlari' ? 'selected' : '' }}>Kullanım Şartları</option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="legal_content" name="content" rows="20">{{ $page->content['content'] ?? '' }}</textarea>
...
<!-- TinyMCE veya Summernote Editor -->
<script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
tinymce.init({
    selector: '#legal_content',
    height: 500,
    menubar: true,
    plugins: [
    ...
    toolbar: 'undo redo | blocks | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | code | help',
