                            ...
                            <div class="tab-pane active" id="navbar" role="tabpanel">
                                ...
                                <form id="navbarForm">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label class="form-label">Logo Dosya Yolu</label>
                                                <input type="text" class="form-control" id="navbar_logo" 
                                                       value="{{ $navbar->content['logo'] ?? 'frontend/img/logo_turkce.png' }}" 
                                                       placeholder="frontend/img/logo_turkce.png">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-info">
                                        <strong>Not:</strong> Menü öğelerini şu an için JSON formatında düzenlemeniz gerekiyor. İlerleyen zamanlarda drag & drop menü düzenleyicisi eklenecektir.
                                    </div>
...
$('#navbarForm').on('submit', function(e) {
    ...
    // Mevcut menu_items'ı koru, sadece butonları ve logoyu güncelle
    const existingNavbar = {!! json_encode($navbar->content ?? []) !!};
    
    const content = {
        logo: $('#navbar_logo').val(),
    ...
    saveContent('navbar_content', content, '#navbar');
});
