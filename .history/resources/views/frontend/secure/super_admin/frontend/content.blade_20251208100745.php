...
$('.header-form').on('submit', function(e) {
    ...
    // Eğer currentData boş veya geçerli bir obje değilse, yeni bir obje oluştur
    ...
    $.ajax({
        ...
        error: function(xhr) {
            console.error('Hata:', xhr.responseText); // Debug için
            toastr.error('Bir hata oluştu');
        }
    });
});
