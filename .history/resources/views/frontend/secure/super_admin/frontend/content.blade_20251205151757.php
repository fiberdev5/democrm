                        ...
                        <div class="tab-content p-3">
                            ...
                            <div class="tab-pane active" id="hero" role="tabpanel">
                                ...
                                <form id="heroForm">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Hero Resmi (Yol)</label>
                                        <input type="text" class="form-control" id="hero_image" value="{{ $hero->content['image'] ?? '' }}">
                                    </div>
                            ...
                            <div class="tab-pane" id="headers" role="tabpanel">
                                ...
                                <div class="card mb-3">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0">İstatistikler Bölümü</h6>
                                    </div>
                                    <div class="card-body">
                                        <form class="header-form" data-section="stats">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Badge</label>
                                                    <input type="text" class="form-control" name="badge" value="{{ $sectionHeaders->content['stats']['badge'] ?? '' }}">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Başlık</label>
                                                    <input type="text" class="form-control" name="title" value="{{ $sectionHeaders->content['stats']['title'] ?? '' }}">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label">Vurgulanan Kelime</label>
                                                    <input type="text" class="form-control" name="highlight" value="{{ $sectionHeaders->content['stats']['highlight'] ?? '' }}">
                                                </div>
                                            </div>
...
$('#heroForm').on('submit', function(e) {
    ...
    const data = {
        ...
        content: {
            ...
            primary_button_icon: $('#hero_primary_icon').val(),
            secondary_button_text: $('#hero_secondary_btn').val(),
            secondary_button_icon: $('#hero_secondary_icon').val(),
            features: features,
            image: $('#hero_image').val()
        }
    };
...
$('.header-form').on('submit', function(e) {
    ...
    // Mevcut section_headers'ı al ve güncelle
    const currentData = @json($sectionHeaders->content ?? []);
    ...
    $.ajax({
        ...
        success: function(response) {
            toastr.success(section.toUpperCase() + ' bölüm başlığı güncellendi');
