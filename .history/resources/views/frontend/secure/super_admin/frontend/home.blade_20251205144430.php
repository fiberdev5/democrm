                                            ...
                                            <table class="table table-bordered table-hover align-middle">
                                                ...
                                                <tbody id="testimonialsTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div style="width: 20px; height: 30px; background: {{ $testimonial->data['color'] == 'blue' ? '#49657B' : '#f37021' }}; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; margin: 0 auto;">
