                                            ...
                                            @foreach($features->content['categories'] as $catIndex => $category)
                                                <div class="card mb-4 category-item">
                                                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="{{ route('frontend.secure.super_admin.frontend.feature_detail', $category['slug']) }}" class="btn btn-light btn-sm me-2">
...
$(document).on('input', '.category-slug', function() {
    ...
    if(slug) {
        const detailUrl = "{{ route('frontend.secure.super_admin.frontend.feature_detail', ':slug') }}".replace(':slug', slug);
