                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="text" class="form-control menu-title" value="{{ $item['title'] }}" readonly="false">
                                        </div>
                                        <div class="col-md-4 mb-2">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Başlık</label>
                        <input type="text" class="form-control menu-title" placeholder="ANASAYFA" value="">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Tip</label>
                        <select class="form-control menu-type">
...
$('#navbarForm').on('submit', function(e) {
    ...
    console.log('Toplanan menü öğeleri:', menuItems); // Debug için
    ...
    console.log('Gönderilecek content:', content); // Debug için
    ...
    $.ajax({
        ...
        error: function(xhr) {
            console.error('AJAX Hatası:', xhr); // Debug için
