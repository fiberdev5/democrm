                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="statsTable">
                                            ...
                                            <tr>
                                                <td class="align-middle">{{ $stat->order }}</td>
                                                <td class="align-middle">{{ $stat->data['number'] ?? '' }}</td>
                                                <td class="align-middle">{{ $stat->data['label'] ?? '' }}</td>
                                                <td class="align-middle">
                                                    <span class="badge bg-{{ $stat->is_active ? 'success' : 'danger' }}">
                                                        {{ $stat->is_active ? 'Aktif' : 'Pasif' }}
                                                    </span>
                                                </td>
                                                <td class="text-center align-middle"> <!-- Ortalamak için class eklendi -->
                                                    <button class="btn btn-link p-0 me-3" onclick="editStat({{ $stat->id }})">
                                                        <i class="fas fa-edit text-warning" ></i>
                                                    </button>
                                                    <button class="btn btn-link p-0" onclick="deleteStat({{ $stat->id }})">
