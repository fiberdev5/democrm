                      ...
                      <div class="col-auto">
                        <div class="form-group mb-3">
                          ...
                          <div class="d-flex gap-1">
                            <button type="button" class="btn btn-outline-secondary  action-btn" id="clear-filter" title="Temizle">
                              <i class="fas fa-eraser"></i>
                            </button>
                            <a href="#" class="btn btn-outline-secondary  action-btn" id="excel-export" title="Excel İndir">
