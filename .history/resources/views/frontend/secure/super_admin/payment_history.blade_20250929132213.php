  ...
  <div class="col-lg-2 col-md-6 col-sm-12">
    <div class="form-group mb-3">
      ...
      <div class="d-flex flex-wrap gap-1">
        <button type="button" class="btn btn-outline-secondary btn-sm quick-filter px-2" data-days="7" style="white-space: nowrap; font-size: 11px;">Son 7</button>
        <button type="button" class="btn btn-outline-secondary btn-sm quick-filter px-2" data-days="30" style="white-space: nowrap; font-size: 11px;">Son 30</button>
        ...
        <button type="button" class="btn btn-outline-secondary btn-sm px-2" id="last-month" style="white-space: nowrap; font-size: 11px;">G.Ay</button>
      </div>
    </div>
  </div>
</div>
