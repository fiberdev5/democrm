...
<div class="row g-3">
    ...
    <div class="col-lg-6 col-12">
        <div class="modern-widget subscription-widget">
            <!-- Widget Header -->
            <div class="widget-header">
                <div class="widget-title">
                    <i class="fas fa-crown widget-icon"></i>
                ...
                <div class="widget-actions">
                    <button class="btn-refresh" onclick="refreshSubscriptionInfo()" title="Yenile">
                        <i class="fas fa-sync-alt"></i>
                    </button>
                    <button class="btn-details" onclick="toggleSubscriptionDetails()" title="Detaylar">
                    ...
                    <div class="time-progress">
                        <div class="time-info">
                            <div class="time-item">
                                <div class="time-value">
                                    @if($isTrialFromTenant)
                                        {{ $tenant->trial_ends_at->diffInDays(now()) }}
                                    @else
                                        {{ $currentSubscription->getRemainingDays() ?? 0 }}
                                    @endif
                                </div>
                                <div class="time-label">Kalan Gün</div>
                            </div>
                            <div class="time-divider"></div>
                            <div class="time-item">
                                <div class="time-value">30</div>
                                <div class="time-label">Toplam Gün</div>
                            </div>
                        </div>
                        ...
                        <div class="circular-progress">
                            <svg class="progress-ring" width="100" height="100">
                                ...
                                <circle class="progress-ring-circle progress-success" 
                                        cx="50" cy="50" r="40" 
                ...
                <div class="linear-progress-container">
                    <div class="progress-info">
                        <span class="start-date">
                            Başlangıç: {{ $currentSubscription->starts_at ? $currentSubscription->starts_at->format('d.m.Y') : ($tenant->created_at->format('d.m.Y')) }}
                        </span>
                        <span class="end-date">
                            Bitiş: 
                            @if($isTrialFromTenant)
                    ...
                    <div class="progress-bar-container">
                        <div class="progress-bar-bg">
                            <div class="progress-bar-fill bg-gradient-success" style="width: 77%">
            ...
            <div class="subscription-features" id="subscriptionFeatures" style="display: none;">
                <div class="features-grid">
                    <div class="feature-item">
                        <i class="fas fa-users text-primary"></i>
                        <div class="feature-info">
                            <span class="feature-label">Kullanıcı</span>
                            <span class="feature-value">
                                @if($isTrialFromTenant)
                                    @if($tenant->personelSayisi == -1)
                                        Sınırsız
                                    @else
                                        {{ $tenant->personelSayisi ?? 'Belirsiz' }}
                                    @endif
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-info">
                            <span class="feature-label">Bayi</span>
                            <span class="feature-value">
                                @if($isTrialFromTenant)
                                    @if($tenant->bayiSayisi == -1)
                                        Sınırsız
                                    @else
                                        {{ $tenant->bayiSayisi ?? 'Belirsiz' }}
                                    @endif
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-info">
                            <span class="feature-label">Stok Ürün</span>
                            <span class="feature-value">
                                @if($isTrialFromTenant)
                                    @if($tenant->stokSayisi == -1)
                                        Sınırsız
                                    @else
                                        {{ $tenant->stokSayisi ?? 'Belirsiz' }}
                                    @endif
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-info">
                            <span class="feature-label">Konsinye</span>
                            <span class="feature-value">
                                @if($isTrialFromTenant)
                                    @if($tenant->konsinyeSayisi == -1)
                                        Sınırsız
                                    @else
                                        {{ $tenant->konsinyeSayisi ?? 'Belirsiz' }}
                                    @endif
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-info">
                            <span class="feature-label">Aylık Destek</span>
                            <span class="feature-value">
            ...
            <div class="widget-actions-bottom">
                <button class="btn btn-manage-widget" onclick="toggleSubscriptionDetails()">
                    <i class="fas fa-info-circle"></i>
                    <span>Detaylar</span>
                </button>
                <button class="btn btn-upgrade-widget">
    ...
    <!-- Depolama Widget -->
    <div class="col-lg-6 col-12">
        <div class="modern-widget storage-widget">
            <!-- Widget Header -->
            <div class="widget-header">
                <div class="widget-title">
                    ...
                    @if(isset($storageInfo['danger_threshold']) && $storageInfo['danger_threshold'])
                        <span class="status-badge status-danger">Kritik Seviye</span>
                    @elseif(isset($storageInfo['warning_threshold']) && $storageInfo['warning_threshold'])
                        <span class="status-badge status-warning">Dikkat Gerekli</span>
                    @else
            ...
            <div class="storage-overview">
                <div class="usage-container">
                        ...
                        <svg class="progress-ring" width="120" height="120">
                            ...
                            <circle class="progress-ring-circle 
                                ...
                                @endif" 
                                    ...
                                    stroke-dashoffset="{{ 314 - (314 * ($storageInfo['usage_percentage'] ?? 0) / 100) }}">
                            </circle>
                        </svg>
                        <div class="progress-text">
                            <span class="percentage">{{ $storageInfo['usage_percentage'] ?? 0 }}%</span>
                    ...
                    <div class="usage-stats">
                        <div class="stat-item">
                            <div class="stat-value">{{ $storageInfo['current_usage_formatted'] ?? '0 B' }}</div>
                            <div class="stat-label">Kullanılan</div>
                        </div>
                        <div class="stat-divider"></div>
                        <div class="stat-item">
                            <div class="stat-value">{{ $storageInfo['remaining_formatted'] ?? '0 B' }}</div>
                            <div class="stat-label">Kalan</div>
                        </div>
                        <div class="stat-divider"></div>
                        <div class="stat-item">
                            <div class="stat-value">{{ $storageInfo['limit_formatted'] ?? '0 GB' }}</div>
                ...
                <div class="linear-progress-container">
                    <div class="progress-info">
                        <span class="current-usage">{{ $storageInfo['current_usage_formatted'] ?? '0 B' }}</span>
                        <span class="total-limit">{{ $storageInfo['limit_formatted'] ?? '0 GB' }}</span>
                    </div>
                    <div class="progress-bar-container">
                        <div class="progress-bar-bg">
                            <div class="progress-bar-fill 
                                ...
                                @endif" 
                                 ...
                                 data-percentage="{{ $storageInfo['usage_percentage'] ?? 0 }}">
                                <div class="progress-bar-glow"></div>
                            </div>
                        </div>
                        <div class="progress-markers">
            ...
            <!-- Alert Messages -->
            @if(isset($storageInfo['danger_threshold']) && $storageInfo['danger_threshold'])
                <div class="storage-alert alert-danger">
            ...
            @elseif(isset($storageInfo['warning_threshold']) && $storageInfo['warning_threshold'])
                <div class="storage-alert alert-warning">
                    ...
                    <div class="alert-content">
                        ...
                        <p>%{{ $storageInfo['usage_percentage'] ?? 0 }} kullanıldı. Yakında limit dolacak.</p>
                    </div>
                </div>
            @endif

            <!-- Storage Details (Hidden by default) -->
                    ...
                    <div class="plan-details">
                        <span class="plan-name">
                            @if($isTrialFromTenant)
                                Ücretsiz Deneme
                            @else
                                {{ $currentSubscription->plansubs->name ?? 'Temel' }}
                            @endif
                        </span>
                        <span class="plan-limit">{{ $storageInfo['limit_formatted'] ?? '0 GB' }} Depolama</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Action Buttons -->
            <div class="widget-actions-bottom">
                @if(isset($storageInfo['warning_threshold']) && $storageInfo['warning_threshold'])
                    <a href="{{ route('subscription.plans', $tenant->id) }}" class="btn btn-upgrade-widget">
                        <i class="fas fa-arrow-up"></i>
                        <span>Planı Yükselt</span>
                    </a>
                    <a href="{{ route('storage.packages', $tenant->id) }}" class="btn btn-storage-widget">
                        <i class="fas fa-plus-circle"></i>
                        <span>Ek Depolama</span>
                    </a>
                @endif
                
                <button class="btn btn-manage-widget" onclick="toggleStorageDetails()">
...
function createPaymentRow(payment) {
  ...
  function refreshSubscriptionInfo() {
    const refreshBtn = document.querySelector('.subscription-widget .btn-refresh');
...
function refreshStorageInfo() {
    const refreshBtn = document.querySelector('.storage-widget .btn-refresh');
    const icon = refreshBtn.querySelector('i');
    
    icon.style.animation = 'spin 1s linear infinite';
    
    // Buraya AJAX çağrısı eklenecek - mevcut loadStorageDetails fonksiyonu kullanılabilir
    setTimeout(() => {
        icon.style.animation = '';
...
function toggleSubscriptionDetails() {
    const details = document.getElementById('subscriptionFeatures');
...
function toggleStorageDetails() {
    ...
    if (isVisible) {
        ...
        details.style.display = 'block';
        // Mevcut loadStorageDetails fonksiyonu varsa çağır
        if (typeof loadStorageDetails === 'function') {
            loadStorageDetails();
        }
    }
...
.btn-upgrade-widget, .btn-storage-widget {
    background: rgba(255, 255, 255, 0.1);
    color: white;
    flex: 1;
    border: 1px solid rgba(255,255,255,0.2);
...
.btn-upgrade-widget:hover, .btn-storage-widget:hover {
    background: rgba(255, 255, 255, 0.2);
    color: white;
...
.text-purple { color: #ba68c8 !important; }

/* Loading state */
.modern-widget.loading {
    opacity: 0.7;
    pointer-events: none;
}

.modern-widget.loading .btn-refresh i {
...
@media (max-width: 576px) {
    ...
    .circular-progress .progress-ring-circle-bg,
