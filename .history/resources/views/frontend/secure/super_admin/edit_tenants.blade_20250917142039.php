<!-- Tenant Detay Modal -->
<!-- Header -->
<div class="card bg-primary text-white d-flex align-items-left justify-content-between" style="margin-bottom: 0px !important;" >
  ...
  <button type="button" class="btn-close btn-close-white align-items-right!important" data-bs-dismiss="modal"></button>
</div>
