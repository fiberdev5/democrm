...
@media (max-width: 768px) {
  ...
  /* Servis İstatistikleri Özel Stiller */
       .service-stats-wrapper {
        ...
        .service-period-item:hover {
            background: #f8f9fa;
            color: #495057;
        }

        .service-period-item.period-selected {
            background: #e9ecef;
            color: #212529;
        }
        ...
        .service-data-list::-webkit-scrollbar {
            width: 6px;
        }

        .service-data-list::-webkit-scrollbar-track {
            background: #f8f9fa;
        }

        .service-data-list::-webkit-scrollbar-thumb {
            background: #dee2e6;
            border-radius: 3px;
        }
