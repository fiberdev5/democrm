...
<form method="post" id="editInvo" action="{{ route('super.admin.invoices.update')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
  ...
  <div class="card f5">
    <div class="card-header ch1" style="padding: 3px 10px;">
      <div class="tarihWrap" style="display: flex; align-items: center; gap: 6px;">
  <label style="display: flex; justify-content: flex-end; margin: 0;">
    Tarih<span style="font-weight: bold; color: red;"> *</span>
  </label>
  <input type="date" name="faturaTarihi" 
         class="form-control datepicker kayitTarihi" 
         value="{{ \Carbon\Carbon::parse($invoice_id->faturaTarihi)->format('Y-m-d')}}" 
...
$(document).ready(function() {
    ...
    if (response.status === 'success') {
        ...
        uploadBtn.html('<i class="fas fa-check"></i>');
