     ...
     <div class="card-body">
        <div class="row">
           <div class="col-sm-6 s1">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8 rw2">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div>
                            <div style="font-weight: 600; color: #495057; margin-bottom: 5px;" id="seciliFirmaAdi"></div>
                            <div style="font-size: 12px; color: #6c757d;" id="seciliFirmaDetay"></div>
                            </div>
              ...
              <!-- Diğer firma bilgileri firma seçildikten sonra gösterilecek -->
           </div>
        </div>
     </div>
  </div>
...
<script type="text/javascript">
  ...
  window.firmaSec = function(id, firmaAdi, tel1, tel2, il, ilce, adres, vergiNo, vergiDairesi) {
    ...
    $('#seciliFirmaDetay').html(
        '<div style="margin-bottom: 2px;">Telefon: ' + (tel1 || 'Belirtilmemiş') + '</div>' +
        '<div style="margin-bottom: 2px;">' + (il || '') + '/' + (ilce || '') + '</div>' +
  ...
  window.firmaTemizle = function() {
    ...
    $('input[name="vergiNo"]').val('');
    $('input[name="vergiDairesi"]').val('');
    $('input[name="tel1"]').val('');
    $('input[name="tel2"]').val('');
    $('input[name="il"]').val('');
    $('input[name="ilce"]').val('');
...
function firmaListesiGoster(firmalar) {
    ...
    if (firmalar.length === 0) {
        ...
        firmalar.forEach(function(firma) {
            ...
            var vergiNo = firma.vergNo ? firma.vergNo.replace(/'/g, "\\'") : '';
