...
$(document).ready(function() {
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        alert(response.message);
                              ...
                              uploadBtn.find('i').removeClass('fas fa-spinner fa-spin fas fa-upload').addClass('fas fa-check');
    ...
    function resetUploadButton() {
        var uploadBtn = $('#uploadPdfBtn');
        uploadBtn.find('i').removeClass('fas fa-spinner fa-spin fas fa-check').addClass('fas fa-upload');
        uploadBtn.prop('disabled', false);
