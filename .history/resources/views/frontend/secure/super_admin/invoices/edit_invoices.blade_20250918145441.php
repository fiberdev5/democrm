     ...
     <div class="card-body">
        <div class="row">
           <div class="col-12">
              ...
              <!-- Hidden inputs for form submission - vergiNo ve vergiDairesi field isimleri düzeltildi -->
...
<!-- InvoiceModal - Bu modal eksikti, onu ekledim -->
<div class="modal fade" id="InvoiceModal" tabindex="-1" aria-labelledby="InvoiceModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="InvoiceModalLabel">Fatura Düzenle</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
$(document).ready(function(){
    // Modal açma işlemi - Geliştirilmiş hata yakalama ile
    $('#editInvo').on('click', '.invoic_e', function(e){
        ...
        if(!id) {
            ...
            alert('Fatura ID bulunamadı');
            return;
        }
        
        console.log('Fatura ID:', id);
        
        // Modal'ı göster ve loading içeriği ekle
        ...
        $('#InvoiceModal .modal-body').html(`
            <div class="d-flex justify-content-center align-items-center" style="min-height: 200px;">
                <div class="text-center">
                    ...
                    <div class="mt-2">Fatura yükleniyor...</div>
                </div>
            </div>
        `);
...
<script>
  $(document).ready(function() {
    ...
    // Müşteri değiştirme modalı - data attribute'lar düzeltildi
    $('.musteriKaydet').click(function() {
      ...
      if (selectedOption.val()) {
        ...
        console.log('Seçilen müşteri:', {id, firmaAdi, tel1, il, ilce, adres, vergiNo, vergiDairesi});
