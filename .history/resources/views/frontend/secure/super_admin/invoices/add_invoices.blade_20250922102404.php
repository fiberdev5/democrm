...
<script type="text/javascript">
  ...
  function autoFillFormFromPayment(amount, description) {
    ...
    // Fiyat ve tutar alanlarını KDV hariç tutarla doldur
...
<script>
  $(document).ready(function (e) {
    ...
    $(document).on('click', '.satirSil', function () {
      ...
      // Satır silindikten sonra toplamı yeniden hesapla
      sonucToplam = 0;
      $('.miktar').each(function(index, data) {
        var fiyat = Number($(".fiyat"+index).val()) || 0;
        var miktar = Number($(this).val()) || 0;
...
$(document).click(function(e) {
    ...
    $('#addInvo').submit(function (event) {
      ...
      // Ödeme seçimi kontrolü - isteğe bağlı hale getirildi
      // Bu kontrol kaldırıldı çünkü manuel fatura girişi de olabilir
