          ...
          <div class="row form-group">
            ...
            <div class="col-md-9 rw2">
              <input type="text" id="firmaArama" class="form-control" placeholder="Firma adı yazın..." autocomplete="off">
               <button type="button" id="bekleyenOdemelerBtn" class="btn btn-sm btn-primary" title="Faturası olmayan ödemeli firmaları göster">
                <i class="fas fa-filter"></i> Bekleyen
              </button>
