    ...
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="myModalLabel">Fatura Ekle</h6>
         <div class="tarihWrap d-flex align-items-center">
    <label class="me-2 mb-0">Tarih <span style="font-weight: bold; color: red;">*</span></label>
    <input type="date" name="faturaTarihi" class="form-control form-control-sm" 
           value="{{date('Y-m-d')}}" style="width:97px; background:#fff;     margin-left: 566px !important;" required>
  </div>
