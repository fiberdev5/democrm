...
function firmaListesiGoster(firmalar) {
    ...
    if (firmalar.length === 0) {
        ...
        firmalar.forEach(function(firma) {
            const item = `
                <li class="list-group-item" style="cursor: pointer;" onclick="firmaSecç(${firma.id}, '${firma.firma_adi}', '${firma.tel1 || ''}', '${firma.tel2 || ''}', '${firma.il || ''}', '${firma.ilce || ''}', '${firma.adres || ''}', '${firma.vergNo || ''}', '${firma.vergiDairesi || ''}')">
