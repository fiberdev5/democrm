<style>
  ...
  /* Firma listesi öğeleri için yeni stil */
  #firmaListesi .list-group-item {
    padding: 8px 12px;
    font-size: 12px;
    background: #343a40;
    color: #fff;
  ...
  #firmaListesi .list-group-item:first-child {
    border-top-left-radius: 4px;
    border-top-right-radius: 4px;
  }

  #firmaListesi .list-group-item:last-child {
  ...
  .firma-search-input::placeholder {
    color: #adb5bd;
  }
