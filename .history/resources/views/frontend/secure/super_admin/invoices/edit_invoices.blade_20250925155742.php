...
@endif
  ...
  <div class="col-md-8 rw2">
    <div class="btnWrap">
      ...
      <!-- YENİ: Modal olmadan direkt yükleme butonu -->
      <div style="display: inline-block; position: relative;">
        ...
        <button type="button" class="btn btn-success btn-sm" onclick="document.getElementById('pdfFileInput').click();" title="Yükle">
