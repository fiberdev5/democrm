...
function refreshPaymentList() {
  ...
  function updateSelectedPaymentsSummary() {
    ...
    selectedPayments.forEach(function(payment, index) {
        ...
        html += '</div>';
        html += '<div style="font-weight: 600; margin-right: 10px;">' + payment.amount + ' TL</div>';
      ...
      success: function(payments) {
        ...
        if (payments.length === 0) {
          ...
          payments.forEach(function(payment) {
            ...
            // Eğer mevcut bağlı ödeme ise selectedPayments array'ine ekle (sadece ilk yüklemede)
            if (isExistingPayment && selectedPayments.length === 0) {
              selectedPayments.push({
