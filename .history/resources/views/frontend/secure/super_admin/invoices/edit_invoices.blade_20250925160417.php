...
$(document).ready(function() {
    ...
    $('#pdfFileInput').on('change', function() {
        ...
        if (fileInput.files.length > 0) {
            ...
            var uploadBtn = $(fileInput).siblings('button');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        // Görüntüle butonunu göster/güncelle
                        var viewBtn = $('.btnWrap a[href*="asset"]');
                        ...
                        // Başarı efekti
                        uploadBtn.addClass('btn-success').removeClass('btn-primary');
                        setTimeout(function() {
                            uploadBtn.removeClass('btn-success').addClass('btn-primary');
                        }, 2000);
