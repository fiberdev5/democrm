...
<div class="row form-group">
    ...
    <div class="col-md-9 rw2">
        <div style="display: flex; gap: 5px; margin-bottom: 5px; align-items: stretch;">
            ...
            <button type="button" id="bekleyenOdemelerBtn" class="btn btn-sm" style="background: #5dade2; color: white; white-space: nowrap; padding: 6px 10px; border: none;" title="Faturası oluşturulmamış ödemesi olan firmaları göster">
