...
<div class="row form-group" style="border:0">
  ...
  <div class="col-md-8 rw2">
    <div class="btnWrap">
      ...
      <a href="#" target="_blank" class="btn btn-warning btn-sm btn-block d-none" id="viewPdfBtn">Görüntüle</a>
      @else
      <a href="{{asset($invoice_id->faturaPdf)}}" target="_blank" class="btn btn-warning btn-sm btn-block" id="viewPdfBtn">Görüntüle</a>
      @endif
      
      <!-- YENİ: Modal olmadan direkt yükleme butonu - belge varsa devre dışı -->
      <div style="display: inline-block; position: relative;">
        ...
        <button type="button" 
          ...
          @if($invoice_id->faturaPdf != null) Yüklendi @else Yükle @endif
        </button>
      </div>
