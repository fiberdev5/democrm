...
<div class="row form-group">
    ...
    <div class="col-md-9 rw2">
        <div style="display: flex; gap: 8px; margin-bottom: 5px;">
            ...
            <button type="button" id="bekleyenOdemelerBtn" class="btn btn-sm btn-warning" style="white-space: nowrap; padding: 6px 12px;" title="Faturası oluşturulmamış ödemesi olan firmaları göster">
