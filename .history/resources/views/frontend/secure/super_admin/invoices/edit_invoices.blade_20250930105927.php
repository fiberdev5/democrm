  ...
  <div style="display: inline-block; position: relative;">
    ...
    @if($invoice_id->faturaPdf != null)
      ...
      <a href="{{asset($invoice_id->faturaPdf)}}" target="_blank" 
         style="display: inline-block; padding: 6px 12px; border: 1px solid #dee2e6; border-radius: 4px; color: #495057; text-decoration: none; font-size: 12px; background: #f8f9fa;"
         id="uploadedFileBtn"
      ...
      <a href="" class="btn btn-outline-danger btn-sm mobilBtn mbuton1 eArsivSil" data-id="{{$invoice_id->id}}" title="Sil" style="margin-left: 5px;">
        <i class="fas fa-trash-alt"></i>
      </a>
    @else
      <!-- Dosya yoksa "Dosya Seç" butonu -->
      <button type="button" 
              style="display: inline-block; padding: 6px 12px; border: 1px solid #dee2e6; border-radius: 4px; color: #495057; background: #fff; font-size: 12px; cursor: pointer;"
              id="uploadPdfBtn"
