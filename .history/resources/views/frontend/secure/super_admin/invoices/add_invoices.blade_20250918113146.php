  ...
  $(document).ready(function (e) {
    ...
    $('.firmaSecim').change(function() {
      ...
      if (selectedOption.val()) {
        $('.vergiNo').val(selectedOption.data('vergi-no'));
        $('.vergiDairesi').val(selectedOption.data('vergi-dairesi'));
        $('.il').val(selectedOption.data('il'));
        $('.ilce').val(selectedOption.data('ilce'));
        $('.adres').val(selectedOption.data('adres'));
      } else {
        // Temizle
        $('.vergiNo').val('');
        $('.vergiDairesi').val('');
