           ...
           <div class="col-12">
              <div class="row form-group">
                 ...
                 <div class="col-md-10 rw2">
                   ...
                   <div id="seciliFirma" style="display: none; background: #f8f9fa; border: 1px solid #dee2e6; padding: 15px; margin-top: 5px; border-radius: 4px;">
...
<script type="text/javascript">
  ...
  window.firmaSec = function(id, firmaAdi, tel1, tel2, il, ilce, adres, vergiNo, vergiDairesi) {
    ...
    $('#seciliFirmaDetay').html(
        '<div style="margin-bottom: 3px;">📞 Telefon: ' + (tel1 || 'Belirtilmemiş') + (tel2 ? ' / ' + tel2 : '') + '</div>' +
        '<div style="margin-bottom: 3px;">📍 Konum: ' + (il || '') + '/' + (ilce || '') + '</div>' +
        '<div style="margin-bottom: 3px;">🏢 Vergi: ' + (vergiNo || 'Belirtilmemiş') + (vergiDairesi ? ' - ' + vergiDairesi : '') + '</div>' +
