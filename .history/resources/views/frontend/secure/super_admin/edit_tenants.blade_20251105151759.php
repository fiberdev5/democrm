...
@php
    // Backend'den gelen yüzdeyi al - artık doğru hesaplanıyor
    ...
    // Debug için - geliştirme ortamında açın
    // dd([
    //     'current_usage_gb' => $storageInfo['current_usage_gb'] ?? 'N/A',
    //     'total_limit_gb' => $storageInfo['total_limit_gb'] ?? 'N/A',
