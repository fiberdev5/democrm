  ...
  <div class="row align-items-end">
    ...
    <div class="col-lg-3 col-md-6">
      <div class="form-group mb-3">
        ...
        <div class="d-flex gap-1 flex-wrap" style="height: 31px; align-items: center;">
          <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="7" title="Son 7 Gün" style="white-space: nowrap;">
            Son 7 Gün
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm quick-filter" data-days="30" title="Son 30 Gün" style="white-space: nowrap;">
            Son 30 Gün
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="this-month" title="Bu Ay" style="white-space: nowrap;">
            Bu Ay
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="last-month" title="Geçen Ay" style="white-space: nowrap;">
            Geçen Ay
          </button>
        </div>
      </div>
    ...
    <div class="col-lg-1 col-md-6 text-end">
      <div class="form-group mb-3">
        ...
        <div class="d-flex gap-1 justify-content-end" style="height: 31px; align-items: center;">
