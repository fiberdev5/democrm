                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="{{ route('tenant.payment-history.index',$tenant->id) }}">
                                        <div class="row">
                                            <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <a href="{{ route('tenant.payment-history.index') }}" class="btn btn-secondary">
                                    ...
                                    @foreach($pagination as $index => $payment)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($payment['type'] === 'subscription' && isset($payment['starts_at']))
                                                    <br>
                                                    <small class="text-muted">
                                                        {{ \Carbon\Carbon::parse($payment['starts_at'])->format('d.m.Y') }} - 
                                                        {{ \Carbon\Carbon::parse($payment['ends_at'])->format('d.m.Y') }}
                                                    </small>
                                                @endif
