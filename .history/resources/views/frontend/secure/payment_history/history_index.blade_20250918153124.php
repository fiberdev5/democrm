                                    ...
                                    @foreach($pagination as $index => $payment)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-{{ $payment['type'] === 'subscription' ? 'success' : 'success' }}">
...
$(document).ready(function() {
    ...
    console.log('Filter form exists:', $('#filter-form').length);
    console.log('Date from exists:', $('#date_from').length);
    console.log('Date to exists:', $('#date_to').length);
    console.log('Quick filter buttons:', $('.quick-filter').length);
    ...
    $('.quick-filter').on('click', function(e) {
        e.preventDefault();
        console.log('Quick filter clicked:', $(this).data('days'));
        ...
        $('.quick-filter').removeClass('btn-info').addClass('btn-outline-info');
        ...
        setTimeout(function() {
            ...
            $('#filter-form')[0].submit(); // Native submit kullan
        }, 200);
    });
    ...
    $('#this-month').on('click', function(e) {
        ...
        // Aktif butonu vurgula
        $('.quick-filter, #last-month').removeClass('btn-warning').addClass('btn-outline-warning');
        $(this).removeClass('btn-outline-warning').addClass('btn-warning');
        
        // Formu otomatik submit et
        setTimeout(function() {
            console.log('Submitting this month form...');
            $('#filter-form')[0].submit(); // Native submit kullan
        }, 200);
    });
    ...
    $('#last-month').on('click', function(e) {
        ...
        // Aktif butonu vurgula
        $('.quick-filter, #this-month').removeClass('btn-warning').addClass('btn-outline-warning');
        $(this).removeClass('btn-outline-warning').addClass('btn-warning');
        
        // Formu otomatik submit et
        setTimeout(function() {
            console.log('Submitting last month form...');
            $('#filter-form')[0].submit(); // Native submit kullan
        }, 200);
    });
    ...
    $('#excel-export').on('click', function(e) {
        ...
        // Base URL'yi dinamik olarak oluştur
        const tenantId = '{{ $tenant->id }}';
        const baseUrl = '{{ url("/") }}/tenant/' + tenantId + '/payment-history/export';
    ...
    $('button[type="submit"]').on('click', function(e) {
        ...
        console.log('Form data will be:', $('#filter-form').serialize());
    });
    ...
    $('#filter-form').on('submit', function(e) {
        ...
        // 10 saniye sonra butonu normale döndür (sayfa yüklenmezse)
        setTimeout(function() {
    ...
    $('.btn-outline-secondary').on('click', function(e) {
        ...
        console.log('Clear button href:', $(this).attr('href'));
    });
