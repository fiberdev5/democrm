                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          <div class="form-group mb-3">
                            ...
                            <input type="date" 
                              ...
                              name="date_from" 
                              value="{{ $dateFrom }}"
                              title="Başlangıç tarihi seçin" style="width: auto!important;">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                          <div class="form-group mb-3">
                            ...
                            <input type="date" 
                              ...
                              name="date_to" 
                              value="{{ $dateTo }}"
                              title="Bitiş tarihi seçin" style="width: auto!important;">                        
                          </div>
                        </div>
                        ...
                        <div class="row mt-3">
                          <div class="col-12">
                            <div class="d-flex flex-wrap gap-2">
                              ...
                              <button type="button" class="btn btn-outline-info btn-sm quick-filter" data-days="7" onclick="console.log('Button clicked directly')">
                                Son 7 Gün
                              </button>
                              <button type="button" class="btn btn-outline-info btn-sm quick-filter" data-days="30" onclick="console.log('Button clicked directly')">
                                Son 30 Gün
                              </button>
