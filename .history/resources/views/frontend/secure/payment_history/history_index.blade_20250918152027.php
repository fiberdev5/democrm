...
$(document).ready(function() {
    ...
    $('.quick-filter').on('click', function(e) {
        ...
        $('.quick-filter, #this-month, #last-month').removeClass('btn-info').addClass('btn-outline-info');
    ...
    $('#excel-export').on('click', function(e) {
        ...
        // Excel export URL'ini kontrol et
        const baseUrl = "{{ route('payment-history.export', $tenant->id ?? 1) }}";
    ...
    $('.btn-outline-secondary').on('click', function(e) {
        ...
        // Bu butonun href'i zaten ?clear=1 parametresi ile ayarlanmış
