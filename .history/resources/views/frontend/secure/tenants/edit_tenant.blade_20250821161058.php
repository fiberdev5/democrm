<div class="card border-0 shadow-lg rounded-3 overflow-hidden">
  ...
  <div class="card-body p-4">
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <div class="d-flex align-items-center">
          <div class="icon bg-light text-danger rounded-circle me-2 d-flex justify-content-center align-items-center" style="width:40px; height:40px;">
  ...
  <div class="card-footer bg-light d-flex justify-content-end">
    ...
    <a href="{{ route('edit.tenant', [$tenant->id, $tenant->id]) }}" class="btn btn-sm btn-primary">Düzenle</a>
  </div>
</div>
