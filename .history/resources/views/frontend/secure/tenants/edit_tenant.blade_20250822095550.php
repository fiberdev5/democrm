<!-- Tenant Detay Modal -->
<div class="modal fade" id="tenantDetailModal" tabindex="-1" aria-labelledby="tenantDetailLabel" aria-hidden="true" style="background: rgba(0,0,0,0.5);">
    ...
    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
      ...
      <div class="card-header bg-gradient bg-primary text-white d-flex align-items-center justify-content-between p-3">
        <div class="d-flex align-items-center">
          <img src="https://via.placeholder.com/60" class="rounded-circle me-3" alt="Logo">
          <div>
