...
<div class="modal fade" id="tenantUsersModal" tabindex="-1" aria-hidden="true" style="background: rgba(0, 0, 0, 0.7); padding-top:100px;">
  <div class="modal-dialog modal-lg modal-dialog-centered">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.impersonate-tenant-owner', function() {
        ...
        $('#confirmImpersonationBtn').off('click').on('click', function() {
            var reason = $('#impersonationReason').val() || 'Admin tarafından firma yönetimi';
    ...
    $(document).on('click', '.impersonate-user-btn', function() {
        ...
        $('#confirmImpersonationBtn').off('click').on('click', function() {
            var reason = $('#impersonationReason').val() || 'Admin tarafından kullanıcı desteği';
