        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div class="flex items-start space-x-2 mb-6">
           ...
           <label for="terms" class="text-sm text-gray-600">
              <a href="#" data-legal-type="terms" class="text-orange-600 hover:underline">Kullanım Koşulları</a> ve 
...
<div id="privacyModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="privacyContent" style="max-height: 300px; overflow-y: auto;">
                <div class="text-center"><i class="fas fa-spinner fa-spin"></i> Yükleniyor...</div>
            </div>
        </div>
    </div>
