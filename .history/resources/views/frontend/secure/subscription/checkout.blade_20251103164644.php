      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div class="space-y-4">
          ...
          <div id="bireysel-fields">
            ...
            <input type="text" name="identity_number" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-orange-400" value="{{ old('identity_number', $tenant->tcNo ?? '') }}" maxlength="11" pattern="[0-9]{1,11}">
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <select name="il" id="sehirSelect" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-orange-400" required>
            ...
            <div>
              ...
              <select name="ilce" id="ilceSelect" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-orange-400" required>
