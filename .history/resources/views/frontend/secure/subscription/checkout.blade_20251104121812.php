...
<div class="space-y-3">
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-24">Adınız</label>
  ...
  <div id="bireysel-fields" class="space-y-3">
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-24">TC Kimlik No</label>
      <input type="text" name="identity_number" class="flex-1 border rounded-lg p-2 focus:ring-2 focus:ring-orange-400" value="{{ old('identity_number', $tenant->tcNo ?? '') }}" maxlength="11" pattern="[0-9]{1,11}">
    </div>
  </div>
  ...
  <div id="kurumsal-fields" style="display:none;" class="space-y-3">
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-24">Vergi Dairesi</label>
    ...
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-24">Vergi Numarası</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-24">E-Posta</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-24">Telefon</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-24">İl / İlçe</label>
  ...
  <div class="flex gap-2 items-start">
    <label class="text-sm font-medium text-gray-600 w-24 pt-2">Adres</label>
    <textarea name="address" rows="3" class="flex-1 border rounded-lg p-2 focus:ring-2 focus:ring-orange-400">{{ old('address', $tenant->adres ?? '') }}</textarea>
      ...
      <!-- Butonlar -->
      <div class="col-span-2 flex justify-end space-x-3mt-6">
