        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div class="flex items-start space-x-2 mb-6">
           ...
           <label for="terms" class="text-sm text-gray-600">
              <a href="#" data-legal-type="terms"class="hover:underline">Kullanım Koşulları</a>
              <a href="#" data-legal-type="privacy" class="hover:underline">Gizlilik Politikası</a>'nı okudum, kabul ediyorum.
          </label>
          </div>
