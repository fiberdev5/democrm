...
<div class="flex space-x-4 mb-4">
  <label class="flex items-center space-x-2 cursor-pointer" style="display:none;">
    <input type="radio" name="billing_type" value="bireysel" id="bireysel" class="form-radio">
    <span>Bireysel</span>
  </label>
  <label class="flex items-center space-x-2 cursor-pointer">
    <input type="radio" name="billing_type" value="kurumsal" id="kurumsal" class="form-radio" checked>
    <span>Kurumsal</span>
  </label>
</div>
<!-- Form alanları -->
<div class="space-y-3">
  ...
  <div id="bireysel-fields" class="space-y-3">
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-32">TC Kimlik No</label>
...
document.addEventListener('DOMContentLoaded', function () {
 ...
 // Kurumsal her zaman seçili gelsin
