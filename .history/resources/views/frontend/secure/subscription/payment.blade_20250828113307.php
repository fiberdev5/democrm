                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="12/25" name="Expiry" class="form-control" 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const cardExpiryInput = document.querySelector('input[name="Expiry"]');
    if (cardExpiryInput) {
    ...
    // CVC sadece sayı
    const cardCvcInput = document.querySelector('input[name="Cvv2"]');
    if (cardCvcInput) {
