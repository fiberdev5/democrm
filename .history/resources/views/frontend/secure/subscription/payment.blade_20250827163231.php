        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('subscription.payment.complete', [$tenant_id, $planid]) }}" method="POST">
                            @csrf
                            @php
                             $rnd = microtime();
                            $hashstr = "5" . "346" . {{ $planData['price'] }} . "http://127.0.0.1:8000/booking-success" . "http://127.0.0.1:8000/payfor3DPayPayment" . "Auth" . "0" . $rnd . "12345678";
                            $hash = base64_encode(pack('H*',sha1($hashstr))); 
                            @endphp

                            <input type="hidden" name="MbrId" value="5">
                            <input type="hidden" name="MerchantID" value="085300000009704">
                            <input type="hidden" name="UserCode" value="QNB_ISYERI_KULLANICI_3DPAY">
                            <input type="hidden" name="UserPass" value="a1234">
                            ...
                            <input type="hidden" name="OkUrl" value="http://127.0.0.1:8000/booking-success">
                            <input type="hidden" name="FailUrl" value="http://127.0.0.1:8000/payfor3DPayPayment">
                            <input type="hidden" name="OrderId" value="346">
                            <input type="hidden" name="PurchAmount" value="{{ $planData['price'] }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between h5">
                            ...
                            <strong>{{ number_format($planData['price'] * 1.18, 2) }} TL</strong>
                        </div>
