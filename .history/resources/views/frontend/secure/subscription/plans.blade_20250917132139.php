  ...
  <div class="container-fluid">
    ...
    @if($currentPlan)
      ...
      <div class="subscription-overview">
        ...
        {{-- Storage Durumu --}}
        <div class="storage-info-card text-dark">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0">
              <i class="fas fa-database text-primary me-2"></i>
              Depolama Kullanımı
            </h6>
            <span class="badge bg-{{ $storageInfo['danger_threshold'] ? 'danger' : ($storageInfo['warning_threshold'] ? 'warning' : 'success') }}">
              %{{ $storageInfo['usage_percentage'] }}
            </span>
          </div>
          
          <div class="d-flex justify-content-between mb-2 small">
            <span>{{ $storageInfo['current_usage_formatted'] }} kullanılıyor</span>
            <span>{{ $storageInfo['remaining_formatted'] }} kalan</span>
          </div>
          ...
          @if($storageInfo['warning_threshold'])
            <div class="text-center mt-3">
              <a href="{{ route('storage.packages', $tenant->id) }}" class="btn btn-warning btn-sm">
                <i class="fas fa-plus-circle me-1"></i>Ek Depolama Satın Al
              </a>
            </div>
          @endif
        </div>
        ...
        <div class="row text-center">
          ...
          <div class="col-md-4">
            ...
            @if($currentPlan->id !== $maxPlan->id)
              <a href="#upgrade" class="btn btn-light btn-sm">
          ...
          <div class="col-md-4">
            <a href="#" class="btn btn-light btn-sm">
              <i class="fas fa-file-invoice me-1"></i>Fatura Geçmişi
            </a>
          </div>
        </div>
      </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-3">
                    <div class="text-center">
                      <div class="fw-bold text-primary">{{ number_format($purchase->amount, 2) }} ₺</div>
