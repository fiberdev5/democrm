...
<div class="space-y-3">
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-6">Adınız</label>
  ...
  <div id="bireysel-fields" class="space-y-3">
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-6">TC Kimlik No</label>
  ...
  <div id="kurumsal-fields" style="display:none;" class="space-y-3">
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-6">Vergi Dairesi</label>
    ...
    <div class="flex gap-2 items-center">
      <label class="text-sm font-medium text-gray-600 w-6">Vergi Numarası</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-6">E-Posta</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-6">Telefon</label>
  ...
  <div class="flex gap-2 items-center">
    <label class="text-sm font-medium text-gray-600 w-6">İl / İlçe</label>
  ...
  <div class="flex gap-2 items-start">
    <label class="text-sm font-medium text-gray-600 w-6 pt-2">Adres</label>
