...
<style>
  ...
  .btn-outline-primary:hover{background: #28a745!important;color: #f8fafc!important;}
  .pricing-card {
      ...
      <div class="subscription-overview">
        <div class="row align-items-center mb-4">
          ...
          <div class="col-md-4 text-end">
            ...
            <p class=" mb-0" style="color: #e2e8f0">{{ $tenant->subscription_ends_at?->format('d.m.Y') ?? 'Süresiz' }}</p>
          </div>
        </div>
