...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            @if (session('warning'))
    <div id="trial-warning-notification" class="fixed-alert warning-alert">
        <span>{{ session('warning') }}</span>
        <button type="button" class="close-alert-button" onclick="this.parentElement.style.display='none';">&times;</button>
    </div>
@endif
            @yield('user')
            <!-- End Page-content -->
