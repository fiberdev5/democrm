                ...
                <div class="col-lg-6 {{ $index % 2 == 0 ? '' : 'order-lg-1' }}">
                    <div class="benefit-visual">
                        @if(isset($benefit['image']))
                            <div class="benefit-screenshot-box">
                                <img src="{{ asset($benefit['image']) }}" alt="{{ $benefit['title'] }}" onerror="this.src='https://via.placeholder.com/500x350/49657B/ffffff?text={{ urlencode($benefit['title']) }}'">
                            </div>
                        @else
                            <div class="benefit-icon-box">
                                ...
                                <div class="benefit-icon-label">{{ $benefit['title'] }}</div>
                            </div>
                        @endif
                    </div>
                </div>
