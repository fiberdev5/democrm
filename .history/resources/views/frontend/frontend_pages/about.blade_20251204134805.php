        ...
        <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
                <div class="story-image-container">
                    <img src="{{ asset('frontend/img/about/story.jpg') }}" alt="Hikayemiz" onerror="this.src='https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&h=450&fit=crop'">
