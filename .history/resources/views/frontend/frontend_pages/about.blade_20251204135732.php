        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-hero-image">
                    <img src="{{ asset('frontend/img/about/team-work.jpg') }}" alt="Serbis Ekibi" onerror="this.src='https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=400&fit=crop'">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
                <div class="story-image-container">
                    <img src="{{ asset('frontend/img/about/hakkimizda1.jpeg') }}" alt="Hikayemiz" onerror="this.src='https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&h=450&fit=crop'">
