...
<div class="col-lg-6 {{ $index % 2 == 0 ? '' : 'order-lg-1' }}">
    <div class="benefit-visual">
        <div class="benefit-stat-single">
            <div class="stat-icon-large">
                <i class="{{ $benefit['stat']['icon'] }}"></i>
            </div>
            <div class="stat-number-large">{{ $benefit['stat']['number'] }}</div>
            <div class="stat-label-large">{{ $benefit['stat']['label'] }}</div>
        </div>
    </div>
</div>
            </div>
