...
<!-- Features Section -->
@if(isset($sector['features']) && count($sector['features']) > 0)
...
<!-- Services Section -->
@if((isset($sector['services']) && count($sector['services']) > 0) || (isset($sector['benefits']) && count($sector['benefits']) > 0))
<section id="hizmetler" class="sector-services-section section">
    <div class="container">
        <div class="row">
            @if(isset($sector['services']) && count($sector['services']) > 0)
            ...
            @if(isset($sector['benefits']) && count($sector['benefits']) > 0)
            <div class="col-lg-6">
                <div class="section-header text-start">
...
<!-- FAQ Section -->
@if(isset($sector['faqs']) && count($sector['faqs']) > 0)
