                ...
                <div class="hero-bento-grid">
                    ...
                    @foreach($heroStats as $index => $stat)
                        <div class="bento-item bento-small">
                            <div class="bento-card stat-card" style="background: {{ $stat['gradient'] }};">
