                    ...
                    <div class="hero-stats-wrapper">
                        @php
                            $heroStats = $hero['stats'] ?? [
                                ['icon' => 'fas fa-building', 'number' => '500+', 'label' => 'Aktif Firma'],
                                ['icon' => 'fas fa-tasks', 'number' => '50.000+', 'label' => 'Tamamlanan İş'],
                                ['icon' => 'fas fa-headset', 'number' => '7/24', 'label' => 'Destek'],
                                ['icon' => 'fas fa-award', 'number' => '99.9%', 'label' => 'Uptime']
                            ];
                        @endphp
