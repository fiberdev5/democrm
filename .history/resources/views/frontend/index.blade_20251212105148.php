        ...
        <div id="integrationsCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $chunkIndex == 0 ? 'active' : '' }}">
                    <!-- px-5 sınıfı ile içeriği kenarlardan uzaklaştırıp oklara yer açıyoruz -->
            ...
            <!-- Oklar Müşteri Yorumları stilinde (left/right: 0) -->
            <button class="carousel-control-prev" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="prev" style="width: 50px; left: 0;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; opacity: 0.8;">
                    <i class="fas fa-chevron-left" style="color: white; font-size: 14px;"></i>
                </span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="next" style="width: 50px; right: 0;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; opacity: 0.8;">
