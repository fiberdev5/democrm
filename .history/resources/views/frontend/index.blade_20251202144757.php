        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="hero-buttons">
                    <a href="{{ url('/kullanici-girisi') }}" class="btn-hero-primary">
...
<section class="cta-section">
    <div class="container">
        ...
        <button class="btn btn-cta" onclick="window.location.href='{{ url('/kullanici-girisi')}}'">
...
<div class="modal fade" id="videoModal" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content" style="background: transparent; border: none;">
            <div class="modal-header" style="border: none; position: absolute; right: 0; z-index: 1;">
