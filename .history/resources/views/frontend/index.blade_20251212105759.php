...
<section class="integrations-section section">
    <div class="container">
        ...
        <!-- position-relative ekledik ki oklar bu kutuya göre hizalansın -->
        <div id="integrationsCarousel" class="carousel slide position-relative" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $chunkIndex == 0 ? 'active' : '' }}">
                    <!-- BURASI ÖNEMLİ: px-4 ve px-lg-5 ekledik. 
                         Bu sayede içerik sağdan soldan içeri basılır, oklar içeriğin üstüne binmez. -->
                    <div class="row g-4 px-4 px-lg-5">
                        @foreach($chunk as $integration)
                        <div class="col-md-4">
                            <!-- h-100 ile kartların boyunu eşitledik -->
            ...
            <!-- SOL OK -->
            <!-- left: -80px YERİNE left: 0 yaptık (Mobilde taşmayı engeller) -->
            <!-- top: 50% ve transform: translateY(-50%) ile dikey ortaladık -->
            <button class="carousel-control-prev" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="prev" 
                    style="width: 50px; left: 0; top: 50%; bottom: auto; transform: translateY(-50%); opacity: 1;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
                    <i class="fas fa-chevron-left" style="color: white;"></i>
                </span>
            </button>

            <!-- SAĞ OK -->
            <!-- right: -80px YERİNE right: 0 yaptık -->
            <button class="carousel-control-next" type="button" data-bs-target="#integrationsCarousel" data-bs-slide="next" 
                    style="width: 50px; right: 0; top: 50%; bottom: auto; transform: translateY(-50%); opacity: 1;">
                <span style="width: 40px; height: 40px; background: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
