...
Route::get('/subscription/{planid}/payment/success', [SubscriptionController::class, 'paymentSuccess'])->name('subscription.payment.success');
    Route::get('/subscription/{planid}/payment/fail', [SubscriptionController::class, 'paymentFail'])->name('subscription.payment.fail');
