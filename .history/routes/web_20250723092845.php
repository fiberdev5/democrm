...
Route::controller(SurveyController::class)->group(function() {
    ...
    Route::post('/anket-yapilan-ara', 'YapilanAnketlerAra')->name('survey.yapilan.ara');
    Route::post('/anket-yapilmayan-ara', 'YapilmayanAnketlerAra')->name('survey.yapilmayan.ara');
