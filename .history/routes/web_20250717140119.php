...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth','checkTenantId']], function () {
    ...
    Route::controller(SurveyController::class)->group(function() {
        Route::get('/anketler', 'AllSurveys')->name('all.surveys');
        Route::get('/anket/form/{service_id}', 'SurveyForm')->name('survey.form');
        Route::post('/anket/kaydet', 'StoreSurvey')->name('store.survey');
        Route::get('/anket/duzenle/{id}', 'EditSurvey')->name('edit.survey');
        Route::post('/anket/guncelle', 'UpdateSurvey')->name('update.survey');
        Route::delete('/anket/sil/{id}', 'DeleteSurvey')->name('delete.survey');
    });
