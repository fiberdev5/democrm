...
Route::controller(StatisticController::class)->group(function() {
    ...
    Route::controller(StockController::class)->group(function() {
        ...
        // Yeni eklenen arama route'ları
        Route::get('/tedarikci-ara', 'searchSuppliers')->name('search.suppliers');
        Route::get('/personel-ara',  'searchPersonel')->name('search.personel');
        ...
        Route::post('/stok-foto-degistir',  'replacePhoto')->name('stock.photo.replace');
        Route::get('/stok-foto-kontrol/{stock_id}', 'hasPhoto')->name('stock.photo.check');
