...
Route::controller(StatisticController::class)->group(function() {
    ...
    Route::get('/teknisyen-istatistikleri-data', 'TechnicianStatisticsData')->name('technician.statistics.data');
    Route::post('/teknisyen-istatistikleri-detay', 'TechnicianStatisticsDetail')->name('technician.statistics.detail');
    // Route dosyasına ekle
Route::get('/debug-technician-data', 'debugTechnicianData')->name('debug.technician.data');
    //Operatör Statistics
