...
Route::middleware(['auth'])->prefix('super-admin')->name('super.admin.')->group(function () {
    Route::get('support/dashboard', [SupportTicketAdminController::class, 'dashboard'])->name('support.dashboard');
    Route::resource('support', SupportTicketAdminController::class)->only(['index', 'show']);
    Route::post('support/{ticket}/reply', [SupportTicketAdminController::class, 'reply'])->name('support.reply');
    Route::patch('support/{ticket}/close', [SupportTicketAdminController::class, 'close'])->name('support.close');
    Route::patch('support/{ticket}/reopen', [SupportTicketAdminController::class, 'reopen'])->name('support.reopen');
    Route::get('support/{ticket}/download/{fileName}', [SupportTicketAdminController::class, 'downloadAttachment'])->name('support.download');
});
//İmpersonation 
