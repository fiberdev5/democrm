...
Route::middleware(['check.token.expiration', 'auth:sanctum'])->group(function () {
    ...
    Route::get('/fault-codes/by-code/{kod}', [ServiceController::class, 'getFaultCodesByCode']);
    Route::get('/fault-codes/search', [ServiceController::class, 'getFaultCodesByCode']); // Alternatif
