...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth','checkTenantId']], function () {
    ...
    Route::controller(SurveyController::class)->group(function() {
        // Anket formunu getiren route
        Route::get('/servis-anketi/form/{serviceId}', 'getSurveyForm')->name('survey.form');
        // Anket verilerini kaydeden/güncelleyen route
        Route::post('/servis-anketi/kaydet', 'saveSurvey')->name('survey.save');
