...
Route::controller(StatisticController::class)->group(function() {
    ...
    //Teknisyen Statistics
    Route::get('/teknisyen-istatistikleri', 'TechnicianStatistics')->name('technician.statistics');
    // AJAX ile ana tablo verilerini getiren rota
    Route::post('/teknisyen-istatistikleri-tablo', 'getTechnicianStatisticsTable')->name('technician.statistics.table');
    // AJAX ile detay tablo verilerini getiren rota
     Route::post('/teknisyen-istatistikleri-tablo-detay', 'getTechnicianStatisticsDetailTable')->name('technician.statistics.detail.table');
    //Operatör Statistics
