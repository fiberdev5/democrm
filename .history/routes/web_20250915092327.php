...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth']], function () {
    // Activity Logs
    Route::get('/log-kayitlari', [App\Http\Controllers\Frontend\ActivityLogController::class, 'index'])->name('activity.logs.index');
    Route::get('/activity-logs/data', [App\Http\Controllers\Frontend\ActivityLogController::class, 'getLogs'])->name('activity.logs.data');
});
