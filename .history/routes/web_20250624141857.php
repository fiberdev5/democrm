...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth','checkTenantId']], function () {
    ...
    Route::controller(StockController::class)->group(function() {
        ...
        //Konsinye Cihazlar
        Route::get('/konsinye-cihazlar', 'consignmentDevice')->name('konsinye-cihazlar');
        Route::get('/konsinye-cihazlar/data', 'consignmentDeviceData')->name('konsinye-cihazlar.data');
