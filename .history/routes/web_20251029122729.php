...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth','checkTenantId','check.subscription','redirect_after_login','check.tenant.status']], function () {
    ...
    // });
        ...
        Route::controller(IntegrationMarketplaceController::class)->group(function() { 
            Route::get('/integrations',  'index')->name('integrations.marketplace');
    Route::get('/integrations/{slug}', 'show')->name('integrations.show');
    Route::get('/integrations/{id}/activate', 'activate')->name('integrations.activate');
    Route::get('/integrations/{id}/deactivate', 'deactivate')->name('integrations.deactivate');
        });
