        ...
        Route::controller(IntegrationMarketplaceController::class)->group(function() { 
            ...
            Route::post('/integrations/hipcall/refresh-contacts','refreshHipcallContacts')
                ->name('tenant.integrations.hipcall.refresh-contacts');
                    ...
                    Route::post('/integrations/hipcall/test-card','testHipcallCard')
            ->name('tenant.integrations.hipcall.test-card');
...
Route::post('/api/webhook/hipcall/{token}', function(Request $request, $token) {
    Log::info('🔥 WEBHOOK GELDİ!', [
        'token' => $token,
        'data' => $request->all()
    ]);
