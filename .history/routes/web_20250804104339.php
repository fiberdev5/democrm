...
Route::controller(StatisticController::class)->group(function() {
    ...
    Route::post('/teknisyen-istatistikleri-detay', 'TechnicianStatisticsDetail')->name('technician.statistics.detail');Route::get('/debug-technician-stats', 'debugTechnicianStats')->name('debug.technician.stats');
