...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/{tenant_id}/depolama-alani/bilgisi', [GenelAyarlarController::class, 'getStorageInfo']);
...
Route::get('/storage-odeme-basarili/{purchase_id}', [StorageController::class, 'paymentSuccess'])->name('storage.payment.success');
Route::get('/storage-odeme-basarisiz/{purchase_id}', [StorageController::class, 'paymentFail'])->name('storage.payment.fail');
