...
Route::controller(HomeController::class)->group(function() {
    ...
    Route::get('/firma/register', 'step1Form')->name('firma.register.step1');
    Route::post('/firma/register', 'step1Post')->name('firma.register.step1.post');

    //2. Adım Sms Doğrulama
    Route::get('/kullanici-kaydi/sms', 'smsForm')->name('firma.register.sms');
    Route::post('/kullanici-kaydi/sms', 'smsPost')->name('firma.register.sms.post');

    Route::get('/kullanici-kaydi-complete', 'complete')->name('firma.register.complete');
