...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/{tenant_id}/storage/info', [GenelAyarlarController::class, 'getStorageInfo']);
    // Storage detayları (bu yeni eklediğimiz)
    Route::get('/tenant/{tenant_id}/storage/details', [GenelAyarlarController::class, 'getStorageDetails'])
         ->name('tenant.storage.details');
    
    // Storage temizleme
    Route::post('/tenant/{tenant_id}/storage/cleanup', [GenelAyarlarController::class, 'cleanupStorageFiles'])
