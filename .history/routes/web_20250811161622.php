...
Route::controller(StatisticController::class)->group(function() {
    ...
    //Cash Statistics
    // GET: Kasa İstatistik sayfası (kasa istatistiklerinin genel görünümü)
        Route::get('/kasa-istatistik', 'GetKasaStatistics')->name('secure.cash.statistics');
        
        // POST: Filtrelenmiş gelir tablosu verisi
        Route::post('/gelir-tablo/getir', 'kasaFilteredData')->name('secure.gelir.tablo.getir');
        
        // POST: Filtrelenmiş gider tablosu verisi
        Route::post('/gider-tablo/getir', 'giderTabloGetir')->name('secure.gider.tablo.getir');
        
        // POST: Filtrelenmiş gelir grafik verisi
        Route::post('/gelir-grafik/getir', 'gelirGrafikGetir')->name('secure.gelir.grafik.getir');
        
        // POST: Filtrelenmiş gider grafik verisi
        Route::post('/gider-grafik/getir', 'giderGrafikGetir')->name('secure.gider.grafik.getir');
