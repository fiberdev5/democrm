...
Route::middleware(['auth'])->prefix('super-admin')->name('super.admin.')->group(function () {
    Route::get('support/dashboard', [SupportTicketController::class, 'dashboard'])->name('support.dashboard');
    Route::resource('support', SupportTicketController::class)->only(['index', 'show']);
    Route::post('support/{ticket}/reply', [SupportTicketController::class, 'reply'])->name('support.reply');
