...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth']], function () {
    ...
    Route::post('/subscription/{planid}/payment/initiate', [SubscriptionController::class, 'initiatePayment'])->name('subscription.payment.initiate');
...
// PayTR Success/Fail URL'leri - Parametresiz, sadece session üzerinden çalışacak
...
// Callback route - CSRF'den muaf
Route::post('/subscription/payment/callback', [SubscriptionController::class, 'paymentCallback'])
