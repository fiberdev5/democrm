...
Route::controller(StatisticController::class)->group(function() {
    ...
    Route::get('/kasa-istatistik', 'GetKasaStatistics')->name('all.statistics');
    Route::post('/gelir-tablo/getir', 'kasaFilteredData');
    Route::post('/gider-tablo/getir', 'giderTabloGetir');
    Route::post('/gelir-grafik/getir', 'gelirGrafikGetir');
    Route::post('/gider-grafik/getir', 'giderGrafikGetir');
