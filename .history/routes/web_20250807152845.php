...
Route::group(['prefix' => '{tenant_id}', 'middleware' => ['auth','checkTenantId','check.subscription']], function () {
    ...
    Route::controller(GenelAyarlarController::class)->group(function() {
        ...
        Route::post('/prim-ayari/guncelle', 'UpdatePrim')->name('update.firm.prim');
    });
    ...
    Route::controller(PrimController::class)->group(function() { 
        // Prim hesaplama ana sayfa
        Route::get('/prim', 'index')->name('prim.index');
        
        // Prim hesaplama işlemi
        Route::post('/prim/hesapla', 'hesapla')->name('prim.hesapla');
        
        // Servis detayları
        Route::get('/prim/detay', 'detay')->name('prim.detay');
        
        // AJAX personel listesi
        Route::get('/prim/personeller', 'getPersoneller')->name('prim.personeller');
