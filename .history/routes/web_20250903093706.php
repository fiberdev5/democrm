...
Route::middleware(['auth'])->prefix('super-admin')->name('super.admin.')->group(function () {
    Route::get('support', [AdminSupportController::class, 'index2'])->name('support.index');
    ...
    Route::patch('support/{ticket}/close', [AdminSupportController::class, 'close'])->name('support.close');
    Route::patch('support/{ticket}/reopen', [AdminSupportController::class, 'reopen'])->name('support.reopen');
    Route::get('support/{ticket}/download/{fileName}', [AdminSupportController::class, 'downloadAttachment'])->name('support.download');
});
//İmpersonation 
