...
Route::controller(StatisticController::class)->group(function() {
    ...
    //Depo Statistics
    Route::get('/depo-istatistikleri', 'DepotStatistics')->name('depot.statistics');
    Route::post('/depo-istatistikleri/data', 'getDepotStatisticsData')->name('depot.statistics.data');


    
    //Survey Statistics
    Route::get('/anket-istatistikleri', 'SurveyStatistics')->name('survey.statistics');
    Route::post('/anket-istatistikleri/data', 'SurveyStatisticsData')->name('survey.statistics.data');
