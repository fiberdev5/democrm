...
Route::get('/subscription/{tenant_id}/{planid}/payment/success', [SubscriptionController::class, 'paymentSuccess'])
    ->name('subscription.payment.success');

Route::get('/subscription/{tenant_id}/{planid}/payment/fail', [SubscriptionController::class, 'paymentFail'])
