...
class Stock extends Model
{
    use HasFactory;
            ...
            {
                return $this->hasMany(StockAction::class, 'stokId');
            }

            public function getCurrentAmountAttribute()
            {
                $toplamGiris = $this->stockActions()->where('islem', 1)->sum('adet');
                $toplamCikis = $this->stockActions()->whereIn('islem', [2, 3])->sum('adet');
