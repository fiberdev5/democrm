...
class Tenant extends Model
{
    ...
    // Bayi limitini kontrol et
    public function getDealerLimit()
    {
        return $this->getFeatureLimit('dealers');
    }

    // Bayi modülüne erişim kontrolü
    public function canAccessDealers()
    {
        // Önce aktif abonelik kontrolü
        if (!$this->hasActiveSubscription()) {
            return false;
        }

        // Bayi limitini kontrol et
        $dealerLimit = $this->getDealerLimit();
        
        // Limit 0 ise erişim yok
        return $dealerLimit > 0;
    }
