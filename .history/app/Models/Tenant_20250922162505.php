...
public function getStorageInfo()
{
    ...
    // current_usage_formatted'dan byte değerini çıkar ve yüzdeyi hesapla
    $currentUsageBytes = $currentUsage * 1024 * 1024 * 1024; // GB to bytes
    $formattedUsage = $this->formatBytes($currentUsageBytes, 2, true);
    
    // Yüzde hesaplaması - totalLimit GB cinsinden
    $percentage = $totalLimit == 0 ? 0 : round(($currentUsage / $totalLimit) * 100, 1);
