...
class StockAction extends Model
{
    ...
    // Stok gönderilen personel (personel alanı için)
    public function sentToPersonel()
    {
        return $this->belongsTo(\App\Models\User::class, 'personel', 'user_id');
    }

    // PersonelStock ilişkisi
    public function personelStock()
    {
        return $this->belongsTo(\App\Models\PersonelStock::class, 'perStokId');
    }
