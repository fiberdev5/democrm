...
class TenantSubscription extends Model
{
    ...
    public function getStatusBadge()
    {
        switch ($this->status) {
            ...
            case 'expired':
                return '<span class="badge bg-danger"><i class="mdi mdi-close-circle"></i> Süresi Dolmuş</span>';
            case 'canceled':
                return '<span class="badge bg-warning"><i class="mdi mdi-cancel"></i> İptal Edilmiş</span>';
            case 'paused':
                return '<span class="badge bg-secondary"><i class="mdi mdi-pause"></i> Duraklatılmış</span>';
            default:
                return '<span class="badge bg-secondary">Bilinmeyen</span>';
        }
    }
}
