    ...
    public function getImpersonatableUsers(?int $specificTenantId = null) // Yeni parametre
{
    ...
    // Ya da bu kısıtı tamamen kaldırmak istiyorsanız bu if bloğunu yorum satırı yapın/silin.
    if ($specificTenantId) {
    ...
    $query->where('user_id', '!=', $this->user_id)
        ...
        //    ->whereHas('roles', function($q) { // Rol kısıtlamasını isterseniz burada tutun
