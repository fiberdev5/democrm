            ...
            $markalar = DB::table('markalar')
                ...
                ->map(function($marka) {
                    ...
                    if (!empty($marka->resimyol)) {
                        $resimUrl = asset('storage/marka_resimleri/' . $marka->resimyol);
                        // veya sadece dosya adı:
                        // $resimUrl = $marka->resimyol;
                    }
            ...
            $modeller = DB::table('modeller')
                ...
                ->map(function($model) {
                    ...
                    if (!empty($model->resimyol)) {
                        // Resim yolu varsa tam URL oluştur
                        $resimUrl = asset('storage/model_resimleri/' . $model->resimyol);
                        // veya sadece dosya adı:
                        // $resimUrl = $model->resimyol;
                    }
