...
class InvoicesController extends Controller
{
    ...
    if($invoice){
        ...
        if ($request->attributes->get('storage_warning')) {
            $storageInfo = $request->attributes->get('storage_info');
            $warningMessage = "Fatura eklendi ancak storage alanınız %{$storageInfo['usage_percentage']} dolu. Planınızı yükseltmeyi düşünün.";
            ...
            session()->flash('storage_warning', $notification);
        }
...
// Controller'a formatBytes helper metodunu ekleyin
