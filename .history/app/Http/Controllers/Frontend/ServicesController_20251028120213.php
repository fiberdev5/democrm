    ...
    try {
        ...
        foreach ($planCevaplar as $cevap) {
            ...
            if ($request->has($soruKey)) {
                ...
                // PARÇA SEÇİMİ KONTROLÜNÜ KALDIR - Artık düzenlemede parça değişikliği yapılamaz
                if ($yeniCevap == 'Parca') {
                    // Eski parça bilgisini koru, değiştirme
                    continue; // Bu cevabı atlat, güncelleme yapma
