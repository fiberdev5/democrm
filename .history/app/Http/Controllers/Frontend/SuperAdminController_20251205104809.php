...
{
    return view('frontend.superadmin.frontend.index');
}
...
public function homeSettings()
{
    ...
    return view('frontend.superadmin.frontend.home', compact('stats', 'modules', 'sectors', 'integrations', 'testimonials', 'faqs'));
}
// İstatistik GET
