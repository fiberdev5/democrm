      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- Filtreler (All Staffs tarzında) -->
            <div class="row mt-3 mb-3">
              <div class="col-md-3">
                <label for="raf" class="form-label">Raf</label>
                <select id="raf" name="raf" class="form-select">
              ...
              <div class="col-md-3">
                <label for="cihaz" class="form-label">Cihaz</label>
                <select id="cihaz" name="cihaz" class="form-select">
                  <option value="">Hepsi</option>
              ...
              <div class="col-md-3">
                ...
                <select id="personel" name="personel" class="form-select">
                  <option value="">Hepsi</option>
...
$(document).ready(function() {
  ...
  // Filtre değişimlerinde tabloyu tekrar çiz
