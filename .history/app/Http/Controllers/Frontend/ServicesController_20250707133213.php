...
private function parcaIslemleriniYap(Request $request, $servisId, $planId, $tenantId, $soruId, $gelenIslem)
{
 ...
 private function parcaTeslimEt($stokId, $adet, $servisId, $planId, $tenantId)
    ...
    public function EditServicePlan($tenant_id, $planid) {
        ...
        // Personelin üzerindeki tüm stokları doğrudan PersonelStock tablosundan çekin
        // Ve ilgili Stock bilgilerini de eager load ile getirin.
    ...
    // Konsinye cihazların toplam adedini hesapla (ServiceStageQuestionShow mantığıyla)
    $consignmentDevices = Stock::where('firma_id', $firma->id)
                               ->where('urunKategori', 3)
                               ->get();
    ...
    return view('frontend.secure.all_services.edit_service_plan', compact(
        ...
        'servis',
        'personellerAll',
        'stoklar', // Bu PersonelStock koleksiyonu
        'kullanici',
        'tenant_id',
        'toplamPersonelStokAdedi',
        'toplamConsignmentAdedi' // Sadece toplam adedi gönderiyoruz
    ));
}
