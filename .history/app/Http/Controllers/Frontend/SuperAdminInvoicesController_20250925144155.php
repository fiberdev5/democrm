   ...
   public function UploadInvoice(Request $request) {
    ...
    if($document) {
        ...
        try {
            ...
            // YENİ: Çoklu ödeme sistemi için güncelleme
           ...
           return response()->json([
                'status' => 'success',
                'message' => 'Fatura başarıyla yüklendi ve ödeme kayıtları güncellendi',
                'invoice_id' => $invoice_id // Modalın yenilenmesi için id'yi döndürüyoruz
            ]);
            ...
            DB::rollback();
             ...
             return response()->json([
                'status' => 'error',
                'message' => 'Fatura yüklenemedi: ' . $e->getMessage()
            ]);
        }
        }
       return response()->json([
