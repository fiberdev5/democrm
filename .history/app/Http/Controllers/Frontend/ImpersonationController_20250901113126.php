...
class ImpersonationController extends Controller
{
    ...
    public function stop(Request $request)
    {
        ...
        $originalUserIsSuperAdmin = session('original_user_is_super_admin', false); // BURASI EKLENDİ
        ...
        // YÖNLENDIRME MANTIGI DEĞİŞTİRİLDİ
       $redirectUrl = $originalUserIsSuperAdmin ? 
              route('super.admin.return') : 
