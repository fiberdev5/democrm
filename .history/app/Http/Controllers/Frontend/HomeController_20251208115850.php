...
class HomeController extends Controller
{
    ...
    $navbarLinks = HomepageContent::getSection('navbar_links');
    if(!$navbarLinks) {
        $navbarLinks = [
            'links' => [
                ['title' => 'Anasayfa', 'url' => '/', 'target' => '_self'],
                ['title' => 'Hakkımızda', 'url' => '/hakkimizda', 'target' => '_self'],
                ['title' => 'Sektörler', 'url' => '/sektorler', 'target' => '_self'],
                ['title' => 'Özellikler', 'url' => '/ozellikler', 'target' => '_self'],
                ['title' => 'Entegrasyonlar', 'url' => '/entegrasyonlar', 'target' => '_self'],
                ['title' => 'Fiyatlar', 'url' => '/fiyatlar', 'target' => '_self'],
                ['title' => 'İletişim', 'url' => '/iletisim', 'target' => '_self']
            ]
        ];
    }
    
    $footerLinks = HomepageContent::getSection('footer_links');
    if(!$footerLinks) {
        $footerLinks = [
            'product' => [
                ['title' => 'Anasayfa', 'url' => '/'],
                ['title' => 'Hakkımızda', 'url' => '/hakkimizda'],
                ['title' => 'Sektörler', 'url' => '/sektorler'],
            ...
            'features' => [
                ...
                ['title' => 'İş Talep Yönetimi', 'url' => '/feature/is-talep-yonetimi'],
                ['title' => 'Mobil Saha Yönetimi', 'url' => '/feature/mobil-saha-yonetimi'],
                ['title' => 'Stok Yönetimi', 'url' => '/feature/stok-parca'],
                ['title' => 'Fatura Yönetimi', 'url' => '/feature/fatura-yonetimi'],
                ['title' => 'Teklif Yönetimi', 'url' => '/feature/teklif-yonetimi']
            ],
            'contact' => [
                ['title' => 'Telefon', 'url' => 'tel:02129092861', 'icon' => 'fas fa-phone'],
                ['title' => 'E-posta', 'url' => 'mailto:info@serbis.com', 'icon' => 'fas fa-envelope'],
                ['title' => 'Adres', 'url' => '#', 'icon' => 'fas fa-map-marker-alt']
            ]
        ];
    }
    
    $socialMedia = HomepageContent::getSection('social_media');
    if(!$socialMedia) {
        $socialMedia = [
            'facebook' => '#',
            'twitter' => '#',
    ...
    $mobileApps = HomepageContent::getSection('mobile_apps');
    if(!$mobileApps) {
        $mobileApps = [
            'app_store' => '#',
            'google_play' => '#'
        ...
        return view('frontend.index', compact('stats', 'modules', 'sectors', 'integrations', 'testimonials', 'faqs', 'hero', 'sectionHeaders', 'contact', 'cta', 'video',    'navbarLinks',
        'footerLinks',
        'socialMedia',
        'mobileApps'));
    }
