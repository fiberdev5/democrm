    ...
    try {
        ...
        foreach ($planCevaplar as $cevap) {
            ...
            if ($soru->cevapTuru == '[Parca]') {
                ...
                // NOT: Sizin kodunuzda 'parca[cevap->id][consignment_id]' şeklinde bir input yakalanmış.
                // Frontend kodunuzda bu input isimlerini kullandığınızdan emin olun.
                ...
                if ($consignmentDeviceId && $consignmentQuantity !== null) {
                    // İstenen string formatını oluştur
