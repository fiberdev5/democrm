...
class BulkSmsController extends Controller
{
    ...
    {   
        ...
        // Firmanın aktif SMS entegrasyonu var mı kontrol et
        $hasActiveSms = DB::table('integration_purchases')
        ...
        if (!$hasActiveSms) {
            ...
            // Entegrasyonlar pazarına yönlendir
            return redirect()->route('tenant.integrations.marketplace', ['category' => 'sms'])->with($notification);
        }
