    ...
    try {
        ...
        foreach ($planCevaplar as $cevap) {
            ...
            if ($soru->cevapTuru == '[Parca]') {
                ...
                $this->updateConsignmentApproval($request, $tenant_id, $servisPlan->servisid, $planid, $cevap->soruid);
                $cevap->cevap = $this->getUpdatedConsignmentAnswer($request, $cevap->soruid); 
            }
            else {
                // Diğer cevap türleri
