...
class BulkSmsController extends Controller
{
    ...
    public function list(Request $request, $tenant_id)
    {
        try {
            ...
            // Tarihleri parse et
            $tarih1 = Carbon::createFromFormat('Y-m-d', $request->input('tarih1'))->startOfDay();
$tarih2 = Carbon::createFromFormat('Y-m-d', $request->input('tarih2'))->endOfDay();
            // Query builder
            ...
            return view('frontend.secure.bulk_sms.list', compact('servisler', 'durumBaslik'))->render();
