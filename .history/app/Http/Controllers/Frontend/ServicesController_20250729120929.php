...
class ServicesController extends Controller
{
    ...
    if ($request->filled('tarih1') && $request->filled('tarih2')) {
        $from = Carbon::createFromFormat('Y-m-d', $request->tarih1)->startOfDay();
        $to = Carbon::createFromFormat('Y-m-d', $request->tarih2)->endOfDay();
        ...
        return view('frontend.secure.all_services.services', compact('services', 'device_brands', 'device_types', 'service_stages','firma', 'service_resources','states','operator_id','tarih1','tarih2'));
    }
