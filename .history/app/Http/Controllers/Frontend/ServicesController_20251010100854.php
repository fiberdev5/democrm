...
private function isDefaultDateRange(Request $request): bool
{
 ...
 // ServicesController.php içinde

// Yardımcı fonksiyon ekleyin


// applyDefaultLast3DaysIfEmpty fonksiyonunu güncelleyin
private function applyDefaultLast3DaysIfEmpty($query, Request $request): void
{
    ...
    // KARAR MANTII (Eski PHP kodunuzdaki mantık):
    // - Eğer herhangi bir tarih filtresi varsa, onu kullan
    // - Eğer arama/filtre var ama tarih yoksa, TÜM kayıtlarda ara (tarih kısıtlaması yok)
    // - Eğer hiçbir şey yoksa, varsayılan son 3 günü uygula
...
// applyMainDateRange fonksiyonunu güncelleyin
