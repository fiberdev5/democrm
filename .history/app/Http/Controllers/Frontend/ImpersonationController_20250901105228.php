    ...
    public function stop(Request $request, $userId)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json([
                ...
                'redirect_url' => route('super.admin.dashboard', ['tenant_id' => $target_User->tenant_id])
            ]);
        }
        ...
        return redirect()->route('super.admin.dashboard', ['tenant_id' => $target_User->tenant_id])->with($notification);
    }
