...
public function getFilteredSurveys(Request $request)
{
    $query = Survey::query();
    ...
    if ($request->filled('yapilananket_tarih1') && $request->filled('yapilananket_tarih2')) {
        $query->whereBetween('created_at', [
            $request->yapilananket_tarih1 . ' 00:00:00',
            $request->yapilananket_tarih2 . ' 23:59:59'
        ]);
    }
