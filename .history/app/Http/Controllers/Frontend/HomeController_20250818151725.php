...
class HomeController extends Controller
{
    ...
    public function RegisterAction(Request $request) {
       ...
       // 6 haneli rastgele bir doğrulama kodu oluştur
        ...
        //         $request->tel, // Alıcı telefon numarası
        //         [
        //             'from' => $twilioPhoneNumber,
        //             'body' => 'Teknik Servis Programı doğrulama kodunuz: ' . $verificationCode
        //         ]
        //     );

        // } catch (\Exception $e) {
        //     // SMS gönderilemezse hata mesajı ile geri dön
        //     return redirect()->back()->withErrors(['tel' => 'Telefon numaranıza SMS gönderilemedi. Lütfen numaranızı kontrol edin.'])->withInput();
        // }

        // SMS gönderimi başarılıysa, doğrulama sayfasına yönlendir
        return redirect()->route('frontend.auth.register_sms')->with('phone_number', $request->tel);
    ...
    public function verifySmsCode(Request $request) {
        ...
        $request->session()->forget(['registration_data', 'sms_verification_code']);
    ...
    private function createTenantAndUser(array $data) {
        ...
        $tenant = new Tenant([
            ...
            'tel1' => $data['tel'],
            'eposta' => $data['email'],
            'username' => strtolower(str_replace(' ', '', $data['firma_adi'])) . '.com',
