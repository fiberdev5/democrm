...
class SupportTicketController extends Controller
{
    ...
    // Dosyaları organized şekilde kaydetme methodu
    private function storeAttachments($files, $tenant, $ticketNumber)
    {
        $attachments = [];
        ...
        foreach ($files as $file) {
            ...
            // Firma adı ve ticket numarasına göre path oluştur
    ...
    public function store(Request $request, $tenant_id)
    {
        ...
        // Dosya yükleme - organized storage
        if ($request->hasFile('attachments')) {
            $attachments = $this->storeAttachments($request->file('attachments'), $tenant, $ticketNumber);
        }
    ...
    // Reply için dosya yükleme
    private function storeReplyAttachments($files, $ticket)
    {
        $attachments = [];
        ...
        foreach ($files as $file) {
            ...
            // Reply için aynı ticket klasörü içinde replies alt klasörü
    ...
    public function reply(Request $request, $tenant_id, SupportTicket $ticket)
    {
        ...
        // Dosya yükleme - organized storage
        if ($request->hasFile('attachments')) {
            $attachments = $this->storeReplyAttachments($request->file('attachments'), $ticket);
        }
