    ...
    public function verifySmsCode(Request $request) 
{
    ...
    try {
        ...
        try {
            $smsService = new TescomService();
            $smsMessage = "Serbis ailesine hoşgeldiniz.Demo talebiniz alınmıştır. Serbis demo hesap bilgileriniz en kısa süre içerisinde e-posta adresinize gönderilecektir.";
