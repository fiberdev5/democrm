...
public function updateHomepageContent(Request $request)
{
    ...
    // Diğer section'lar için eski kod
...
{
    $navbar = HomepageContent::where('section', 'navbar_links')->first();
    $footer = HomepageContent::where('section', 'footer_links')->first();
    $socialMedia = HomepageContent::where('section', 'social_media')->first();
    $mobileApps = HomepageContent::where('section', 'mobile_apps')->first();
    
    return view('frontend.secure.super_admin.frontend.navigation', compact('navbar', 'footer', 'socialMedia', 'mobileApps'));
}
/*************************************************** Frontend Düzenelemeleri *****************************************************/
