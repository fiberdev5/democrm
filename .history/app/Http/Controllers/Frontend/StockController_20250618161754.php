     ...
     public function AllStocks($tenant_id, Request $request){
                    ...
                    return DataTables::of($query)  //adet bilgisi 
                            ->addColumn('adet', function ($stock) {
                                $adet = $stock->sonHareket ? $stock->sonHareket->adet : '-';
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Adet:</div>'.$adet.'
                                        </a>';
                            })
                            ->addColumn('fiyatBirim', function ($stock) {
                                $fiyat = $stock->fiyatBirim ? number_format($stock->fiyatBirim, 2) . ' ₺' : '-';
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Fiyat:</div>'.$fiyat.'
                                        </a>';
                            })
                            ->addColumn('toplamTutar', function ($stock) {
                                $tutar = ($stock->sonHareket && $stock->fiyatBirim) ? number_format($stock->sonHareket->adet * $stock->fiyatBirim, 2) . ' ₺' : '-';
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Toplam:</div>'.$tutar.'
                                        </a>';
                            })
                            ->addColumn('raf_adi', function ($stock) {
                                $raf = $stock->raf ? $stock->raf->raf_adi : '-';
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Raf:</div>'.$raf.'
                                        </a>';
                            })
                            ->addColumn('marka_cihaz', function ($stock) {
                                ...
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Marka / Cihaz:</div>'.trim($marka . ' / ' . $cihaz, ' / ').'
                                        </a>';
                            })
                            ->editColumn('created_at', function($row) {
                                return '<a class="t-link editStock" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">
                                            <div class="mobileTitle">Tarih:</div>'.$row->created_at->format('d.m.Y H:i').'
                                        </a>';
                            })
