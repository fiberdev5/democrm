...
class SupportTicketController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // Yönlendirme: tenant_id ve ticket->id parametrelerini doğru sırada gönderiyoruz
return redirect()->route('support.show', ['tenant_id' => $user->tenant_id, 'ticket' => $ticket->id])
