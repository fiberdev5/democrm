...
class StockController extends Controller
{
    ...
    ->addColumn('adet', function ($stock) {
        return '<a href="javascript:void(0);" class="t-link editStock" data-bs-id="'.$stock->id.'" data-bs-toggle="modal" data-bs-target="#editStockModal">'.$stock->sonHareket ? $stock->sonHareket->adet : '-'.'</a>';
    })
