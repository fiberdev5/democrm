...
private function getLastServices($tenant_id)
{
    ...
    $statusMap = [
        237 => ['name' => 'Cihaz Atölyeye Alındı', 'class' => 'status-high'],
        2 => ['name' => 'Orta Öncelik', 'class' => 'status-medium'],
        3 => ['name' => 'Tamamlandı', 'class' => 'status-completed'],
        4 => ['name' => 'Beklemede', 'class' => 'status-pending'],
        // Kendi sisteminizdeki diğer ID'leri ve durumları buraya ekleyebilirsiniz. Örnekler:
        // 5 => ['name' => 'İptal Edildi', 'class' => 'status-cancelled'],
        // 6 => ['name' => 'Fiyat Onayı Bekliyor', 'class' => 'status-medium'],
        
        // Eşleşmeyen bir ID gelirse kullanılacak varsayılan durum
