...
{
    public function legalSettings($tenant_id)  // ← tenant_id parametresi eklendi
    {
        $firma = auth()->user()->tenant;  // ← $firma değişkeni eklendi
    ...
    public function updateLegalSettings(Request $request, $tenant_id)  // ← tenant_id parametresi eklendi
    {
        try {
            $request->validate([
    ...
    public function getTermsContent($tenant_id)  // ← tenant_id parametresi eklendi
    {
        $content = LegalContent::getTerms();
        return response()->json(['content' => $content]);
    }
    
    public function getPrivacyContent($tenant_id)  // ← tenant_id parametresi eklendi
    {
