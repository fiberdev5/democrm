...
{
    // Sektörler - Ana sayfadakiyle aynı ama detaylı
    $sectors = [
        [
            'slug' => 'elektrik-elektronik',
            'icon' => 'fas fa-plug',
            'title' => 'Elektrik-Elektronik',
            'short_description' => 'Elektrik ve elektronik cihaz servisleri',
        ...
        [
            ...
            'icon' => 'fas fa-tv',
            'title' => 'Beyaz Eşya',
            'short_description' => 'Buzdolabı, çamaşır makinesi servisleri',
        ...
        [
            ...
            'icon' => 'fas fa-fan',
            'title' => 'Klima-Soğutma',
            'short_description' => 'Klima, havalandırma servisleri',
        ...
        [
            ...
            'short_description' => 'Bilgisayar, laptop teknik servisleri',
        ...
        [
            'slug' => 'telekominasvon',
            'icon' => 'fas fa-mobile-alt',
            'title' => 'Telekominasvon',
            'short_description' => 'Cep telefonu, tablet onarım servisleri',
        ...
        [
            ...
            'short_description' => 'Yazıcı, fotokopi makinesi servisleri',
        ...
        [
            ...
            'short_description' => 'Kamera, alarm sistemleri kurulumu',
        ...
        [
            ...
            'short_description' => 'Tıbbi cihaz bakım servisleri',
...
{
    // Sektör detayları - slug'a göre
    $sectorDetails = [
        'elektrik-elektronik' => [
            'title' => 'Elektrik-Elektronik Servisleri',
            'icon' => 'fas fa-plug',
            'hero_image' => 'frontend/img/sectors/elektrik-elektronik.jpg',
            'description' => 'Elektrik ve elektronik cihazlarınızın tüm teknik servis ihtiyaçlarını profesyonel ekibimizle karşılıyoruz. Arıza tespitinden onarıma, bakımdan yedek parça teminlere kadar tüm süreçlerde yanınızdayız.',
            'features' => [
                [
                    'title' => 'Hızlı Arıza Tespiti',
                    'description' => 'Modern test cihazları ile hızlı ve doğru arıza tespiti yapıyoruz.',
                    'icon' => 'fas fa-search'
                ],
                [
                    'title' => 'Periyodik Bakım',
                    'description' => 'Cihazlarınızın ömrünü uzatmak için düzenli bakım hizmetleri sunuyoruz.',
                    'icon' => 'fas fa-calendar-check'
                ],
                [
                    'title' => 'Yedek Parça Garantisi',
                    'description' => 'Orijinal ve garantili yedek parçalarla güvenli onarım sağlıyoruz.',
                    'icon' => 'fas fa-shield-alt'
                ],
                [
                    'title' => 'Teknik Destek',
                    'description' => '7/24 teknik destek hattımızla her zaman yanınızdayız.',
                    'icon' => 'fas fa-headset'
                ]
            ],
            'services' => [
                ...
                'Ev Elektroniği Servisi',
                'Endüstriyel Ekipman Bakımı',
            ...
            'benefits' => [
                ...
                'Hızlı servis süresi ve zamanında teslimat',
                'Uygun fiyat garantisi',
                'Servis sonrası garanti desteği',
        ...
        'beyaz-esya' => [
            'title' => 'Beyaz Eşya Servisleri',
            'icon' => 'fas fa-tv',
            'hero_image' => 'frontend/img/sectors/beyaz-esya.jpg',
            'description' => 'Buzdolabı, çamaşır makinesi, bulaşık makinesi ve tüm beyaz eşya ürünlerinizin teknik servis ihtiyaçlarını profesyonel ekibimizle karşılıyoruz.',
            'features' => [
                [
                    'title' => 'Tüm Markalar',
                    'description' => 'Her marka ve model beyaz eşya için servis hizmeti veriyoruz.',
                    'icon' => 'fas fa-certificate'
                ],
                [
                    'title' => 'Yerinde Servis',
                    'description' => 'Büyük beyaz eşyalar için yerinde servis imkanı sunuyoruz.',
                    'icon' => 'fas fa-home'
                ],
                [
                    'title' => 'Orijinal Parça',
                    'description' => 'Sadece orijinal ve garantili yedek parçalar kullanıyoruz.',
                    'icon' => 'fas fa-cog'
                ],
                [
                    'title' => 'Uygun Fiyat',
                    'description' => 'Piyasa araştırması ile en uygun fiyatları sunuyoruz.',
                    'icon' => 'fas fa-tag'
                ]
            ],
            'services' => [
            ...
            'benefits' => [
                ...
                '12 ay servis garantisi',
                'Müşteri memnuniyeti garantisi',
                'Esnek ödeme seçenekleri'
            ],
            'stats' => [
                ['number' => '20+', 'label' => 'Yıllık Deneyim'],
                ['number' => '8000+', 'label' => 'Tamamlanan Servis'],
                ['number' => '99%', 'label' => 'Müşteri Memnuniyeti'],
                ['number' => '2-3', 'label' => 'Gün Ortalama Süre']
            ]
        ],
        'klima-sogutma' => [
            'title' => 'Klima-Soğutma Servisleri',
            'icon' => 'fas fa-fan',
            'hero_image' => 'frontend/img/sectors/klima-sogutma.jpg',
            'description' => 'Klima montajından bakımına, gaz dolumundan arıza tamirlerine kadar tüm klima ve soğutma sistemleri hizmetlerini profesyonel ekibimizle sunuyoruz.',
            'features' => [
                [
                    'title' => 'Profesyonel Montaj',
                    'description' => 'Tüm marka klimalar için profesyonel montaj hizmeti.',
                    'icon' => 'fas fa-tools'
                ],
                [
                    'title' => 'Periyodik Bakım',
                    'description' => 'Yıllık bakım anlaşmaları ile sorunsuz kullanım.',
                    'icon' => 'fas fa-sync'
                ],
                [
                    'title' => 'Gaz Dolumu',
                    'description' => 'Orijinal gazlarla dolum ve test işlemleri.',
                    'icon' => 'fas fa-fill-drip'
                ],
                [
                    'title' => 'Hızlı Müdahale',
                    'description' => 'Arızalara 24 saat içinde müdahale garantisi.',
                    'icon' => 'fas fa-bolt'
                ]
            ],
            'services' => [
            ...
            'stats' => [
                ...
                ['number' => '6000+', 'label' => 'Montaj'],
                ['number' => '97%', 'label' => 'Müşteri Memnuniyeti'],
                ['number' => '1-2', 'label' => 'Gün Ortalama Süre']
            ]
        ],
        'bilgisayar-teknoloji' => [
            'title' => 'Bilgisayar-Teknoloji Servisleri',
            'icon' => 'fas fa-laptop',
            'hero_image' => 'frontend/img/sectors/bilgisayar-teknoloji.jpg',
            'description' => 'Masaüstü bilgisayar, laptop, tablet ve tüm teknoloji ürünlerinizin donanım ve yazılım servis ihtiyaçlarını karşılıyoruz.',
            'features' => [
                [
                    'title' => 'Donanım Onarımı',
                    'description' => 'Tüm donanım arızalarına hızlı ve kalıcı çözümler.',
                    'icon' => 'fas fa-microchip'
                ],
                [
                    'title' => 'Yazılım Desteği',
                    'description' => 'İşletim sistemi ve yazılım problemlerinde uzman destek.',
                    'icon' => 'fas fa-code'
                ],
                [
                    'title' => 'Veri Kurtarma',
                    'description' => 'Kayıp verilerin kurtarılması için özel çözümler.',
                    'icon' => 'fas fa-database'
                ],
                [
                    'title' => 'Network Kurulumu',
                    'description' => 'Kurumsal ağ sistemleri kurulum ve yönetimi.',
            ...
            'benefits' => [
                ...
                'Hızlı teşhis ve onarım',
                'Uygun fiyat garantisi',
                'Veri güvenliği garantisi',
                'Ücretsiz yazılım desteği',
                '6 ay onarım garantisi'
            ],
            'stats' => [
                ['number' => '10+', 'label' => 'Yıllık Deneyim'],
                ['number' => '4000+', 'label' => 'Tamamlanan Servis'],
                ['number' => '96%', 'label' => 'Başarı Oranı'],
                ['number' => '24', 'label' => 'Saat Hızlı Servis']
            ]
        ],
        // Diğer sektörler için de benzer yapıyı ekleyebilirsin
    ];

    // Sektör bulunamazsa 404
