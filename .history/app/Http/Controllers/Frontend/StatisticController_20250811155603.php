...
public function CashStatistics($tenant_id) 
{
    $kasaHareketleri = CashTransaction::where('tenant_id', $tenant_id)
        ->where('islemTarihi', '>=', date("Y-m").'-01 00:00:00')
    ...
    $odemeSekliAll = "";
    $odemeSekilleri = PaymentMethod::where('tenant_id', $tenant_id)->orderBy('id','asc')->get();
    ...
    return view('frontend.secure.statistics.cash_statistics', compact('tenant_id','nakit','eft','kart','gelirler','odemeSekliAll','odemeTuruAll','giderlerToplam','odemeTuruSonuc','odemeTuruRenkler','giderler'));
}
