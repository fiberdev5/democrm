...
public function resendSmsCode(Request $request)
{
    ...
    // Eğer direkt giriş yapılıyorsa (plan seçimi olmadan), session'ı temizle
    // ?register parametresi yoksa plan seçimini temizle
    if (!request()->has('register')) {
        session()->forget(['selected_plan', 'selected_plan_index', 'selected_plan_info', 'show_register']);
    }
