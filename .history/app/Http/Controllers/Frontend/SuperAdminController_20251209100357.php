...
{
    $about = HomepageContent::where('section', 'about_content')->first();
    
    return view('superadmin.frontend.about-content', compact('about'));
}
...
public function updateAboutContent(Request $request)
{
    ...
    return back()->with('success', 'Hakkımızda içeriği güncellendi');
}
/*************************************************** Frontend Düzenelemeleri *****************************************************/
