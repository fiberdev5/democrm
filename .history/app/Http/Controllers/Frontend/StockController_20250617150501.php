     ...
     public function AddStock($tenant_id)
        {
            ...
            return view('frontend.secure.stocks.add_stock', compact('rafListesi', 'markalar', 'cihazlar', 'tenant_id'));
        }
     ...
     public function StoreStock(Request $request, $tenant_id)
        {
            $request->validate([
                ...
                'urunKodu' => 'nullable|string|max:100',
                'fiyat' => 'nullable|numeric',
                'adet' => 'required|integer',
                'raf_id' => 'nullable|exists:stock_shelves,id',
                'marka_id' => 'nullable|exists:device_brands,id',
                'cihaz_id' => 'nullable|exists:device_types,id',
            ]);
