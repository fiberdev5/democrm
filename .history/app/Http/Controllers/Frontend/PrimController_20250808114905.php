...
class PrimController extends Controller
{
    ...
    DB::raw('MAX(service_plannings.created_at) as created_at'),
    DB::raw('MAX(service_plannings.gidenIslem) as gidenIslem'),
    DB::raw('MAX(services.servisDurum) as servisDurum'),
    DB::raw('MAX(services.kayitAlan) as kayitAlan'),
    DB::raw('MAX(services.id) as service_id')
)
