...
class SuperAdminInvoicesController extends Controller
{
    public function AllInvoice(Request $request) {
        ...
        $tenants = Tenant::where('durum', 1)->orderBy('firma_adi', 'ASC')->get();
        ...
        return view('super_admin.invoices.all_invoices',compact('tenants','invoices'));
    }
    ...
    public function AddInvoice() {
        ...
        return view('super_admin.invoices.add_invoices',compact('tenants','payment_methods'));
    }
