...
class ImpersonationController extends Controller
{
    ...
    public function stop(Request $request)
    {
        ...
        session()->forget([
            ...
            // Eğer orijinal kullanıcı bir Super Admin ise, onu Super Admin dashboard'una yönlendirin
        if ($originalUser->isSuperAdmin()) {
            $notification['message'] = 'Super Admin hesabınıza geri döndünüz.';
            return redirect()->route('super.admin.dashboard')->with($notification);
        }
        
        // Değilse, kendi tenant'ının ana sayfasına yönlendirin
