        ...
        return DataTables::of($data)
           ...
           ->addColumn('durum', function($row) {
                $statusBadge = $row->status == 1
                    ? '<span class="badge" style="background-color: #28a745; color: white; padding: 6px 12px; font-size: 13px;"><i class="mdi mdi-check-circle"></i> Aktif</span>'
                    : '<span class="badge bg-danger" style="padding: 6px 12px; font-size: 13px;"><i class="mdi mdi-close-circle"></i> Pasif</span>';
