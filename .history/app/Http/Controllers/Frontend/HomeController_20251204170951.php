...
public function Integrations()
{
    ...
    $integrations = [
     ...
     $faqs = [
        [
            'question' => 'Entegrasyonları kullanmak için ek ücret ödemem gerekir mi?',
            'answer' => 'Serbis paneli üzerinden entegrasyonları aktif etmek tamamen ücretsizdir. Ancak entegrasyon sağladığınız firma (Örn: NetGSM, Paraşüt, Hipcall) kendi hizmetleri için sizden ücret talep edebilir. Serbis sadece iki sistemin konuşmasını sağlayan köprüyü kurar.'
        ],
        [
