...
public function CashStatistics($tenant_id) {
    ...
    $renkler = [
    '#C08E8E', // Tozlu Gül Kurusu
    '#A3B899', // Adaçayı Yeşili
    '#8E9EAC', // Sisli Mavi
    '#D4A25E', // Hardal Sarısı
    '#B87354', // Yanık Kiremit
    '#A7A2B4', // Lavanta Grisi
    '#7A9D96', // Okyanus Sisi
    '#BFA893', // Toprak Beji
    '#4A586E', // Gece Yarısı Mavisi
    '#8A8A6A', // Zeytin Yeşili
    '#9E9E9E', // Güvercin Grisi
    '#A15D6A', // Ahududu
    '#C9B5A4'  // Kum Taşı
];
