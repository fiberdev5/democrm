...
class InvoicesController extends Controller
{
    public function AllInvoice(Request $request, $tenant_id) {
        ...
        $tenants = Tenant::whereNotIn('firma_adi', ['Super Admin Panel'])
                ->orderBy('firma_adi', 'ASC')
                ->get();
         dd($tenants); // Bu satırı ekleyin
        ...
        return view('frontend.secure.invoices.all_invoices',compact('musteriler','invoices','firma','tenants'));
    }
    ...
    public function AddInvoice($tenant_id) {
        ...
        return view('frontend.secure.invoices.add_invoices',compact('musteriler','payment_methods','firma','countries','tenants'));
    }
