...
class BulkSmsController extends Controller
{
    ...
    public function list(Request $request, $tenant_id)
    {
        ...
        $tarih2 = Carbon::createFromFormat('Y-m-d', $tarih2Input)->endOfDay();
         // Debug için loglayın (isteğe bağlı)
        \Log::info('Tarih1 Input: ' . $tarih1Input . ' -> Parsed: ' . $tarih1->format('Y-m-d H:i:s'));
        \Log::info('Tarih2 Input: ' . $tarih2Input . ' -> Parsed: ' . $tarih2->format('Y-m-d H:i:s'));
