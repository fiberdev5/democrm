...
public function CashStatistics($tenant_id) {
    ...
    // Yöntem 4: Default olarak 1 kullan (geçici çözüm)
    if (empty($firma_id)) {
        $firma_id = 1; // Ya da tablondaki mevcut bir firma_id
        \Log::warning('Using default firma_id: ' . $firma_id);
    }
    
    \Log::info('Final firma_id: ' . $firma_id);
    ...
    \Log::info('Found transactions:', $kasaHareketleri->count());
