                ...
                if ($request->has($soruKey)) {
                    ...
                    if ($yeniCevap == 'Parca') {
                        ...
                        $cevap->cevap = $parcaCevap;
                         ...
                         Log::info('Konsinye Cihaz İşleme Bloğu.', [
        'plan_id' => $cevap->id,
        'request_konsinye_cihaz' => $request->input("konsinye_cihaz.{$cevap->id}"),
        'request_konsinye_adet' => $request->input("konsinye_adet.{$cevap->id}")
    ]);
