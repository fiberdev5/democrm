...
public function addPaymentToInvoice(Request $request, $firma_id)
{
    try {
        $validated = $request->validate([
            ...
            'parasut_invoice_id' => 'required|string',
        ...
        // Paraşüt entegrasyonu var mı kontrol et
        ...
        // Ödeme ekle
        $result = $parasutService->addPayment($validated['parasut_invoice_id'], [
            'account_id' => $validated['account_id'],
            'amount' => $validated['amount'],
            'date' => $validated['date'],
            'description' => $validated['description'] ?? 'Tahsilat',
            'exchange_rate' => null // TL için null
        ]);
...
public function getInvoicePayments($firma_id, $invoice_id)
{
    try {
        ...
        $parasutService = InvoiceIntegrationFactory::make($firma_id);
        $result = $parasutService->getInvoicePayments($invoice->integration_invoice_id);
