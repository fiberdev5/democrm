        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('id', function($row) {
                    return '<a class="t-link editIncomingCall idWrap" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal">{{$item->id}}</a>';
                })
                ->addColumn('created_at', function($row) {
                    $tarih = Carbon::parse($row->created_at)->format('d/m/Y H:i');
                    return '<a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Tarih:</div> '.$tarih.'</a>';
                })
                ->addColumn('telefon', function($row) {
                    $kaynak = $row->kaynak_name ?? '-';
                    return '<a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Telefon:</div>'.$kaynak.'</a>';
                })
                ->addColumn('marka', function($row) {
                    $marka = $row->marka_name ?? '-';
                    return '<a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Marka:</div>'.$marka.'</a>';
                })
                ->addColumn('aciklama', function($row) {
                    $aciklama = $row->ariza ?? '-';
                    return '<a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Açıklama:</div>'.$aciklama.'</a>';
                })
                ->addColumn('personel', function($row) {
                    $kayitAlan = $row->personel_name ?? '-';
                    return '<a class="t-link editIncomingCall" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal"><div class="mobileTitle">Personel:</div>'.$kayitAlan.'</a>';
                })
                ->addColumn('action', function($row) {
                    $buttons = '';
                    
                    // Detay butonu
                    $buttons .= '<a href="javascript:void(0);" class="btn btn-warning btn-sm editIncomingCall mobilBtn mbuton1" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>';
                    
                    // Düzenleme butonu (eğer gerekirse)
                    $buttons .= '<a href="javascript:void(0);"  class="btn btn-danger btn-sm mobilBtn deleteIncomingCall" data-bs-id="'.$row->id.'" title="Sil"><i class="fas fa-trash-alt"></i> <span> Sil</span></a>';
