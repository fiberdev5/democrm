...
class ImpersonationController extends Controller
{
    ...
    public function stop(Request $request)
    {
        ...
        // Bu noktada hangi rotaya gideceğimizi ve hangi kullanıcının aktif olduğunu kontrol edelim
        dd([
            'message' => 'Impersonation STOP metodu sonu',
            'impersonator_id' => $impersonatorId,
            'original_user_is_super_admin' => $originalUser ? $originalUser->isSuperAdmin() : 'N/A',
            'redirect_route_name' => app('router')->getRoutes()->match(Request::create($redirectRoute))->getName(), // Rota ismini almak için
            ...
            'session_has_impersonator_id_after_forget' => session()->has('impersonator_id'), // Session temizlendikten sonraki durum
        ]);
