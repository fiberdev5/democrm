...
class StockController extends Controller
{
    ...
    public function EditStock($tenant_id, $id) {
            ...
            return view('frontend.secure.stocks.edit_stock', compact('firma', 'stock', 'rafListesi', 'markalar', 'cihazlar'));
        }
        ...
        public function UpdateStock(Request $request, $tenant_id, $id)
{
    ...
    if ($hareket) {
        ...
        $hareket->fiyatBirim = $request->fiyatBirim;
        $hareket->save();
    }

    return response()->json(['message' => 'Stok başarıyla güncellendi.']);
}
