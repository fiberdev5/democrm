...
public function CashStatistics($tenant_id)
{
 ...
 public function GetKasaStatistics(){
        ...
        return view('backend.kasa_istatistik.kasa-istatistik',compact('nakit','eft','kart','gelirler','odemeSekliAll','odemeTuruAll','giderlerToplam','odemeTuruSonuc','odemeTuruRenkler','giderler'));
    }
