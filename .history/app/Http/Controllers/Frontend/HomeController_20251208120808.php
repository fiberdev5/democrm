...
class HomeController extends Controller
{
        public function index()
    {
       ...
       // Bölüm Başlıkları
        ...
        return view('frontend.index', compact('stats', 'modules', 'sectors', 'integrations', 'testimonials', 'faqs', 'hero', 'sectionHeaders', 'contact', 'cta', 'video','navbarContent', 'footerContent'));
    }
