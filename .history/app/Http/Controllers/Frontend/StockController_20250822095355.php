...
public function searchBrands(Request $request)
{
    ...
    $brands = Brand::where('tenant_id', $this->tenant_id)
...
// Cihaz türü arama metodu
public function searchDevices(Request $request)
{
    $term = $request->get('q');
    
    $devices = Device::where('tenant_id', $this->tenant_id)
...
public function searchCategories(Request $request)
{
    ...
    $categories = Category::where('tenant_id', $this->tenant_id)
...
public function searchShelves(Request $request)
{
    ...
    $shelves = Shelf::where('tenant_id', $this->tenant_id)
