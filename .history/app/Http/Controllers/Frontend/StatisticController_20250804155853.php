...
///////////////////////////////////////////////////////Technician Statistics///////////////////////////////////////////////////////////////////
 public function TechnicianStatistics($tenant_id)
    ...
    public function getTechnicianStatisticsDetailTable(Request $request, $tenant_id)
    {
        ...
        $assignedServices = ServicePlanning::where('pid', $personelId)
            ->whereBetween('created_at', [$startDate, $endDate])
            ->when($deviceTypeId, function ($query, $deviceTypeId) {
                $query->whereHas('service', function ($q) use ($deviceTypeId) {
                    $q->where('cihazTur', $deviceTypeId);
            ...
            ->with(['service.musteri', 'service.turCihaz'])
            ->get();
        
        return view('statistics.technician_statistics_detail_table', compact('assignedServices'));
    }
