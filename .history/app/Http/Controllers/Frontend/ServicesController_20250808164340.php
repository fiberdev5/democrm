...
class ServicesController extends Controller
{
    ...
    public function TumServiceDesc($tenant_id, $id) {
        ...
        if (!empty($service_id->konsinye_cihazlar_json)) {
            $seciliKonsinyeCihazlar = json_decode($service_id->konsinye_cihazlar_json, true);
        }
        dd([
    'secililer' => $seciliKonsinyeCihazlar,
    'konsinye_ids' => $konsinyeCihazlar->pluck('id'),
    'eşleşenler' => $konsinyeCihazlar->whereIn('id', $seciliKonsinyeCihazlar),
]);
