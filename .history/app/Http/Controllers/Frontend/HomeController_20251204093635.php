...
public function Features()
{
    ...
    $features = [
        [
            ...
            'icon' => 'fas fa-users',
            'title' => 'Müşteri Yönetimi',
            'short_description' => 'Tüm müşteri bilgilerinizi tek merkezden yönetin',
            'color' => 'blue',
            'image' => 'frontend/img/features/musteri-yonetimi.jpg'
        ],
        [
            'slug' => 'is-talep-yonetimi',
            'icon' => 'fas fa-clipboard-list',
            'title' => 'İş Talep Yönetimi',
            'short_description' => 'Servis taleplerini kaydedin ve takip edin',
            'color' => 'blue',
            'image' => 'frontend/img/features/is-talep.jpg'
        ],
        [
            'slug' => 'mobil-saha-yonetimi',
            'icon' => 'fas fa-mobile-alt',
            'title' => 'Mobil Saha Yönetimi',
            'short_description' => 'Teknisyenleriniz sahadan işlem yapabilir',
            'color' => 'blue',
            'image' => 'frontend/img/features/mobil-saha.jpg'
        ],
        [
            'slug' => 'stok-parca',
            'icon' => 'fas fa-boxes',
            'title' => 'Stok Yönetimi',
            'short_description' => 'Parça stoklarınızı takip edin, stok uyarıları alın',
            'color' => 'blue',
            'image' => 'frontend/img/features/stok-yonetimi.jpg'
        ],
        [
            'slug' => 'fatura-yonetimi',
            'icon' => 'fas fa-file-invoice-dollar',
            'title' => 'Fatura Yönetimi',
            'short_description' => 'E-fatura oluşturun, gelir-gider takibi yapın',
            'color' => 'blue',
            'image' => 'frontend/img/features/fatura.jpg'
        ],
        [
            'slug' => 'destek-yardim',
            'icon' => 'fas fa-headset',
            'title' => 'Destek ve Yardım',
            'short_description' => '7/24 teknik destek hizmetimizden faydalanın',
            'color' => 'blue',
            'image' => 'frontend/img/features/destek.jpg'
        ],
        [
            'slug' => 'teklif-yonetimi',
            'icon' => 'fas fa-file-alt',
            'title' => 'Teklif Yönetimi',
            'short_description' => 'Profesyonel teklifler oluşturun ve gönderin',
            'color' => 'blue',
            'image' => 'frontend/img/features/teklif.jpg'
        ],
        [
            'slug' => 'entegrasyonlar',
            'icon' => 'fas fa-plug',
            'title' => 'Entegrasyonlar',
            'short_description' => 'Paraşüt, SMS, Email ve daha fazlası',
            'color' => 'blue',
            'image' => 'frontend/img/features/entegrasyon.jpg'
        ]
    ];

    return view('frontend.frontend_pages.features', compact('features'));
}
public function FeatureDetail($slug)
{
    $featureDetails = [
        'musteri-yonetimi' => [
           ...
           'benefits' => [
            [
                ...
                'description' => 'Her müşteri için ad, soyad, telefon, email, adres gibi temel bilgilerin yanı sıra özel notlar, etiketler ve kategoriler ekleyin. Müşteri tipini belirleyin (bireysel/kurumsal) ve özel indirimler tanımlayın.',
                'icon' => 'fas fa-user-circle', // EKLE
                'image' => 'frontend/img/features/musteri2.jpg'
            ],
            [
                'title' => 'Geçmiş İşlem Takibi',
                'description' => 'Müşterinin daha önce yaptırdığı tüm servisleri, satın aldığı parçaları ve ödemelerini kronolojik sırada görün. Hangi cihazları getirmiş, hangi arızalar yaşanmış, kim tamir etmiş - hepsi tek tıkla.',
                'icon' => 'fas fa-history', // EKLE
                'image' => 'frontend/img/features/musteri.jpg'
            ],
            [
                'title' => 'Hızlı Arama ve Filtreleme',
                'description' => 'Binlerce müşteri arasında isim, telefon, email veya müşteri numarası ile anında arama yapın. Şehir, ilçe, müşteri tipi gibi filtreleme seçenekleri ile listelerinizi daraltın.',
                'icon' => 'fas fa-search',// EKLE
                'image' => 'frontend/img/features/musteri3.png'
            ],
            [
                'title' => 'Otomatik SMS/Email',
                'description' => 'Doğum günü kutlamaları, servis hazır bildirimleri, kampanya duyuruları gibi otomatik mesajlar gönderin. Müşteri iletişimini sistematik hale getirin.',
                'icon' => 'fas fa-envelope', // EKLE
                'image' => 'frontend/img/features/musteri4.png'
            ]
        ],
            'features_list' => [
        ...
        'is-talep-yonetimi' => [
            ...
            'description' => 'İş Talep Yönetimi modülü ile gelen her servis talebini sistematik bir şekilde kaydedin. Müşteri bilgisi, cihaz bilgisi, arıza açıklaması ve öncelik durumunu belirleyin. Teknisyen ataması yapın ve iş sürecini baştan sona takip edin.',
            'benefits' => [
                [
                    'title' => 'Hızlı Servis Kaydı',
                    'description' => 'Müşteri seçimi, cihaz bilgisi, arıza açıklaması ve fotoğraf ekleme işlemlerini tek ekrandan hızlıca tamamlayın. Seri numarası, IMEI veya barkod okutarak otomatik kayıt yapın.'
                ],
                [
                    'title' => 'Teknisyen Atama ve İş Dağılımı',
                    'description' => 'Servisleri teknisyenlere atayın, iş yüklerini dengeleyin. Her teknisyenin açık, devam eden ve tamamlanan işlerini görerek dengeli dağılım sağlayın.'
                ],
                [
                    'title' => 'Durum Takibi ve Bildirimler',
                    'description' => 'Servis durumlarını takip edin: Beklemede, Onarımda, Parça Bekliyor, Tamamlandı, Teslim Edildi. Her durum değişikliğinde müşteriye otomatik SMS gönderilebilir.'
                ],
                [
                    'title' => 'Önceliklendirme Sistemi',
                    'description' => 'Acil, yüksek, normal, düşük öncelik seviyeleri belirleyin. Garanti kapsamındaki işleri etiketleyin. VIP müşterilere özel işlem yapın.'
                ]
            ],
            'features_list' => [
                'Hızlı servis kaydı ve barkod desteği',
                'Teknisyen atama ve iş dağılımı',
                'Durum bazlı süreç takibi',
                'Otomatik müşteri bildirimleri',
                'Fotoğraflı arıza kaydı',
                'Parça talep ve onay sistemi',
                'İşlem geçmişi ve not ekleme',
                'Garanti sorgulama entegrasyonu'
            ],
            'screenshots' => [
                'Servis kayıt formu',
                'İş listesi ve filtreleme',
                'Teknisyen iş yükü görünümü',
                'Durum güncelleme ekranı'
            ]
        ],
        'mobil-saha-yonetimi' => [
            'title' => 'Mobil Saha Yönetimi',
            'subtitle' => 'Teknisyenleriniz sahadan mobil cihazlarla işlem yapabilir',
            'hero_image' => 'frontend/img/features/mobil-saha.jpg',
            'description' => 'Mobil uyumlu Serbis arayüzü ile teknisyenleriniz sahada tablet veya telefonlarından tüm işlemleri gerçekleştirebilir. İş listesini görüntüleme, durum güncelleme, fotoğraf yükleme, parça talep etme ve müşteri imzası alma gibi tüm işlemler mobilde.',
            'benefits' => [
                [
                    'title' => 'Her Yerden Erişim',
                    'description' => 'Responsive (mobil uyumlu) tasarım sayesinde teknisyenler sahada telefon veya tabletlerinden sisteme giriş yapabilir. İnternet bağlantısı olan her yerden çalışma imkanı.'
                ],
                [
                    'title' => 'Sahada İşlem Yapma',
                    'description' => 'Teknisyenler kendilerine atanan işleri görebilir, durumlarını güncelleyebilir, not ekleyebilir ve parça talep edebilir. Tüm işlemler anlık olarak merkeze iletilir.'
                ],
                [
                    'title' => 'Fotoğraf ve İmza',
                    'description' => 'Arıza fotoğrafları çekin, onarım öncesi-sonrası görüntüleri kaydedin. Müşteriden dijital imza alarak teslimat işlemlerini tamamlayın.'
                ],
                [
                    'title' => 'Lokasyon Takibi',
                    'description' => 'Teknisyenlerin nerede olduğunu harita üzerinde görün (opsiyonel). Rota optimizasyonu yapın, en yakın teknisyeni işe atayın.'
                ]
            ],
            'features_list' => [
                'Mobil uyumlu responsive tasarım',
                'Teknisyen iş listesi görüntüleme',
                'Sahadan durum güncelleme',
                'Fotoğraf çekme ve yükleme',
                'Dijital müşteri imzası alma',
                'Parça talep etme',
                'Offline çalışma desteği (yakında)',
                'GPS lokasyon entegrasyonu'
            ],
            'screenshots' => [
                'Mobil iş listesi görünümü',
                'İş detay ve durum güncelleme',
                'Fotoğraf yükleme ekranı',
                'Dijital imza ekranı'
            ]
        ],
        'stok-parca' => [
            'title' => 'Stok ve Yedek Parça Yönetimi',
            'subtitle' => 'Parça stoklarınızı takip edin, kritik seviyelerde uyarı alın',
            'hero_image' => 'frontend/img/features/stok-yonetimi.jpg',
            'description' => 'Stok Yönetimi modülü ile tüm yedek parça, malzeme ve sarf malzemelerinizin stok durumunu takip edin. Giriş-çıkış hareketlerini kaydedin, kritik stok seviyelerinde otomatik uyarılar alın ve tedarikçi yönetimi yapın.',
            'benefits' => [
                [
                    'title' => 'Detaylı Stok Kartları',
                    'description' => 'Her parça için stok kartı oluşturun. Parça adı, kodu, kategorisi, birimi, alış-satış fiyatları, kritik stok seviyesi gibi bilgileri kaydedin. Barkod veya QR kod tanımlayın.'
                ],
                [
                    'title' => 'Giriş-Çıkış Takibi',
                    'description' => 'Parça alımlarını, servislerde kullanılan parçaları, fire ve iadeleri sisteme kaydedin. Her hareketin kim tarafından, ne zaman yapıldığını görün.'
                ],
                [
                    'title' => 'Kritik Stok Uyarıları',
                    'description' => 'Her parça için minimum stok seviyesi belirleyin. Stok kritik seviyenin altına düştüğünde otomatik email veya SMS uyarısı alın.'
                ],
                [
                    'title' => 'Tedarikçi Yönetimi',
                    'description' => 'Tedarikçi firmalarınızı sisteme tanımlayın. Hangi parçayı hangi tedarikçiden aldığınızı kaydedin. Sipariş geçmişini takip edin.'
                ]
            ],
            'features_list' => [
                'Detaylı parça stok kartları',
                'Barkod/QR kod sistemi',
                'Giriş-çıkış hareket takibi',
                'Kritik stok seviyesi uyarıları',
                'Tedarikçi yönetimi',
                'Fiyat geçmişi ve kar-zarar analizi',
                'Envanter sayım raporları',
                'Excel toplu içe-dışa aktarım'
            ],
            'screenshots' => [
                'Stok listesi ve arama',
                'Parça detay kartı',
                'Giriş-çıkış hareket listesi',
