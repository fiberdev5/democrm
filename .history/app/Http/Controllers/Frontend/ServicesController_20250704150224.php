    ...
    try {
        ...
        foreach ($planCevaplar as $cevap) {
            ...
            if ($soru->cevapTuru == '[Parca]') {
                ...
                // Konsinye Cihaz seçimi - DÜZELTME
                $soruKey = 'soru' . $cevap->id; // Doğru key
                $selectedConsignment = $request->input($soruKey);
                
                if ($selectedConsignment) {
                    // Değer zaten "C_123---5" formatında geliyor
        ...
        \Log::error("Servis Planı Güncelleme Hatası: " . $e->getMessage());
