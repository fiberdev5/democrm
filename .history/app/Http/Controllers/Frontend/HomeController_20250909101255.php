    ...
    try {
        if ($step == 1) {
            ...
            $validatedData = $request->validate([
                ...
                'emailre' => 'required|email|max:255|unique:tenants,eposta',
                'vergiNo' => 'required|max:10|unique:tenants,vergiNo',
            ], [
                'name.required' => 'Ad Soyad alanı zorunludur.',
                'name.max' => 'Ad Soyad alanı en fazla 255 karakter olmalıdır.',
                'emailre.required' => 'E-posta alanı zorunludur.',
                'emailre.email' => 'Geçerli bir e-posta adresi giriniz.',
                'emailre.max' => 'E-posta alanı en fazla 255 karakter olmalıdır.',
                'emailre.unique' => 'Bu e-posta adresi zaten kayıtlı.',
            ...
            // 2. Adım validasyonu (1. adım verilerini de kontrol et)
            $validatedData = $request->validate([
                'name' => 'required|string|max:255',
                'emailre' => 'required|email|max:255|unique:tenants,eposta',
                'vergiNo' => 'required|max:10|unique:tenants,vergiNo',
...
// RegisterAction metodunuzu da güncelleyin:
