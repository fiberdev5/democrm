            ...
            $storagePurchases = $tenant->storagePurchases()
                ...
                ->map(function($purchase) {
                    return [
                        ...
                        'currency' => 'TL',
                        'payment_method' => $this->extractPaymentMethodForExport($purchase),
                        'status_label' => $this->getStatusLabel($purchase->status),
                        ...
                        'transaction_id' => $purchase->payment_token ?? '-',
                        'gateway' => 'Depolama Sistemi',
