...
class SurveyController extends Controller
{
    ...
    public function AllSurveys(Request $request)
    {
        ...
        return view('', compact('surveys'));
    }

    /**
     * Anket formu - Modal için AJAX ile döner
     */
    public function SurveyForm($service_id)
    {
        ...
        return view('frontend.secure.surveys.survey_form', compact('service', 'existingSurvey', 'personels', 'dealers'));
    }
    ...
    public function DeleteSurvey($id)
    {
        try {
            ...
            Log::info("ServisAnketID: {$id} Servis Anketi Silindi");
            ...
            Log::error("Anket Silme Hatası: " . $e->getMessage());
            return response()->json([
                'success' => false,
