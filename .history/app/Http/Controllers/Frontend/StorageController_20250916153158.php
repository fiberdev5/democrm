...
class StorageController extends Controller
{
    ...
    public function purchase(Request $request, $tenant_id)
    {
        ...
        $paymentToken = 'STORAGE' . $tenant_id . time() . Str::random(10);
        ...
        // PayTR hash oluştur
        $hash_str = $merchant_id . $user_ip . $paymentToken . $firma->eposta ?: 'noreply@example.com' .  $payment_amount . $user_basket . 1 . 0 . 'TL' . 1;
