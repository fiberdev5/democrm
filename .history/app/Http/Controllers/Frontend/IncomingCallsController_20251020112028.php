        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row) {
                    ...
                    // Görüntüleme butonu
                    $buttons .= '<a href="javascript:void(0);" class="btn btn-outline-primary btn-sm editIncomingCall mobilBtn mbuton1" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal" title="Görüntüle"><i class="fas fa-edit"></i> <span> Görüntüle</span></a>';
