...
{     
    ...
    try {
        ...
        // Her listeden en fazla 3'er tane göster (dashboard'da daha fazla görünür olması için)
        $alerts['critical'] = array_slice($alerts['critical'], 0, 3);
        $alerts['low'] = array_slice($alerts['low'], 0, 3);
