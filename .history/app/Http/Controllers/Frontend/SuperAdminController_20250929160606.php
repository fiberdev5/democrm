...
return DataTables::of($allPayments)
    ...
    $statusStyles = match($row['status']) {
        'active', 'completed' => 'background-color: #28a745; color: white;',
        ...
        default => 'background-color: #343a40; color: white;'
    };
    ...
    return '<a href="javascript:void(0);" class="t-link status-cell" style="' . $statusStyles . ' padding: 8px 12px; border-radius: 4px; font-weight: 600; display: block; text-align: center;">' 
    ...
    return '<a href="javascript:void(0);" class="t-link invoice-cell" style="' . $invoiceStyle . ' padding: 8px 12px; border-radius: 4px; font-weight: 600; display: block; text-align: center;">' 
           . $icon . $text . 
           '</a>';
})
