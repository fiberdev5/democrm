...
$stokDurumu = StockAction::where('stokId', $stokId)
    ->selectRaw("
        SUM(CASE WHEN islem = 1 THEN adet ELSE 0 END) as giris,
        SUM(CASE WHEN islem = 2 THEN adet ELSE 0 END) as cikis
    ")
    ->first();

$kalanAdet = ($stokDurumu->giris ?? 0) - ($stokDurumu->cikis ?? 0);
