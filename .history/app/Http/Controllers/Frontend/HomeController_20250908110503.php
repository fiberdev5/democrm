...
class HomeController extends Controller
{
    ...
    private function createTenantAndUser(array $data) {
        ...
        $planId = $request->plan_id ?? session('selected_plan');
        ...
        $tenant = new Tenant([
            ...
            'trial_used' => 1,
            'personelSayisi'  => $plan->limits['users'],
            'bayiSayisi' => $plan->limits['dealers'],
            'stokSayisi' => $plan->limits['stocks'],
            'konsinyeSayisi' => $plan->limits['konsinye'],
        ]);
        $tenant->save();
