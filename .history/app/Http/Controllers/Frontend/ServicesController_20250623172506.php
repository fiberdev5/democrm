        ...
        try {
            ...
            if ($servisGuncellendi) {                
                ...
                if ($kasaSec) {
                    ...
                    CashTransaction::where('firma_id', $ten)
                        ->where('id', $kasaSec->id)
                        ->update($kasaUpdateData);
                    
                    Log::info("ServisID: {$asamaSec->servisid}, KasaID: {$kasaSec->id} Kasa Ödeme Güncellendi");
                }
                ...
                DB::rollBack();
                Log::error("ServisID: {$asamaSec->servisid}, ServisParaID: {$id} Servis Ödeme Güncellenemedi");
