    ...
    if ($request->ajax()) {
                    ...
                    $subscriptionPayments = $tenant->subscriptionPayments()
                        ...
                        ->map(function($payment) use ($tenant) {
                            return [
                                ...
                                'invoice_status' => !empty($payment->invoice_path) ? '<span class="badge badge-success"><i class="fas fa-check mr-1"></i>Mevcut</span>' : '<span class="badge badge-warning"><i class="fas fa-clock mr-1"></i>Bekleniyor</span>',
                    ...
                    $storagePurchases = $tenant->storagePurchases()
                        ...
                        ->map(function($purchase) use ($tenant) {
                            ...
                            return [
                                ...
                                'invoice_status' => !empty($purchase->invoice_path) ? '<span class="badge badge-success"><i class="fas fa-check mr-1"></i>Mevcut</span>' : '<span class="badge badge-warning"><i class="fas fa-clock mr-1"></i>Bekleniyor</span>',
        ...
        return DataTables::of($allPayments)
            ...
            ->editColumn('status_label', function($row) {
                ...
                return '<span class="badge badge-' . $statusClass . '">' . $row['status_label'] . '</span>';
            })
