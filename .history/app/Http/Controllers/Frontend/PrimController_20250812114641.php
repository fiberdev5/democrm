        ...
        foreach ($gunler as $gun) {
            ...
            $bitenServisler = DB::table('service_plannings')
                ...
                ->select('service_plannings.servisid', 'service_plannings.created_at', 
                        ...
                        'services.kayitAlan', 'services.id')     //ekiden sonlanan servislerin primlerini hesaplıyorduk: ->where('service_plannings.gidenIslem', 255)
                ->whereBetween('service_plannings.created_at', [$gunBaslangic, $gunBitis])
                ->where('services.kayitAlan', $personelId)
                ->get()
                ->pluck('service_plannings.servisid');
                ...
                if (!$musteriIptal) {
                    ...
                    if (!$cihazTamirEdilemiyor) {
                        ...
                        $servisSon = DB::table('service_plannings')
                            ->where('servisid', $servis->servisid)  //eskiden servis sonlanmışsa hesaplıyorduk: ->where('gidenIslem', 255) bunu eklemiştik.şimdi servis sonlanmışsa diye koşulu kaldırdık.
                            ->exists();
