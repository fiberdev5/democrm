...
public function uploadPhoto(Request $request, $tenant_id)
{
    ...
    $path = 'uploads/stock_photos/';
    $fullPath = public_path($path . $filename);

    \Intervention\Image\Laravel\Facades\Image::read($file)->resize(700, 400)->save($fullPath);

    $resimyol = '/' . $path . $filename;

    $new = \App\Models\stock_photos::create([
        'kid' => $tenant_id,
