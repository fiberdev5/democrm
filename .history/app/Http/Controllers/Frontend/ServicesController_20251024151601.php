...
if ($request->ajax()) {
    ...
    private function applyDefaultLast3DaysIfEmpty($query, Request $request): void
    {
        ...
        if ($hasSearch || $hasFilters) {
         ...
         $isTechnician = auth()->user()->hasRole('teknisyen');
        // Config dosyasında veya model'de tanımlayın
$defaultDaysToShow = $isTechnician ? 30 : 3; // Teknisyen için 30 gün, diğerleri için 3 gün

$from = Carbon::today()->subDays($defaultDaysToShow - 1)->startOfDay();
