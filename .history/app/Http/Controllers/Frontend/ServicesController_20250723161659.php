            ...
            if ($request->filterType && $request->filters) {
                ...
                switch ($request->filterType) {
                    ...
                    // Anketleri olan servisleri getir ve anketin yapıldığı tarihe göre filtrele
                        ...
                        if ($request->filled('anketi_yapilan_personel') && $request->anketi_yapilan_personel != 0) {
                            $query->where('personel', $request->anketi_yapilan_personel);
                        }

                        // Anketi ekleyen personel filtresi
                        if ($request->filled('anketi_yapan_personel') && $request->anketi_yapan_personel != 0) {
                            $query->where('ekleyen', $request->anketi_yapan_personel);
                        }
