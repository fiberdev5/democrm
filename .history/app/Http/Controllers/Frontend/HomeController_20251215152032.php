...
$hero = [
    'badge' => 'Yeni: AI destekli servis yönetimi',
    'title' => 'Teknik Servisi',
    'highlight' => 'Yeniden Tanımlayın',
    'description' => 'Müşteri, servis, stok ve personel yönetiminizi tek güçlü platformda birleştirin. Verimliliği artırın, maliyetleri düşürün.',
    'primary_button_text' => 'Ücretsiz Başla',
    'primary_button_icon' => 'fas fa-rocket',
    'secondary_button_text' => 'Demo İzle',
    'secondary_button_icon' => 'fas fa-play-circle',
    'features' => [
        ['icon' => 'fas fa-bolt', 'text' => '14 gün ücretsiz'],
        ['icon' => 'fas fa-shield-alt', 'text' => 'Kredi kartı gerektirmez'],
        ['icon' => 'fas fa-check-circle', 'text' => 'Anında kurulum']
    ],
    'image' => 'frontend/img/anasayfa.png',
    'floating_stat' => [
        'icon' => 'fas fa-bolt',
        'number' => '2,450+',
        'label' => 'Aktif Servis'
    ...
    public function verifySmsCode(Request $request) 
{
    ...
    try {
        ...
        // KAYIT BAŞARILI SMS GÖNDER
        try {
            $smsService = new TescomService();
            $smsMessage = "Serbis ailesine hoşgeldiniz.\nDemo talebiniz alınmıştır. Serbis demo hesap bilgileriniz en kısa süre içerisinde e-posta adresinize gönderilecektir.";
