        ...
        return DataTables::of($data)
           ...
           ->addColumn('durum', function($row) {
                $statusBadge = $row->status == 1
                    ? '<span class="badge" style="background-color: #28a745; color: white; padding: 4px 7px; font-size: 10px;"><i class="mdi mdi-check-circle"></i> Aktif</span>'
                    : '<span class="badge bg-danger" style="padding: 4px 7px; font-size: 10px;"><i class="mdi mdi-close-circle"></i> Pasif</span>';
