...
{
    $pages = HomepageContent::whereIn('section', ['gizlilik', 'kullanim-sartlari', 'kvkk'])
        ->get();
    
    return view('frontend.secure.super_admin.frontend.legal-pages', compact('pages'));
}
...
public function editLegalPage($section = null)
{
    ...
    return view('frontend.secure.super_admin.frontend.legal-page-edit', compact('page', 'section'));
}
...
{
    $validated = $request->validate([
        'section' => 'required|string|in:gizlilik,kullanim-sartlari,kvkk',
    ...
    return redirect()->route('frontend.secure.super_admin.frontend.legal-pages')->with('success', 'Sayfa kaydedildi');
}
...
public function deleteLegalPage($section)
{
    ...
    return redirect()->route('frontend.secure.super_admin.frontend.legal-pages')->with('success', 'Sayfa silindi');
}
/*************************************************** Frontend Düzenelemeleri *****************************************************/
