...
class CashTransactionsController extends Controller
{
    ...
    {   
        ...
        $personel = User::where('tenant_id', $tenant_id)->whereNotIn('role', ['Bayi', 'Admin', 'Patron'])->where('status', 1)->orderBy('name', 'asc')->get();
        ...
        return view('frontend.secure.cash_transactions.all_cash_transaction',compact('cash_transactions', 'payment_types', 'payment_methods' ,'personel','musteriler','firma','bayiler'));
