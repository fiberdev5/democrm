   ...
   public function index()
{
    ...
    // Option A: Inspect the SQL query
    // dd($tickets->toSql(), $tickets->getBindings());

    // Option B: Inspect the results directly
    // dd($tickets->get()); // Get all tickets for debugging, ignore pagination for a moment
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('frontend.secure.support.show', $ticket->id)
