...
public function addPaymentToInvoice(Request $request, $firma_id)
{
    ...
    try {
        ...
        // ⭐ Kalan tutarı al - Bu tutar otomatik olarak eklenecek
    ...
    $newPaymentId = $paymentResult['payment_id']; // ✅ Cast yapmadan önce logla
    
    Log::info('Yeni payment ID kaydediliyor', [
        'raw_payment_id' => $newPaymentId,
        'payment_id_type' => gettype($newPaymentId),
        'existing_payment_ids' => $paymentIds
    ]);
    ...
    Log::info('Payment IDs kaydedildi', [
        'saved_payment_ids' => $paymentIds,
        ...
        return response()->json([
            ...
            'remaining_amount' => 0, // Tamamı ödendi
