...
if ($request->ajax()) {
    ...
    private function applyDefaultLast3DaysIfEmpty($query, Request $request): void
    {
        ...
        // Teknisyen kontrolü ekleyin
    $isTechnician = auth()->user()->hasRole('teknisyen'); // veya benzeri bir kontrol
    ...
    // Teknisyen ise tarih kısıtlaması uygulama
    if ($isTechnician) {
        // Teknisyene atanan TÜM servisleri göster
        return;
    }
