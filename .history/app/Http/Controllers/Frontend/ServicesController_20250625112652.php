...
class ServicesController extends Controller
{
    ...
    public function ServicePhotos($tenant_id, $service_id) {
        ...
        return view('frontend.secure.all_services.service_photos.all_service_photos', compact('firma', 'servis'));
    }
    ...
    public function StoreServicePhoto($tenant_id, Request $request) {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'servisid.required' => 'Servis ID gereklidir.',
                'servisid.exists' => 'Geçersiz servis ID.'
            ]);
            ...
            // Dosyayı kaydet
            $filePath = $file->storeAs('servis_fotolari', $fileName, 'public');
            ...
            return response()->json([
                ...
                'photo' => [
                    'id' => $photo->id,
                    'url' => asset($photo->belge),
                    'thumbnail' => asset($photo->belge), // Thumbnail oluşturmak isterseniz buraya ekleyebilirsiniz
            ...
            \Log::error('Servis fotoğraf yükleme hatası: ' . $e->getMessage());
