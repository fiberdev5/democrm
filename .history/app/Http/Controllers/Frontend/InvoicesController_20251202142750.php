...
class InvoicesController extends Controller
{
    ...
    if($hasParasutIntegration) {
        $earsivButton = '<a href="javascript:void(0);" data-invoice-id="'.$row->id.'" class="btn btn-outline-primary btn-sm formalizeInvoice mobilBtn mbuton1" title="Paraşütte Resmileştir"><i class="fas fa-paper-plane"></i> </a>';
    } else {
