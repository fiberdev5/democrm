...
{
    $firma = Tenant::findOrFail($tenant_id);
    $stockAction = StockAction::where('firma_id', $firma->id)->where('id', $id)->firstOrFail();

    // İlişkili kayıtlar varsa onları da silebilirsin (isteğe bağlı)
    ...
    return response()->json(['success' => true, 'message' => 'Stok hareketi silindi.']);
}
