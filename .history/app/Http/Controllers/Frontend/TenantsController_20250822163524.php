...
class TenantsController extends Controller
{
    ...
    public function changeTenantStatus($id)
    {
        ...
        // Mevcut durumu tersine çevir (1 ise 0 yap, 0 ise 1 yap)
        $tenant->status = $tenant->status == 1 ? 0 : 1;
        $tenant->save();

        // Kullanıcıya bildirim mesajı hazırla
        ...
        // Kullanıcıyı bir önceki sayfaya bildirim ile birlikte geri yönlendir
        return redirect()->back()->with($notification);
    }
}
