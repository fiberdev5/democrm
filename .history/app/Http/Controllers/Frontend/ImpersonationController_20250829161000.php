...
class ImpersonationController extends Controller
{
    ...
    if ($originalUser && $originalUser->isSuperAdmin()) {
        ...
        $redirectRoute = 'secure.home';
        $redirectParams = ['tenant_id' => $originalUser->tenant_id];
    }
    ...
    if ($request->expectsJson()) {
        return response()->json([
            ...
            'redirect_url' => route($redirectRoute, $redirectParams)
        ]);
    }
    ...
    return redirect()->route($redirectRoute, $redirectParams)->with($notification);
}
