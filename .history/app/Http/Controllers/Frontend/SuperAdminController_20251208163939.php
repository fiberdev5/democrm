...
public function storeLegalPage(Request $request, $section = null)
{
    ...
    return redirect()->route('frontend.secure.super_admin.frontend.legal_pages')->with('success', 'Sayfa kaydedildi');
}
...
public function deleteLegalPage($section)
{
    ...
    return redirect()->route('frontend.secure.super_admin.frontend.legal_pages')->with('success', 'Sayfa silindi');
}
/*************************************************** Frontend Düzenelemeleri *****************************************************/
