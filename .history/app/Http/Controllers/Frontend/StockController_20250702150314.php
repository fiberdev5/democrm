...
public function StokActions($tenant_id, $stock_id)
{
   ...
   $stokHareketleri = StockAction::with(['musteri'])
            ->select(
                'stock_actions.*',
                'stock_suppliers.tedarikci as tedarikci_adi',
...
public function StoreStockAction(Request $request, $tenant_id)
{
    ...
    $validated = $request->validate([
        ...
        'tedarikci' => 'nullable|integer|exists:stock_suppliers,id',
        'servisid'   => 'required_if:islem,2|integer',
        'personel'   => 'required_if:islem,3|integer',
    ]);
