 ...
 public function StoreStockAction(Request $request, $tenant_id)
    {
        ...
        if ($personelStok) {
            ...
            $personelStok = PersonelStock::create([
                'stokid'   => $stokId,
                'kid'      => $firma->id, // Bu 'kid' muhtemelen firma_id'yi temsil ediyor, model tanımınıza göre değişebilir
                'firma_id' => $firma->id,
        ...
        // stockAction'ın personel alanı, işlemi yapan personel olmalı. 
        // Zaten yukarıda $stockAction->kid olarak ayarlanmıştı.
