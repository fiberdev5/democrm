...
class ServicesController extends Controller
{
    ...
    $viewUrl     = route('show.service', [$row->firma_id, $row->id]); // 👈 Görüntüleme route’unu ayarlamalısın

    $editButton  = '<a href="javascript:void(0);" data-bs-id="'.$row->id.'" 
                       class="btn btn-outline-primary btn-sm mobilBtn mbuton1 serBilgiDuzenle" 
    ...
    $viewButton  = '<a href="javascript:void(0);" data-bs-id="'.$row->id.'" 
                       class="btn btn-outline-info btn-sm mobilBtn mbuton2 serBilgiDuzenle"
                       data-bs-toggle="modal" data-bs-target="#editServiceDescModal" 
                       title="Görüntüle">
    ...
    if (Auth::user()->can('Servisleri Silebilir')) {
        $deleteButton = '<a href="'.$deleteUrl.'" 
                            class="btn btn-danger btn-sm mobilBtn mbuton3" 
                            id="delete" title="Sil">
