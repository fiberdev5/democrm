   ...
   public function stop(Request $request)
{
    ...
    $impersonatorId = session('impersonator_id');   // ✅ gerçek ID
    $impersonationId = session('impersonated_user_id');
    ...
    return redirect()->route('super.admin.dashboard', ['tenant_id' => $originalUser->tenant_id])
                     ->with($notification);
}
