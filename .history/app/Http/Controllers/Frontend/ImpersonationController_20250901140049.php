...
class ImpersonationController extends Controller
{
	...
	1	id Birincil	bigint(20)		UNSIGNED	Hayır	Yok		AUTO_INCREMENT	Değiştir Değiştir	Kaldır Kaldır	
	2	impersonator_id Index	bigint(20)		UNSIGNED	Hayır	Yok			Değiştir Değiştir	Kaldır Kaldır	
	3	impersonated_id Index	bigint(20)		UNSIGNED	Hayır	Yok			Değiştir Değiştir	Kaldır Kaldır	
	4	tenant_id Index	bigint(20)		UNSIGNED	Hayır	Yok			Değiştir Değiştir	Kaldır Kaldır	
	5	started_at Index	timestamp			Hayır	current_timestamp()		ON UPDATE CURRENT_TIMESTAMP()	Değiştir Değiştir	Kaldır Kaldır	
	6	ended_at	timestamp			Evet	NULL			Değiştir Değiştir	Kaldır Kaldır	
	7	ip_address	varchar(255)	utf8mb4_unicode_ci		Evet	NULL			Değiştir Değiştir	Kaldır Kaldır	
	8	reason	text	utf8mb4_unicode_ci		Evet	NULL			Değiştir Değiştir	Kaldır Kaldır	
	9	created_at	timestamp			Evet	NULL			Değiştir Değiştir	Kaldır Kaldır	
	10	updated_at	timestamp			Evet	NULL			Değiştir Değiştir	Kaldır Kaldır
