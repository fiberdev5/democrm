        ...
        if ($request->has('status_group')) {
            ...
            if ($request->status_group === 'cancelled') {
                ...
                if ($request->has('dashboard_istatistik_tarih1') && $request->has('dashboard_istatistik_tarih2')) {
                    // DATE() yerine direkt datetime karşılaştırması
                    $startDateTime = $request->dashboard_istatistik_tarih1 . ' 00:00:00';
                    $endDateTime = $request->dashboard_istatistik_tarih2 . ' 23:59:59';
                    
                    $query->whereBetween('updated_at', [$startDateTime, $endDateTime]);
                }
            } 
            // İŞLEMDE OLAN SERVİSLER
