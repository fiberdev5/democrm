...
class ServicesController extends Controller
{
    ...
    $zaten_sonlanmis_asama_adi = 'Sonlandırıldı';

        // İlişkili 'asamalar' modelinin var olup olmadığını kontrol edelim.
    if ($row->asamalar) {
        ...
        if (in_array($row->asamalar->asama, $sonlandirabilir_asamalar)) {
            ...
            // "Servisi Sonlandır" işlemiyle geçilecek olan hedef aşamanın ID'si.
            $hedef_sonlanmis_asama_id = 255; // 'Sonlandırıldı' veya 'Tamamlandı' aşamanızın ID'si

            // Bootstrap 5 'form-switch' yapısı kullanılıyor.
            return '
        ...
        // DURUM 2: Servis zaten sonlanmış bir aşamadaysa (Switch 'ON' ve pasif durumda)
