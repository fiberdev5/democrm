            ...
            if ($request->filterType && $request->filters) {
                ...
                switch ($request->filterType) {
                    ...
                    case 'acilArama':
                        ...
                        ->whereBetween('created_at', [$t1, $t2]);
                    break;
                  // Anketi yapılan personel → survey.personel
        if (!empty($filters['yapilan_anketi_yapilan_personel']) && $filters['yapilan_anketi_yapilan_personel'] != '0') {
            $query->where('personel', $filters['yapilan_anketi_yapilan_personel']);
        }

        // Anketi ekleyen personel → survey.ekleyen
        if (!empty($filters['yapilan_anketi_yapan_personel']) && $filters['yapilan_anketi_yapan_personel'] != '0') {
            $query->where('ekleyen', $filters['yapilan_anketi_yapan_personel']);
        }
