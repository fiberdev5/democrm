...
class HomeController extends Controller
{
    ...
    public function verifySmsCode(Request $request) {
        ...
        return redirect()->route('kayit')->with([
            'message' => 'Hesabınız başarıyla oluşturuldu. Giriş bilgileriniz mail adresinize iletilmiştir. Giriş yapabilirsiniz.',
            'alert-type' => 'success'
        ]);
    }
    public function resendSmsCode(Request $request) {
        ...
        // Burada SMS gönderimini yapabilirsin

        return redirect()->back()->with('message', 'Yeni doğrulama kodu gönderildi!');
    }
    /**
    ...
    private function createTenantAndUser(array $data) {
        ...
        Mail::to($data['email'])->queue(new UserRegisteredMail($user->eposta));
    }
