...
public function checkFormalizationStatusController(Request $request, $firma_id, $invoice_id)
{
    ...
    // Durum kontrolü yap
    $statusCheck = $parasutService->checkFormalizationStatus($invoice->integration_invoice_id);
    ...
    if ($statusCheck['success']) {
        ...
        // ⭐ YENİ: Eğer Paraşüt'ten resmi numara geldiyse ve bizdeki boşsa veya farklıysa güncelle
        ...
        // ... Return işlemleri aynı ...
        return response()->json([
            'success' => true,
            'formalized' => $statusCheck['formalized'],
            'status' => $statusCheck['status'],
            'invoice_number' => $statusCheck['invoice_number'] ?? null, // Frontend'e de gönderelim
