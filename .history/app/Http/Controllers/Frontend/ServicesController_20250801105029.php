...
class ServicesController extends Controller
{
    public function AllServices($tenant_id, Request $request) {
        ...
        $survey_istatistik_tarih1 = $request->survey_istatistik_tarih1;
        $survey_istatistik_tarih2 = $request->survey_istatistik_tarih2;
 ...
 // Personel filtresi
    if ($request->has('personel_id') && $request->personel_id) {
        $query->where('personel_id', $request->personel_id);
    }
    
    // Sadece anket yapılan servisler
