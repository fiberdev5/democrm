...
public function UpdateServicePlan(Request $request, $tenant_id)
{
    ...
    \Log::info("Gelen Konsinye Cihaz Cevabı ($soruKey): " . ($selectedConsignment ?? 'BOŞ'));
    // Veya sadece geliştirme ortamında kullanmak için:
    // dd($selectedConsignment);

    if ($selectedConsignment) {
        // Eğer burada hala "C_53" gibi eksik geliyorsa, sorun frontend'den gelende demektir.
        // Eğer "C_53---2" gibi doğru geliyorsa, ve veritabanına yanlış kaydediliyorsa, veritabanı alan tipini kontrol edin.
