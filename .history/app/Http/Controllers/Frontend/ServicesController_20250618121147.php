    ...
    public function SaveServicePlan(Request $request, $tenant_id) {
        ...
        try {
            ...
            if ($planId) {
                ...
                $data  = Service::where('id', $servisId)
                    ->update([
                ...
                // Alt aşamaları yeniden hesapla
                $altAsamaIDs = explode(',', $servisId->asamalar->altAsamalar);
                $altAsamalar = ServiceStage::where('id', $service->servisDurum)->orderBy('asama')->get();
                
                return response()->json([
                    'success' => true,
                    'altAsamalar' => $altAsamalar,
                    'yeniAsama' => $servisId->asamalar["asama"], // Güncel asama
