    ...
    public function stop(Request $request)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json([
                ...
                'redirect_url' => route('super.admin.dashboard', ['tenant_id' => $originalUser->tenant_id])
            ]);
        }
        ...
        return redirect()->route('super.admin.dashboard', ['tenant_id' => $originalUser->tenant_id])->with($notification);
    }
