...
class ServicesController extends Controller
{
    ...
    private function colActions($row): string
    {
        ...
        $editButton  = '<a href="javascript:void(0);" data-bs-id="'.$row->id.'" class="btn btn-outline-primary  btn-sm serBilgiDuzenle mobilBtn mbuton1" data-bs-toggle="modal" data-bs-target="#editServiceDescModal" title="Düzenle" ><i class="fas fa-edit"></i><span> Düzenle</span></a>';
        $deleteButton= '';
