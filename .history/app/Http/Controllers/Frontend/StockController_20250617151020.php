...
class StockController extends Controller
{
     ...
     public function AddStock($tenant_id){
        ...
        public function StoreStock(Request $request, $tenant_id){
            ...
            $stock->raf_id    = $request->raf_id;     // ilişkili raf tablosu id'si
            $stock->marka_id  = $request->marka_id;   // ilişkili marka tablosu id'si
            $stock->cihaz_id  = $request->cihaz_id;   // ilişkili cihaz tablosu id'si
            $stock->save();
