...
class ArizaKoduController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($model_id && $model_id > 0) {
            // Model bazlı kodlar
            $kodlar = ArizaKodu::where('model_id', $model_id)->get();
            ...
            // Marka bazlı kodlar
            $kodlar = ArizaKodu::where('marka_id', $marka_id)->get();
        ...
        return view('kodlar.index', compact('kodlar', 'titleSec', 'marka_id', 'model_id'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('kodlar.create', compact('marka_id', 'model_id'));
    }
    // Kod kaydet
    ...
    public function edit($id)
    {
        ...
        return view('kodlar.edit', compact('kodSec'));
    }
    // Kod güncelle
