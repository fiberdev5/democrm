...
public function Integrations()
{
    ...
    $integrations = [
        'SMS' => [
            [
                ...
                'category' => 'SMS',
                'detail' => 'Türkiye\'nin lider SMS sağlayıcısı ile entegre çalışın. Servis durumu değişikliklerinde otomatik bildirim gönderin.',
                'features' => [
                    'Toplu SMS gönderimi',
                    'Servis durumu bildirimleri',
                    'SMS şablonları',
                    'Gönderim raporları',
                    'API entegrasyonu'
                ]
            ...
            [
                ...
                'category' => 'SMS',
                'detail' => 'Tescom altyapısı ile güvenilir SMS iletişimi. Müşterilerinizi her aşamada bilgilendirin.',
                'features' => [
                    'Yüksek iletim oranı',
            ...
            [
                ...
                'category' => 'SMS',
                'detail' => 'Verimor altyapısı ile hızlı ve güvenilir SMS gönderimi. Uygun fiyatlarla yüksek kalite.',
                'features' => [
    ...
    return view('frontend.frontend_pages.integrations', compact('integrations'));
}
    // public function Index() {
