        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('id', function($row) {
                    return '<a class="t-link editIncomingCall idWrap" href="javascript:void(0);" data-bs-id="'.$row->id.'" data-bs-toggle="modal" data-bs-target="#editIncomingCallModal">'.$row->id.'</a>';
                })
