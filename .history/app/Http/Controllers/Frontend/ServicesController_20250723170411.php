...
class ServicesController extends Controller
{
    public function AllServices($tenant_id, Request $request) {
        ...
        if ($request->ajax()) {           
            ...
            // Personel filtresi (kayitAlan sütununa göre)
            ...
            // Bayi filtresi
            if (!empty($filters['bayiler']) && $filters['bayiler'] != '0') {
                // Burada 'bayi' sütununun 'data' modelinde olduğunu varsayıyorum.
                // Eğer 'bayi' bilgisi de 'cevaplar' veya başka bir ilişki üzerinden geliyorsa
                // buna göre düzenlemek gerekebilir.
                $data->where('bayi', $filters['bayiler']);
            }

            // Anketleri olmayan servisleri getir
            // Belirtilen filtrelerle eşleşen, ancak ilişkili 'surveys' kaydı olmayan servisleri filtreler.
