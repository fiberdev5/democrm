...
class BulkSmsController extends Controller
{
    ...
    public function list(Request $request, $tenant_id)
    {
        ...
        // DÜZELTME: d-m-Y formatında parse et
        $tarih1 = Carbon::createFromFormat('d-m-Y', $tarih1Input)->startOfDay();
        $tarih2 = Carbon::createFromFormat('d-m-Y', $tarih2Input)->endOfDay();
