...
class StockController extends Controller
{
   ...
   public function StoreStock(Request $request, $tenant_id){
    ...
    // Ürün adı kontrolü (hem ajax hem normal form için)
    ...
    if ($existingName) {
        if ($request->ajax()) {
            return response()->json([
                ...
                'message' => 'Bu ürün adıyla zaten kayıtlı bir ürün var: "' . $existingName->urunAdi . '"'
            ]);
        } else {
            return redirect()->back()->withInput()->with([
                'message' => 'Bu ürün adıyla zaten kayıtlı bir ürün var: "' . $existingName->urunAdi . '"',
    ...
    // Normal form submit ise redirect et
