...
class PaymentHistoryController extends Controller
{
    ...
    private function getDataTablesData(Request $request, $tenant)
    {
        ...
        $data = $paymentsForPage->map(function($payment) {
            ...
            // Fatura durumu rengi ve ikonu
            $invoiceColor = $payment['invoice_path'] ? '#17a2b8' : '#fd7e14';
            $invoiceIcon = $payment['invoice_path'] 
                ? '<i class="fas fa-check-circle me-1"></i>' 
                : '<i class="fas fa-clock me-1"></i>';
            $invoiceText = $payment['invoice_path'] ? 'Mevcut' : 'Bekleniyor';
            ...
            return [
                ...
                'invoice_status' => '<a href="javascript:void(0);" class="t-link" style="color: ' . $invoiceColor . ' !important; font-weight: 600;">' . $invoiceIcon . $invoiceText . '</a>'
            ];
        });
