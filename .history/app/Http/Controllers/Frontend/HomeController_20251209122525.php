    ...
    public function verifySmsCode(Request $request) 
{
    ...
    try {
        ...
        try {
            $smsService = new TescomService();
            $smsMessage = "Kayıt Başarılı. Demo talebiniz alınmıştır. Hoş geldiniz! Serbis demo hesap bilgilerinizi en kısa süre içerisinde e-posta adresinize göndereceğiz.";
