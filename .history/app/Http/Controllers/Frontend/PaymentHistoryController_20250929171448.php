    ...
    private function getDataTablesData(Request $request, $tenant)
    {
        ...
        $data = $paymentsForPage->map(function($payment) {
            ...
            return [
                ...
                'status_label' => '<a href="javascript:void(0);" class="t-link"><span class="badge badge-' . $statusClass . '">' . $payment['status_label'] . '</span></a>',
                'created_at' => '<a href="javascript:void(0);" class="t-link"><strong>' . $payment['created_at']->format('d.m.Y') . '</strong></a>',
                'invoice_status' => '<a href="javascript:void(0);" class="t-link">' . $invoiceStatus . '</a>'
            ];
        });
