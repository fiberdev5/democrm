        ...
        if ($request->ajax()) {           
            ...
            if ($request->filterType && $request->filters) {
                ...
                switch ($request->filterType) {
                    ...
                    // Bayi filtresi: Service modeli ile ilişkili ServiceStageAnswer tablosundaki
                    // 'soruid' 3 olan ve 'cevap' değeri filtrelenen bayi ID'sine eşit olan kayıtları olmayan servisleri bul.
                    if (!empty($filters['bayiler']) && $filters['bayiler'] != '0') {
