...
class ServicesController extends Controller
{
    ...
    public function ServiceMoneyActions($tenant_id, $service_id) {
        ...
        return view('frontend.secure.all_services.service_money_actions', compact('firma', 'servis'));
    }
    ...
    public function AddServiceIncome($tenant_id, $service_id) {
        ...
        return view('frontend.secure.all_services.add_service_income', compact('firma', 'servis'));
    }
    ...
    public function AddServiceExpense($tenant_id, $service_id) {
        ...
        return view('frontend.secure.all_services.add_service_expense', compact('firma', 'servis'));
    }
