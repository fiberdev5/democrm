...
class ServicesController extends Controller
{
    ...
    {
        $hasMainRange = $request->filled('from_date') && $request->filled('to_date');

        // Diğer tüm özel tarih filtreleri (operator/state/stage/ilce/personel) de yoksa uygula
        $hasAnyOtherRange =
        ...
        if (!$hasMainRange && !$hasAnyOtherRange) {
            $from = Carbon::today()->subDays(2)->startOfDay(); // önceki 2 gün + bugün = 3 gün
