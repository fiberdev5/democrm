      ...
      public function handle(Request $request, Closure $next)
        {
            if (Auth::check()) {
                ...
                // Yetkilendirme mantığınıza göre bunu 'can' veya 'hasPermissionTo' olarak değiştirebilirsiniz.
                if (Auth::user()->can('Kendi Servislerini Görebilir') && $request->routeIs('dashboard')) {
