...
class VerimorProvider implements SmsProviderInterface
{
    ...
    protected function getErrorMessage(int $statusCode, string $errorBody = ''): string
    {
        ...
        $httpErrors = [
            ...
            401 => 'Yetkilendirme hatası: Kullanıcı adı/şifre hatalı veya IP adresi kayıtlı değil (https://oim.verimor.com.tr/sms_settings/edit)',
            403 => 'Erişim engellendi: Yetersiz bakiye veya hesap askıda',
