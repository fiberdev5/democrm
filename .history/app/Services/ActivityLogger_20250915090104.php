...
class ActivityLogger
{
    ...
    public static function logServiceCreated($serviceId, $planId = null)
    {
        $description = $planId ? 
            "ServisID: {$serviceId}, PlanID: {$planId} Servis Planlamaya Aşama Eklendi" : 
            "ServisID: {$serviceId} Servis Kaydı Oluşturuldu";

        self::log('service_created', $description, [
            'module' => 'service',
    ...
    public static function logServiceUpdated($serviceId, $oldData, $newData, $planId = null)
    {
        $description = $planId ? 
            "ServisID: {$serviceId}, PlanID: {$planId} Servis Planlamaya Aşama Eklendi" : 
            "ServisID: {$serviceId} Servis Kaydı Güncellendi";

        self::log('service_updated', $description, [
            'module' => 'service',
            'reference_table' => 'services',
            'reference_id' => $serviceId,
            'old_values' => $oldData,
