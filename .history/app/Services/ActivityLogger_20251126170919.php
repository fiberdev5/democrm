   ...
   // Destek Talepleri Log Metodları
    ...
    public static function logSubscriptionPurchased($subscriptionId, $planName, $amount, $billingCycle)
    {
        self::log([
            'action' => 'created',
            'module' => 'subscription',
            'description' => "Yeni abonelik satın alındı: {$planName} ({$billingCycle})",
    ...
    public static function logSubscriptionUpgraded($subscriptionId, $oldPlanName, $newPlanName, $oldAmount, $newAmount)
    {
        self::log([
            'action' => 'updated',
            'module' => 'subscription',
            'description' => "Abonelik yükseltildi: {$oldPlanName} → {$newPlanName}",
            'reference_table' => 'tenant_subscriptions',
            'reference_id' => $subscriptionId,
    ...
    public static function logSubscriptionCanceled($subscriptionId, $planName, $reason = null)
    {
        self::log([
            'action' => 'deleted',
            'module' => 'subscription',
            'description' => "Abonelik iptal edildi: {$planName}" . ($reason ? " - Sebep: {$reason}" : ""),
            'reference_table' => 'tenant_subscriptions',
            'reference_id' => $subscriptionId,
            'old_values' => json_encode([
                'plan_name' => $planName,
    ...
    public static function logPaymentSuccess($paymentId, $amount, $paymentMethod, $orderId)
    {
        self::log([
            'action' => 'created',
            'module' => 'payment',
            'description' => "Ödeme başarıyla tamamlandı: {$amount} TL ({$paymentMethod})",
    ...
    public static function logPaymentFailed($paymentId, $amount, $paymentMethod, $failureReason)
    {
        self::log([
            'action' => 'updated',
            'module' => 'payment',
            'description' => "Ödeme başarısız oldu: {$amount} TL - {$failureReason}",
            'reference_table' => 'subscription_payments',
            'reference_id' => $paymentId,
            'new_values' => json_encode([
                'amount' => $amount,
    ...
    public static function logTrialStarted($tenantId, $trialDays)
    {
        self::log([
            'action' => 'created',
            'module' => 'subscription',
            'description' => "Deneme süresi başladı: {$trialDays} gün",
    ...
    public static function logSubscriptionRenewed($subscriptionId, $planName, $amount, $newEndDate)
    {
        self::log([
            'action' => 'updated',
            'module' => 'subscription',
            'description' => "Abonelik yenilendi: {$planName}",
            'reference_table' => 'tenant_subscriptions',
            'reference_id' => $subscriptionId,
            'new_values' => json_encode([
                'plan_name' => $planName,
    ...
    public static function logStoragePurchased($purchaseId, $storageGb, $amount, $packageName)
    {
        self::log([
            'action' => 'created',
            'module' => 'storage',
            'description' => "Ek depolama satın alındı: +{$storageGb} GB ({$packageName})",
    ...
    public static function logStoragePurchaseFailed($purchaseId, $storageGb, $amount, $failureReason)
    {
        self::log([
            'action' => 'updated',
            'module' => 'storage',
            'description' => "Depolama satın alma başarısız: {$storageGb} GB - {$failureReason}",
            'reference_table' => 'storage_purchases',
            'reference_id' => $purchaseId,
            'new_values' => json_encode([
                'storage_gb' => $storageGb,
    ...
    public static function logIntegrationPurchased($purchaseId, $integrationName, $amount)
    {
        self::log([
            'action' => 'created',
            'module' => 'integration',
            'description' => "Entegrasyon satın alındı: {$integrationName}",
    ...
    public static function logIntegrationPurchaseFailed($purchaseId, $integrationName, $amount, $failureReason)
    {
        self::log([
            'action' => 'updated',
            'module' => 'integration',
            'description' => "Entegrasyon satın alma başarısız: {$integrationName} - {$failureReason}",
            'reference_table' => 'integration_purchases',
            'reference_id' => $purchaseId,
            'new_values' => json_encode([
                'integration_name' => $integrationName,
    ...
    public static function logHipcallWebhookCreated($purchaseId, $webhookUrl)
    {
        self::log([
            'action' => 'created',
            'module' => 'integration',
            'description' => "Hipcall webhook oluşturuldu",
            'reference_table' => 'integration_purchases',
            'reference_id' => $purchaseId,
            'new_values' => json_encode([
    ...
    public static function logStoragePurchaseInitiated($purchaseId, $packageName, $storageGb, $amount, $paymentToken)
    {
        self::log([
            'action' => 'created',
            'module' => 'storage',
            'description' => "Depolama satın alma başlatıldı: {$packageName} ({$storageGb} GB)",
            'reference_table' => 'storage_purchases',
            'reference_id' => $purchaseId,
            'new_values' => json_encode([
                'package_name' => $packageName,
    ...
    public static function logStoragePaymentIframeError($purchaseId, $errorMessage)
    {
        self::log([
            'action' => 'updated',
            'module' => 'storage',
            'description' => "Depolama ödeme sayfası oluşturulamadı: {$errorMessage}",
            'reference_table' => 'storage_purchases',
            'reference_id' => $purchaseId,
            'new_values' => json_encode([
                'error' => $errorMessage,
    ...
    public static function logStoragePaymentSuccessPage($tenantId, $message, $packageName = null)
    {
        self::log([
            'action' => 'viewed',
            'module' => 'storage',
            'description' => "Depolama ödeme başarı sayfasına yönlendirildi",
            'reference_table' => 'tenants',
            'reference_id' => $tenantId,
            'new_values' => json_encode([
                'message' => $message,
    ...
    public static function logStoragePaymentFailPage($tenantId, $message, $reason = null)
    {
        self::log([
            'action' => 'viewed',
            'module' => 'storage',
            'description' => "Depolama ödeme başarısız - Kullanıcı hata sayfasına yönlendirildi" . ($reason ? ": {$reason}" : ""),
            'reference_table' => 'tenants',
            'reference_id' => $tenantId,
            'new_values' => json_encode([
                'message' => $message,
