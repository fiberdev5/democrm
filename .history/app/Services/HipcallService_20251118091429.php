...
public function sendCard($callId, $cardData)
{
    ...
    try {
        ...
        $response = Http::timeout(10)
            ...
            ->post($url, [
                'card' => $cardData  // ✅ 'card' key ile gönder
            ]);
...
public function createContact($contactData)
{
    ...
    try {
        ...
        // Hipcall API'ye gönderilecek veri
        $requestData = [
        ...
        // TC/Vergi bilgilerini custom_url veya not alanında saklayabilirsiniz
