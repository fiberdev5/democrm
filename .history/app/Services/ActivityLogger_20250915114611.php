...
public static function logServiceDeleted($serviceId)
{
    ...
    public static function logServiceStageAdded($serviceId, $stageName, $planId = null)
{
    self::log('service_stage_added', "ServisID: {$serviceId} Aşama Eklendi: {$stageName}", [
        'module' => 'service',
        'reference_table' => 'service_plannings',
        'reference_id' => $planId
    ]);
}
public static function ($serviceId, $stageName, $planId = null)
{
