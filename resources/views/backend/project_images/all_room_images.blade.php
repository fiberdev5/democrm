  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <a href="{{ route('add.room.image', $rooms->id)}}" class="btn btn-info mb-3 btn-sm">Ürün Resmi Ekle</a>
      </div>
    </div>
          ...
          @foreach($room_images as $item)
            <div class="col-xl-2 col-sm-4 mb-3 imgWrap">
              <div class="card text-white  o-hidden h-100">
                <img src="{{asset($item->room_images) }}" >
                <div class="row1 mt-1">
                  <span class="col-sm-12 mb-2">
                    <input value="{{$item['room']['title']}}" class="form-control" readonly>
                  </span>
                  <span class="col-sm-12">
                    <a href="{{ route('delete.room.image', $item->id)}}" class="btn btn-danger btn-sm mb-1" id="delete"><i class="fas fa-trash-alt"></i></a>
                  </span>
                  <!-- <span class="col-sm-6">
