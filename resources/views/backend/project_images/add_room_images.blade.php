      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <h4 class="card-title">Ürün Resimleri Ekleme</h4><br>
            <form method="post" action="{{ route('store.room.image')}}" enctype="multipart/form-data" class="needs-validation" novalidate>   <!--buradaki enctype veritabanına resim yüklenmesine yarıyor -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="room" class="form-select" required>
                    ...
                    <option value="{{ $room->id }}" {{ $room->id == $odalar->id ? 'selected' : ''}}>{{ $room->title }}</option>
                    @endforeach
                  </select>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input class="form-control" name="room_images[]" type="file"  id="image" multiple="" required>
