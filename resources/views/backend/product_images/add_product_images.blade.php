      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('store.product.image')}}" enctype="multipart/form-data" class="needs-validation" novalidate>   <!--buradaki enctype veritabanına resim yüklenmesine yarıyor -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="product" class="form-select" required>
                    ...
                    <option value="{{ $urun->id }}" {{ $urun->id == $products->id ? 'selected' : ''}}>{{ $urun->title }}</option>
                    @endforeach
                  </select>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input class="form-control" name="product_images[]" type="file"  id="image" multiple="" required>
