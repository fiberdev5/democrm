      ...
      <div class="col-lg-7">
        ...
        <div class="our-story">
          ...
          <div class="watch-video d-flex align-items-center position-relative">
            ...
            <a data-aos="fade-up" data-aos-delay="200" href="{{route('contact')}}" class="btn-get-started">Contact Us</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="container surecWrap py-5">
  <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
    <h3 class="display-6 mb-5">Modules That Can Be Integrated</h3>
  </div>
  <div class="">
    <div class="row g-0 feature-row">
      ...
      <div class="col-md-6 col-lg-4 wow fadeIn " data-wow-delay="0.7s">
        <div class="feature-item border h-100 container-feature" >
