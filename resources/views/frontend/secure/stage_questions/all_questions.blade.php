  ...
  <div class="col-12">
    <div class="card" style="margin-bottom: 185px;">
      <div class="card-header sayfaBaslik" style="font-size:13px;">
        Servis Aşama Soruları
      </div>
    <div class="card-body" id="servisAsamaSoru">
                    ...
                    <tr>
                      ...
                      <td style="padding-left: 2px;">
                        <a href="javascript:void(0);" data-bs-id="{{ $question->id }}" 
                           class="btn btn-warning btn-sm editStageQuestion" 
                           data-bs-toggle="modal" data-bs-target="#editStageQuestionModal" 
                           title="Düzenle">
                           <i class="fas fa-edit"></i>
                        </a>
                        <a href="javascript:void(0);" data-bs-id="{{ $question->id }}" 
                           class="btn btn-danger btn-sm deleteStageQuestion" title="Sil">
