        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div class="flex items-start space-x-2 mb-6">
            ...
            <label for="terms" class="text-sm text-gray-600">
              <a href="#" target="_blank" class="text-orange-600 hover:underline">Kullanım Koşulları</a> ve 
              <a href="#" target="_blank" class="text-orange-600 hover:underline">Gizlilik Politikası</a>'nı okudum, kabul ediyorum.
            </label>
          </div>
