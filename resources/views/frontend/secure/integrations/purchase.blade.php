                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('tenant.integrations.marketplace', $firma->id) }}">Entegrasyonlar</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('tenant.integrations.show', [$firma->id, $integration->slug]) }}">{{ $integration->name }}</a></li>
                            ...
                            <div class="col-md-8">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-md me-3">
                                        @if($integration->logo)
                                        <img src="{{ asset('frontend/' . $integration->logo) }}" alt="{{ $integration->name }}" class="rounded" style="width: 60px; height: 60px; object-fit: contain;">
                                        @else
