          ...
          <tbody>
            @foreach($roles as $item)
              <tr data-id="{{$item->id}}">
                ...
                <td class="tabloBtn">
                  <a href="javascript:void(0);" class="btn btn-warning btn-sm editRole mobilBtn mbuton1" data-bs-id="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#editRoleModal" title="Düzenle"><i class="fas fa-edit"></i> <span> Düzenle</span></a>
                  <a href="javascript:void(0);" class="btn btn-danger btn-sm mobilBtn deleteRole" data-bs-id="{{$item->id}}" title="Sil"><i class="fas fa-trash-alt"></i> <span> Sil</span></a>
                </td>
              </tr>
            @endforeach
          </tbody>
