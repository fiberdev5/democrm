...
<div class="tab-content">
  <div id="tab1" class="tab-pane active" style="padding: 0">
    <form method="post" id="editCust" class="editCust" action="{{ route('update.customer', [$firma->id, $customer->id]) }}" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <label class="col-sm-4 custom-p-r">Kayıt Tarihi<span style="font-weight: bold; color: red;">*</span></label>
      ...
      <div class="row">
        <label class="col-sm-4 custom-p-r">Müşteri Tipi: </label>
        <div class="col-sm-8 custom-p-l">
      ...
      <div class="row">
        <label class="col-sm-4 custom-p-r"><span class="musteriAdiSpan">Müşteri Adı</span><span style="font-weight: bold; color: red;">*</span></label>
        <div class="col-sm-8 custom-p-l">
      ...
      <div class="row" id="tcNo">
        <label class="col-sm-4 custom-p-r">T.C. No <span style="font-weight: bold; color: red;">*</span></label>
        <div class="col-sm-8 custom-p-l">
      ...
      <div class="row vergi-box" id="vergiBox">
        <label class="col-sm-4 custom-p-r">Vergi No/Dairesi</label>
